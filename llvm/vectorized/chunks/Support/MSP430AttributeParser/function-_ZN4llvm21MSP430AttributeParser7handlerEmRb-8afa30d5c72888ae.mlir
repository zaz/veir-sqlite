"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr, %arg1: !llvm.ptr, %arg2: i64, %arg3: !llvm.ptr):
    ...
    %3 = "llvm.mlir.constant"() <{value = 85 : i8}> : () -> i8
    %4 = "llvm.mlir.addressof"() <{global_name = @switch.table._ZN4llvm21MSP430AttributeParser7handlerEmRb}> : () -> !llvm.ptr
    ...
    %12 = "llvm.add"(%arg2, %1) <{overflowFlags = 0 : i32}> : (i64, i64) -> i64
    %13 = "llvm.icmp"(%12, %2) <{predicate = 6 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%13)[^bb1, ^bb7] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb1:  // pred: ^bb0
    %14 = "llvm.trunc"(%12) <{overflowFlags = 2 : i32}> : (i64) -> i8
    %15 = "llvm.lshr"(%3, %14) : (i8, i8) -> i8
    %16 = "llvm.trunc"(%15) <{overflowFlags = 0 : i32}> : (i8) -> i1
    "llvm.cond_br"(%16)[^bb2, ^bb7] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb2:  // pred: ^bb1
    %17 = "llvm.getelementptr"(%4, %5, %12) <{elem_type = !llvm.array<7 x ptr>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, -2147483648>}> : (!llvm.ptr, i64, i64) -> !llvm.ptr
    ...
    %20 = "llvm.load"(%19) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "_ZTSN4llvm21MSP430AttributeParser14DisplayHandlerE", members = {<#llvm.tbaa_type_desc<id = "_ZTSN4llvm11MSP430Attrs8AttrTypeE", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, 0>, <#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 8>}>, access_type = <id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, offset = 8>]}> : (!llvm.ptr) -> i64
    %21 = "llvm.getelementptr"(%18, %7) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    %24 = "llvm.and"(%20, %8) : (i64, i64) -> i64
    %25 = "llvm.icmp"(%24, %5) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%25)[^bb4, ^bb3] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb3:  // pred: ^bb2
    %26 = "llvm.load"(%23) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "vtable pointer", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, access_type = <id = "vtable pointer", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, offset = 0>]}> : (!llvm.ptr) -> !llvm.ptr
    %27 = "llvm.getelementptr"(%26, %20) <{elem_type = i8, noWrapFlags = 0 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %28 = "llvm.getelementptr"(%27, %9) <{elem_type = i8, noWrapFlags = 0 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %29 = "llvm.load"(%28) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
    "llvm.br"(%29)[^bb5] : (!llvm.ptr) -> ()
  ^bb4:  // pred: ^bb2
    %30 = "llvm.inttoptr"(%20) : (i64) -> !llvm.ptr
    "llvm.br"(%30)[^bb5] : (!llvm.ptr) -> ()
  ^bb5(%31: !llvm.ptr):  // 2 preds: ^bb3, ^bb4
    %32 = "llvm.trunc"(%arg2) <{overflowFlags = 2 : i32}> : (i64) -> i32
    "llvm.call"(%31, %arg0, %23, %32) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<tail>, arg_attrs = [{llvm.align = 8 : i64, llvm.dead_on_unwind, llvm.sret = !llvm.struct<"class.llvm::Error", (ptr)>, llvm.writable}, {llvm.align = 8 : i64, llvm.dereferenceable = 136 : i64, llvm.nonnull, llvm.noundef}, {llvm.noundef}], fastmathFlags = #llvm.fastmath<none>, no_unwind, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 4, 0>}> : (!llvm.ptr, !llvm.ptr, !llvm.ptr, i32) -> ()
    ...
    %34 = "llvm.icmp"(%33, %10) <{predicate = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> i1
    "llvm.cond_br"(%34)[^bb6, ^bb8] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb6:  // pred: ^bb5
    "llvm.store"(%11, %arg3) <{alignment = 1 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "bool", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, access_type = <id = "bool", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (i8, !llvm.ptr) -> ()
    "llvm.br"()[^bb7] : () -> ()
