"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr, %arg1: !llvm.ptr):
    ...
    %6 = "llvm.mlir.constant"() <{value = -10 : i8}> : () -> i8
  ...
  ^bb1:  // pred: ^bb0
    ...
    %14 = "llvm.load"(%13) <{alignment = 1 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, access_type = <id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, offset = 0>]}> : (!llvm.ptr) -> i8
    %15 = "llvm.getelementptr"(%13, %3) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %16 = "llvm.add"(%11, %4) <{overflowFlags = 0 : i32}> : (i64, i64) -> i64
    "llvm.store"(%15, %arg0) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "any pointer", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, access_type = <id = "any pointer", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (!llvm.ptr, !llvm.ptr) -> ()
    "llvm.store"(%16, %10) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "long", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, access_type = <id = "long", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (i64, !llvm.ptr) -> ()
    %17 = "llvm.add"(%14, %5) <{overflowFlags = 0 : i32}> : (i8, i8) -> i8
    %18 = "llvm.icmp"(%17, %6) <{predicate = 6 : i64}> : (i8, i8) -> i1
    "llvm.cond_br"(%18, %2)[^bb5, ^bb2] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i1) -> ()
  ^bb2:  // pred: ^bb1
    %19 = "llvm.zext"(%14) <{nonNeg}> : (i8) -> i32
    %20 = "llvm.add"(%19, %7) <{overflowFlags = 1 : i32}> : (i32, i32) -> i32
    "llvm.store"(%20, %arg1) <{alignment = 4 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, access_type = <id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (i32, !llvm.ptr) -> ()
    %21 = "llvm.icmp"(%16, %1) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%21, %8, %20, %16, %15)[^bb5, ^bb3] <{operandSegmentSizes = array<i32: 1, 1, 3>}> : (i1, i1, i32, i64, !llvm.ptr) -> ()
  ^bb3(%22: i32, %23: i64, %24: !llvm.ptr):  // 2 preds: ^bb2, ^bb4
    ...
    %26 = "llvm.add"(%25, %5) <{overflowFlags = 0 : i32}> : (i8, i8) -> i8
    %27 = "llvm.icmp"(%26, %6) <{predicate = 6 : i64}> : (i8, i8) -> i1
    "llvm.cond_br"(%27, %8)[^bb5, ^bb4] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i1) -> ()
  ^bb4:  // pred: ^bb3
    %28 = "llvm.zext"(%25) <{nonNeg}> : (i8) -> i32
    %29 = "llvm.getelementptr"(%24, %3) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %30 = "llvm.add"(%23, %4) <{overflowFlags = 0 : i32}> : (i64, i64) -> i64
    "llvm.store"(%29, %arg0) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "any pointer", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, access_type = <id = "any pointer", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (!llvm.ptr, !llvm.ptr) -> ()
    "llvm.store"(%30, %10) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "long", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, access_type = <id = "long", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (i64, !llvm.ptr) -> ()
    %31 = "llvm.mul"(%22, %9) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
    %32 = "llvm.add"(%31, %7) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
    %33 = "llvm.add"(%32, %28) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
    "llvm.store"(%33, %arg1) <{alignment = 4 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, access_type = <id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (i32, !llvm.ptr) -> ()
    %34 = "llvm.icmp"(%30, %1) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%34, %8, %33, %30, %29)[^bb5, ^bb3] <{loop_annotation = #llvm.loop_annotation<mustProgress = true>, operandSegmentSizes = array<i32: 1, 1, 3>}> : (i1, i1, i32, i64, !llvm.ptr) -> ()
  ^bb5(%35: i1):  // 5 preds: ^bb0, ^bb1, ^bb2, ^bb3, ^bb4
    "llvm.return"(%35) : (i1) -> ()
  }) : () -> ()
