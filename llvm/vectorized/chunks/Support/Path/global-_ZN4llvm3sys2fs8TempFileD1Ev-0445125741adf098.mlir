"builtin.module"() ({
  "llvm.mlir.alias"() <{alias_type = !llvm.func<void (ptr)>, linkage = #llvm.linkage<external>, sym_name = "_ZN4llvm3sys2fs8TempFileD1Ev", tls_mode = 0 : i64, unnamed_addr = 2 : i64, visibility_ = 0 : i64}> ({
    %13 = "llvm.mlir.addressof"() <{global_name = @_ZN4llvm3sys2fs8TempFileD2Ev}> : () -> !llvm.ptr
  ...
  ^bb0(%arg0: !llvm.ptr):
    ...
    %7 = "llvm.icmp"(%5, %6) <{predicate = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> i1
  ...
  ^bb1:  // pred: ^bb0
    ...
    %10 = "llvm.icmp"(%9, %3) <{predicate = 6 : i64}> : (i64, i64) -> i1
    "llvm.intr.assume"(%10) <{op_bundle_sizes = array<i32>}> : (i1) -> ()
    "llvm.br"()[^bb3] : () -> ()
  ^bb2:  // pred: ^bb0
    %11 = "llvm.load"(%6) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, access_type = <id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, offset = 0>]}> : (!llvm.ptr) -> i64
    %12 = "llvm.add"(%11, %2) <{overflowFlags = 0 : i32}> : (i64, i64) -> i64
    "llvm.call"(%5, %12) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<tail>, arg_attrs = [{llvm.noundef}, {llvm.noundef}], builtin, callee = @_ZdlPvm, fastmathFlags = #llvm.fastmath<none>, no_unwind, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 2, 0>}> : (!llvm.ptr, i64) -> ()
    "llvm.br"()[^bb3] : () -> ()
  ^bb3:  // 2 preds: ^bb1, ^bb2
    "llvm.return"() : () -> ()
  }) : () -> ()
