"builtin.module"() ({
  ...
  ^bb1:  // pred: ^bb0
    ...
    %15 = "llvm.lshr"(%3, %14) : (i16, i16) -> i16
    %16 = "llvm.trunc"(%15) <{overflowFlags = 0 : i32}> : (i16) -> i1
    "llvm.cond_br"(%16)[^bb2, ^bb7] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb2:  // pred: ^bb1
    %17 = "llvm.getelementptr"(%4, %5, %12) <{elem_type = !llvm.array<11 x ptr>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, -2147483648>}> : (!llvm.ptr, i64, i64) -> !llvm.ptr
