"builtin.module"() ({
  ...
  ^bb0(%arg0: i32):
    ...
    %3 = "llvm.mlir.addressof"() <{global_name = @_ZL20NumRegisteredSignals}> : () -> !llvm.ptr
    %4 = "llvm.mlir.constant"() <{value = 0 : i32}> : () -> i32
    %5 = "llvm.mlir.addressof"() <{global_name = @_ZL20RegisteredSignalInfo}> : () -> !llvm.ptr
    %6 = "llvm.mlir.constant"() <{value = 152 : i64}> : () -> i64
    ...
    %12 = "llvm.load"(%0) <{alignment = 8 : i64, ordering = 7 : i64}> : (!llvm.ptr) -> i64
    %13 = "llvm.icmp"(%12, %1) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%13)[^bb2, ^bb1] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb1:  // pred: ^bb0
    %14 = "llvm.inttoptr"(%12) : (i64) -> !llvm.ptr
    "llvm.call"(%14) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<tail>, fastmathFlags = #llvm.fastmath<none>, no_unwind, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 1, 0>}> : (!llvm.ptr) -> ()
    "llvm.br"()[^bb2] : () -> ()
  ^bb2:  // 2 preds: ^bb0, ^bb1
    "llvm.store"(%11, %10) <{alignment = 4 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, access_type = <id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (i32, !llvm.ptr) -> ()
    %15 = "llvm.icmp"(%arg0, %2) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%15)[^bb3, ^bb7] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb3:  // pred: ^bb2
    %16 = "llvm.load"(%3) <{alignment = 4 : i64, ordering = 7 : i64}> : (!llvm.ptr) -> i32
  ...
  ^bb4:  // pred: ^bb3
    ...
    "llvm.br"(%1)[^bb5] : (i64) -> ()
  ^bb5(%19: i64):  // 2 preds: ^bb4, ^bb5
    %20 = "llvm.getelementptr"(%5, %1, %19) <{elem_type = !llvm.array<16 x struct<"struct.anon.104", (struct<"struct.sigaction", (struct<"union.anon.105", (ptr)>, struct<"struct.__sigset_t", (array<16 x i64>)>, i32, ptr)>, i32)>>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, -2147483648>}> : (!llvm.ptr, i64, i64) -> !llvm.ptr
    ...
    %23 = "llvm.call"(%22, %20, %7) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<tail>, arg_attrs = [{llvm.noundef}, {llvm.nonnull, llvm.noundef}, {llvm.noundef}], callee = @sigaction, fastmathFlags = #llvm.fastmath<none>, no_unwind, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 3, 0>}> : (i32, !llvm.ptr, !llvm.ptr) -> i32
    %24 = "llvm.atomicrmw"(%3, %8) <{alignment = 4 : i64, bin_op = 2 : i64, ordering = 7 : i64}> : (!llvm.ptr, i32) -> i32
    %25 = "llvm.add"(%19, %9) <{overflowFlags = 3 : i32}> : (i64, i64) -> i64
    %26 = "llvm.icmp"(%25, %18) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%26, %25)[^bb6, ^bb5] <{loop_annotation = #llvm.loop_annotation<mustProgress = true>, operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i64) -> ()
  ^bb6:  // 2 preds: ^bb3, ^bb5
    %27 = "llvm.call"(%2) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<tail>, arg_attrs = [{llvm.noundef}], callee = @raise, fastmathFlags = #llvm.fastmath<none>, no_unwind, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 1, 0>}> : (i32) -> i32
    "llvm.br"()[^bb7] : () -> ()
  ^bb7:  // 2 preds: ^bb2, ^bb6
    "llvm.return"() : () -> ()
  }) : () -> ()
