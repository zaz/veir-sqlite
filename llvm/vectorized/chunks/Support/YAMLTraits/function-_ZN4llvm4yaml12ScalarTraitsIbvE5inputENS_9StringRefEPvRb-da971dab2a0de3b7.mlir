"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr, %arg1: i64, %arg2: !llvm.ptr, %arg3: !llvm.ptr):
    ...
    %3 = "llvm.mlir.addressof"() <{global_name = @".str.39"}> : () -> !llvm.ptr
    %4 = "llvm.mlir.constant"() <{value = 0 : i64}> : () -> i64
    %5 = "llvm.mlir.zero"() : () -> !llvm.ptr
    %6 = "llvm.mlir.poison"() : () -> !llvm.struct<(ptr, i64)>
    %7 = "llvm.call"(%arg0, %arg1) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<tail>, callee = @_ZN4llvm4yaml9parseBoolENS_9StringRefE, fastmathFlags = #llvm.fastmath<none>, no_unwind, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 2, 0>}> : (!llvm.ptr, i64) -> i16
    %8 = "llvm.and"(%7, %0) : (i16, i16) -> i16
    %9 = "llvm.icmp"(%8, %1) <{predicate = 0 : i64}> : (i16, i16) -> i1
    "llvm.cond_br"(%9, %2, %3)[^bb2, ^bb1] <{operandSegmentSizes = array<i32: 1, 2, 0>}> : (i1, i64, !llvm.ptr) -> ()
  ^bb1:  // pred: ^bb0
    %10 = "llvm.trunc"(%7) <{overflowFlags = 0 : i32}> : (i16) -> i8
  ...
  ^bb2(%11: i64, %12: !llvm.ptr):  // 2 preds: ^bb0, ^bb1
    %13 = "llvm.insertvalue"(%6, %12) <{position = array<i64: 0>}> : (!llvm.struct<(ptr, i64)>, !llvm.ptr) -> !llvm.struct<(ptr, i64)>
