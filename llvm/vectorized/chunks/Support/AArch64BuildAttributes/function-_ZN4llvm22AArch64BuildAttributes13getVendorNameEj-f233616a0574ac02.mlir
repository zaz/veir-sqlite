"builtin.module"() ({
  "llvm.mlir.global"() <{addr_space = 0 : i32, alignment = 1 : i64, constant, dso_local, global_type = !llvm.array<23 x i8>, linkage = #llvm.linkage<external>, sym_name = ".str", tls_mode = 0 : i64, unnamed_addr = 2 : i64, visibility_ = 1 : i64}> ({
  }) : () -> ()
  ...
  ^bb0(%arg0: i32):
    ...
    %5 = "llvm.mlir.addressof"() <{global_name = @".str.1"}> : () -> !llvm.ptr
    %6 = "llvm.mlir.poison"() : () -> !llvm.struct<(ptr, i64)>
    "llvm.switch"(%arg0, %0, %1)[^bb3, ^bb4, ^bb1, ^bb2] <{case_operand_segments = array<i32: 2, 0, 0>, case_values = dense<[0, 1, 404]> : vector<3xi32>, operandSegmentSizes = array<i32: 1, 0, 2>}> : (i32, i64, !llvm.ptr) -> ()
  ^bb1:  // pred: ^bb0
    "llvm.br"(%4, %5)[^bb4] : (i64, !llvm.ptr) -> ()
  ^bb2:  // pred: ^bb0
    "llvm.br"(%2, %3)[^bb4] : (i64, !llvm.ptr) -> ()
  ^bb3:  // pred: ^bb0
    "llvm.br"(%2, %3)[^bb4] : (i64, !llvm.ptr) -> ()
  ^bb4(%7: i64, %8: !llvm.ptr):  // 4 preds: ^bb0, ^bb1, ^bb2, ^bb3
