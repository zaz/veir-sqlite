"builtin.module"() ({
  ...
  ^bb1:  // pred: ^bb0
    ...
    %18 = "llvm.getelementptr"(%arg0, %9) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %19 = "llvm.load"(%18) <{alignment = 4 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> i16
    %20 = "llvm.zext"(%19) : (i16) -> i64
    %21 = "llvm.shl"(%20, %10) <{overflowFlags = 3 : i32}> : (i64, i64) -> i64
    "llvm.br"(%17, %21)[^bb3] : (i32, i64) -> ()
  ^bb2:  // pred: ^bb0
    %22 = "llvm.and"(%11, %5) : (i32, i32) -> i32
    %23 = "llvm.icmp"(%22, %1) <{predicate = 0 : i64}> : (i32, i32) -> i1
    %24 = "llvm.and"(%14, %6) : (i32, i32) -> i32
    %25 = "llvm.select"(%23, %24, %14) <{fastmathFlags = #llvm.fastmath<none>}> : (i1, i32, i32) -> i32
    "llvm.br"(%25, %7)[^bb3] : (i32, i64) -> ()
  ^bb3(%26: i32, %27: i64):  // 2 preds: ^bb1, ^bb2
