"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr, %arg1: i16):
    ...
    "llvm.cond_br"(%12, %3)[^bb1, ^bb5] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i1) -> ()
  ^bb1:  // pred: ^bb0
    %13 = "llvm.and"(%10, %4) : (i32, i32) -> i32
    %14 = "llvm.icmp"(%13, %2) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%14, %5)[^bb5, ^bb2] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i1) -> ()
  ^bb2:  // pred: ^bb1
    %15 = "llvm.shl"(%9, %6) <{overflowFlags = 2 : i32}> : (i32, i32) -> i32
    %16 = "llvm.ashr"(%15, %6) <{isExact}> : (i32, i32) -> i32
    "llvm.switch"(%16, %5)[^bb4, ^bb5, ^bb3] <{case_operand_segments = array<i32: 1, 0>, case_values = dense<[0, 1]> : vector<2xi32>, operandSegmentSizes = array<i32: 1, 0, 1>}> : (i32, i1) -> ()
  ^bb3:  // pred: ^bb2
    %17 = "llvm.and"(%10, %7) : (i32, i32) -> i32
    %18 = "llvm.icmp"(%17, %2) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.br"(%18)[^bb5] : (i1) -> ()
  ^bb4:  // pred: ^bb2
    "llvm.br"(%3)[^bb5] : (i1) -> ()
  ^bb5(%19: i1):  // 5 preds: ^bb0, ^bb1, ^bb2, ^bb3, ^bb4
    "llvm.return"(%19) : (i1) -> ()
  }) : () -> ()
