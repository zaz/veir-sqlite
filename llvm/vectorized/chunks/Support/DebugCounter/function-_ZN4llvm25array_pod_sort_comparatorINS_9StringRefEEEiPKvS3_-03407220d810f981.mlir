"builtin.module"() ({
  "llvm.comdat"() <{sym_name = "__llvm_global_comdat"}> ({
    "llvm.comdat_selector"() <{comdat = 0 : i64, sym_name = "_ZN4llvm25array_pod_sort_comparatorINS_9StringRefEEEiPKvS3_"}> : () -> ()
  }) : () -> ()
  ...
  "llvm.func"() <{CConv = #llvm.cconv<ccc>, arg_attrs = [{llvm.noundef}, {llvm.noundef}], comdat = @__llvm_global_comdat::@_ZN4llvm25array_pod_sort_comparatorINS_9StringRefEEEiPKvS3_, dso_local, function_type = !llvm.func<i32 (ptr, ptr)>, inline_hint, linkage = #llvm.linkage<weak_odr>, no_unwind, passthrough = ["mustprogress", ["min-legal-vector-width", "0"], ["no-trapping-math", "true"], ["stack-protector-buffer-size", "8"], ["target-cpu", "x86-64"]], res_attrs = [{llvm.noundef}], sym_name = "_ZN4llvm25array_pod_sort_comparatorINS_9StringRefEEEiPKvS3_", target_cpu = "x86-64", target_features = #llvm.target_features<["+cmov", "+cx8", "+fxsr", "+mmx", "+sse", "+sse2", "+x87"]>, tune_cpu = "generic", unnamed_addr = 0 : i64, uwtable_kind = #llvm.uwtableKind<async>, visibility_ = 1 : i64}> ({
  ^bb0(%arg0: !llvm.ptr, %arg1: !llvm.ptr):
    ...
    %7 = "llvm.getelementptr"(%arg1, %0) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %8 = "llvm.load"(%7) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "long", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, access_type = <id = "long", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (!llvm.ptr) -> i64
    %9 = "llvm.intr.umin"(%6, %8) : (i64, i64) -> i64
  ...
  ^bb2:  // pred: ^bb0
    %16 = "llvm.icmp"(%6, %8) <{predicate = 6 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%16, %3)[^bb10, ^bb7] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i32) -> ()
  ^bb3:  // pred: ^bb1
    %17 = "llvm.icmp"(%6, %8) <{predicate = 6 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%17, %3)[^bb10, ^bb5] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i32) -> ()
  ^bb4:  // pred: ^bb1
    %18 = "llvm.icmp"(%14, %2) <{predicate = 2 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%18, %3, %11, %12)[^bb10, ^bb6] <{operandSegmentSizes = array<i32: 1, 1, 2>}> : (i1, i32, !llvm.ptr, !llvm.ptr) -> ()
  ^bb5:  // pred: ^bb3
    ...
    "llvm.br"(%20, %19)[^bb6] : (!llvm.ptr, !llvm.ptr) -> ()
  ^bb6(%21: !llvm.ptr, %22: !llvm.ptr):  // 2 preds: ^bb4, ^bb5
    %23 = "llvm.call"(%21, %22, %9) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<tail>, arg_attrs = [{llvm.noundef}, {llvm.noundef}, {llvm.noundef}], callee = @memcmp, fastmathFlags = #llvm.fastmath<none>, memory_effects = #llvm.memory_effects<other = none, argMem = read, inaccessibleMem = none, errnoMem = none, targetMem0 = none, targetMem1 = none>, no_unwind, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 3, 0>, will_return}> : (!llvm.ptr, !llvm.ptr, i64) -> i32
  ...
  ^bb7:  // 2 preds: ^bb2, ^bb6
    %26 = "llvm.icmp"(%8, %6) <{predicate = 6 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%26, %2)[^bb9, ^bb10] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i32) -> ()
  ^bb8:  // pred: ^bb6
    %27 = "llvm.icmp"(%24, %2) <{predicate = 2 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%27, %2)[^bb9, ^bb10] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i32) -> ()
  ^bb9:  // 2 preds: ^bb7, ^bb8
    "llvm.br"(%4)[^bb10] : (i32) -> ()
  ^bb10(%28: i32):  // 6 preds: ^bb2, ^bb3, ^bb4, ^bb7, ^bb8, ^bb9
    "llvm.return"(%28) : (i32) -> ()
  }) : () -> ()
