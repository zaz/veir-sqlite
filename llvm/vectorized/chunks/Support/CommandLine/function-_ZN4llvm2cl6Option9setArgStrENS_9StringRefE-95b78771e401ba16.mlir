"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr, %arg1: !llvm.ptr, %arg2: i64):
    ...
    %2 = "llvm.mlir.constant"() <{value = 16384 : i16}> : () -> i16
    %3 = "llvm.mlir.constant"() <{value = 0 : i16}> : () -> i16
    %4 = "llvm.mlir.addressof"() <{global_name = @_ZZL12globalParservE12GlobalParser}> : () -> !llvm.ptr
    %5 = "llvm.mlir.constant"() <{value = 0 : i64}> : () -> i64
    %6 = "llvm.mlir.addressof"() <{global_name = @_ZN4llvm14object_creatorIN12_GLOBAL__N_117CommandLineParserEE4callEv}> : () -> !llvm.ptr
    %7 = "llvm.mlir.addressof"() <{global_name = @_ZN4llvm14object_deleterIN12_GLOBAL__N_117CommandLineParserEE4callEPv}> : () -> !llvm.ptr
    %8 = "llvm.mlir.constant"() <{value = 8 : i64}> : () -> i64
    %9 = "llvm.mlir.constant"() <{value = 16 : i64}> : () -> i64
    %10 = "llvm.mlir.addressof"() <{global_name = @_ZN4llvm12function_refIFvRNS_2cl10SubCommandEEE11callback_fnIZN12_GLOBAL__N_117CommandLineParser12updateArgStrEPNS1_6OptionENS_9StringRefEEUlS3_E_EEvlS3_}> : () -> !llvm.ptr
    %11 = "llvm.mlir.constant"() <{value = 24 : i64}> : () -> i64
    %12 = "llvm.mlir.constant"() <{value = 1 : i64}> : () -> i64
    %13 = "llvm.mlir.constant"() <{value = 4096 : i16}> : () -> i16
    ...
    %16 = "llvm.alloca"(%0) <{alignment = 8 : i64, elem_type = !llvm.struct<"class.anon.236", (ptr, ptr, ptr)>}> : (i32) -> !llvm.ptr
  ...
  ^bb4:  // 2 preds: ^bb0, ^bb3
    ...
    %31 = "llvm.icmp"(%arg2, %12) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%31)[^bb5, ^bb6] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb5:  // pred: ^bb4
    %32 = "llvm.load"(%17) <{alignment = 2 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> i16
    %33 = "llvm.or"(%32, %13) : (i16, i16) -> i16
    "llvm.store"(%33, %17) <{alignment = 2 : i64, ordering = 0 : i64}> : (i16, !llvm.ptr) -> ()
    "llvm.br"()[^bb6] : () -> ()
  ^bb6:  // 2 preds: ^bb4, ^bb5
    "llvm.return"() : () -> ()
  }) : () -> ()
