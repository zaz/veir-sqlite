"builtin.module"() ({
  "llvm.comdat"() <{sym_name = "__llvm_global_comdat"}> ({
    "llvm.comdat_selector"() <{comdat = 0 : i64, sym_name = "_ZN4llvm2cl3optIjLb0ENS0_6parserIjEEEC2IJA1_cEEEDpRKT_"}> : () -> ()
  }) : () -> ()
  "llvm.mlir.global"() <{addr_space = 0 : i32, alignment = 8 : i64, constant, global_type = !llvm.struct<(array<6 x ptr>)>, linkage = #llvm.linkage<external>, sym_name = "_ZTVN4llvm2cl6parserIjEE", tls_mode = 0 : i64, unnamed_addr = 2 : i64, visibility_ = 0 : i64}> ({
  }) : () -> ()
  "llvm.mlir.global"() <{addr_space = 0 : i32, alignment = 8 : i64, constant, global_type = !llvm.struct<(array<13 x ptr>)>, linkage = #llvm.linkage<external>, sym_name = "_ZTVN4llvm2cl3optIjLb0ENS0_6parserIjEEEE", tls_mode = 0 : i64, unnamed_addr = 2 : i64, visibility_ = 0 : i64}> ({
  }) : () -> ()
  ...
  ^bb0(%arg0: !llvm.ptr, %arg1: !llvm.ptr):
    ...
    %7 = "llvm.mlir.addressof"() <{global_name = @_ZTVN4llvm2cl11OptionValueIjEE}> : () -> !llvm.ptr
    %8 = "llvm.getelementptr"(%7, %6) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %9 = "llvm.mlir.addressof"() <{global_name = @_ZTVN4llvm2cl3optIjLb0ENS0_6parserIjEEEE}> : () -> !llvm.ptr
    ...
    %12 = "llvm.mlir.addressof"() <{global_name = @_ZTVN4llvm2cl6parserIjEE}> : () -> !llvm.ptr
