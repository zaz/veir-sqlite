"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr, %arg1: !llvm.ptr):
    ...
    %14 = "llvm.trunc"(%13) <{overflowFlags = 3 : i32}> : (i64) -> i32
    %15 = "llvm.icmp"(%10, %3) <{predicate = 0 : i64}> : (i32, i32) -> i1
  ...
  ^bb1:  // pred: ^bb0
    ...
    "llvm.br"(%3)[^bb2] : (i32) -> ()
  ^bb2(%18: i32):  // 2 preds: ^bb1, ^bb2
    %19 = "llvm.zext"(%18) <{nonNeg}> : (i32) -> i64
    %20 = "llvm.getelementptr"(%16, %19) <{elem_type = i64, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %21 = "llvm.load"(%20) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "long", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, access_type = <id = "long", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (!llvm.ptr) -> i64
    %22 = "llvm.getelementptr"(%17, %19) <{elem_type = i64, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %23 = "llvm.load"(%22) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "long", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, access_type = <id = "long", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (!llvm.ptr) -> i64
    %24 = "llvm.xor"(%23, %5) : (i64, i64) -> i64
    %25 = "llvm.and"(%21, %24) : (i64, i64) -> i64
    %26 = "llvm.icmp"(%25, %6) <{predicate = 0 : i64}> : (i64, i64) -> i1
    %27 = "llvm.add"(%18, %7) <{overflowFlags = 3 : i32}> : (i32, i32) -> i32
    %28 = "llvm.icmp"(%27, %14) <{predicate = 1 : i64}> : (i32, i32) -> i1
    %29 = "llvm.select"(%26, %28, %8) <{fastmathFlags = #llvm.fastmath<none>}> : (i1, i1, i1) -> i1
    "llvm.cond_br"(%29, %27, %26)[^bb2, ^bb3] <{loop_annotation = #llvm.loop_annotation<mustProgress = true>, operandSegmentSizes = array<i32: 1, 1, 1>}> : (i1, i32, i1) -> ()
  ^bb3(%30: i1):  // 2 preds: ^bb0, ^bb2
    "llvm.return"(%30) : (i1) -> ()
  }) : () -> ()
