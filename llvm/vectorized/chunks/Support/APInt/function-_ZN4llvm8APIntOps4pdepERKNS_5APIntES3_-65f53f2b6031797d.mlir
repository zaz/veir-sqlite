"builtin.module"() ({
  ...
  ^bb5:  // pred: ^bb4
    ...
    %50 = "llvm.and"(%45, %8) : (i32, i32) -> i32
    %51 = "llvm.zext"(%50) <{nonNeg}> : (i32) -> i64
    %52 = "llvm.shl"(%9, %51) <{overflowFlags = 2 : i32}> : (i64, i64) -> i64
    %53 = "llvm.and"(%52, %40) : (i64, i64) -> i64
    %54 = "llvm.icmp"(%53, %6) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%54)[^bb7, ^bb6] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb6:  // pred: ^bb5
    %55 = "llvm.or"(%44, %46) : (i64, i64) -> i64
    "llvm.br"(%55, %49)[^bb8] : (i64, i32) -> ()
  ^bb7:  // pred: ^bb5
    %56 = "llvm.xor"(%46, %12) : (i64, i64) -> i64
  ...
  ^bb10:  // pred: ^bb9
    ...
    %73 = "llvm.and"(%64, %8) : (i32, i32) -> i32
    %74 = "llvm.zext"(%73) <{nonNeg}> : (i32) -> i64
    %75 = "llvm.shl"(%9, %74) <{overflowFlags = 2 : i32}> : (i64, i64) -> i64
    %76 = "llvm.and"(%75, %40) : (i64, i64) -> i64
    %77 = "llvm.icmp"(%76, %6) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%77)[^bb12, ^bb11] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb11:  // pred: ^bb10
    %78 = "llvm.or"(%63, %65) : (i64, i64) -> i64
    "llvm.br"(%78, %72)[^bb13] : (i64, i32) -> ()
  ^bb12:  // pred: ^bb10
    %79 = "llvm.xor"(%65, %12) : (i64, i64) -> i64
  ...
  ^bb16:  // pred: ^bb15
    ...
    %99 = "llvm.and"(%86, %8) : (i32, i32) -> i32
    %100 = "llvm.zext"(%99) <{nonNeg}> : (i32) -> i64
    %101 = "llvm.shl"(%9, %100) <{overflowFlags = 2 : i32}> : (i64, i64) -> i64
    %102 = "llvm.lshr"(%86, %10) : (i32, i32) -> i32
    %103 = "llvm.zext"(%102) <{nonNeg}> : (i32) -> i64
    %104 = "llvm.getelementptr"(%33, %103) <{elem_type = i64, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %105 = "llvm.select"(%32, %arg1, %104) <{fastmathFlags = #llvm.fastmath<none>}> : (i1, !llvm.ptr, !llvm.ptr) -> !llvm.ptr
    ...
    %107 = "llvm.and"(%106, %101) : (i64, i64) -> i64
    %108 = "llvm.icmp"(%107, %6) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%108)[^bb18, ^bb17] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb17:  // pred: ^bb16
    %109 = "llvm.getelementptr"(%26, %92) <{elem_type = i64, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    %111 = "llvm.or"(%110, %90) : (i64, i64) -> i64
    ...
    "llvm.br"(%98)[^bb19] : (i32) -> ()
  ^bb18:  // pred: ^bb16
    %112 = "llvm.xor"(%90, %12) : (i64, i64) -> i64
    %113 = "llvm.getelementptr"(%26, %92) <{elem_type = i64, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    "llvm.store"(%115, %113) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, access_type = <id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, offset = 0>]}> : (i64, !llvm.ptr) -> ()
    "llvm.br"(%98)[^bb19] : (i32) -> ()
  ^bb19(%116: i32):  // 3 preds: ^bb15, ^bb17, ^bb18
    %117 = "llvm.add"(%87, %11) <{overflowFlags = 2 : i32}> : (i32, i32) -> i32
    %118 = "llvm.icmp"(%117, %18) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%118, %116, %117)[^bb20, ^bb15] <{loop_annotation = #llvm.loop_annotation<mustProgress = true>, operandSegmentSizes = array<i32: 1, 0, 2>}> : (i1, i32, i32) -> ()
