"builtin.module"() ({
  ...
  ^bb2:  // pred: ^bb0
    ...
    %11 = "llvm.add"(%10, %2) <{overflowFlags = 3 : i32}> : (i64, i64) -> i64
    %12 = "llvm.lshr"(%11, %3) : (i64, i64) -> i64
    %13 = "llvm.and"(%12, %4) : (i64, i64) -> i64
    ...
    "llvm.store"(%14, %arg0) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, access_type = <id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, offset = 0>]}> : (!llvm.ptr, !llvm.ptr) -> ()
    ...
    "llvm.intr.memcpy"(%14, %15, %13) <{arg_attrs = [{llvm.align = 8 : i64, llvm.nonnull}, {llvm.align = 8 : i64}, {}], isVolatile = false}> : (!llvm.ptr, !llvm.ptr, i64) -> ()
    "llvm.br"()[^bb3] : () -> ()
  ^bb3:  // 2 preds: ^bb1, ^bb2
    "llvm.return"() : () -> ()
  }) : () -> ()
