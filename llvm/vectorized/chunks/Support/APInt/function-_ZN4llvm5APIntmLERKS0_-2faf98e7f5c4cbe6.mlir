"builtin.module"() ({
  ...
  ^bb1:  // pred: ^bb0
    ...
    %16 = "llvm.load"(%arg1) <{alignment = 8 : i64, noalias_scopes = [#llvm.alias_scope<id = distinct[0]<>, domain = <id = distinct[1]<>, description = "_ZNK4llvm5APIntmlERKS0_">, description = "_ZNK4llvm5APIntmlERKS0_: argument 0">], ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, access_type = <id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, offset = 0>]}> : (!llvm.ptr) -> i64
    %17 = "llvm.mul"(%16, %15) <{overflowFlags = 0 : i32}> : (i64, i64) -> i64
    %18 = "llvm.add"(%13, %7) <{overflowFlags = 3 : i32}> : (i32, i32) -> i32
    %19 = "llvm.and"(%18, %7) : (i32, i32) -> i32
    %20 = "llvm.xor"(%19, %7) : (i32, i32) -> i32
    %21 = "llvm.zext"(%20) <{nonNeg}> : (i32) -> i64
    %22 = "llvm.lshr"(%8, %21) : (i64, i64) -> i64
    %23 = "llvm.icmp"(%13, %11) <{predicate = 0 : i64}> : (i32, i32) -> i1
    %24 = "llvm.select"(%23, %5, %22) <{fastmathFlags = #llvm.fastmath<none>}> : (i1, i64, i64) -> i64
    %25 = "llvm.and"(%17, %24) : (i64, i64) -> i64
    "llvm.br"(%25)[^bb6] : (i64) -> ()
  ^bb2:  // pred: ^bb0
    %26 = "llvm.zext"(%13) : (i32) -> i64
  ...
  ^bb4:  // pred: ^bb3
    ...
    "llvm.store"(%54, %52) <{alignment = 8 : i64, noalias_scopes = [#llvm.alias_scope<id = distinct[0]<>, domain = <id = distinct[1]<>, description = "_ZNK4llvm5APIntmlERKS0_">, description = "_ZNK4llvm5APIntmlERKS0_: argument 0">], ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, access_type = <id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, offset = 0>]}> : (i64, !llvm.ptr) -> ()
    %55 = "llvm.icmp"(%32, %10) <{predicate = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> i1
    "llvm.cond_br"(%55, %44)[^bb6, ^bb5] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i64) -> ()
  ^bb5:  // pred: ^bb4
    ...
    "llvm.br"(%44)[^bb6] : (i64) -> ()
  ^bb6(%56: i64):  // 3 preds: ^bb1, ^bb4, ^bb5
    "llvm.store"(%56, %arg0) <{alignment = 8 : i64, ordering = 0 : i64}> : (i64, !llvm.ptr) -> ()
