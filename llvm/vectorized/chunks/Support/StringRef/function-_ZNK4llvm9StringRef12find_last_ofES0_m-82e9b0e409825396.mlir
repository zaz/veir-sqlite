"builtin.module"() ({
  ...
  ^bb7:  // pred: ^bb6
    ...
    "llvm.cond_br"(%62, %52, %52)[^bb6, ^bb8] <{loop_annotation = #llvm.loop_annotation<mustProgress = true>, operandSegmentSizes = array<i32: 1, 1, 1>}> : (i1, i64, i64) -> ()
