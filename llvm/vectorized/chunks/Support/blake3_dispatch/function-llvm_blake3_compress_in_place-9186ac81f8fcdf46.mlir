"builtin.module"() ({
  ...
  ^bb6(%55: i32):  // 5 preds: ^bb1, ^bb2, ^bb3, ^bb4, ^bb5
    ...
    "llvm.br"()[^bb7] : () -> ()
  ^bb7:  // 2 preds: ^bb0, ^bb6
    "llvm.call"(%arg0, %arg1, %arg2, %arg3, %arg4) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<tail>, arg_attrs = [{llvm.noundef}, {llvm.noundef}, {llvm.noundef, llvm.zeroext}, {llvm.noundef}, {llvm.noundef, llvm.zeroext}], callee = @llvm_blake3_compress_in_place_portable, fastmathFlags = #llvm.fastmath<none>, no_unwind, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 5, 0>}> : (!llvm.ptr, !llvm.ptr, i8, i64, i8) -> ()
    "llvm.return"() : () -> ()
  }) : () -> ()
