"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr):
    ...
    %19 = "llvm.mlir.addressof"() <{global_name = @_ZN4llvm11APFloatBase16semFloat8E8M0FNUE}> : () -> !llvm.ptr
    %20 = "llvm.mlir.constant"() <{value = true}> : () -> i1
    %21 = "llvm.mlir.constant"() <{value = 4294967295 : i64}> : () -> i64
    %22 = "llvm.mlir.constant"() <{value = 64 : i32}> : () -> i32
    %23 = "llvm.mlir.constant"() <{value = 9223372036854775806 : i64}> : () -> i64
    %24 = "llvm.getelementptr"(%arg0, %0) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %25 = "llvm.load"(%24) <{alignment = 4 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> i8
    %26 = "llvm.and"(%25, %1) : (i8, i8) -> i8
    %27 = "llvm.icmp"(%26, %2) <{predicate = 1 : i64}> : (i8, i8) -> i1
    %28 = "llvm.and"(%25, %3) : (i8, i8) -> i8
    %29 = "llvm.icmp"(%28, %4) <{predicate = 1 : i64}> : (i8, i8) -> i1
    %30 = "llvm.and"(%27, %29) : (i1, i1) -> i1
  ...
  ^bb1:  // pred: ^bb0
    ...
    "llvm.br"(%33, %35)[^bb3] : (!llvm.ptr, i1) -> ()
  ^bb2:  // pred: ^bb0
    %36 = "llvm.load"(%arg0) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "_ZTSN4llvm6detail9IEEEFloatE", members = {<#llvm.tbaa_type_desc<id = "any pointer", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, 0>, <#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 8>, <#llvm.tbaa_type_desc<id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, 16>, <#llvm.tbaa_type_desc<id = "_ZTSN4llvm11APFloatBase11fltCategoryE", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, 20>, <#llvm.tbaa_type_desc<id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, 20>}>, access_type = <id = "any pointer", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (!llvm.ptr) -> !llvm.ptr
    "llvm.br"(%36, %5)[^bb3] : (!llvm.ptr, i1) -> ()
  ^bb3(%37: !llvm.ptr, %38: i1):  // 2 preds: ^bb1, ^bb2
    %39 = "llvm.getelementptr"(%37, %6) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    "llvm.cond_br"(%41)[^bb4, ^bb14] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb4:  // pred: ^bb3
    %42 = "llvm.getelementptr"(%37, %0) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    "llvm.cond_br"(%44)[^bb5, ^bb14] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb5:  // pred: ^bb4
    "llvm.cond_br"(%38, %5)[^bb6, ^bb21] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i1) -> ()
  ^bb6:  // pred: ^bb5
    %45 = "llvm.icmp"(%37, %19) <{predicate = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> i1
    "llvm.cond_br"(%45, %20)[^bb21, ^bb7] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i1) -> ()
  ^bb7:  // pred: ^bb6
    %46 = "llvm.getelementptr"(%37, %8) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %47 = "llvm.load"(%46) <{alignment = 4 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "_ZTSN4llvm12fltSemanticsE", members = {<#llvm.tbaa_type_desc<id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, 0>, <#llvm.tbaa_type_desc<id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, 4>, <#llvm.tbaa_type_desc<id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, 8>, <#llvm.tbaa_type_desc<id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, 12>, <#llvm.tbaa_type_desc<id = "_ZTSN4llvm20fltNonfiniteBehaviorE", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, 16>, <#llvm.tbaa_type_desc<id = "_ZTSN4llvm14fltNanEncodingE", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, 20>, <#llvm.tbaa_type_desc<id = "bool", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, 24>, <#llvm.tbaa_type_desc<id = "bool", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, 25>, <#llvm.tbaa_type_desc<id = "bool", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, 26>, <#llvm.tbaa_type_desc<id = "bool", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, 27>, <#llvm.tbaa_type_desc<id = "bool", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, 28>}>, access_type = <id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 8>]}> : (!llvm.ptr) -> i32
    %48 = "llvm.add"(%47, %9) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
    %49 = "llvm.icmp"(%48, %10) <{predicate = 6 : i64}> : (i32, i32) -> i1
    ...
    %52 = "llvm.select"(%49, %51, %50) <{fastmathFlags = #llvm.fastmath<none>}> : (i1, !llvm.ptr, !llvm.ptr) -> !llvm.ptr
    %53 = "llvm.load"(%52) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "long", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, access_type = <id = "long", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (!llvm.ptr) -> i64
    %54 = "llvm.and"(%53, %17) : (i64, i64) -> i64
    %55 = "llvm.icmp"(%54, %15) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%55, %5)[^bb8, ^bb21] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i1) -> ()
  ^bb8:  // pred: ^bb7
    %56 = "llvm.add"(%47, %11) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
    %57 = "llvm.lshr"(%56, %12) : (i32, i32) -> i32
    %58 = "llvm.intr.umax"(%57, %7) : (i32, i32) -> i32
    %59 = "llvm.add"(%58, %13) <{overflowFlags = 1 : i32}> : (i32, i32) -> i32
    %60 = "llvm.icmp"(%59, %14) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%60, %53)[^bb13, ^bb9] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i64) -> ()
  ^bb9:  // pred: ^bb8
    %61 = "llvm.zext"(%59) <{nonNeg}> : (i32) -> i64
    "llvm.br"(%15)[^bb11] : (i64) -> ()
  ^bb10:  // pred: ^bb11
    %62 = "llvm.add"(%64, %17) <{overflowFlags = 3 : i32}> : (i64, i64) -> i64
    %63 = "llvm.icmp"(%62, %61) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%63, %62)[^bb12, ^bb11] <{loop_annotation = #llvm.loop_annotation<mustProgress = true>, operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i64) -> ()
  ^bb11(%64: i64):  // 2 preds: ^bb9, ^bb10
    %65 = "llvm.getelementptr"(%52, %64) <{elem_type = i64, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %66 = "llvm.load"(%65) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "long", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, access_type = <id = "long", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (!llvm.ptr) -> i64
    %67 = "llvm.icmp"(%64, %15) <{predicate = 0 : i64}> : (i64, i64) -> i1
    %68 = "llvm.zext"(%67) : (i1) -> i64
    %69 = "llvm.and"(%66, %21) : (i64, i64) -> i64
    %70 = "llvm.or"(%69, %68) : (i64, i64) -> i64
    %71 = "llvm.icmp"(%70, %21) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%71, %5)[^bb10, ^bb21] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i1) -> ()
  ^bb12:  // pred: ^bb10
    %72 = "llvm.getelementptr"(%52, %61) <{elem_type = i64, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %73 = "llvm.load"(%72) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "long", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, access_type = <id = "long", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (!llvm.ptr) -> i64
    "llvm.br"(%73)[^bb13] : (i64) -> ()
  ^bb13(%74: i64):  // 2 preds: ^bb8, ^bb12
    %75 = "llvm.icmp"(%47, %7) <{predicate = 8 : i64}> : (i32, i32) -> i1
    %76 = "llvm.sext"(%75) : (i1) -> i32
    %77 = "llvm.add"(%47, %22) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
    %78 = "llvm.add"(%77, %76) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
    %79 = "llvm.shl"(%58, %12) <{overflowFlags = 2 : i32}> : (i32, i32) -> i32
    %80 = "llvm.sub"(%78, %79) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
    %81 = "llvm.zext"(%80) <{nonNeg}> : (i32) -> i64
    %82 = "llvm.shl"(%16, %81) <{overflowFlags = 1 : i32}> : (i64, i64) -> i64
    %83 = "llvm.or"(%74, %82) : (i64, i64) -> i64
    %84 = "llvm.and"(%83, %23) : (i64, i64) -> i64
    %85 = "llvm.icmp"(%84, %23) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.br"(%85)[^bb21] : (i1) -> ()
  ^bb14:  // 2 preds: ^bb3, ^bb4
    "llvm.cond_br"(%38, %5)[^bb15, ^bb21] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i1) -> ()
  ^bb15:  // pred: ^bb14
    %86 = "llvm.getelementptr"(%37, %8) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %87 = "llvm.load"(%86) <{alignment = 4 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "_ZTSN4llvm12fltSemanticsE", members = {<#llvm.tbaa_type_desc<id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, 0>, <#llvm.tbaa_type_desc<id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, 4>, <#llvm.tbaa_type_desc<id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, 8>, <#llvm.tbaa_type_desc<id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, 12>, <#llvm.tbaa_type_desc<id = "_ZTSN4llvm20fltNonfiniteBehaviorE", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, 16>, <#llvm.tbaa_type_desc<id = "_ZTSN4llvm14fltNanEncodingE", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, 20>, <#llvm.tbaa_type_desc<id = "bool", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, 24>, <#llvm.tbaa_type_desc<id = "bool", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, 25>, <#llvm.tbaa_type_desc<id = "bool", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, 26>, <#llvm.tbaa_type_desc<id = "bool", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, 27>, <#llvm.tbaa_type_desc<id = "bool", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, 28>}>, access_type = <id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 8>]}> : (!llvm.ptr) -> i32
    %88 = "llvm.add"(%87, %9) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
    %89 = "llvm.icmp"(%88, %10) <{predicate = 6 : i64}> : (i32, i32) -> i1
    %90 = "llvm.getelementptr"(%arg0, %8) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %91 = "llvm.load"(%90) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
    %92 = "llvm.select"(%89, %91, %90) <{fastmathFlags = #llvm.fastmath<none>}> : (i1, !llvm.ptr, !llvm.ptr) -> !llvm.ptr
    %93 = "llvm.add"(%87, %11) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
    %94 = "llvm.lshr"(%93, %12) : (i32, i32) -> i32
    %95 = "llvm.intr.umax"(%94, %7) : (i32, i32) -> i32
    %96 = "llvm.add"(%95, %13) <{overflowFlags = 1 : i32}> : (i32, i32) -> i32
    %97 = "llvm.icmp"(%96, %14) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%97)[^bb19, ^bb16] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb16:  // pred: ^bb15
    %98 = "llvm.zext"(%96) <{nonNeg}> : (i32) -> i64
    "llvm.br"(%15)[^bb18] : (i64) -> ()
  ^bb17:  // pred: ^bb18
    %99 = "llvm.add"(%101, %17) <{overflowFlags = 3 : i32}> : (i64, i64) -> i64
    %100 = "llvm.icmp"(%99, %98) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%100, %99)[^bb19, ^bb18] <{loop_annotation = #llvm.loop_annotation<mustProgress = true>, operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i64) -> ()
  ^bb18(%101: i64):  // 2 preds: ^bb16, ^bb17
    %102 = "llvm.getelementptr"(%92, %101) <{elem_type = i64, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %103 = "llvm.load"(%102) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "long", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, access_type = <id = "long", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (!llvm.ptr) -> i64
    %104 = "llvm.icmp"(%103, %16) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%104, %5)[^bb17, ^bb21] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i1) -> ()
  ^bb19:  // 2 preds: ^bb15, ^bb17
    %105 = "llvm.icmp"(%87, %18) <{predicate = 6 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%105, %5)[^bb21, ^bb20] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i1) -> ()
  ^bb20:  // pred: ^bb19
    %106 = "llvm.shl"(%95, %12) <{overflowFlags = 2 : i32}> : (i32, i32) -> i32
    %107 = "llvm.sub"(%93, %106) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
    %108 = "llvm.zext"(%107) <{nonNeg}> : (i32) -> i64
    %109 = "llvm.shl"(%16, %108) <{overflowFlags = 1 : i32}> : (i64, i64) -> i64
    %110 = "llvm.zext"(%96) <{nonNeg}> : (i32) -> i64
    %111 = "llvm.getelementptr"(%92, %110) <{elem_type = i64, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %112 = "llvm.load"(%111) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "long", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, access_type = <id = "long", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (!llvm.ptr) -> i64
    %113 = "llvm.or"(%112, %109) : (i64, i64) -> i64
    %114 = "llvm.icmp"(%113, %16) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.br"(%114)[^bb21] : (i1) -> ()
  ^bb21(%115: i1):  // 9 preds: ^bb5, ^bb6, ^bb7, ^bb11, ^bb13, ^bb14, ^bb18, ^bb19, ^bb20
    "llvm.return"(%115) : (i1) -> ()
  }) : () -> ()
