"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr):
    ...
    %17 = "llvm.mlir.constant"() <{value = -49064778989728563 : i64}> : () -> i64
    %18 = "llvm.mlir.constant"() <{value = 10 : i64}> : () -> i64
    %19 = "llvm.mlir.constant"() <{value = 18 : i64}> : () -> i64
    %20 = "llvm.alloca"(%0) <{alignment = 1 : i64, elem_type = !llvm.struct<"struct.std::array.99", (array<18 x i8>)>}> : (i32) -> !llvm.ptr
    %21 = "llvm.alloca"(%0) <{alignment = 1 : i64, elem_type = !llvm.struct<"struct.std::array", (array<6 x i8>)>}> : (i32) -> !llvm.ptr
    ...
    %25 = "llvm.icmp"(%24, %3) <{predicate = 1 : i64}> : (i8, i8) -> i1
    %26 = "llvm.and"(%23, %4) : (i8, i8) -> i8
    %27 = "llvm.icmp"(%26, %5) <{predicate = 1 : i64}> : (i8, i8) -> i1
    %28 = "llvm.and"(%25, %27) : (i1, i1) -> i1
    "llvm.cond_br"(%28)[^bb2, ^bb1] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb1:  // pred: ^bb0
    %29 = "llvm.icmp"(%26, %6) <{predicate = 0 : i64}> : (i8, i8) -> i1
    %30 = "llvm.lshr"(%23, %5) : (i8, i8) -> i8
    %31 = "llvm.and"(%30, %6) : (i8, i8) -> i8
    %32 = "llvm.select"(%29, %3, %31) <{fastmathFlags = #llvm.fastmath<none>}> : (i1, i8, i8) -> i8
    ...
    "llvm.store"(%26, %21) <{alignment = 1 : i64, ordering = 0 : i64}> : (i8, !llvm.ptr) -> ()
    %35 = "llvm.getelementptr"(%21, %8) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
  ...
  ^bb2:  // pred: ^bb0
    ...
    %45 = "llvm.add"(%44, %12) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
    %46 = "llvm.icmp"(%45, %13) <{predicate = 6 : i64}> : (i32, i32) -> i1
    ...
    %49 = "llvm.select"(%46, %48, %47) <{fastmathFlags = #llvm.fastmath<none>}> : (i1, !llvm.ptr, !llvm.ptr) -> !llvm.ptr
    %50 = "llvm.add"(%44, %14) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
    %51 = "llvm.lshr"(%50, %15) : (i32, i32) -> i32
    %52 = "llvm.intr.umax"(%51, %0) : (i32, i32) -> i32
    %53 = "llvm.shl"(%52, %16) <{overflowFlags = 3 : i32}> : (i32, i32) -> i32
    %54 = "llvm.zext"(%53) <{nonNeg}> : (i32) -> i64
    %55 = "llvm.call"(%49, %54) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<tail>, arg_attrs = [{llvm.noundef}, {llvm.noundef}], callee = @_ZN4llvm11xxh3_64bitsEPKhm, fastmathFlags = #llvm.fastmath<none>, no_unwind, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 2, 0>, res_attrs = [{llvm.noundef}]}> : (!llvm.ptr, i64) -> i64
    %56 = "llvm.xor"(%55, %17) : (i64, i64) -> i64
    "llvm.intr.lifetime.start"(%20) : (!llvm.ptr) -> ()
    "llvm.store"(%26, %20) <{alignment = 1 : i64, ordering = 0 : i64}> : (i8, !llvm.ptr) -> ()
    %57 = "llvm.getelementptr"(%20, %8) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    "llvm.store"(%40, %57) <{alignment = 1 : i64, ordering = 0 : i64}> : (i8, !llvm.ptr) -> ()
    %58 = "llvm.load"(%42) <{alignment = 4 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, access_type = <id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (!llvm.ptr) -> i32
    %59 = "llvm.getelementptr"(%20, %9) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    "llvm.store"(%58, %59) <{alignment = 1 : i64, ordering = 0 : i64}> : (i32, !llvm.ptr) -> ()
    %60 = "llvm.load"(%43) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, access_type = <id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (!llvm.ptr) -> i32
    %61 = "llvm.getelementptr"(%20, %10) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    "llvm.store"(%60, %61) <{alignment = 1 : i64, ordering = 0 : i64}> : (i32, !llvm.ptr) -> ()
    %62 = "llvm.getelementptr"(%20, %18) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    "llvm.store"(%56, %62) <{alignment = 1 : i64, ordering = 0 : i64}> : (i64, !llvm.ptr) -> ()
    %63 = "llvm.call"(%20, %19) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<none>, arg_attrs = [{llvm.nonnull, llvm.noundef}, {llvm.noundef}], callee = @_ZN4llvm11xxh3_64bitsEPKhm, fastmathFlags = #llvm.fastmath<none>, no_unwind, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 2, 0>, res_attrs = [{llvm.noundef}]}> : (!llvm.ptr, i64) -> i64
    "llvm.intr.lifetime.end"(%20) : (!llvm.ptr) -> ()
    "llvm.br"(%63)[^bb3] : (i64) -> ()
  ^bb3(%64: i64):  // 2 preds: ^bb1, ^bb2
    %65 = "llvm.xor"(%64, %17) : (i64, i64) -> i64
    "llvm.return"(%65) : (i64) -> ()
  }) : () -> ()
