"builtin.module"() ({
  ...
  ^bb3(%29: i64):  // 2 preds: ^bb1, ^bb2
    ...
    "llvm.cond_br"(%32, %9)[^bb2, ^bb7] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i1) -> ()
  ^bb4:  // 2 preds: ^bb0, ^bb2
    %33 = "llvm.icmp"(%15, %5) <{predicate = 8 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%33)[^bb5, ^bb6] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb5:  // pred: ^bb4
    %34 = "llvm.shl"(%23, %4) <{overflowFlags = 2 : i32}> : (i32, i32) -> i32
    %35 = "llvm.sub"(%34, %15) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
    %36 = "llvm.add"(%35, %5) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
    %37 = "llvm.zext"(%36) <{nonNeg}> : (i32) -> i64
    %38 = "llvm.lshr"(%11, %37) : (i64, i64) -> i64
    %39 = "llvm.zext"(%24) <{nonNeg}> : (i32) -> i64
    %40 = "llvm.getelementptr"(%20, %39) <{elem_type = i64, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %41 = "llvm.load"(%40) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "long", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, access_type = <id = "long", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (!llvm.ptr) -> i64
    %42 = "llvm.and"(%41, %38) : (i64, i64) -> i64
    %43 = "llvm.icmp"(%42, %8) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%43, %9)[^bb6, ^bb7] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i1) -> ()
  ^bb6:  // 2 preds: ^bb4, ^bb5
    "llvm.br"(%12)[^bb7] : (i1) -> ()
  ^bb7(%44: i1):  // 3 preds: ^bb3, ^bb5, ^bb6
    "llvm.return"(%44) : (i1) -> ()
  }) : () -> ()
