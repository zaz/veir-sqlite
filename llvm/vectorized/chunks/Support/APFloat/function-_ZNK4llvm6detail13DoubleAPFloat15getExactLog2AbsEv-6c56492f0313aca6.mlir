"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr):
    ...
    %8 = "llvm.mlir.constant"() <{value = 6 : i8}> : () -> i8
    ...
    %25 = "llvm.load"(%24) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, access_type = <id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, offset = 0>]}> : (!llvm.ptr) -> !llvm.ptr
    %26 = "llvm.icmp"(%25, %2) <{predicate = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> i1
    %27 = "llvm.getelementptr"(%23, %3) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %28 = "llvm.load"(%27) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
    %29 = "llvm.select"(%26, %28, %24) <{fastmathFlags = #llvm.fastmath<none>}> : (i1, !llvm.ptr, !llvm.ptr) -> !llvm.ptr
    ...
    "llvm.cond_br"(%33, %23, %7)[^bb1, ^bb12] <{operandSegmentSizes = array<i32: 1, 1, 1>}> : (i1, !llvm.ptr, i32) -> ()
  ^bb1(%34: !llvm.ptr):  // 2 preds: ^bb0, ^bb11
    ...
    "llvm.cond_br"(%36)[^bb11, ^bb2] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb2:  // pred: ^bb1
    %37 = "llvm.getelementptr"(%34, %4) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %38 = "llvm.load"(%37) <{alignment = 4 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> i8
    %39 = "llvm.and"(%38, %8) : (i8, i8) -> i8
    %40 = "llvm.icmp"(%39, %9) <{predicate = 0 : i64}> : (i8, i8) -> i1
    %41 = "llvm.and"(%38, %5) : (i8, i8) -> i8
    %42 = "llvm.icmp"(%41, %6) <{predicate = 0 : i64}> : (i8, i8) -> i1
    %43 = "llvm.or"(%40, %42) : (i1, i1) -> i1
    "llvm.cond_br"(%43, %7)[^bb12, ^bb3] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i32) -> ()
  ^bb3:  // pred: ^bb2
    %44 = "llvm.getelementptr"(%35, %0) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    %46 = "llvm.add"(%45, %10) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
    %47 = "llvm.icmp"(%46, %11) <{predicate = 6 : i64}> : (i32, i32) -> i1
    %48 = "llvm.getelementptr"(%34, %0) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %49 = "llvm.load"(%48) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
    %50 = "llvm.select"(%47, %49, %48) <{fastmathFlags = #llvm.fastmath<none>}> : (i1, !llvm.ptr, !llvm.ptr) -> !llvm.ptr
    %51 = "llvm.add"(%45, %12) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
    %52 = "llvm.lshr"(%51, %13) : (i32, i32) -> i32
    %53 = "llvm.intr.umax"(%52, %14) : (i32, i32) -> i32
    %54 = "llvm.zext"(%53) <{nonNeg}> : (i32) -> i64
    "llvm.br"(%15, %16)[^bb5] : (i64, i32) -> ()
  ^bb4:  // pred: ^bb5
    %55 = "llvm.add"(%57, %17) <{overflowFlags = 3 : i32}> : (i64, i64) -> i64
    %56 = "llvm.icmp"(%55, %54) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%56, %55, %63)[^bb6, ^bb5] <{loop_annotation = #llvm.loop_annotation<mustProgress = true>, operandSegmentSizes = array<i32: 1, 0, 2>}> : (i1, i64, i32) -> ()
  ^bb5(%57: i64, %58: i32):  // 2 preds: ^bb3, ^bb4
    %59 = "llvm.getelementptr"(%50, %57) <{elem_type = i64, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %60 = "llvm.load"(%59) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "long", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, access_type = <id = "long", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (!llvm.ptr) -> i64
    %61 = "llvm.intr.ctpop"(%60) : (i64) -> i64
    %62 = "llvm.trunc"(%61) <{overflowFlags = 3 : i32}> : (i64) -> i32
    %63 = "llvm.add"(%58, %62) <{overflowFlags = 3 : i32}> : (i32, i32) -> i32
    %64 = "llvm.icmp"(%63, %14) <{predicate = 8 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%64, %7)[^bb12, ^bb4] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i32) -> ()
  ^bb6:  // pred: ^bb4
    %65 = "llvm.getelementptr"(%34, %18) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    %67 = "llvm.getelementptr"(%35, %19) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    "llvm.cond_br"(%69, %66)[^bb7, ^bb12] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i32) -> ()
  ^bb7:  // pred: ^bb6
    %70 = "llvm.zext"(%52) <{nonNeg}> : (i32) -> i64
    %71 = "llvm.load"(%50) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "long", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, access_type = <id = "long", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (!llvm.ptr) -> i64
    %72 = "llvm.icmp"(%71, %15) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%72, %16, %15, %20, %16, %71)[^bb10, ^bb9] <{operandSegmentSizes = array<i32: 1, 2, 3>}> : (i1, i32, i64, i1, i32, i64) -> ()
  ^bb8:  // pred: ^bb10
    %73 = "llvm.icmp"(%85, %70) <{predicate = 6 : i64}> : (i64, i64) -> i1
    "llvm.br"(%73, %87, %89)[^bb9] : (i1, i32, i64) -> ()
  ^bb9(%74: i1, %75: i32, %76: i64):  // 2 preds: ^bb7, ^bb8
    %77 = "llvm.intr.cttz"(%76) <{is_zero_poison = true}> : (i64) -> i64
    %78 = "llvm.trunc"(%77) <{overflowFlags = 3 : i32}> : (i64) -> i32
    %79 = "llvm.sub"(%66, %45) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
    %80 = "llvm.add"(%79, %14) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
    %81 = "llvm.add"(%80, %75) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
    %82 = "llvm.add"(%81, %78) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
    "llvm.intr.assume"(%74) <{op_bundle_sizes = array<i32>}> : (i1) -> ()
    "llvm.br"(%82)[^bb12] : (i32) -> ()
  ^bb10(%83: i32, %84: i64):  // 2 preds: ^bb7, ^bb10
    %85 = "llvm.add"(%84, %17) <{overflowFlags = 3 : i32}> : (i64, i64) -> i64
    %86 = "llvm.icmp"(%85, %54) <{predicate = 1 : i64}> : (i64, i64) -> i1
    "llvm.intr.assume"(%86) <{op_bundle_sizes = array<i32>}> : (i1) -> ()
    %87 = "llvm.add"(%83, %21) <{overflowFlags = 2 : i32}> : (i32, i32) -> i32
    %88 = "llvm.getelementptr"(%50, %85) <{elem_type = i64, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %89 = "llvm.load"(%88) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "long", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, access_type = <id = "long", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (!llvm.ptr) -> i64
    %90 = "llvm.icmp"(%89, %15) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%90, %87, %85)[^bb10, ^bb8] <{loop_annotation = #llvm.loop_annotation<mustProgress = true>, operandSegmentSizes = array<i32: 1, 2, 0>}> : (i1, i32, i64) -> ()
  ^bb11:  // pred: ^bb1
    %91 = "llvm.getelementptr"(%34, %0) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    %98 = "llvm.select"(%95, %97, %93) <{fastmathFlags = #llvm.fastmath<none>}> : (i1, !llvm.ptr, !llvm.ptr) -> !llvm.ptr
    ...
    %101 = "llvm.and"(%100, %5) : (i8, i8) -> i8
    %102 = "llvm.icmp"(%101, %6) <{predicate = 0 : i64}> : (i8, i8) -> i1
    "llvm.cond_br"(%102, %92, %7)[^bb1, ^bb12] <{operandSegmentSizes = array<i32: 1, 1, 1>}> : (i1, !llvm.ptr, i32) -> ()
  ^bb12(%103: i32):  // 6 preds: ^bb0, ^bb2, ^bb5, ^bb6, ^bb9, ^bb11
    "llvm.return"(%103) : (i32) -> ()
  }) : () -> ()
