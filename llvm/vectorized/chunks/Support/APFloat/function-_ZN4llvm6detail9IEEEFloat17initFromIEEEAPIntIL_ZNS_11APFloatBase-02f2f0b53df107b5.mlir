"builtin.module"() ({
  "llvm.comdat"() <{sym_name = "__llvm_global_comdat"}> ({
    "llvm.comdat_selector"() <{comdat = 0 : i64, sym_name = "_ZN4llvm6detail9IEEEFloat17initFromIEEEAPIntIL_ZNS_11APFloatBase13semFloat8E4M3EEEEvRKNS_5APIntE"}> : () -> ()
  }) : () -> ()
  ...
  ^bb0(%arg0: !llvm.ptr, %arg1: !llvm.ptr):
    ...
    %8 = "llvm.mlir.addressof"() <{global_name = @_ZN4llvm11APFloatBase13semFloat8E4M3E}> : () -> !llvm.ptr
    ...
    %53 = "llvm.icmp"(%52, %0) <{predicate = 0 : i64}> : (i64, i64) -> i1
  ...
  ^bb1:  // pred: ^bb0
    ...
    "llvm.br"()[^bb9] : () -> ()
  ^bb2:  // pred: ^bb0
    %59 = "llvm.icmp"(%52, %0) <{predicate = 1 : i64}> : (i64, i64) -> i1
  ...
  ^bb7:  // pred: ^bb6
    ...
    "llvm.br"()[^bb9] : () -> ()
  ^bb8:  // pred: ^bb6
    %73 = "llvm.or"(%31, %0) <{isDisjoint}> : (i64, i64) -> i64
