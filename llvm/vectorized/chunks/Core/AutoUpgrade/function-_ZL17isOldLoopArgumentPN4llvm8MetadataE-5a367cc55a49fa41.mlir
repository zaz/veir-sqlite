"builtin.module"() ({
  ...
  ^bb3:  // pred: ^bb2
    ...
    "llvm.cond_br"(%23, %1)[^bb12, ^bb6] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i1) -> ()
  ^bb4:  // pred: ^bb2
    ...
    "llvm.cond_br"(%26, %1)[^bb12, ^bb5] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i1) -> ()
  ^bb5:  // pred: ^bb4
