"builtin.module"() ({
  ...
  "llvm.mlir.global"() <{addr_space = 0 : i32, alignment = 4 : i64, constant, dso_local, global_type = !llvm.array<8 x i32>, linkage = #llvm.linkage<external>, sym_name = "switch.table._ZN4llvm24convertRoundingModeToStrENS_12RoundingModeE.rel", tls_mode = 0 : i64, unnamed_addr = 2 : i64, visibility_ = 1 : i64}> ({
    %0 = "llvm.mlir.addressof"() <{global_name = @switch.table._ZN4llvm24convertRoundingModeToStrENS_12RoundingModeE.rel}> : () -> !llvm.ptr
    ...
    %22 = "llvm.mlir.addressof"() <{global_name = @".str.5"}> : () -> !llvm.ptr
    ...
    %26 = "llvm.mlir.undef"() : () -> !llvm.array<8 x i32>
    %27 = "llvm.insertvalue"(%26, %25) <{position = array<i64: 0>}> : (!llvm.array<8 x i32>, i32) -> !llvm.array<8 x i32>
    %28 = "llvm.insertvalue"(%27, %21) <{position = array<i64: 1>}> : (!llvm.array<8 x i32>, i32) -> !llvm.array<8 x i32>
    %29 = "llvm.insertvalue"(%28, %17) <{position = array<i64: 2>}> : (!llvm.array<8 x i32>, i32) -> !llvm.array<8 x i32>
    %30 = "llvm.insertvalue"(%29, %13) <{position = array<i64: 3>}> : (!llvm.array<8 x i32>, i32) -> !llvm.array<8 x i32>
    %31 = "llvm.insertvalue"(%30, %9) <{position = array<i64: 4>}> : (!llvm.array<8 x i32>, i32) -> !llvm.array<8 x i32>
    %32 = "llvm.insertvalue"(%31, %5) <{position = array<i64: 5>}> : (!llvm.array<8 x i32>, i32) -> !llvm.array<8 x i32>
    %33 = "llvm.insertvalue"(%32, %5) <{position = array<i64: 6>}> : (!llvm.array<8 x i32>, i32) -> !llvm.array<8 x i32>
    %34 = "llvm.insertvalue"(%33, %5) <{position = array<i64: 7>}> : (!llvm.array<8 x i32>, i32) -> !llvm.array<8 x i32>
    "llvm.return"(%34) : (!llvm.array<8 x i32>) -> ()
  }) : () -> ()
