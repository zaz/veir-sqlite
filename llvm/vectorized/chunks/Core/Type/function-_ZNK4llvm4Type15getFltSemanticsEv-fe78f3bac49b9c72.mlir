"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr):
    ...
    %9 = "llvm.getelementptr"(%2, %3, %8) <{elem_type = !llvm.array<7 x ptr>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, -2147483648>}> : (!llvm.ptr, i64, i64) -> !llvm.ptr
