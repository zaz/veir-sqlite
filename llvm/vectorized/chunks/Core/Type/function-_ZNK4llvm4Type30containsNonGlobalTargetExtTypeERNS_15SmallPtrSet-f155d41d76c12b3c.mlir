"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr, %arg1: !llvm.ptr):
    ...
    "llvm.cond_br"(%10, %arg0, %8, %arg0)[^bb1, ^bb2] <{operandSegmentSizes = array<i32: 1, 1, 2>}> : (i1, !llvm.ptr, i32, !llvm.ptr) -> ()
  ^bb1(%11: !llvm.ptr):  // 2 preds: ^bb0, ^bb1
    %12 = "llvm.getelementptr"(%11, %3) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    "llvm.cond_br"(%17, %13, %15, %13)[^bb1, ^bb2] <{operandSegmentSizes = array<i32: 1, 1, 2>}> : (i1, !llvm.ptr, i32, !llvm.ptr) -> ()
  ^bb2(%18: i32, %19: !llvm.ptr):  // 2 preds: ^bb0, ^bb1
    %20 = "llvm.trunc"(%18) <{overflowFlags = 0 : i32}> : (i32) -> i8
    "llvm.switch"(%20, %4)[^bb5, ^bb3, ^bb4] <{case_operand_segments = array<i32: 0, 0>, case_values = dense<[16, 21]> : vector<2xi8>, operandSegmentSizes = array<i32: 1, 1, 0>}> : (i8, i1) -> ()
  ^bb3:  // pred: ^bb2
    %21 = "llvm.call"(%19, %arg1) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<tail>, arg_attrs = [{llvm.align = 8 : i64, llvm.dereferenceable = 32 : i64, llvm.nonnull, llvm.noundef}, {llvm.align = 8 : i64, llvm.dereferenceable = 17 : i64, llvm.nonnull, llvm.noundef}], callee = @_ZNK4llvm10StructType30containsNonGlobalTargetExtTypeERNS_15SmallPtrSetImplIPKNS_4TypeEEE, fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 2, 0>, res_attrs = [{llvm.noundef, llvm.zeroext}]}> : (!llvm.ptr, !llvm.ptr) -> i1
    "llvm.br"(%21)[^bb5] : (i1) -> ()
  ^bb4:  // pred: ^bb2
    %22 = "llvm.call"(%19) <{CConv = #llvm.cconv<fastcc>, TailCallKind = #llvm.tailcallkind<tail>, arg_attrs = [{llvm.nonnull, llvm.noundef, llvm.readonly}], callee = @_ZL17getTargetTypeInfoPKN4llvm13TargetExtTypeE, fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 1, 0>}> : (!llvm.ptr) -> !llvm.struct<(ptr, i64)>
    %23 = "llvm.extractvalue"(%22) <{position = array<i64: 1>}> : (!llvm.struct<(ptr, i64)>) -> i64
    %24 = "llvm.and"(%23, %5) : (i64, i64) -> i64
    %25 = "llvm.icmp"(%24, %6) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.br"(%25)[^bb5] : (i1) -> ()
  ^bb5(%26: i1):  // 3 preds: ^bb2, ^bb3, ^bb4
    "llvm.return"(%26) : (i1) -> ()
  }) : () -> ()
