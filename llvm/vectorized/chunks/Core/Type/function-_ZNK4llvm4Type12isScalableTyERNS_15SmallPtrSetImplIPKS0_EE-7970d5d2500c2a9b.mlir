"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr, %arg1: !llvm.ptr):
    ...
    "llvm.cond_br"(%11, %arg0, %9, %arg0)[^bb1, ^bb2] <{operandSegmentSizes = array<i32: 1, 1, 2>}> : (i1, !llvm.ptr, i32, !llvm.ptr) -> ()
  ^bb1(%12: !llvm.ptr):  // 2 preds: ^bb0, ^bb1
    %13 = "llvm.getelementptr"(%12, %3) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    "llvm.cond_br"(%18, %14, %16, %14)[^bb1, ^bb2] <{operandSegmentSizes = array<i32: 1, 1, 2>}> : (i1, !llvm.ptr, i32, !llvm.ptr) -> ()
  ^bb2(%19: i32, %20: !llvm.ptr):  // 2 preds: ^bb0, ^bb1
    %21 = "llvm.and"(%19, %1) : (i32, i32) -> i32
    %22 = "llvm.icmp"(%21, %4) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%22)[^bb3, ^bb4] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb3:  // pred: ^bb2
    %23 = "llvm.call"(%20, %arg1) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<tail>, arg_attrs = [{llvm.align = 8 : i64, llvm.dereferenceable = 32 : i64, llvm.nonnull, llvm.noundef}, {llvm.align = 1 : i64, llvm.nonnull, llvm.noundef}], callee = @_ZNK4llvm10StructType12isScalableTyERNS_15SmallPtrSetImplIPKNS_4TypeEEE, fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 2, 0>, res_attrs = [{llvm.noundef, llvm.zeroext}]}> : (!llvm.ptr, !llvm.ptr) -> i1
    "llvm.br"(%23)[^bb7] : (i1) -> ()
  ^bb4:  // pred: ^bb2
    %24 = "llvm.trunc"(%19) <{overflowFlags = 0 : i32}> : (i32) -> i8
    "llvm.switch"(%24, %5)[^bb6, ^bb7, ^bb5] <{case_operand_segments = array<i32: 1, 0>, case_values = dense<[19, 21]> : vector<2xi8>, operandSegmentSizes = array<i32: 1, 0, 1>}> : (i8, i1) -> ()
  ^bb5:  // pred: ^bb4
    %25 = "llvm.call"(%20) <{CConv = #llvm.cconv<fastcc>, TailCallKind = #llvm.tailcallkind<tail>, arg_attrs = [{llvm.nonnull, llvm.noundef, llvm.readonly}], callee = @_ZL17getTargetTypeInfoPKN4llvm13TargetExtTypeE, fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 1, 0>}> : (!llvm.ptr) -> !llvm.struct<(ptr, i64)>
    %26 = "llvm.extractvalue"(%25) <{position = array<i64: 0>}> : (!llvm.struct<(ptr, i64)>) -> !llvm.ptr
    ...
    %29 = "llvm.and"(%28, %1) : (i32, i32) -> i32
    %30 = "llvm.icmp"(%29, %6) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.br"(%30)[^bb7] : (i1) -> ()
  ^bb6:  // pred: ^bb4
    "llvm.br"(%7)[^bb7] : (i1) -> ()
  ^bb7(%31: i1):  // 4 preds: ^bb3, ^bb4, ^bb5, ^bb6
    "llvm.return"(%31) : (i1) -> ()
  }) : () -> ()
