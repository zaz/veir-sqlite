"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr, %arg1: !llvm.ptr, %arg2: !llvm.ptr):
    ...
    %20 = "llvm.icmp"(%arg0, %0) <{predicate = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> i1
    "llvm.cond_br"(%20, %1)[^bb13, ^bb1] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i1) -> ()
  ^bb1:  // pred: ^bb0
  ...
  ^bb2:  // pred: ^bb1
    %25 = "llvm.and"(%22, %8) : (i64, i64) -> i64
    %26 = "llvm.icmp"(%25, %9) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%26, %1)[^bb5, ^bb13] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i1) -> ()
  ^bb3:  // pred: ^bb1
    ...
    "llvm.cond_br"(%29, %1)[^bb4, ^bb13] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i1) -> ()
  ^bb4:  // pred: ^bb3
  ...
  ^bb5:  // pred: ^bb2
    %32 = "llvm.lshr"(%22, %3) : (i64, i64) -> i64
    %33 = "llvm.and"(%32, %10) : (i64, i64) -> i64
    %34 = "llvm.sub"(%4, %33) <{overflowFlags = 1 : i32}> : (i64, i64) -> i64
    %35 = "llvm.getelementptr"(%21, %34) <{elem_type = !llvm.struct<"class.llvm::MDOperand", (ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
  ...
  ^bb6(%36: !llvm.ptr):  // 2 preds: ^bb4, ^bb5
    ...
    %39 = "llvm.icmp"(%38, %11) <{predicate = 0 : i64}> : (i8, i8) -> i1
    %40 = "llvm.getelementptr"(%36, %12) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    %44 = "llvm.and"(%39, %43) : (i1, i1) -> i1
    "llvm.cond_br"(%44, %1)[^bb7, ^bb13] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i1) -> ()
  ^bb7:  // pred: ^bb6
    ...
    %46 = "llvm.extractvalue"(%45) <{position = array<i64: 0>}> : (!llvm.struct<(ptr, i64)>) -> !llvm.ptr
    %47 = "llvm.extractvalue"(%45) <{position = array<i64: 1>}> : (!llvm.struct<(ptr, i64)>) -> i64
    %48 = "llvm.icmp"(%arg1, %0) <{predicate = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> i1
    "llvm.cond_br"(%48, %4)[^bb9, ^bb8] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i64) -> ()
  ^bb8:  // pred: ^bb7
  ...
  ^bb12:  // 2 preds: ^bb10, ^bb11
    ...
    %58 = "llvm.getelementptr"(%57, %16) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %59 = "llvm.getelementptr"(%57, %17) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %60 = "llvm.load"(%59) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "_ZTSN4llvm5APIntE", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>, <#llvm.tbaa_type_desc<id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, 8>}>, access_type = <id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 8>]}> : (!llvm.ptr) -> i32
    %61 = "llvm.icmp"(%60, %18) <{predicate = 6 : i64}> : (i32, i32) -> i1
    %62 = "llvm.load"(%58) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
    %63 = "llvm.select"(%61, %58, %62) <{fastmathFlags = #llvm.fastmath<none>}> : (i1, !llvm.ptr, !llvm.ptr) -> !llvm.ptr
    ...
    "llvm.store"(%64, %arg2) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "long", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, access_type = <id = "long", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (i64, !llvm.ptr) -> ()
    "llvm.br"(%19)[^bb13] : (i1) -> ()
  ^bb13(%65: i1):  // 7 preds: ^bb0, ^bb2, ^bb3, ^bb6, ^bb9, ^bb11, ^bb12
    "llvm.return"(%65) : (i1) -> ()
  }) : () -> ()
