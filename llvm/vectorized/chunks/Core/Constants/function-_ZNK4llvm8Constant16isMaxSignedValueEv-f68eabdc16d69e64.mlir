"builtin.module"() ({
  ...
  "llvm.func"() <{CConv = #llvm.cconv<ccc>, alignment = 2 : i64, arg_attrs = [{llvm.align = 8 : i64, llvm.dereferenceable = 24 : i64, llvm.nonnull, llvm.noundef}], dso_local, function_type = !llvm.func<i1 (ptr)>, linkage = #llvm.linkage<external>, no_unwind, passthrough = ["mustprogress", ["min-legal-vector-width", "0"], ["no-trapping-math", "true"], ["stack-protector-buffer-size", "8"], ["target-cpu", "x86-64"]], res_attrs = [{llvm.noundef, llvm.zeroext}], sym_name = "_ZNK4llvm8Constant16isMaxSignedValueEv", target_cpu = "x86-64", target_features = #llvm.target_features<["+cmov", "+cx8", "+fxsr", "+mmx", "+sse", "+sse2", "+x87"]>, tune_cpu = "generic", unnamed_addr = 1 : i64, uwtable_kind = #llvm.uwtableKind<async>, visibility_ = 0 : i64}> ({
  ^bb0(%arg0: !llvm.ptr):
    ...
    %13 = "llvm.mlir.constant"() <{value = 254 : i32}> : () -> i32
  ...
  ^bb1(%17: !llvm.ptr):  // 2 preds: ^bb0, ^bb16
    ...
    "llvm.switch"(%18)[^bb15, ^bb2, ^bb6] <{case_operand_segments = array<i32: 0, 0>, case_values = dense<[5, 7]> : vector<2xi8>, operandSegmentSizes = array<i32: 1, 0, 0>}> : (i8) -> ()
  ^bb2:  // pred: ^bb1
    %19 = "llvm.getelementptr"(%17, %1) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %20 = "llvm.getelementptr"(%17, %12) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    %22 = "llvm.icmp"(%21, %4) <{predicate = 6 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%22)[^bb3, ^bb4] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb3:  // pred: ^bb2
    %23 = "llvm.load"(%19) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, access_type = <id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, offset = 0>]}> : (!llvm.ptr) -> i64
    %24 = "llvm.add"(%21, %5) <{overflowFlags = 1 : i32}> : (i32, i32) -> i32
    %25 = "llvm.zext"(%24) <{nonNeg}> : (i32) -> i64
    %26 = "llvm.shl"(%11, %25) <{overflowFlags = 1 : i32}> : (i64, i64) -> i64
    %27 = "llvm.xor"(%23, %26) : (i64, i64) -> i64
    %28 = "llvm.icmp"(%27, %11) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.br"(%28)[^bb17] : (i1) -> ()
  ^bb4:  // pred: ^bb2
    %29 = "llvm.add"(%21, %5) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
  ...
  ^bb8:  // pred: ^bb6
    ...
    "llvm.br"()[^bb9] : () -> ()
  ^bb9:  // 2 preds: ^bb7, ^bb8
    %45 = "llvm.getelementptr"(%16, %3) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %46 = "llvm.load"(%45) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "_ZTSN4llvm5APIntE", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>, <#llvm.tbaa_type_desc<id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, 8>}>, access_type = <id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 8>]}> : (!llvm.ptr) -> i32
    %47 = "llvm.icmp"(%46, %4) <{predicate = 6 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%47)[^bb12, ^bb10] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb10:  // pred: ^bb9
    %48 = "llvm.add"(%46, %5) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
    %49 = "llvm.and"(%48, %6) : (i32, i32) -> i32
    %50 = "llvm.zext"(%49) <{nonNeg}> : (i32) -> i64
    %51 = "llvm.shl"(%7, %50) <{overflowFlags = 2 : i32}> : (i64, i64) -> i64
    %52 = "llvm.load"(%16) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
    %53 = "llvm.lshr"(%48, %8) : (i32, i32) -> i32
    ...
    %56 = "llvm.load"(%55) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, access_type = <id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, offset = 0>]}> : (!llvm.ptr) -> i64
    %57 = "llvm.and"(%56, %51) : (i64, i64) -> i64
    %58 = "llvm.icmp"(%57, %9) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%58, %10)[^bb11, ^bb13] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i1) -> ()
  ^bb11:  // pred: ^bb10
    %59 = "llvm.call"(%16) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<none>, arg_attrs = [{llvm.align = 8 : i64, llvm.dereferenceable = 12 : i64, llvm.nonnull, llvm.noundef}], callee = @_ZNK4llvm5APInt25countTrailingOnesSlowCaseEv, fastmathFlags = #llvm.fastmath<none>, memory_effects = #llvm.memory_effects<other = read, argMem = read, inaccessibleMem = read, errnoMem = read, targetMem0 = none, targetMem1 = none>, no_unwind, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 1, 0>, res_attrs = [{llvm.noundef}], will_return}> : (!llvm.ptr) -> i32
    %60 = "llvm.icmp"(%59, %48) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.br"(%60)[^bb13] : (i1) -> ()
  ^bb12:  // pred: ^bb9
    %61 = "llvm.load"(%16) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, access_type = <id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, offset = 0>]}> : (!llvm.ptr) -> i64
    %62 = "llvm.add"(%46, %5) <{overflowFlags = 1 : i32}> : (i32, i32) -> i32
    %63 = "llvm.zext"(%62) <{nonNeg}> : (i32) -> i64
    %64 = "llvm.shl"(%11, %63) <{overflowFlags = 1 : i32}> : (i64, i64) -> i64
    %65 = "llvm.xor"(%61, %64) : (i64, i64) -> i64
    %66 = "llvm.icmp"(%65, %11) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.br"(%66)[^bb14] : (i1) -> ()
  ^bb13(%67: i1):  // 2 preds: ^bb10, ^bb11
    ...
    "llvm.br"(%67)[^bb14] : (i1) -> ()
  ^bb14(%68: i1):  // 2 preds: ^bb12, ^bb13
    "llvm.intr.lifetime.end"(%16) : (!llvm.ptr) -> ()
    "llvm.br"(%68)[^bb17] : (i1) -> ()
  ^bb15:  // pred: ^bb1
    %69 = "llvm.getelementptr"(%17, %3) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    "llvm.cond_br"(%74, %10)[^bb16, ^bb17] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i1) -> ()
  ^bb16:  // pred: ^bb15
    %75 = "llvm.call"(%17, %10) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<tail>, arg_attrs = [{llvm.align = 8 : i64, llvm.dereferenceable = 24 : i64, llvm.nonnull, llvm.noundef}, {llvm.noundef, llvm.zeroext}], callee = @_ZNK4llvm8Constant13getSplatValueEb, fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 2, 0>, res_attrs = [{llvm.noundef}]}> : (!llvm.ptr, i1) -> !llvm.ptr
    %76 = "llvm.icmp"(%75, %15) <{predicate = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> i1
    "llvm.cond_br"(%76, %10, %75)[^bb17, ^bb1] <{operandSegmentSizes = array<i32: 1, 1, 1>}> : (i1, i1, !llvm.ptr) -> ()
  ^bb17(%77: i1):  // 6 preds: ^bb3, ^bb4, ^bb5, ^bb14, ^bb15, ^bb16
    "llvm.return"(%77) : (i1) -> ()
  }) : () -> ()
