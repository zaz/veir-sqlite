"builtin.module"() ({
  "llvm.comdat"() <{sym_name = "__llvm_global_comdat"}> ({
    "llvm.comdat_selector"() <{comdat = 0 : i64, sym_name = "_ZN4llvm19ConstantExprKeyType11rangesEqualERKSt8optionalINS_13ConstantRangeEES5_"}> : () -> ()
  }) : () -> ()
  ...
  "llvm.func"() <{CConv = #llvm.cconv<ccc>, alignment = 2 : i64, arg_attrs = [{llvm.align = 8 : i64, llvm.dereferenceable = 40 : i64, llvm.nonnull, llvm.noundef}, {llvm.align = 8 : i64, llvm.dereferenceable = 40 : i64, llvm.nonnull, llvm.noundef}], comdat = @__llvm_global_comdat::@_ZN4llvm19ConstantExprKeyType11rangesEqualERKSt8optionalINS_13ConstantRangeEES5_, dso_local, function_type = !llvm.func<i1 (ptr, ptr)>, linkage = #llvm.linkage<weak_odr>, no_unwind, passthrough = ["mustprogress", ["min-legal-vector-width", "0"], ["no-trapping-math", "true"], ["stack-protector-buffer-size", "8"], ["target-cpu", "x86-64"]], res_attrs = [{llvm.noundef, llvm.zeroext}], sym_name = "_ZN4llvm19ConstantExprKeyType11rangesEqualERKSt8optionalINS_13ConstantRangeEES5_", target_cpu = "x86-64", target_features = #llvm.target_features<["+cmov", "+cx8", "+fxsr", "+mmx", "+sse", "+sse2", "+x87"]>, tune_cpu = "generic", unnamed_addr = 1 : i64, uwtable_kind = #llvm.uwtableKind<async>, visibility_ = 1 : i64}> ({
  ^bb0(%arg0: !llvm.ptr, %arg1: !llvm.ptr):
    ...
    %8 = "llvm.trunc"(%7) <{overflowFlags = 2 : i32}> : (i8) -> i1
  ...
  ^bb2:  // 2 preds: ^bb0, ^bb1
    %12 = "llvm.icmp"(%7, %10) <{predicate = 0 : i64}> : (i8, i8) -> i1
    "llvm.br"(%12)[^bb10] : (i1) -> ()
  ^bb3:  // pred: ^bb1
    ...
    %18 = "llvm.icmp"(%7, %10) <{predicate = 0 : i64}> : (i8, i8) -> i1
    %19 = "llvm.and"(%18, %17) : (i1, i1) -> i1
    "llvm.cond_br"(%19, %2)[^bb4, ^bb10] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i1) -> ()
  ^bb4:  // pred: ^bb3
    %20 = "llvm.icmp"(%14, %3) <{predicate = 6 : i64}> : (i32, i32) -> i1
  ...
  ^bb5:  // pred: ^bb4
    ...
    %22 = "llvm.load"(%arg1) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, access_type = <id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, offset = 0>]}> : (!llvm.ptr) -> i64
    %23 = "llvm.icmp"(%21, %22) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%23, %2)[^bb7, ^bb10] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i1) -> ()
  ^bb6:  // pred: ^bb4
    %24 = "llvm.call"(%arg0, %arg1) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<tail>, arg_attrs = [{llvm.align = 8 : i64, llvm.dereferenceable = 12 : i64, llvm.nonnull, llvm.noundef}, {llvm.align = 8 : i64, llvm.dereferenceable = 12 : i64, llvm.nonnull, llvm.noundef}], callee = @_ZNK4llvm5APInt13equalSlowCaseERKS0_, fastmathFlags = #llvm.fastmath<none>, memory_effects = #llvm.memory_effects<other = read, argMem = read, inaccessibleMem = read, errnoMem = read, targetMem0 = none, targetMem1 = none>, no_unwind, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 2, 0>, res_attrs = [{llvm.noundef, llvm.zeroext}], will_return}> : (!llvm.ptr, !llvm.ptr) -> i1
    "llvm.cond_br"(%24, %2)[^bb7, ^bb10] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i1) -> ()
  ^bb7:  // 2 preds: ^bb5, ^bb6
    ...
    %29 = "llvm.icmp"(%28, %3) <{predicate = 6 : i64}> : (i32, i32) -> i1
  ...
  ^bb8:  // pred: ^bb7
    ...
    %32 = "llvm.icmp"(%30, %31) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.br"(%32)[^bb10] : (i1) -> ()
  ^bb9:  // pred: ^bb7
    %33 = "llvm.call"(%25, %26) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<tail>, arg_attrs = [{llvm.align = 8 : i64, llvm.dereferenceable = 12 : i64, llvm.nonnull, llvm.noundef}, {llvm.align = 8 : i64, llvm.dereferenceable = 12 : i64, llvm.nonnull, llvm.noundef}], callee = @_ZNK4llvm5APInt13equalSlowCaseERKS0_, fastmathFlags = #llvm.fastmath<none>, memory_effects = #llvm.memory_effects<other = read, argMem = read, inaccessibleMem = read, errnoMem = read, targetMem0 = none, targetMem1 = none>, no_unwind, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 2, 0>, res_attrs = [{llvm.noundef, llvm.zeroext}], will_return}> : (!llvm.ptr, !llvm.ptr) -> i1
    "llvm.br"(%33)[^bb10] : (i1) -> ()
  ^bb10(%34: i1):  // 6 preds: ^bb2, ^bb3, ^bb5, ^bb6, ^bb8, ^bb9
    "llvm.return"(%34) : (i1) -> ()
  }) : () -> ()
