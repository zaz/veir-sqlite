"builtin.module"() ({
  ...
  "llvm.func"() <{CConv = #llvm.cconv<ccc>, alignment = 2 : i64, arg_attrs = [{llvm.align = 8 : i64, llvm.dereferenceable = 24 : i64, llvm.nonnull, llvm.noundef}], dso_local, function_type = !llvm.func<i1 (ptr)>, linkage = #llvm.linkage<external>, no_unwind, passthrough = ["mustprogress", ["min-legal-vector-width", "0"], ["no-trapping-math", "true"], ["stack-protector-buffer-size", "8"], ["target-cpu", "x86-64"]], res_attrs = [{llvm.noundef, llvm.zeroext}], sym_name = "_ZNK4llvm8Constant16isMinSignedValueEv", target_cpu = "x86-64", target_features = #llvm.target_features<["+cmov", "+cx8", "+fxsr", "+mmx", "+sse", "+sse2", "+x87"]>, tune_cpu = "generic", unnamed_addr = 1 : i64, uwtable_kind = #llvm.uwtableKind<async>, visibility_ = 0 : i64}> ({
  ^bb0(%arg0: !llvm.ptr):
    ...
    %12 = "llvm.mlir.constant"() <{value = 254 : i32}> : () -> i32
  ...
  ^bb1(%16: !llvm.ptr):  // 2 preds: ^bb0, ^bb16
    ...
    "llvm.switch"(%17)[^bb15, ^bb2, ^bb6] <{case_operand_segments = array<i32: 0, 0>, case_values = dense<[5, 7]> : vector<2xi8>, operandSegmentSizes = array<i32: 1, 0, 0>}> : (i8) -> ()
  ^bb2:  // pred: ^bb1
    %18 = "llvm.getelementptr"(%16, %1) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %19 = "llvm.getelementptr"(%16, %11) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
  ...
  ^bb3:  // pred: ^bb2
    %22 = "llvm.load"(%18) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, access_type = <id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, offset = 0>]}> : (!llvm.ptr) -> i64
    ...
    %26 = "llvm.icmp"(%22, %25) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.br"(%26)[^bb17] : (i1) -> ()
  ^bb4:  // pred: ^bb2
    %27 = "llvm.add"(%20, %5) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
    %28 = "llvm.and"(%27, %6) : (i32, i32) -> i32
    %29 = "llvm.zext"(%28) <{nonNeg}> : (i32) -> i64
    %30 = "llvm.shl"(%7, %29) <{overflowFlags = 2 : i32}> : (i64, i64) -> i64
    %31 = "llvm.load"(%18) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
    %32 = "llvm.lshr"(%27, %8) : (i32, i32) -> i32
  ...
  ^bb8:  // pred: ^bb6
    ...
    "llvm.br"()[^bb9] : () -> ()
  ^bb9:  // 2 preds: ^bb7, ^bb8
    %43 = "llvm.getelementptr"(%15, %3) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %44 = "llvm.load"(%43) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "_ZTSN4llvm5APIntE", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>, <#llvm.tbaa_type_desc<id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, 8>}>, access_type = <id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 8>]}> : (!llvm.ptr) -> i32
    %45 = "llvm.icmp"(%44, %4) <{predicate = 6 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%45)[^bb12, ^bb10] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb10:  // pred: ^bb9
    %46 = "llvm.add"(%44, %5) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
    %47 = "llvm.and"(%46, %6) : (i32, i32) -> i32
    %48 = "llvm.zext"(%47) <{nonNeg}> : (i32) -> i64
    %49 = "llvm.shl"(%7, %48) <{overflowFlags = 2 : i32}> : (i64, i64) -> i64
    %50 = "llvm.load"(%15) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
    %51 = "llvm.lshr"(%46, %8) : (i32, i32) -> i32
    ...
    %55 = "llvm.and"(%54, %49) : (i64, i64) -> i64
    %56 = "llvm.icmp"(%55, %9) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%56, %10)[^bb13, ^bb11] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i1) -> ()
  ^bb11:  // pred: ^bb10
    %57 = "llvm.call"(%15) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<none>, arg_attrs = [{llvm.align = 8 : i64, llvm.dereferenceable = 12 : i64, llvm.nonnull, llvm.noundef}], callee = @_ZNK4llvm5APInt26countTrailingZerosSlowCaseEv, fastmathFlags = #llvm.fastmath<none>, memory_effects = #llvm.memory_effects<other = read, argMem = read, inaccessibleMem = read, errnoMem = read, targetMem0 = none, targetMem1 = none>, no_unwind, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 1, 0>, res_attrs = [{llvm.noundef}], will_return}> : (!llvm.ptr) -> i32
    %58 = "llvm.icmp"(%57, %46) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.br"(%58)[^bb13] : (i1) -> ()
  ^bb12:  // pred: ^bb9
    %59 = "llvm.load"(%15) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, access_type = <id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, offset = 0>]}> : (!llvm.ptr) -> i64
    %60 = "llvm.add"(%44, %5) <{overflowFlags = 1 : i32}> : (i32, i32) -> i32
    %61 = "llvm.zext"(%60) <{nonNeg}> : (i32) -> i64
    %62 = "llvm.shl"(%7, %61) <{overflowFlags = 2 : i32}> : (i64, i64) -> i64
    %63 = "llvm.icmp"(%59, %62) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.br"(%63)[^bb14] : (i1) -> ()
  ^bb13(%64: i1):  // 2 preds: ^bb10, ^bb11
    ...
    "llvm.br"(%64)[^bb14] : (i1) -> ()
  ^bb14(%65: i1):  // 2 preds: ^bb12, ^bb13
    "llvm.intr.lifetime.end"(%15) : (!llvm.ptr) -> ()
    "llvm.br"(%65)[^bb17] : (i1) -> ()
  ^bb15:  // pred: ^bb1
    %66 = "llvm.getelementptr"(%16, %3) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
