"builtin.module"() ({
  ...
  ^bb0(%arg0: i32):
    ...
    %4 = "llvm.mlir.addressof"() <{global_name = @switch.table._ZN4llvm7CmpInst29getFlippedStrictnessPredicateENS0_9PredicateE}> : () -> !llvm.ptr
