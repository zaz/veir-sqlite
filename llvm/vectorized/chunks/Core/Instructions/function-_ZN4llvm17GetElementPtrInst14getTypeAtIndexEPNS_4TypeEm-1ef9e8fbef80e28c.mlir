"builtin.module"() ({
  ...
  "llvm.func"() <{CConv = #llvm.cconv<ccc>, alignment = 2 : i64, arg_attrs = [{llvm.noundef, llvm.readonly}, {llvm.noundef}], dso_local, function_type = !llvm.func<ptr (ptr, i64)>, linkage = #llvm.linkage<external>, memory_effects = #llvm.memory_effects<other = read, argMem = read, inaccessibleMem = none, errnoMem = read, targetMem0 = none, targetMem1 = none>, no_unwind, passthrough = ["mustprogress", "nofree", "norecurse", "nosync", ["min-legal-vector-width", "0"], ["no-trapping-math", "true"], ["stack-protector-buffer-size", "8"], ["target-cpu", "x86-64"]], res_attrs = [{llvm.noundef}], sym_name = "_ZN4llvm17GetElementPtrInst14getTypeAtIndexEPNS_4TypeEm", target_cpu = "x86-64", target_features = #llvm.target_features<["+cmov", "+cx8", "+fxsr", "+mmx", "+sse", "+sse2", "+x87"]>, tune_cpu = "generic", unnamed_addr = 1 : i64, uwtable_kind = #llvm.uwtableKind<async>, visibility_ = 0 : i64, will_return}> ({
  ^bb0(%arg0: !llvm.ptr, %arg1: i64):
    ...
    %14 = "llvm.icmp"(%arg0, %3) <{predicate = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> i1
    %15 = "llvm.or"(%14, %13) : (i1, i1) -> i1
  ...
  ^bb1:  // pred: ^bb0
    ...
    %19 = "llvm.icmp"(%18, %arg1) <{predicate = 8 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%19, %3)[^bb2, ^bb8] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, !llvm.ptr) -> ()
  ^bb2:  // pred: ^bb1
    ...
    %22 = "llvm.getelementptr"(%21, %arg1) <{elem_type = !llvm.ptr, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    "llvm.br"(%22)[^bb7] : (!llvm.ptr) -> ()
  ^bb3:  // pred: ^bb0
    %23 = "llvm.icmp"(%12, %6) <{predicate = 1 : i64}> : (i32, i32) -> i1
    %24 = "llvm.or"(%14, %23) : (i1, i1) -> i1
  ...
  ^bb5:  // pred: ^bb3
    %26 = "llvm.and"(%11, %8) : (i32, i32) -> i32
    %27 = "llvm.icmp"(%26, %9) <{predicate = 1 : i64}> : (i32, i32) -> i1
    %28 = "llvm.or"(%14, %27) : (i1, i1) -> i1
    "llvm.cond_br"(%28, %3)[^bb8, ^bb6] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, !llvm.ptr) -> ()
  ^bb6:  // pred: ^bb5
  ...
  ^bb7(%30: !llvm.ptr):  // 3 preds: ^bb2, ^bb4, ^bb6
  ...
  ^bb8(%32: !llvm.ptr):  // 3 preds: ^bb1, ^bb5, ^bb7
