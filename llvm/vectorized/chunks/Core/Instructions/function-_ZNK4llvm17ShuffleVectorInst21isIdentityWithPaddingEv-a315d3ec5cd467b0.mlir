"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr):
    ...
    "llvm.cond_br"(%22, %3)[^bb14, ^bb1] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i1) -> ()
  ^bb1:  // pred: ^bb0
    ...
    %27 = "llvm.getelementptr"(%26, %5) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    %29 = "llvm.getelementptr"(%18, %5) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %30 = "llvm.load"(%29) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "_ZTSN4llvm10VectorTypeE", members = {<#llvm.tbaa_type_desc<id = "_ZTSN4llvm4TypeE", members = {<#llvm.tbaa_type_desc<id = "any pointer", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, 0>, <#llvm.tbaa_type_desc<id = "_ZTSN4llvm4Type6TypeIDE", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, 8>, <#llvm.tbaa_type_desc<id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, 9>, <#llvm.tbaa_type_desc<id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, 12>, <#llvm.tbaa_type_desc<id = "any pointer", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, 16>}>, 0>, <#llvm.tbaa_type_desc<id = "any pointer", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, 24>, <#llvm.tbaa_type_desc<id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, 32>}>, access_type = <id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 32>]}> : (!llvm.ptr) -> i32
    %31 = "llvm.icmp"(%30, %28) <{predicate = 4 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%31, %3)[^bb2, ^bb14] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i1) -> ()
  ^bb2:  // pred: ^bb1
    ...
    %37 = "llvm.getelementptr"(%33, %36) <{elem_type = i32, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %38 = "llvm.icmp"(%35, %8) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%38, %3, %9, %33, %9)[^bb14, ^bb3] <{operandSegmentSizes = array<i32: 1, 1, 3>}> : (i1, i1, i8, !llvm.ptr, i8) -> ()
  ^bb3(%39: i8, %40: !llvm.ptr, %41: i8):  // 2 preds: ^bb2, ^bb5
    %42 = "llvm.load"(%40) <{alignment = 4 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, access_type = <id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (!llvm.ptr) -> i32
    %43 = "llvm.icmp"(%42, %10) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%43, %41, %39)[^bb5, ^bb4] <{operandSegmentSizes = array<i32: 1, 2, 0>}> : (i1, i8, i8) -> ()
  ^bb4:  // pred: ^bb3
    %44 = "llvm.icmp"(%42, %28) <{predicate = 2 : i64}> : (i32, i32) -> i1
    %45 = "llvm.and"(%39, %11) : (i8, i8) -> i8
    %46 = "llvm.zext"(%44) : (i1) -> i8
    %47 = "llvm.or"(%45, %46) : (i8, i8) -> i8
    %48 = "llvm.icmp"(%47, %9) <{predicate = 0 : i64}> : (i8, i8) -> i1
    %49 = "llvm.icmp"(%42, %28) <{predicate = 5 : i64}> : (i32, i32) -> i1
    %50 = "llvm.and"(%41, %11) : (i8, i8) -> i8
    %51 = "llvm.zext"(%49) : (i1) -> i8
    %52 = "llvm.or"(%50, %51) : (i8, i8) -> i8
    %53 = "llvm.icmp"(%52, %9) <{predicate = 0 : i64}> : (i8, i8) -> i1
    %54 = "llvm.select"(%48, %12, %53) <{fastmathFlags = #llvm.fastmath<none>}> : (i1, i1, i1) -> i1
    "llvm.cond_br"(%54, %52, %47, %3)[^bb5, ^bb14] <{operandSegmentSizes = array<i32: 1, 2, 1>}> : (i1, i8, i8, i1) -> ()
  ^bb5(%55: i8, %56: i8):  // 2 preds: ^bb3, ^bb4
    %57 = "llvm.getelementptr"(%40, %13) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %58 = "llvm.icmp"(%57, %37) <{predicate = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> i1
    "llvm.cond_br"(%58, %56, %57, %55)[^bb6, ^bb3] <{operandSegmentSizes = array<i32: 1, 0, 3>}> : (i1, i8, !llvm.ptr, i8) -> ()
  ^bb6:  // pred: ^bb5
    %59 = "llvm.trunc"(%56) <{overflowFlags = 2 : i32}> : (i8) -> i1
    %60 = "llvm.trunc"(%55) <{overflowFlags = 2 : i32}> : (i8) -> i1
    %61 = "llvm.select"(%59, %12, %60) <{fastmathFlags = #llvm.fastmath<none>}> : (i1, i1, i1) -> i1
    "llvm.cond_br"(%61, %3)[^bb7, ^bb14] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i1) -> ()
  ^bb7:  // pred: ^bb6
    %62 = "llvm.icmp"(%35, %14) <{predicate = 2 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%62, %15)[^bb10, ^bb9] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i64) -> ()
  ^bb8:  // pred: ^bb9
    %63 = "llvm.add"(%65, %16) <{overflowFlags = 3 : i32}> : (i64, i64) -> i64
    %64 = "llvm.icmp"(%63, %36) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%64, %63)[^bb10, ^bb9] <{loop_annotation = #llvm.loop_annotation<mustProgress = true>, operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i64) -> ()
  ^bb9(%65: i64):  // 2 preds: ^bb7, ^bb8
    %66 = "llvm.getelementptr"(%33, %65) <{elem_type = i32, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %67 = "llvm.load"(%66) <{alignment = 4 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, access_type = <id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (!llvm.ptr) -> i32
    %68 = "llvm.icmp"(%67, %10) <{predicate = 0 : i64}> : (i32, i32) -> i1
    %69 = "llvm.zext"(%67) : (i32) -> i64
    %70 = "llvm.icmp"(%65, %69) <{predicate = 0 : i64}> : (i64, i64) -> i1
    %71 = "llvm.or"(%68, %70) : (i1, i1) -> i1
    %72 = "llvm.trunc"(%65) <{overflowFlags = 0 : i32}> : (i64) -> i32
    %73 = "llvm.add"(%28, %72) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
    %74 = "llvm.icmp"(%67, %73) <{predicate = 0 : i64}> : (i32, i32) -> i1
    %75 = "llvm.or"(%74, %71) : (i1, i1) -> i1
    "llvm.cond_br"(%75, %3)[^bb8, ^bb14] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i1) -> ()
  ^bb10:  // 2 preds: ^bb7, ^bb8
    %76 = "llvm.sext"(%28) : (i32) -> i64
    %77 = "llvm.sext"(%30) : (i32) -> i64
    "llvm.br"(%76)[^bb12] : (i64) -> ()
  ^bb11:  // pred: ^bb12
    %78 = "llvm.add"(%81, %16) <{overflowFlags = 1 : i32}> : (i64, i64) -> i64
    %79 = "llvm.trunc"(%78) <{overflowFlags = 0 : i32}> : (i64) -> i32
    %80 = "llvm.icmp"(%30, %79) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%80, %78)[^bb13, ^bb12] <{loop_annotation = #llvm.loop_annotation<mustProgress = true>, operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i64) -> ()
  ^bb12(%81: i64):  // 2 preds: ^bb10, ^bb11
    %82 = "llvm.getelementptr"(%33, %81) <{elem_type = i32, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %83 = "llvm.load"(%82) <{alignment = 4 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, access_type = <id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (!llvm.ptr) -> i32
    %84 = "llvm.icmp"(%83, %10) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%84, %3)[^bb11, ^bb14] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i1) -> ()
  ^bb13:  // pred: ^bb11
    %85 = "llvm.icmp"(%78, %77) <{predicate = 5 : i64}> : (i64, i64) -> i1
    "llvm.br"(%85)[^bb14] : (i1) -> ()
  ^bb14(%86: i1):  // 8 preds: ^bb0, ^bb1, ^bb2, ^bb4, ^bb6, ^bb9, ^bb12, ^bb13
    "llvm.return"(%86) : (i1) -> ()
  }) : () -> ()
