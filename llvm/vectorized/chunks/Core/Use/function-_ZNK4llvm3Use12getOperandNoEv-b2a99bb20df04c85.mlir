"builtin.module"() ({
  ...
  ^bb2:  // pred: ^bb0
    %16 = "llvm.and"(%11, %5) : (i32, i32) -> i32
    %17 = "llvm.zext"(%16) <{nonNeg}> : (i32) -> i64
    %18 = "llvm.sub"(%6, %17) <{overflowFlags = 1 : i32}> : (i64, i64) -> i64
    %19 = "llvm.getelementptr"(%9, %18) <{elem_type = !llvm.struct<"class.llvm::Use", (ptr, ptr, ptr, ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    "llvm.br"(%19)[^bb3] : (!llvm.ptr) -> ()
  ^bb3(%20: !llvm.ptr):  // 2 preds: ^bb1, ^bb2
    %21 = "llvm.ptrtoint"(%arg0) : (!llvm.ptr) -> i64
    %22 = "llvm.ptrtoint"(%20) : (!llvm.ptr) -> i64
    %23 = "llvm.sub"(%21, %22) <{overflowFlags = 0 : i32}> : (i64, i64) -> i64
    %24 = "llvm.lshr"(%23, %7) <{isExact}> : (i64, i64) -> i64
