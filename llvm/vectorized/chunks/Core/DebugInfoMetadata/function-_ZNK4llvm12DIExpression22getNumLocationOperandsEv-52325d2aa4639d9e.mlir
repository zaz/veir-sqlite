"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr):
    ...
    %14 = "llvm.icmp"(%11, %13) <{predicate = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> i1
    "llvm.cond_br"(%14, %2, %2, %11)[^bb1, ^bb2] <{operandSegmentSizes = array<i32: 1, 1, 2>}> : (i1, i64, i64, !llvm.ptr) -> ()
  ^bb1(%15: i64):  // 2 preds: ^bb0, ^bb8
    "llvm.return"(%15) : (i64) -> ()
  ^bb2(%16: i64, %17: !llvm.ptr):  // 2 preds: ^bb0, ^bb8
  ...
  ^bb3:  // pred: ^bb2
    %20 = "llvm.getelementptr"(%17, %9) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %21 = "llvm.load"(%20) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "long", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, access_type = <id = "long", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (!llvm.ptr) -> i64
    %22 = "llvm.add"(%21, %8) <{overflowFlags = 0 : i32}> : (i64, i64) -> i64
    %23 = "llvm.intr.umax"(%16, %22) : (i64, i64) -> i64
    "llvm.br"(%23, %6)[^bb8] : (i64, i64) -> ()
  ^bb4:  // pred: ^bb2
    %24 = "llvm.add"(%18, %4) <{overflowFlags = 0 : i32}> : (i64, i64) -> i64
    %25 = "llvm.icmp"(%24, %5) <{predicate = 6 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%25, %16, %6)[^bb8, ^bb5] <{operandSegmentSizes = array<i32: 1, 2, 0>}> : (i1, i64, i64) -> ()
  ^bb5:  // pred: ^bb4
    "llvm.switch"(%18, %16, %7, %16, %7, %16, %7, %16, %7, %16, %7)[^bb7, ^bb8, ^bb8, ^bb8, ^bb8, ^bb8, ^bb6, ^bb6, ^bb6, ^bb6, ^bb6, ^bb6, ^bb6, ^bb6] <{case_operand_segments = array<i32: 2, 2, 2, 2, 2, 0, 0, 0, 0, 0, 0, 0, 0>, case_values = dense<[4097, 4096, 4102, 4103, 146, 16, 17, 148, 35, 4098, 4099, 4101, 144]> : vector<13xi64>, operandSegmentSizes = array<i32: 1, 0, 10>}> : (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64) -> ()
  ^bb6:  // 8 preds: ^bb5, ^bb5, ^bb5, ^bb5, ^bb5, ^bb5, ^bb5, ^bb5
    "llvm.br"(%16, %6)[^bb8] : (i64, i64) -> ()
  ^bb7:  // pred: ^bb5
    "llvm.br"(%16, %8)[^bb8] : (i64, i64) -> ()
  ^bb8(%26: i64, %27: i64):  // 9 preds: ^bb3, ^bb4, ^bb5, ^bb5, ^bb5, ^bb5, ^bb5, ^bb6, ^bb7
    ...
    %29 = "llvm.icmp"(%28, %13) <{predicate = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> i1
    "llvm.cond_br"(%29, %26, %26, %28)[^bb1, ^bb2] <{operandSegmentSizes = array<i32: 1, 1, 2>}> : (i1, i64, i64, !llvm.ptr) -> ()
  }) : () -> ()
