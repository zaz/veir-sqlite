"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr):
    ...
    %6 = "llvm.mlir.constant"() <{value = -27 : i8}> : () -> i8
    ...
    %12 = "llvm.and"(%11, %1) : (i64, i64) -> i64
    %13 = "llvm.icmp"(%12, %2) <{predicate = 0 : i64}> : (i64, i64) -> i1
  ...
  ^bb2:  // pred: ^bb0
    %16 = "llvm.lshr"(%11, %1) : (i64, i64) -> i64
    %17 = "llvm.and"(%16, %4) : (i64, i64) -> i64
