"builtin.module"() ({
  ...
  ^bb2:  // pred: ^bb0
    %23 = "llvm.lshr"(%18, %1) : (i64, i64) -> i64
    %24 = "llvm.and"(%23, %4) : (i64, i64) -> i64
    %25 = "llvm.sub"(%2, %24) <{overflowFlags = 1 : i32}> : (i64, i64) -> i64
    %26 = "llvm.getelementptr"(%17, %25) <{elem_type = !llvm.struct<"class.llvm::MDOperand", (ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
  ...
  ^bb3(%27: !llvm.ptr):  // 2 preds: ^bb1, ^bb2
    ...
    "llvm.cond_br"(%30, %7, %8, %29)[^bb18, ^bb4] <{operandSegmentSizes = array<i32: 1, 2, 1>}> : (i1, i64, i8, !llvm.ptr) -> ()
  ^bb4(%31: !llvm.ptr):  // 2 preds: ^bb3, ^bb17
    ...
    "llvm.switch"(%32, %7, %8)[^bb18, ^bb5, ^bb5, ^bb5, ^bb5, ^bb5, ^bb5, ^bb5] <{case_operand_segments = array<i32: 0, 0, 0, 0, 0, 0, 0>, case_values = dense<[12, 37, 34, 36, 13, 14, 15]> : vector<7xi8>, operandSegmentSizes = array<i32: 1, 2, 0>}> : (i8, i64, i8) -> ()
  ^bb5:  // 7 preds: ^bb4, ^bb4, ^bb4, ^bb4, ^bb4, ^bb4, ^bb4
    %33 = "llvm.getelementptr"(%31, %0) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
  ...
  ^bb6:  // pred: ^bb5
    %37 = "llvm.getelementptr"(%31, %3) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %38 = "llvm.load"(%37) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "_ZTSN4llvm15SmallVectorBaseIjEE", members = {<#llvm.tbaa_type_desc<id = "any pointer", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, 0>, <#llvm.tbaa_type_desc<id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, 8>, <#llvm.tbaa_type_desc<id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, 12>}>, access_type = <id = "any pointer", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (!llvm.ptr) -> !llvm.ptr
    "llvm.br"(%38)[^bb8] : (!llvm.ptr) -> ()
  ^bb7:  // pred: ^bb5
    %39 = "llvm.lshr"(%34, %1) : (i64, i64) -> i64
    %40 = "llvm.and"(%39, %4) : (i64, i64) -> i64
    %41 = "llvm.sub"(%2, %40) <{overflowFlags = 1 : i32}> : (i64, i64) -> i64
  ...
  ^bb9:  // pred: ^bb8
    %47 = "llvm.load"(%45) <{alignment = 4 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "_ZTSN4llvm8MetadataE", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>, <#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 1>, <#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 1>, <#llvm.tbaa_type_desc<id = "short", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, 2>, <#llvm.tbaa_type_desc<id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, 4>}>, access_type = <id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, offset = 0>]}> : (!llvm.ptr) -> i8
    %48 = "llvm.icmp"(%47, %9) <{predicate = 0 : i64}> : (i8, i8) -> i1
    "llvm.cond_br"(%48)[^bb10, ^bb13] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb10:  // pred: ^bb9
    %49 = "llvm.getelementptr"(%45, %10) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    "llvm.cond_br"(%51)[^bb13, ^bb11] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb11:  // pred: ^bb10
    ...
    %53 = "llvm.icmp"(%52, %11) <{predicate = 0 : i64}> : (i8, i8) -> i1
  ...
  ^bb12:  // pred: ^bb11
    ...
    %57 = "llvm.icmp"(%56, %13) <{predicate = 6 : i64}> : (i32, i32) -> i1
    %58 = "llvm.load"(%54) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
    %59 = "llvm.select"(%57, %54, %58) <{fastmathFlags = #llvm.fastmath<none>}> : (i1, !llvm.ptr, !llvm.ptr) -> !llvm.ptr
    ...
    %61 = "llvm.icmp"(%60, %2) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%61, %60, %9)[^bb13, ^bb18] <{operandSegmentSizes = array<i32: 1, 0, 2>}> : (i1, i64, i8) -> ()
  ^bb13:  // 5 preds: ^bb8, ^bb9, ^bb10, ^bb11, ^bb12
    %62 = "llvm.icmp"(%32, %14) <{predicate = 0 : i64}> : (i8, i8) -> i1
    "llvm.cond_br"(%62, %7, %8)[^bb14, ^bb18] <{operandSegmentSizes = array<i32: 1, 0, 2>}> : (i1, i64, i8) -> ()
  ^bb14:  // pred: ^bb13
    "llvm.cond_br"(%36)[^bb16, ^bb15] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb15:  // pred: ^bb14
    %63 = "llvm.getelementptr"(%31, %3) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %64 = "llvm.load"(%63) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "_ZTSN4llvm15SmallVectorBaseIjEE", members = {<#llvm.tbaa_type_desc<id = "any pointer", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, 0>, <#llvm.tbaa_type_desc<id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, 8>, <#llvm.tbaa_type_desc<id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, 12>}>, access_type = <id = "any pointer", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (!llvm.ptr) -> !llvm.ptr
    "llvm.br"(%64)[^bb17] : (!llvm.ptr) -> ()
  ^bb16:  // pred: ^bb14
    %65 = "llvm.lshr"(%34, %1) : (i64, i64) -> i64
    %66 = "llvm.and"(%65, %4) : (i64, i64) -> i64
    %67 = "llvm.sub"(%2, %66) <{overflowFlags = 1 : i32}> : (i64, i64) -> i64
    %68 = "llvm.getelementptr"(%33, %67) <{elem_type = !llvm.struct<"class.llvm::MDOperand", (ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    "llvm.br"(%68)[^bb17] : (!llvm.ptr) -> ()
  ^bb17(%69: !llvm.ptr):  // 2 preds: ^bb15, ^bb16
    %70 = "llvm.getelementptr"(%69, %15) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %71 = "llvm.load"(%70) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "_ZTSN4llvm9MDOperandE", members = {<#llvm.tbaa_type_desc<id = "any pointer", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, 0>}>, access_type = <id = "any pointer", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (!llvm.ptr) -> !llvm.ptr
    %72 = "llvm.icmp"(%71, %6) <{predicate = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> i1
    "llvm.cond_br"(%72, %7, %8, %71)[^bb18, ^bb4] <{operandSegmentSizes = array<i32: 1, 2, 1>}> : (i1, i64, i8, !llvm.ptr) -> ()
  ^bb18(%73: i64, %74: i8):  // 5 preds: ^bb3, ^bb4, ^bb12, ^bb13, ^bb17
    %75 = "llvm.insertvalue"(%16, %73) <{position = array<i64: 0>}> : (!llvm.struct<(i64, i8)>, i64) -> !llvm.struct<(i64, i8)>
    %76 = "llvm.insertvalue"(%75, %74) <{position = array<i64: 1>}> : (!llvm.struct<(i64, i8)>, i8) -> !llvm.struct<(i64, i8)>
    "llvm.return"(%76) : (!llvm.struct<(i64, i8)>) -> ()
  }) : () -> ()
