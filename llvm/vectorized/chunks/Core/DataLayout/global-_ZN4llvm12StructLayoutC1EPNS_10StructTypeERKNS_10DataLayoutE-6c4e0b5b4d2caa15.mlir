"builtin.module"() ({
  "llvm.mlir.alias"() <{alias_type = !llvm.func<void (ptr, ptr, ptr)>, linkage = #llvm.linkage<external>, sym_name = "_ZN4llvm12StructLayoutC1EPNS_10StructTypeERKNS_10DataLayoutE", tls_mode = 0 : i64, unnamed_addr = 2 : i64, visibility_ = 0 : i64}> ({
    %120 = "llvm.mlir.addressof"() <{global_name = @_ZN4llvm12StructLayoutC2EPNS_10StructTypeERKNS_10DataLayoutE}> : () -> !llvm.ptr
