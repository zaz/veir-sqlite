"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr, %arg1: i32):
    ...
    %18 = "llvm.alloca"(%0) <{alignment = 16 : i64, elem_type = !llvm.struct<"class.llvm::DenseMap.309", (ptr, ptr, i32, i32)>}> : (i32) -> !llvm.ptr
  ...
  ^bb4(%64: i32):  // 2 preds: ^bb3, ^bb7
    ...
    %68 = "llvm.getelementptr"(%45, %67) <{elem_type = !llvm.struct<"struct.llvm::detail::DenseMapPair.408", (struct<"struct.std::pair.409", (ptr, struct<"class.std::__cxx11::basic_string", (struct<"struct.std::__cxx11::basic_string<char>::_Alloc_hider", (ptr)>, i64, struct<"union.anon.315", (i64, array<8 x i8>)>)>)>)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 0, 1>}> : (!llvm.ptr, i64) -> !llvm.ptr
