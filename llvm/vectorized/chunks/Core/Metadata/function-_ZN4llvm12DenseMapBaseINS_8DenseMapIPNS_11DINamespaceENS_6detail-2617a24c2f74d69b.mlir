"builtin.module"() ({
  ...
  ^bb1(%41: i64, %42: i32, %43: i32):  // 2 preds: ^bb0, ^bb6
    %44 = "llvm.getelementptr"(%20, %41) <{elem_type = !llvm.struct<"class.llvm::detail::DenseSetPair.1186", (ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
  ...
  ^bb4(%56: !llvm.ptr):  // 2 preds: ^bb2, ^bb3
    ...
    "llvm.store"(%58, %16) <{alignment = 16 : i64, ordering = 0 : i64}> : (vector<2x!llvm.ptr>, !llvm.ptr) -> ()
    %59 = "llvm.call"(%16, %1) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<none>, arg_attrs = [{llvm.nonnull, llvm.noundef}, {llvm.noundef}], callee = @_ZN4llvm11xxh3_64bitsEPKhm, fastmathFlags = #llvm.fastmath<none>, no_unwind, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 2, 0>, res_attrs = [{llvm.noundef}]}> : (!llvm.ptr, i64) -> i64
    "llvm.intr.lifetime.end"(%16) : (!llvm.ptr) -> ()
    %60 = "llvm.trunc"(%59) <{overflowFlags = 0 : i32}> : (i64) -> i32
    %61 = "llvm.xor"(%60, %14) : (i32, i32) -> i32
    %62 = "llvm.sub"(%43, %61) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
    %63 = "llvm.and"(%62, %25) : (i32, i32) -> i32
    %64 = "llvm.sub"(%42, %61) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
    %65 = "llvm.and"(%64, %25) : (i32, i32) -> i32
    %66 = "llvm.icmp"(%63, %65) <{predicate = 6 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%66, %43)[^bb5, ^bb6] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i32) -> ()
  ^bb5:  // pred: ^bb4
    %67 = "llvm.zext"(%43) : (i32) -> i64
    %68 = "llvm.getelementptr"(%20, %67) <{elem_type = !llvm.struct<"class.llvm::detail::DenseSetPair.1186", (ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %69 = "llvm.load"(%44) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "any pointer", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, access_type = <id = "any pointer", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (!llvm.ptr) -> !llvm.ptr
    "llvm.store"(%69, %68) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "any pointer", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, access_type = <id = "any pointer", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (!llvm.ptr, !llvm.ptr) -> ()
    "llvm.br"(%42)[^bb6] : (i32) -> ()
  ^bb6(%70: i32):  // 2 preds: ^bb4, ^bb5
    %71 = "llvm.add"(%42, %0) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
    %72 = "llvm.and"(%71, %25) : (i32, i32) -> i32
    %73 = "llvm.zext"(%72) : (i32) -> i64
    %74 = "llvm.lshr"(%73, %6) : (i64, i64) -> i64
    %75 = "llvm.getelementptr"(%22, %74) <{elem_type = i32, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    "llvm.cond_br"(%80, %70, %73, %72, %70)[^bb7, ^bb1] <{operandSegmentSizes = array<i32: 1, 1, 3>}> : (i1, i32, i64, i32, i32) -> ()
  ^bb7(%81: i32):  // 2 preds: ^bb0, ^bb6
    %82 = "llvm.and"(%81, %7) : (i32, i32) -> i32
    %83 = "llvm.shl"(%0, %82) <{overflowFlags = 2 : i32}> : (i32, i32) -> i32
    %84 = "llvm.xor"(%83, %2) : (i32, i32) -> i32
    %85 = "llvm.lshr"(%81, %15) : (i32, i32) -> i32
    %86 = "llvm.zext"(%85) <{nonNeg}> : (i32) -> i64
    %87 = "llvm.getelementptr"(%22, %86) <{elem_type = i32, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
