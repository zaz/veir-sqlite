"builtin.module"() ({
  ...
  ^bb2(%45: i64, %46: i32, %47: i32):  // 2 preds: ^bb1, ^bb7
    %48 = "llvm.getelementptr"(%23, %45) <{elem_type = !llvm.struct<"class.llvm::detail::DenseSetPair.1216", (ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
  ...
  ^bb3:  // pred: ^bb2
    %54 = "llvm.getelementptr"(%49, %12) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    "llvm.br"(%55)[^bb5] : (!llvm.ptr) -> ()
  ^bb4:  // pred: ^bb2
    %56 = "llvm.lshr"(%51, %10) : (i64, i64) -> i64
    %57 = "llvm.and"(%56, %13) : (i64, i64) -> i64
    %58 = "llvm.sub"(%11, %57) <{overflowFlags = 1 : i32}> : (i64, i64) -> i64
  ...
  ^bb5(%60: !llvm.ptr):  // 2 preds: ^bb3, ^bb4
    %61 = "llvm.getelementptr"(%49, %14) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %62 = "llvm.load"(%61) <{alignment = 1 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> i8
    %63 = "llvm.lshr"(%62, %15) : (i8, i8) -> i8
    ...
    "llvm.store"(%64, %19) <{alignment = 16 : i64, ordering = 0 : i64}> : (vector<2x!llvm.ptr>, !llvm.ptr) -> ()
    "llvm.store"(%63, %44) <{alignment = 16 : i64, ordering = 0 : i64}> : (i8, !llvm.ptr) -> ()
    %65 = "llvm.call"(%19, %16) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<none>, arg_attrs = [{llvm.nonnull, llvm.noundef}, {llvm.noundef}], callee = @_ZN4llvm11xxh3_64bitsEPKhm, fastmathFlags = #llvm.fastmath<none>, no_unwind, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 2, 0>, res_attrs = [{llvm.noundef}]}> : (!llvm.ptr, i64) -> i64
    "llvm.intr.lifetime.end"(%19) : (!llvm.ptr) -> ()
    %66 = "llvm.trunc"(%65) <{overflowFlags = 0 : i32}> : (i64) -> i32
    %67 = "llvm.xor"(%66, %17) : (i32, i32) -> i32
    %68 = "llvm.sub"(%47, %67) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
    %69 = "llvm.and"(%68, %28) : (i32, i32) -> i32
    %70 = "llvm.sub"(%46, %67) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
    %71 = "llvm.and"(%70, %28) : (i32, i32) -> i32
    %72 = "llvm.icmp"(%69, %71) <{predicate = 6 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%72, %47)[^bb6, ^bb7] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i32) -> ()
  ^bb6:  // pred: ^bb5
    %73 = "llvm.zext"(%47) : (i32) -> i64
    %74 = "llvm.getelementptr"(%23, %73) <{elem_type = !llvm.struct<"class.llvm::detail::DenseSetPair.1216", (ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
  ...
  ^bb7(%76: i32):  // 2 preds: ^bb5, ^bb6
    %77 = "llvm.add"(%46, %0) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
    %78 = "llvm.and"(%77, %28) : (i32, i32) -> i32
    %79 = "llvm.zext"(%78) : (i32) -> i64
    %80 = "llvm.lshr"(%79, %6) : (i64, i64) -> i64
    %81 = "llvm.getelementptr"(%25, %80) <{elem_type = i32, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
  ...
  ^bb8(%87: i32):  // 2 preds: ^bb0, ^bb7
    ...
    %91 = "llvm.lshr"(%87, %18) : (i32, i32) -> i32
