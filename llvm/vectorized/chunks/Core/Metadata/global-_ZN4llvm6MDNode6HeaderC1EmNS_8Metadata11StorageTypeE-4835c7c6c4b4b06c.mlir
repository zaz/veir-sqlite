"builtin.module"() ({
  "llvm.mlir.alias"() <{alias_type = !llvm.func<void (ptr, i64, i32)>, linkage = #llvm.linkage<external>, sym_name = "_ZN4llvm6MDNode6HeaderC1EmNS_8Metadata11StorageTypeE", tls_mode = 0 : i64, unnamed_addr = 2 : i64, visibility_ = 0 : i64}> ({
    %61 = "llvm.mlir.addressof"() <{global_name = @_ZN4llvm6MDNode6HeaderC2EmNS_8Metadata11StorageTypeE}> : () -> !llvm.ptr
