"builtin.module"() ({
  "llvm.comdat"() <{sym_name = "__llvm_global_comdat"}> ({
    "llvm.comdat_selector"() <{comdat = 0 : i64, sym_name = "_ZN4llvm23SmallVectorTemplateBaseINS_9MDOperandELb0EE19moveElementsForGrowEPS1_"}> : () -> ()
  }) : () -> ()
  ...
  ^bb0(%arg0: !llvm.ptr, %arg1: !llvm.ptr):
    ...
    %21 = "llvm.getelementptr"(%17, %20) <{elem_type = !llvm.struct<"class.llvm::MDOperand", (ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %22 = "llvm.icmp"(%19, %1) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%22, %arg1, %17)[^bb15, ^bb1] <{operandSegmentSizes = array<i32: 1, 0, 2>}> : (i1, !llvm.ptr, !llvm.ptr) -> ()
  ^bb1(%23: !llvm.ptr, %24: !llvm.ptr):  // 2 preds: ^bb0, ^bb9
    ...
    "llvm.cond_br"(%26)[^bb9, ^bb2] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb2:  // pred: ^bb1
  ...
  ^bb8(%54: !llvm.ptr):  // 3 preds: ^bb5, ^bb6, ^bb7
    ...
    "llvm.br"()[^bb9] : () -> ()
  ^bb9:  // 5 preds: ^bb1, ^bb4, ^bb5, ^bb7, ^bb8
    ...
    "llvm.cond_br"(%57, %56, %55)[^bb10, ^bb1] <{loop_annotation = #llvm.loop_annotation<mustProgress = true>, operandSegmentSizes = array<i32: 1, 0, 2>}> : (i1, !llvm.ptr, !llvm.ptr) -> ()
  ^bb10:  // pred: ^bb9
    ...
    "llvm.cond_br"(%60)[^bb15, ^bb11] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb11:  // pred: ^bb10
    %61 = "llvm.zext"(%59) : (i32) -> i64
    %62 = "llvm.getelementptr"(%58, %61) <{elem_type = !llvm.struct<"class.llvm::MDOperand", (ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    "llvm.br"(%62)[^bb12] : (!llvm.ptr) -> ()
  ^bb12(%63: !llvm.ptr):  // 2 preds: ^bb11, ^bb14
  ...
  ^bb14:  // 2 preds: ^bb12, ^bb13
    ...
    "llvm.cond_br"(%67, %64)[^bb15, ^bb12] <{loop_annotation = #llvm.loop_annotation<mustProgress = true>, operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, !llvm.ptr) -> ()
  ^bb15:  // 3 preds: ^bb0, ^bb10, ^bb14
    "llvm.return"() : () -> ()
  }) : () -> ()
