"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr, %arg1: !llvm.ptr):
    ...
    %20 = "llvm.alloca"(%0) <{alignment = 1 : i64, elem_type = !llvm.struct<"struct.std::array.1279", (array<5 x i8>)>}> : (i32) -> !llvm.ptr
    %21 = "llvm.alloca"(%0) <{alignment = 16 : i64, elem_type = !llvm.struct<"struct.std::array.1278", (array<33 x i8>)>}> : (i32) -> !llvm.ptr
  ...
  ^bb5(%68: i64, %69: i32):  // 2 preds: ^bb3, ^bb4
    %70 = "llvm.getelementptr"(%22, %68) <{elem_type = !llvm.struct<"class.llvm::detail::DenseSetPair.1277", (ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
  ...
  ^bb6:  // pred: ^bb5
    %73 = "llvm.getelementptr"(%22, %68) <{elem_type = !llvm.struct<"class.llvm::detail::DenseSetPair.1277", (ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
