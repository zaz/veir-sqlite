"builtin.module"() ({
  ...
  ^bb1:  // pred: ^bb0
    %16 = "llvm.lshr"(%13, %4) : (i64, i64) -> i64
    %17 = "llvm.and"(%16, %5) : (i64, i64) -> i64
    %18 = "llvm.icmp"(%17, %arg1) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%18)[^bb15, ^bb4] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb2:  // pred: ^bb0
    ...
    %22 = "llvm.icmp"(%21, %arg1) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%22)[^bb15, ^bb3] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb3:  // pred: ^bb2
    ...
    "llvm.br"()[^bb15] : () -> ()
  ^bb4:  // pred: ^bb1
    %24 = "llvm.lshr"(%13, %0) : (i64, i64) -> i64
    %25 = "llvm.and"(%24, %5) : (i64, i64) -> i64
    %26 = "llvm.icmp"(%25, %arg1) <{predicate = 6 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%26)[^bb14, ^bb5] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb5:  // pred: ^bb4
    %27 = "llvm.sub"(%1, %25) <{overflowFlags = 1 : i32}> : (i64, i64) -> i64
    %28 = "llvm.getelementptr"(%arg0, %27) <{elem_type = !llvm.struct<"class.llvm::MDOperand", (ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %29 = "llvm.trunc"(%arg1) <{overflowFlags = 0 : i32}> : (i64) -> i32
    %30 = "llvm.trunc"(%17) <{overflowFlags = 3 : i32}> : (i64) -> i32
    %31 = "llvm.sub"(%29, %30) <{overflowFlags = 1 : i32}> : (i32, i32) -> i32
    %32 = "llvm.getelementptr"(%28, %17) <{elem_type = !llvm.struct<"class.llvm::MDOperand", (ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %33 = "llvm.icmp"(%31, %6) <{predicate = 4 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%33, %32, %6, %32)[^bb7, ^bb6] <{operandSegmentSizes = array<i32: 1, 2, 1>}> : (i1, !llvm.ptr, i32, !llvm.ptr) -> ()
  ^bb6(%34: !llvm.ptr):  // 2 preds: ^bb5, ^bb9
    %35 = "llvm.icmp"(%31, %6) <{predicate = 2 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%35, %34, %6)[^bb10, ^bb13] <{operandSegmentSizes = array<i32: 1, 2, 0>}> : (i1, !llvm.ptr, i32) -> ()
  ^bb7(%36: !llvm.ptr, %37: i32):  // 2 preds: ^bb5, ^bb9
    ...
    "llvm.cond_br"(%40)[^bb9, ^bb8] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb8:  // pred: ^bb7
  ...
  ^bb9:  // 2 preds: ^bb7, ^bb8
    ...
    "llvm.cond_br"(%42, %38, %38, %41)[^bb6, ^bb7] <{loop_annotation = #llvm.loop_annotation<mustProgress = true>, operandSegmentSizes = array<i32: 1, 1, 2>}> : (i1, !llvm.ptr, !llvm.ptr, i32) -> ()
  ^bb10(%43: !llvm.ptr, %44: i32):  // 2 preds: ^bb6, ^bb12
  ...
  ^bb11:  // pred: ^bb10
    "llvm.call"(%45, %46) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<tail>, arg_attrs = [{llvm.nonnull, llvm.noundef}, {llvm.align = 4 : i64, llvm.dereferenceable = 8 : i64, llvm.nonnull, llvm.noundef}], callee = @_ZN4llvm16MetadataTracking7untrackEPvRNS_8MetadataE, fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 2, 0>}> : (!llvm.ptr, !llvm.ptr) -> ()
    "llvm.br"()[^bb12] : () -> ()
  ^bb12:  // 2 preds: ^bb10, ^bb11
    "llvm.store"(%8, %45) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "_ZTSN4llvm9MDOperandE", members = {<#llvm.tbaa_type_desc<id = "any pointer", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, 0>}>, access_type = <id = "any pointer", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (!llvm.ptr, !llvm.ptr) -> ()
    %48 = "llvm.add"(%44, %10) <{overflowFlags = 1 : i32}> : (i32, i32) -> i32
    %49 = "llvm.icmp"(%48, %31) <{predicate = 4 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%49, %45, %48)[^bb10, ^bb13] <{loop_annotation = #llvm.loop_annotation<mustProgress = true>, operandSegmentSizes = array<i32: 1, 2, 0>}> : (i1, !llvm.ptr, i32) -> ()
  ^bb13:  // 2 preds: ^bb6, ^bb12
    %50 = "llvm.load"(%arg0) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> i64
    %51 = "llvm.shl"(%arg1, %4) <{overflowFlags = 0 : i32}> : (i64, i64) -> i64
    %52 = "llvm.and"(%51, %11) : (i64, i64) -> i64
    %53 = "llvm.and"(%50, %12) : (i64, i64) -> i64
    %54 = "llvm.or"(%53, %52) <{isDisjoint}> : (i64, i64) -> i64
    "llvm.store"(%54, %arg0) <{alignment = 8 : i64, ordering = 0 : i64}> : (i64, !llvm.ptr) -> ()
    "llvm.br"()[^bb15] : () -> ()
  ^bb14:  // pred: ^bb4
    "llvm.call"(%arg0, %arg1) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<tail>, arg_attrs = [{llvm.align = 8 : i64, llvm.dereferenceable = 12 : i64, llvm.nonnull, llvm.noundef}, {llvm.noundef}], callee = @_ZN4llvm6MDNode6Header18resizeSmallToLargeEm, fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 2, 0>}> : (!llvm.ptr, i64) -> ()
    "llvm.br"()[^bb15] : () -> ()
  ^bb15:  // 5 preds: ^bb1, ^bb2, ^bb3, ^bb13, ^bb14
    "llvm.return"() : () -> ()
  }) : () -> ()
  "llvm.func"() <{CConv = #llvm.cconv<ccc>, alignment = 2 : i64, arg_attrs = [{llvm.align = 8 : i64, llvm.dereferenceable = 12 : i64, llvm.nonnull, llvm.noundef}, {llvm.noundef}], dso_local, function_type = !llvm.func<void (ptr, i64)>, linkage = #llvm.linkage<external>, no_unwind, passthrough = ["mustprogress", ["min-legal-vector-width", "0"], ["no-trapping-math", "true"], ["stack-protector-buffer-size", "8"], ["target-cpu", "x86-64"]], sym_name = "_ZN4llvm6MDNode6Header18resizeSmallToLargeEm", target_cpu = "x86-64", target_features = #llvm.target_features<["+cmov", "+cx8", "+fxsr", "+mmx", "+sse", "+sse2", "+x87"]>, tune_cpu = "generic", unnamed_addr = 1 : i64, uwtable_kind = #llvm.uwtableKind<async>, visibility_ = 0 : i64}> ({
  }) : () -> ()
