"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr, %arg1: !llvm.ptr, %arg2: !llvm.ptr):
    ...
    %27 = "llvm.alloca"(%0) <{alignment = 16 : i64, elem_type = !llvm.struct<"struct.std::array.1278", (array<33 x i8>)>}> : (i32) -> !llvm.ptr
  ...
  ^bb1:  // pred: ^bb0
    %52 = "llvm.getelementptr"(%27, %1) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %53 = "llvm.getelementptr"(%27, %4) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %54 = "llvm.getelementptr"(%27, %9) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %55 = "llvm.getelementptr"(%26, %10) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %56 = "llvm.getelementptr"(%27, %11) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    "llvm.br"(%44, %43, %41)[^bb2] : (i64, i32, i32) -> ()
  ^bb2(%57: i64, %58: i32, %59: i32):  // 2 preds: ^bb1, ^bb9
    %60 = "llvm.getelementptr"(%31, %57) <{elem_type = !llvm.struct<"class.llvm::detail::DenseSetPair.1277", (ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    %64 = "llvm.and"(%63, %13) : (i64, i64) -> i64
    %65 = "llvm.icmp"(%64, %14) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%65)[^bb4, ^bb3] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb3:  // pred: ^bb2
    %66 = "llvm.getelementptr"(%61, %15) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
  ...
  ^bb4:  // pred: ^bb2
    %68 = "llvm.lshr"(%63, %13) : (i64, i64) -> i64
    %69 = "llvm.and"(%68, %16) : (i64, i64) -> i64
    %70 = "llvm.sub"(%14, %69) <{overflowFlags = 1 : i32}> : (i64, i64) -> i64
    ...
    "llvm.br"(%71)[^bb5] : (!llvm.ptr) -> ()
  ^bb5(%72: !llvm.ptr):  // 2 preds: ^bb3, ^bb4
    %73 = "llvm.getelementptr"(%61, %17) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    %75 = "llvm.getelementptr"(%61, %1) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    %77 = "llvm.getelementptr"(%61, %18) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    %79 = "llvm.getelementptr"(%61, %4) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %80 = "llvm.load"(%79) <{alignment = 4 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> i64
    ...
    "llvm.store"(%81, %27) <{alignment = 16 : i64, ordering = 0 : i64}> : (vector<2x!llvm.ptr>, !llvm.ptr) -> ()
    "llvm.store"(%74, %52) <{alignment = 16 : i64, ordering = 0 : i64}> : (i32, !llvm.ptr) -> ()
    "llvm.store"(%76, %53) <{alignment = 4 : i64, ordering = 0 : i64}> : (i32, !llvm.ptr) -> ()
    "llvm.store"(%78, %54) <{alignment = 8 : i64, ordering = 0 : i64}> : (i8, !llvm.ptr) -> ()
    %82 = "llvm.and"(%80, %19) : (i64, i64) -> i64
    %83 = "llvm.icmp"(%82, %14) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%83, %20)[^bb7, ^bb6] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i64) -> ()
  ^bb6:  // pred: ^bb5
    "llvm.intr.lifetime.start"(%26) : (!llvm.ptr) -> ()
    "llvm.store"(%21, %26) <{alignment = 1 : i64, ordering = 0 : i64}> : (i8, !llvm.ptr) -> ()
    %84 = "llvm.trunc"(%80) <{overflowFlags = 0 : i32}> : (i64) -> i32
    "llvm.store"(%84, %55) <{alignment = 1 : i64, ordering = 0 : i64}> : (i32, !llvm.ptr) -> ()
    %85 = "llvm.call"(%26, %6) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<none>, arg_attrs = [{llvm.nonnull, llvm.noundef}, {llvm.noundef}], callee = @_ZN4llvm11xxh3_64bitsEPKhm, fastmathFlags = #llvm.fastmath<none>, no_unwind, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 2, 0>, res_attrs = [{llvm.noundef}]}> : (!llvm.ptr, i64) -> i64
    %86 = "llvm.xor"(%85, %22) : (i64, i64) -> i64
    "llvm.intr.lifetime.end"(%26) : (!llvm.ptr) -> ()
    "llvm.br"(%86)[^bb7] : (i64) -> ()
  ^bb7(%87: i64):  // 2 preds: ^bb5, ^bb6
    "llvm.store"(%87, %56) <{alignment = 1 : i64, ordering = 0 : i64}> : (i64, !llvm.ptr) -> ()
    %88 = "llvm.call"(%27, %23) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<none>, arg_attrs = [{llvm.nonnull, llvm.noundef}, {llvm.noundef}], callee = @_ZN4llvm11xxh3_64bitsEPKhm, fastmathFlags = #llvm.fastmath<none>, no_unwind, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 2, 0>, res_attrs = [{llvm.noundef}]}> : (!llvm.ptr, i64) -> i64
    "llvm.intr.lifetime.end"(%27) : (!llvm.ptr) -> ()
    %89 = "llvm.trunc"(%88) <{overflowFlags = 0 : i32}> : (i64) -> i32
    %90 = "llvm.xor"(%89, %24) : (i32, i32) -> i32
    %91 = "llvm.sub"(%59, %90) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
    %92 = "llvm.and"(%91, %36) : (i32, i32) -> i32
    %93 = "llvm.sub"(%58, %90) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
    %94 = "llvm.and"(%93, %36) : (i32, i32) -> i32
    %95 = "llvm.icmp"(%92, %94) <{predicate = 6 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%95, %59)[^bb8, ^bb9] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i32) -> ()
  ^bb8:  // pred: ^bb7
    %96 = "llvm.zext"(%59) : (i32) -> i64
    %97 = "llvm.getelementptr"(%31, %96) <{elem_type = !llvm.struct<"class.llvm::detail::DenseSetPair.1277", (ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %98 = "llvm.load"(%60) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "any pointer", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, access_type = <id = "any pointer", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (!llvm.ptr) -> !llvm.ptr
    "llvm.store"(%98, %97) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "any pointer", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, access_type = <id = "any pointer", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (!llvm.ptr, !llvm.ptr) -> ()
    "llvm.br"(%58)[^bb9] : (i32) -> ()
  ^bb9(%99: i32):  // 2 preds: ^bb7, ^bb8
    %100 = "llvm.add"(%58, %0) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
    %101 = "llvm.and"(%100, %36) : (i32, i32) -> i32
    %102 = "llvm.zext"(%101) : (i32) -> i64
    %103 = "llvm.lshr"(%102, %6) : (i64, i64) -> i64
    %104 = "llvm.getelementptr"(%33, %103) <{elem_type = i32, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %105 = "llvm.load"(%104) <{alignment = 4 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, access_type = <id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (!llvm.ptr) -> i32
    %106 = "llvm.and"(%101, %7) : (i32, i32) -> i32
    %107 = "llvm.shl"(%0, %106) <{overflowFlags = 2 : i32}> : (i32, i32) -> i32
    %108 = "llvm.and"(%107, %105) : (i32, i32) -> i32
    %109 = "llvm.icmp"(%108, %8) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%109, %99, %102, %101, %99)[^bb10, ^bb2] <{operandSegmentSizes = array<i32: 1, 1, 3>}> : (i1, i32, i64, i32, i32) -> ()
  ^bb10(%110: i32):  // 2 preds: ^bb0, ^bb9
    %111 = "llvm.and"(%110, %7) : (i32, i32) -> i32
    %112 = "llvm.shl"(%0, %111) <{overflowFlags = 2 : i32}> : (i32, i32) -> i32
    %113 = "llvm.xor"(%112, %2) : (i32, i32) -> i32
    %114 = "llvm.lshr"(%110, %25) : (i32, i32) -> i32
    %115 = "llvm.zext"(%114) <{nonNeg}> : (i32) -> i64
    %116 = "llvm.getelementptr"(%33, %115) <{elem_type = i32, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %117 = "llvm.load"(%116) <{alignment = 4 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, access_type = <id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (!llvm.ptr) -> i32
    %118 = "llvm.and"(%117, %113) : (i32, i32) -> i32
    "llvm.store"(%118, %116) <{alignment = 4 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, access_type = <id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (i32, !llvm.ptr) -> ()
    "llvm.return"() : () -> ()
  }) : () -> ()
