"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr):
    ...
    "llvm.switch"(%7, %0)[^bb4, ^bb1, ^bb2] <{case_operand_segments = array<i32: 0, 0>, case_values = dense<[17, 14]> : vector<2xi8>, operandSegmentSizes = array<i32: 1, 1, 0>}> : (i8, i1) -> ()
  ^bb1:  // pred: ^bb0
    %8 = "llvm.getelementptr"(%arg0, %5) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %9 = "llvm.load"(%8) <{alignment = 4 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> i32
    %10 = "llvm.and"(%9, %6) : (i32, i32) -> i32
    %11 = "llvm.icmp"(%10, %4) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.br"(%11)[^bb4] : (i1) -> ()
  ^bb2:  // pred: ^bb0
    ...
    %14 = "llvm.icmp"(%13, %12) <{predicate = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> i1
    "llvm.cond_br"(%14, %0)[^bb3, ^bb4] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i1) -> ()
  ^bb3:  // pred: ^bb2
    ...
    "llvm.br"(%18)[^bb4] : (i1) -> ()
  ^bb4(%19: i1):  // 4 preds: ^bb0, ^bb1, ^bb2, ^bb3
    "llvm.return"(%19) : (i1) -> ()
  }) : () -> ()
