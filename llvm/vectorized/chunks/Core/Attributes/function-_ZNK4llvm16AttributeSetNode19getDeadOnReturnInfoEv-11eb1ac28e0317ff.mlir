"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr):
    ...
    %15 = "llvm.mlir.poison"() : () -> !llvm.struct<(i64, i8)>
    ...
    %18 = "llvm.icmp"(%17, %1) <{predicate = 4 : i64}> : (i8, i8) -> i1
    "llvm.cond_br"(%18, %2, %3)[^bb6, ^bb1] <{operandSegmentSizes = array<i32: 1, 2, 0>}> : (i1, i64, i8) -> ()
  ^bb1:  // pred: ^bb0
    ...
    %27 = "llvm.sub"(%2, %26) <{overflowFlags = 1 : i32}> : (i64, i64) -> i64
    ...
    %33 = "llvm.icmp"(%32, %2) <{predicate = 4 : i64}> : (i64, i64) -> i1
  ...
  ^bb2(%34: !llvm.ptr, %35: i64):  // 2 preds: ^bb1, ^bb4
    ...
    %39 = "llvm.icmp"(%38, %9) <{predicate = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> i1
    "llvm.cond_br"(%39, %10)[^bb4, ^bb3] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i32) -> ()
  ^bb3:  // pred: ^bb2
  ...
  ^bb4(%42: i32):  // 2 preds: ^bb2, ^bb3
    ...
    %49 = "llvm.icmp"(%47, %2) <{predicate = 4 : i64}> : (i64, i64) -> i1
  ...
  ^bb5(%50: !llvm.ptr):  // 2 preds: ^bb1, ^bb4
    ...
    %55 = "llvm.icmp"(%54, %13) <{predicate = 1 : i64}> : (i64, i64) -> i1
    %56 = "llvm.zext"(%55) : (i1) -> i8
    "llvm.br"(%54, %56)[^bb6] : (i64, i8) -> ()
  ^bb6(%57: i64, %58: i8):  // 2 preds: ^bb0, ^bb5
    %59 = "llvm.insertvalue"(%15, %57) <{position = array<i64: 0>}> : (!llvm.struct<(i64, i8)>, i64) -> !llvm.struct<(i64, i8)>
    %60 = "llvm.insertvalue"(%59, %58) <{position = array<i64: 1>}> : (!llvm.struct<(i64, i8)>, i8) -> !llvm.struct<(i64, i8)>
    "llvm.return"(%60) : (!llvm.struct<(i64, i8)>) -> ()
  }) : () -> ()
