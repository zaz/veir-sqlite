"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr, %arg1: i32):
    ...
    %12 = "llvm.mlir.poison"() : () -> !llvm.struct<(i64, i8)>
    ...
    "llvm.cond_br"(%17, %3, %14)[^bb7, ^bb1] <{operandSegmentSizes = array<i32: 1, 2, 0>}> : (i1, i64, !llvm.ptr) -> ()
  ^bb1:  // pred: ^bb0
    %18 = "llvm.zext"(%16) : (i32) -> i64
    "llvm.br"(%14, %18)[^bb2] : (!llvm.ptr, i64) -> ()
  ^bb2(%19: !llvm.ptr, %20: i64):  // 2 preds: ^bb1, ^bb6
    %21 = "llvm.lshr"(%20, %4) : (i64, i64) -> i64
    %22 = "llvm.getelementptr"(%19, %21) <{elem_type = !llvm.struct<"class.llvm::Attribute", (ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    "llvm.cond_br"(%24, %2)[^bb5, ^bb3] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i32) -> ()
  ^bb3:  // pred: ^bb2
    ...
    "llvm.cond_br"(%27, %21, %19)[^bb6, ^bb4] <{operandSegmentSizes = array<i32: 1, 2, 0>}> : (i1, i64, !llvm.ptr) -> ()
  ^bb4:  // pred: ^bb3
    %28 = "llvm.getelementptr"(%23, %7) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    "llvm.br"(%29)[^bb5] : (i32) -> ()
  ^bb5(%30: i32):  // 2 preds: ^bb2, ^bb4
    %31 = "llvm.freeze"(%30) : (i32) -> i32
    %32 = "llvm.icmp"(%31, %arg1) <{predicate = 2 : i64}> : (i32, i32) -> i1
    %33 = "llvm.getelementptr"(%22, %0) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %34 = "llvm.xor"(%21, %8) : (i64, i64) -> i64
    %35 = "llvm.add"(%20, %34) <{overflowFlags = 1 : i32}> : (i64, i64) -> i64
    %36 = "llvm.select"(%32, %35, %21) <{fastmathFlags = #llvm.fastmath<none>}> : (i1, i64, i64) -> i64
    %37 = "llvm.select"(%32, %33, %19) <{fastmathFlags = #llvm.fastmath<none>}> : (i1, !llvm.ptr, !llvm.ptr) -> !llvm.ptr
    "llvm.br"(%36, %37)[^bb6] : (i64, !llvm.ptr) -> ()
  ^bb6(%38: i64, %39: !llvm.ptr):  // 2 preds: ^bb3, ^bb5
    %40 = "llvm.icmp"(%38, %3) <{predicate = 4 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%40, %39, %38, %18, %39)[^bb2, ^bb7] <{loop_annotation = #llvm.loop_annotation<mustProgress = true>, operandSegmentSizes = array<i32: 1, 2, 2>}> : (i1, !llvm.ptr, i64, i64, !llvm.ptr) -> ()
  ^bb7(%41: i64, %42: !llvm.ptr):  // 2 preds: ^bb0, ^bb6
    %43 = "llvm.getelementptr"(%14, %41) <{elem_type = !llvm.struct<"class.llvm::Attribute", (ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %44 = "llvm.icmp"(%42, %43) <{predicate = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> i1
    "llvm.cond_br"(%44, %9, %10)[^bb12, ^bb8] <{operandSegmentSizes = array<i32: 1, 2, 0>}> : (i1, i64, i8) -> ()
  ^bb8:  // pred: ^bb7
    %45 = "llvm.load"(%42) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
    %46 = "llvm.icmp"(%45, %5) <{predicate = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> i1
    "llvm.cond_br"(%46, %9, %10)[^bb12, ^bb9] <{operandSegmentSizes = array<i32: 1, 2, 0>}> : (i1, i64, i8) -> ()
  ^bb9:  // pred: ^bb8
    ...
    "llvm.cond_br"(%49, %9, %10)[^bb12, ^bb10] <{operandSegmentSizes = array<i32: 1, 2, 0>}> : (i1, i64, i8) -> ()
  ^bb10:  // pred: ^bb9
    %50 = "llvm.getelementptr"(%45, %7) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %51 = "llvm.load"(%50) <{alignment = 4 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "_ZTSN4llvm17EnumAttributeImplE", members = {<#llvm.tbaa_type_desc<id = "_ZTSN4llvm13AttributeImplE", members = {<#llvm.tbaa_type_desc<id = "_ZTSN4llvm14FoldingSetBase4NodeE", members = {<#llvm.tbaa_type_desc<id = "any pointer", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, 0>}>, 0>, <#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 8>}>, 0>, <#llvm.tbaa_type_desc<id = "_ZTSN4llvm9Attribute8AttrKindE", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, 12>}>, access_type = <id = "_ZTSN4llvm9Attribute8AttrKindE", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 12>]}> : (!llvm.ptr) -> i32
    %52 = "llvm.icmp"(%51, %arg1) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%52, %9, %10)[^bb11, ^bb12] <{operandSegmentSizes = array<i32: 1, 0, 2>}> : (i1, i64, i8) -> ()
  ^bb11:  // pred: ^bb10
    %53 = "llvm.getelementptr"(%45, %1) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    "llvm.br"(%54, %11)[^bb12] : (i64, i8) -> ()
  ^bb12(%55: i64, %56: i8):  // 5 preds: ^bb7, ^bb8, ^bb9, ^bb10, ^bb11
    %57 = "llvm.insertvalue"(%12, %55) <{position = array<i64: 0>}> : (!llvm.struct<(i64, i8)>, i64) -> !llvm.struct<(i64, i8)>
    %58 = "llvm.insertvalue"(%57, %56) <{position = array<i64: 1>}> : (!llvm.struct<(i64, i8)>, i8) -> !llvm.struct<(i64, i8)>
    "llvm.return"(%58) : (!llvm.struct<(i64, i8)>) -> ()
  }) : () -> ()
