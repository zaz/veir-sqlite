"builtin.module"() ({
  ...
  "llvm.func"() <{CConv = #llvm.cconv<ccc>, alignment = 2 : i64, arg_attrs = [{llvm.align = 8 : i64, llvm.dereferenceable = 8 : i64, llvm.nocapture, llvm.nonnull, llvm.noundef, llvm.readonly}, {llvm.noundef}, {llvm.noundef, llvm.writeonly}], dso_local, function_type = !llvm.func<i1 (ptr, i32, ptr)>, linkage = #llvm.linkage<external>, memory_effects = #llvm.memory_effects<other = read, argMem = readwrite, inaccessibleMem = none, errnoMem = read, targetMem0 = none, targetMem1 = none>, no_unwind, passthrough = ["mustprogress", "nofree", "norecurse", "nosync", ["min-legal-vector-width", "0"], ["no-trapping-math", "true"], ["stack-protector-buffer-size", "8"], ["target-cpu", "x86-64"]], res_attrs = [{llvm.noundef, llvm.zeroext}], sym_name = "_ZNK4llvm13AttributeList16hasAttrSomewhereENS_9Attribute8AttrKindEPj", target_cpu = "x86-64", target_features = #llvm.target_features<["+cmov", "+cx8", "+fxsr", "+mmx", "+sse", "+sse2", "+x87"]>, tune_cpu = "generic", unnamed_addr = 1 : i64, uwtable_kind = #llvm.uwtableKind<async>, visibility_ = 0 : i64}> ({
  ^bb0(%arg0: !llvm.ptr, %arg1: i32, %arg2: !llvm.ptr):
    ...
    "llvm.cond_br"(%15, %1)[^bb8, ^bb1] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i1) -> ()
  ^bb1:  // pred: ^bb0
    %16 = "llvm.getelementptr"(%14, %2) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %17 = "llvm.sdiv"(%arg1, %3) : (i32, i32) -> i32
    %18 = "llvm.sext"(%17) : (i32) -> i64
    %19 = "llvm.getelementptr"(%16, %4, %18) <{elem_type = !llvm.array<16 x i8>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, -2147483648>}> : (!llvm.ptr, i64, i64) -> !llvm.ptr
    ...
    %22 = "llvm.and"(%arg1, %5) : (i32, i32) -> i32
    %23 = "llvm.shl"(%6, %22) <{overflowFlags = 3 : i32}> : (i32, i32) -> i32
    %24 = "llvm.and"(%23, %21) : (i32, i32) -> i32
    %25 = "llvm.icmp"(%24, %7) <{predicate = 1 : i64}> : (i32, i32) -> i1
    %26 = "llvm.icmp"(%arg2, %0) <{predicate = 1 : i64}> : (!llvm.ptr, !llvm.ptr) -> i1
    %27 = "llvm.and"(%26, %25) : (i1, i1) -> i1
    "llvm.cond_br"(%27, %25)[^bb2, ^bb8] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i1) -> ()
  ^bb2:  // pred: ^bb1
    %28 = "llvm.getelementptr"(%14, %8) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    "llvm.cond_br"(%30, %9)[^bb8, ^bb3] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i1) -> ()
  ^bb3:  // pred: ^bb2
    %31 = "llvm.getelementptr"(%14, %10) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %32 = "llvm.zext"(%29) : (i32) -> i64
    "llvm.br"(%4)[^bb4] : (i64) -> ()
  ^bb4(%33: i64):  // 2 preds: ^bb3, ^bb7
    %34 = "llvm.getelementptr"(%31, %33) <{elem_type = !llvm.struct<"class.llvm::AttributeSet", (ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    "llvm.cond_br"(%36)[^bb7, ^bb5] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb5:  // pred: ^bb4
    %37 = "llvm.getelementptr"(%35, %11) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %38 = "llvm.getelementptr"(%37, %4, %18) <{elem_type = !llvm.array<16 x i8>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, -2147483648>}> : (!llvm.ptr, i64, i64) -> !llvm.ptr
    ...
    %41 = "llvm.and"(%23, %40) : (i32, i32) -> i32
    %42 = "llvm.icmp"(%41, %7) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%42)[^bb7, ^bb6] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb6:  // pred: ^bb5
    %43 = "llvm.trunc"(%33) <{overflowFlags = 2 : i32}> : (i64) -> i32
    %44 = "llvm.add"(%43, %12) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
    "llvm.store"(%44, %arg2) <{alignment = 4 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, access_type = <id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (i32, !llvm.ptr) -> ()
    "llvm.br"(%9)[^bb8] : (i1) -> ()
  ^bb7:  // 2 preds: ^bb4, ^bb5
    %45 = "llvm.add"(%33, %13) <{overflowFlags = 3 : i32}> : (i64, i64) -> i64
    %46 = "llvm.icmp"(%45, %32) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%46, %9, %45)[^bb8, ^bb4] <{loop_annotation = #llvm.loop_annotation<mustProgress = true>, operandSegmentSizes = array<i32: 1, 1, 1>}> : (i1, i1, i64) -> ()
  ^bb8(%47: i1):  // 5 preds: ^bb0, ^bb1, ^bb2, ^bb6, ^bb7
    "llvm.return"(%47) : (i1) -> ()
  }) : () -> ()
