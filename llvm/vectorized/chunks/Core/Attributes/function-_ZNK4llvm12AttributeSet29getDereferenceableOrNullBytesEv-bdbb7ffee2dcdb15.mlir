"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr):
    ...
    %12 = "llvm.mlir.constant"() <{value = 98 : i32}> : () -> i32
    ...
    "llvm.cond_br"(%16, %1)[^bb7, ^bb1] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i64) -> ()
  ^bb1:  // pred: ^bb0
    ...
    "llvm.cond_br"(%20, %1)[^bb7, ^bb2] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i64) -> ()
  ^bb2:  // pred: ^bb1
    ...
    %29 = "llvm.sub"(%1, %28) <{overflowFlags = 1 : i32}> : (i64, i64) -> i64
    ...
    %35 = "llvm.icmp"(%34, %1) <{predicate = 4 : i64}> : (i64, i64) -> i1
  ...
  ^bb5(%44: i32):  // 2 preds: ^bb3, ^bb4
    ...
    %51 = "llvm.icmp"(%49, %1) <{predicate = 4 : i64}> : (i64, i64) -> i1
  ...
  ^bb6(%52: !llvm.ptr):  // 2 preds: ^bb2, ^bb5
    ...
    "llvm.br"(%56)[^bb7] : (i64) -> ()
  ^bb7(%57: i64):  // 3 preds: ^bb0, ^bb1, ^bb6
    "llvm.return"(%57) : (i64) -> ()
  }) : () -> ()
