"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr):
    ...
    %1 = "llvm.mlir.constant"() <{value = 3855 : i16}> : () -> i16
    ...
    "llvm.cond_br"(%21, %1)[^bb7, ^bb1] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i16) -> ()
  ^bb1:  // pred: ^bb0
    ...
    %25 = "llvm.icmp"(%24, %4) <{predicate = 0 : i64}> : (i8, i8) -> i1
    "llvm.cond_br"(%25, %1)[^bb7, ^bb2] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i16) -> ()
  ^bb2:  // pred: ^bb1
    %26 = "llvm.getelementptr"(%20, %5) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %27 = "llvm.getelementptr"(%20, %6) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    %30 = "llvm.getelementptr"(%26, %29) <{elem_type = !llvm.struct<"class.llvm::Attribute", (ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %31 = "llvm.getelementptr"(%20, %7) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    %35 = "llvm.getelementptr"(%30, %34) <{elem_type = !llvm.struct<"class.llvm::Attribute", (ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %36 = "llvm.ptrtoint"(%35) : (!llvm.ptr) -> i64
    %37 = "llvm.ptrtoint"(%26) : (!llvm.ptr) -> i64
    %38 = "llvm.sub"(%36, %37) <{overflowFlags = 0 : i32}> : (i64, i64) -> i64
    %39 = "llvm.ashr"(%38, %9) <{isExact}> : (i64, i64) -> i64
    %40 = "llvm.icmp"(%39, %8) <{predicate = 4 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%40, %26, %39, %26)[^bb3, ^bb6] <{operandSegmentSizes = array<i32: 1, 2, 1>}> : (i1, !llvm.ptr, i64, !llvm.ptr) -> ()
  ^bb3(%41: !llvm.ptr, %42: i64):  // 2 preds: ^bb2, ^bb5
    %43 = "llvm.lshr"(%42, %10) : (i64, i64) -> i64
    %44 = "llvm.getelementptr"(%41, %43) <{elem_type = !llvm.struct<"class.llvm::Attribute", (ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    "llvm.cond_br"(%46, %11)[^bb5, ^bb4] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i32) -> ()
  ^bb4:  // pred: ^bb3
  ...
  ^bb5(%49: i32):  // 2 preds: ^bb3, ^bb4
    %50 = "llvm.icmp"(%49, %13) <{predicate = 2 : i64}> : (i32, i32) -> i1
    %51 = "llvm.getelementptr"(%44, %6) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %52 = "llvm.xor"(%43, %14) : (i64, i64) -> i64
    %53 = "llvm.add"(%42, %52) <{overflowFlags = 1 : i32}> : (i64, i64) -> i64
    %54 = "llvm.select"(%50, %53, %43) <{fastmathFlags = #llvm.fastmath<none>}> : (i1, i64, i64) -> i64
    %55 = "llvm.select"(%50, %51, %41) <{fastmathFlags = #llvm.fastmath<none>}> : (i1, !llvm.ptr, !llvm.ptr) -> !llvm.ptr
    %56 = "llvm.icmp"(%54, %8) <{predicate = 4 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%56, %55, %54, %55)[^bb3, ^bb6] <{loop_annotation = #llvm.loop_annotation<mustProgress = true>, operandSegmentSizes = array<i32: 1, 2, 1>}> : (i1, !llvm.ptr, i64, !llvm.ptr) -> ()
  ^bb6(%57: !llvm.ptr):  // 2 preds: ^bb2, ^bb5
    %58 = "llvm.load"(%57) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "any pointer", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, access_type = <id = "any pointer", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (!llvm.ptr) -> i64
    %59 = "llvm.inttoptr"(%58) : (i64) -> !llvm.ptr
    %60 = "llvm.getelementptr"(%59, %15) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    %63 = "llvm.lshr"(%62, %16) : (i16, i16) -> i16
    %64 = "llvm.shl"(%62, %17) <{overflowFlags = 0 : i32}> : (i16, i16) -> i16
    %65 = "llvm.and"(%64, %18) : (i16, i16) -> i16
    %66 = "llvm.and"(%63, %19) : (i16, i16) -> i16
    %67 = "llvm.or"(%65, %66) <{isDisjoint}> : (i16, i16) -> i16
    "llvm.br"(%67)[^bb7] : (i16) -> ()
  ^bb7(%68: i16):  // 3 preds: ^bb0, ^bb1, ^bb6
    "llvm.return"(%68) : (i16) -> ()
  }) : () -> ()
