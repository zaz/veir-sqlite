"builtin.module"() ({
  ...
  "llvm.func"() <{CConv = #llvm.cconv<ccc>, arg_attrs = [{llvm.noundef}], dso_local, function_type = !llvm.func<i1 (ptr)>, linkage = #llvm.linkage<external>, no_unwind, passthrough = ["mustprogress", ["min-legal-vector-width", "0"], ["no-trapping-math", "true"], ["stack-protector-buffer-size", "8"], ["target-cpu", "x86-64"]], res_attrs = [{llvm.noundef, llvm.zeroext}], sym_name = "_ZN4llvm14AttributeFuncs25isNoFPClassCompatibleTypeEPNS_4TypeE", target_cpu = "x86-64", target_features = #llvm.target_features<["+cmov", "+cx8", "+fxsr", "+mmx", "+sse", "+sse2", "+x87"]>, tune_cpu = "generic", unnamed_addr = 1 : i64, uwtable_kind = #llvm.uwtableKind<async>, visibility_ = 0 : i64}> ({
  ^bb0(%arg0: !llvm.ptr):
    ...
    "llvm.cond_br"(%20, %18)[^bb1, ^bb2] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i32) -> ()
  ^bb1:  // pred: ^bb0
  ...
  ^bb2(%26: i32):  // 2 preds: ^bb0, ^bb1
    ...
    "llvm.cond_br"(%28)[^bb13, ^bb3] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb3:  // pred: ^bb2
    %29 = "llvm.and"(%26, %5) : (i32, i32) -> i32
    %30 = "llvm.icmp"(%29, %6) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%30, %7)[^bb15, ^bb4] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i1) -> ()
  ^bb4:  // 2 preds: ^bb3, ^bb13
    %31 = "llvm.trunc"(%18) <{overflowFlags = 0 : i32}> : (i32) -> i8
    "llvm.switch"(%31, %18, %arg0, %arg0)[^bb9, ^bb5, ^bb8] <{case_operand_segments = array<i32: 0, 1>, case_values = dense<[16, 17]> : vector<2xi8>, operandSegmentSizes = array<i32: 1, 2, 1>}> : (i8, i32, !llvm.ptr, !llvm.ptr) -> ()
  ^bb5:  // pred: ^bb4
    %32 = "llvm.and"(%18, %14) : (i32, i32) -> i32
    %33 = "llvm.icmp"(%32, %15) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%33, %16)[^bb15, ^bb6] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i1) -> ()
  ^bb6:  // pred: ^bb5
    ...
    "llvm.cond_br"(%34, %16)[^bb7, ^bb15] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i1) -> ()
  ^bb7:  // pred: ^bb6
    ...
    "llvm.br"(%39, %37)[^bb9] : (i32, !llvm.ptr) -> ()
  ^bb8(%40: !llvm.ptr):  // 2 preds: ^bb4, ^bb8
    ...
    %46 = "llvm.icmp"(%45, %12) <{predicate = 1 : i64}> : (i32, i32) -> i1
    %47 = "llvm.icmp"(%42, %13) <{predicate = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> i1
    %48 = "llvm.or"(%47, %46) : (i1, i1) -> i1
    "llvm.cond_br"(%48, %44, %42, %42)[^bb9, ^bb8] <{loop_annotation = #llvm.loop_annotation<mustProgress = true>, operandSegmentSizes = array<i32: 1, 2, 1>}> : (i1, i32, !llvm.ptr, !llvm.ptr) -> ()
  ^bb9(%49: i32, %50: !llvm.ptr):  // 3 preds: ^bb4, ^bb7, ^bb8
    %51 = "llvm.and"(%49, %1) : (i32, i32) -> i32
    %52 = "llvm.icmp"(%51, %2) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%52, %49)[^bb10, ^bb11] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i32) -> ()
  ^bb10:  // pred: ^bb9
    %53 = "llvm.getelementptr"(%50, %3) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    %56 = "llvm.getelementptr"(%55, %0) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
  ...
  ^bb11(%58: i32):  // 2 preds: ^bb9, ^bb10
    ...
    %60 = "llvm.icmp"(%59, %4) <{predicate = 6 : i64}> : (i8, i8) -> i1
    "llvm.cond_br"(%60)[^bb14, ^bb12] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb12:  // 2 preds: ^bb11, ^bb14
    %61 = "llvm.and"(%58, %5) : (i32, i32) -> i32
    %62 = "llvm.icmp"(%61, %6) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.br"(%62)[^bb15] : (i1) -> ()
  ^bb13:  // pred: ^bb2
    %63 = "llvm.lshr"(%8, %27) : (i8, i8) -> i8
    %64 = "llvm.trunc"(%63) <{overflowFlags = 0 : i32}> : (i8) -> i1
    %65 = "llvm.and"(%26, %9) : (i32, i32) -> i32
    %66 = "llvm.icmp"(%65, %6) <{predicate = 0 : i64}> : (i32, i32) -> i1
    %67 = "llvm.or"(%66, %64) : (i1, i1) -> i1
    "llvm.cond_br"(%67, %7)[^bb15, ^bb4] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i1) -> ()
  ^bb14:  // pred: ^bb11
    %68 = "llvm.lshr"(%8, %59) : (i8, i8) -> i8
    %69 = "llvm.trunc"(%68) <{overflowFlags = 0 : i32}> : (i8) -> i1
    "llvm.cond_br"(%69, %7)[^bb15, ^bb12] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i1) -> ()
  ^bb15(%70: i1):  // 6 preds: ^bb3, ^bb5, ^bb6, ^bb12, ^bb13, ^bb14
    "llvm.return"(%70) : (i1) -> ()
  }) : () -> ()
