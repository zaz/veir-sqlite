"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr):
    ...
    "llvm.cond_br"(%21, %2)[^bb7, ^bb1] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i64) -> ()
  ^bb1:  // pred: ^bb0
    ...
    %24 = "llvm.icmp"(%23, %4) <{predicate = 4 : i64}> : (i8, i8) -> i1
    "llvm.cond_br"(%24, %2)[^bb7, ^bb2] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i64) -> ()
  ^bb2:  // pred: ^bb1
    ...
    %30 = "llvm.getelementptr"(%20, %7) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    %39 = "llvm.icmp"(%38, %2) <{predicate = 4 : i64}> : (i64, i64) -> i1
  ...
  ^bb5(%48: i32):  // 2 preds: ^bb3, ^bb4
    ...
    %50 = "llvm.getelementptr"(%43, %6) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    %55 = "llvm.icmp"(%53, %2) <{predicate = 4 : i64}> : (i64, i64) -> i1
  ...
  ^bb6(%56: !llvm.ptr):  // 2 preds: ^bb2, ^bb5
    ...
    %64 = "llvm.icmp"(%63, %2) <{predicate = 0 : i64}> : (i64, i64) -> i1
    ...
    %65 = "llvm.select"(%64, %2, %17) <{fastmathFlags = #llvm.fastmath<none>}> : (i1, i64, i64) -> i64
    ...
    %69 = "llvm.lshr"(%65, %15) <{isExact}> : (i64, i64) -> i64
    "llvm.intr.lifetime.end"(%19) : (!llvm.ptr) -> ()
    %70 = "llvm.intr.fshl"(%69, %68, %15) : (i64, i64, i64) -> i64
    "llvm.br"(%70)[^bb7] : (i64) -> ()
  ^bb7(%71: i64):  // 3 preds: ^bb0, ^bb1, ^bb6
    "llvm.return"(%71) : (i64) -> ()
  }) : () -> ()
