"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr):
    ...
    %11 = "llvm.mlir.constant"() <{value = 87 : i32}> : () -> i32
    ...
    "llvm.cond_br"(%15, %0)[^bb8, ^bb1] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, !llvm.ptr) -> ()
  ^bb1:  // pred: ^bb0
    ...
    "llvm.cond_br"(%18, %0)[^bb8, ^bb2] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, !llvm.ptr) -> ()
  ^bb2:  // pred: ^bb1
    %19 = "llvm.getelementptr"(%14, %3) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %20 = "llvm.getelementptr"(%14, %4) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    %24 = "llvm.getelementptr"(%14, %5) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    %27 = "llvm.sub"(%6, %26) <{overflowFlags = 1 : i32}> : (i64, i64) -> i64
    ...
    %32 = "llvm.ashr"(%31, %7) <{isExact}> : (i64, i64) -> i64
    %33 = "llvm.icmp"(%32, %6) <{predicate = 4 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%33, %19, %32, %19)[^bb3, ^bb6] <{operandSegmentSizes = array<i32: 1, 2, 1>}> : (i1, !llvm.ptr, i64, !llvm.ptr) -> ()
  ^bb3(%34: !llvm.ptr, %35: i64):  // 2 preds: ^bb2, ^bb5
    ...
    "llvm.cond_br"(%39, %9)[^bb5, ^bb4] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i32) -> ()
  ^bb4:  // pred: ^bb3
    %40 = "llvm.getelementptr"(%38, %10) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
  ...
  ^bb5(%42: i32):  // 2 preds: ^bb3, ^bb4
    %43 = "llvm.icmp"(%42, %11) <{predicate = 2 : i64}> : (i32, i32) -> i1
    %44 = "llvm.getelementptr"(%37, %4) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %45 = "llvm.xor"(%36, %12) : (i64, i64) -> i64
    ...
    %49 = "llvm.icmp"(%47, %6) <{predicate = 4 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%49, %48, %47, %48)[^bb3, ^bb6] <{loop_annotation = #llvm.loop_annotation<mustProgress = true>, operandSegmentSizes = array<i32: 1, 2, 1>}> : (i1, !llvm.ptr, i64, !llvm.ptr) -> ()
  ^bb6(%50: !llvm.ptr):  // 2 preds: ^bb2, ^bb5
    %51 = "llvm.load"(%50) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "any pointer", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, access_type = <id = "any pointer", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (!llvm.ptr) -> i64
    %52 = "llvm.icmp"(%51, %6) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%52, %0)[^bb8, ^bb7] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, !llvm.ptr) -> ()
  ^bb7:  // pred: ^bb6
    %53 = "llvm.inttoptr"(%51) : (i64) -> !llvm.ptr
    %54 = "llvm.getelementptr"(%53, %13) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
  ...
  ^bb8(%56: !llvm.ptr):  // 4 preds: ^bb0, ^bb1, ^bb6, ^bb7
