"builtin.module"() ({
  "llvm.mlir.alias"() <{alias_type = !llvm.func<void (ptr, ptr, i64)>, linkage = #llvm.linkage<external>, sym_name = "_ZN4llvm16AttributeSetNodeC1ENS_8ArrayRefINS_9AttributeEEE", tls_mode = 0 : i64, unnamed_addr = 2 : i64, visibility_ = 0 : i64}> ({
    %62 = "llvm.mlir.addressof"() <{global_name = @_ZN4llvm16AttributeSetNodeC2ENS_8ArrayRefINS_9AttributeEEE}> : () -> !llvm.ptr
