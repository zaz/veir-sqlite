"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr):
    ...
    "llvm.cond_br"(%16, %1)[^bb7, ^bb1] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i32) -> ()
  ^bb1:  // pred: ^bb0
    ...
    %20 = "llvm.icmp"(%19, %4) <{predicate = 0 : i64}> : (i8, i8) -> i1
    "llvm.cond_br"(%20, %1)[^bb7, ^bb2] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i32) -> ()
  ^bb2:  // pred: ^bb1
    %21 = "llvm.getelementptr"(%15, %5) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %22 = "llvm.getelementptr"(%15, %6) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    %26 = "llvm.getelementptr"(%15, %7) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    %29 = "llvm.sub"(%8, %28) <{overflowFlags = 1 : i32}> : (i64, i64) -> i64
    ...
    %34 = "llvm.ashr"(%33, %9) <{isExact}> : (i64, i64) -> i64
    %35 = "llvm.icmp"(%34, %8) <{predicate = 4 : i64}> : (i64, i64) -> i1
  ...
  ^bb3(%36: !llvm.ptr, %37: i64):  // 2 preds: ^bb2, ^bb5
    ...
    "llvm.cond_br"(%41, %1)[^bb5, ^bb4] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i32) -> ()
  ^bb4:  // pred: ^bb3
  ...
  ^bb5(%44: i32):  // 2 preds: ^bb3, ^bb4
    ...
    %46 = "llvm.getelementptr"(%39, %6) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    %51 = "llvm.icmp"(%49, %8) <{predicate = 4 : i64}> : (i64, i64) -> i1
  ...
  ^bb6(%52: !llvm.ptr):  // 2 preds: ^bb2, ^bb5
    ...
    "llvm.br"(%57)[^bb7] : (i32) -> ()
  ^bb7(%58: i32):  // 3 preds: ^bb0, ^bb1, ^bb6
    "llvm.return"(%58) : (i32) -> ()
  }) : () -> ()
