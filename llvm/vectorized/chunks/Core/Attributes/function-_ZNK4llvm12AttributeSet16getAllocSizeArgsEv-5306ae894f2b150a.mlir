"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr):
    ...
    %21 = "llvm.mlir.poison"() : () -> !llvm.struct<(i64, i64)>
    %22 = "llvm.alloca"(%0) <{alignment = 8 : i64, elem_type = !llvm.struct<"struct.std::pair", (i32, struct<"class.std::optional.10", (struct<"struct.std::_Optional_base.11", (struct<"struct.std::_Optional_payload.13", (struct<"struct.std::_Optional_payload_base.base.15", packed (struct<"union.std::_Optional_payload_base<unsigned int>::_Storage", (i32)>, i8)>, array<3 x i8>)>)>)>)>}> : (i32) -> !llvm.ptr
    ...
    "llvm.cond_br"(%24, %2, %3)[^bb7, ^bb1] <{operandSegmentSizes = array<i32: 1, 2, 0>}> : (i1, i64, i64) -> ()
  ^bb1:  // pred: ^bb0
    %25 = "llvm.getelementptr"(%23, %4) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    "llvm.cond_br"(%28, %2, %3)[^bb7, ^bb2] <{operandSegmentSizes = array<i32: 1, 2, 0>}> : (i1, i64, i64) -> ()
  ^bb2:  // pred: ^bb1
    %29 = "llvm.getelementptr"(%23, %7) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %30 = "llvm.getelementptr"(%23, %8) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    %37 = "llvm.sub"(%3, %36) <{overflowFlags = 1 : i32}> : (i64, i64) -> i64
    ...
    %43 = "llvm.icmp"(%42, %3) <{predicate = 4 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%43, %29, %42, %29)[^bb3, ^bb6] <{operandSegmentSizes = array<i32: 1, 2, 1>}> : (i1, !llvm.ptr, i64, !llvm.ptr) -> ()
  ^bb3(%44: !llvm.ptr, %45: i64):  // 2 preds: ^bb2, ^bb5
    ...
    "llvm.cond_br"(%49, %12)[^bb5, ^bb4] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i32) -> ()
  ^bb4:  // pred: ^bb3
    %50 = "llvm.getelementptr"(%48, %13) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
  ...
  ^bb5(%52: i32):  // 2 preds: ^bb3, ^bb4
    %53 = "llvm.icmp"(%52, %14) <{predicate = 2 : i64}> : (i32, i32) -> i1
    %54 = "llvm.getelementptr"(%47, %8) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %55 = "llvm.xor"(%46, %15) : (i64, i64) -> i64
    ...
    %59 = "llvm.icmp"(%57, %3) <{predicate = 4 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%59, %58, %57, %58)[^bb3, ^bb6] <{loop_annotation = #llvm.loop_annotation<mustProgress = true>, operandSegmentSizes = array<i32: 1, 2, 1>}> : (i1, !llvm.ptr, i64, !llvm.ptr) -> ()
  ^bb6(%60: !llvm.ptr):  // 2 preds: ^bb2, ^bb5
    %61 = "llvm.load"(%60) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "any pointer", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, access_type = <id = "any pointer", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (!llvm.ptr) -> i64
    %62 = "llvm.inttoptr"(%61) : (i64) -> !llvm.ptr
    %63 = "llvm.getelementptr"(%62, %16) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    %67 = "llvm.or"(%65, %18) <{isDisjoint}> : (i64, i64) -> i64
    %68 = "llvm.select"(%66, %3, %67) <{fastmathFlags = #llvm.fastmath<none>}> : (i1, i64, i64) -> i64
    %69 = "llvm.lshr"(%64, %19) : (i64, i64) -> i64
    %70 = "llvm.trunc"(%69) <{overflowFlags = 2 : i32}> : (i64) -> i32
    ...
    %71 = "llvm.getelementptr"(%22, %20) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    "llvm.store"(%68, %71) <{alignment = 4 : i64, ordering = 0 : i64}> : (i64, !llvm.ptr) -> ()
    %72 = "llvm.load"(%22) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> i64
    %73 = "llvm.lshr"(%68, %19) : (i64, i64) -> i64
    "llvm.intr.lifetime.end"(%22) : (!llvm.ptr) -> ()
    %74 = "llvm.or"(%73, %18) <{isDisjoint}> : (i64, i64) -> i64
    "llvm.br"(%72, %74)[^bb7] : (i64, i64) -> ()
  ^bb7(%75: i64, %76: i64):  // 3 preds: ^bb0, ^bb1, ^bb6
    %77 = "llvm.insertvalue"(%21, %75) <{position = array<i64: 0>}> : (!llvm.struct<(i64, i64)>, i64) -> !llvm.struct<(i64, i64)>
    %78 = "llvm.insertvalue"(%77, %76) <{position = array<i64: 1>}> : (!llvm.struct<(i64, i64)>, i64) -> !llvm.struct<(i64, i64)>
    "llvm.return"(%78) : (!llvm.struct<(i64, i64)>) -> ()
  }) : () -> ()
