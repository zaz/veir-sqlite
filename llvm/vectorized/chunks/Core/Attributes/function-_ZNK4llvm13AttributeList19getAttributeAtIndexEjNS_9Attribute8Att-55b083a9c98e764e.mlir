"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr, %arg1: i32, %arg2: i32):
    ...
    %13 = "llvm.add"(%arg1, %0) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
    ...
    "llvm.cond_br"(%15, %1)[^bb9, ^bb1] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, !llvm.ptr) -> ()
  ^bb1:  // pred: ^bb0
    ...
    %18 = "llvm.icmp"(%13, %17) <{predicate = 6 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%18, %1)[^bb2, ^bb9] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, !llvm.ptr) -> ()
  ^bb2:  // pred: ^bb1
    %19 = "llvm.getelementptr"(%14, %3) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %20 = "llvm.zext"(%13) : (i32) -> i64
    %21 = "llvm.getelementptr"(%19, %20) <{elem_type = !llvm.struct<"class.llvm::AttributeSet", (ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    %24 = "llvm.icmp"(%22, %4) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%24, %1)[^bb9, ^bb3] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, !llvm.ptr) -> ()
  ^bb3:  // pred: ^bb2
    %25 = "llvm.getelementptr"(%23, %5) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %26 = "llvm.sdiv"(%arg2, %6) : (i32, i32) -> i32
    %27 = "llvm.sext"(%26) : (i32) -> i64
    %28 = "llvm.getelementptr"(%25, %4, %27) <{elem_type = !llvm.array<16 x i8>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, -2147483648>}> : (!llvm.ptr, i64, i64) -> !llvm.ptr
    ...
    %31 = "llvm.and"(%arg2, %7) : (i32, i32) -> i32
    %32 = "llvm.shl"(%0, %31) <{overflowFlags = 3 : i32}> : (i32, i32) -> i32
    %33 = "llvm.and"(%32, %30) : (i32, i32) -> i32
    %34 = "llvm.icmp"(%33, %8) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%34, %1)[^bb9, ^bb4] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, !llvm.ptr) -> ()
  ^bb4:  // pred: ^bb3
    %35 = "llvm.getelementptr"(%23, %9) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    %39 = "llvm.getelementptr"(%35, %38) <{elem_type = !llvm.struct<"class.llvm::Attribute", (ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %40 = "llvm.getelementptr"(%23, %3) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    %43 = "llvm.sub"(%4, %42) <{overflowFlags = 1 : i32}> : (i64, i64) -> i64
    %44 = "llvm.getelementptr"(%39, %43) <{elem_type = !llvm.struct<"class.llvm::Attribute", (ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %45 = "llvm.ptrtoint"(%44) : (!llvm.ptr) -> i64
    %46 = "llvm.ptrtoint"(%35) : (!llvm.ptr) -> i64
    %47 = "llvm.sub"(%45, %46) <{overflowFlags = 0 : i32}> : (i64, i64) -> i64
    %48 = "llvm.ashr"(%47, %10) <{isExact}> : (i64, i64) -> i64
    %49 = "llvm.icmp"(%48, %4) <{predicate = 4 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%49, %35, %48, %35)[^bb5, ^bb8] <{operandSegmentSizes = array<i32: 1, 2, 1>}> : (i1, !llvm.ptr, i64, !llvm.ptr) -> ()
  ^bb5(%50: !llvm.ptr, %51: i64):  // 2 preds: ^bb4, ^bb7
    %52 = "llvm.lshr"(%51, %11) : (i64, i64) -> i64
    %53 = "llvm.getelementptr"(%50, %52) <{elem_type = !llvm.struct<"class.llvm::Attribute", (ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %54 = "llvm.load"(%53) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "any pointer", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, access_type = <id = "any pointer", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (!llvm.ptr) -> !llvm.ptr
    %55 = "llvm.icmp"(%54, %1) <{predicate = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> i1
    "llvm.cond_br"(%55, %8)[^bb7, ^bb6] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i32) -> ()
  ^bb6:  // pred: ^bb5
    %56 = "llvm.getelementptr"(%54, %5) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
  ...
  ^bb7(%58: i32):  // 2 preds: ^bb5, ^bb6
    %59 = "llvm.icmp"(%58, %arg2) <{predicate = 2 : i64}> : (i32, i32) -> i1
    %60 = "llvm.getelementptr"(%53, %2) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %61 = "llvm.xor"(%52, %12) : (i64, i64) -> i64
    %62 = "llvm.add"(%51, %61) <{overflowFlags = 1 : i32}> : (i64, i64) -> i64
    %63 = "llvm.select"(%59, %62, %52) <{fastmathFlags = #llvm.fastmath<none>}> : (i1, i64, i64) -> i64
    %64 = "llvm.select"(%59, %60, %50) <{fastmathFlags = #llvm.fastmath<none>}> : (i1, !llvm.ptr, !llvm.ptr) -> !llvm.ptr
    %65 = "llvm.icmp"(%63, %4) <{predicate = 4 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%65, %64, %63, %64)[^bb5, ^bb8] <{loop_annotation = #llvm.loop_annotation<mustProgress = true>, operandSegmentSizes = array<i32: 1, 2, 1>}> : (i1, !llvm.ptr, i64, !llvm.ptr) -> ()
  ^bb8(%66: !llvm.ptr):  // 2 preds: ^bb4, ^bb7
    %67 = "llvm.load"(%66) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "any pointer", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, access_type = <id = "any pointer", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (!llvm.ptr) -> i64
    %68 = "llvm.inttoptr"(%67) : (i64) -> !llvm.ptr
    "llvm.br"(%68)[^bb9] : (!llvm.ptr) -> ()
  ^bb9(%69: !llvm.ptr):  // 5 preds: ^bb0, ^bb1, ^bb2, ^bb3, ^bb8
