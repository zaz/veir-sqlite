"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr, %arg1: i32):
    ...
    "llvm.cond_br"(%18, %2)[^bb9, ^bb1] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i32) -> ()
  ^bb1:  // pred: ^bb0
    ...
    "llvm.cond_br"(%21, %2)[^bb2, ^bb9] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i32) -> ()
  ^bb2:  // pred: ^bb1
    ...
    %27 = "llvm.icmp"(%25, %5) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%27, %2)[^bb9, ^bb3] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i32) -> ()
  ^bb3:  // pred: ^bb2
    %28 = "llvm.getelementptr"(%26, %6) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    %30 = "llvm.and"(%29, %7) : (i8, i8) -> i8
    %31 = "llvm.icmp"(%30, %8) <{predicate = 0 : i64}> : (i8, i8) -> i1
    "llvm.cond_br"(%31, %2)[^bb9, ^bb4] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i32) -> ()
  ^bb4:  // pred: ^bb3
    %32 = "llvm.getelementptr"(%26, %9) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    %45 = "llvm.ashr"(%44, %10) <{isExact}> : (i64, i64) -> i64
    %46 = "llvm.icmp"(%45, %5) <{predicate = 4 : i64}> : (i64, i64) -> i1
  ...
  ^bb5(%47: !llvm.ptr, %48: i64):  // 2 preds: ^bb4, ^bb7
    ...
    "llvm.cond_br"(%52, %2)[^bb7, ^bb6] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i32) -> ()
  ^bb6:  // pred: ^bb5
  ...
  ^bb7(%55: i32):  // 2 preds: ^bb5, ^bb6
    ...
    %62 = "llvm.icmp"(%60, %5) <{predicate = 4 : i64}> : (i64, i64) -> i1
  ...
  ^bb8(%63: !llvm.ptr):  // 2 preds: ^bb4, ^bb7
    ...
    "llvm.br"(%68)[^bb9] : (i32) -> ()
  ^bb9(%69: i32):  // 5 preds: ^bb0, ^bb1, ^bb2, ^bb3, ^bb8
    "llvm.return"(%69) : (i32) -> ()
  }) : () -> ()
