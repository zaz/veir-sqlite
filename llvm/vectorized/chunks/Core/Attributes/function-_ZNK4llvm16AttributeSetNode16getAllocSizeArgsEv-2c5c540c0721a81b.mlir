"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr):
    ...
    "llvm.cond_br"(%26, %4, %5)[^bb6, ^bb1] <{operandSegmentSizes = array<i32: 1, 2, 0>}> : (i1, i64, i64) -> ()
  ^bb1:  // pred: ^bb0
    ...
    %35 = "llvm.sub"(%5, %34) <{overflowFlags = 1 : i32}> : (i64, i64) -> i64
    ...
    %40 = "llvm.ashr"(%39, %9) <{isExact}> : (i64, i64) -> i64
    %41 = "llvm.icmp"(%40, %5) <{predicate = 4 : i64}> : (i64, i64) -> i1
  ...
  ^bb2(%42: !llvm.ptr, %43: i64):  // 2 preds: ^bb1, ^bb4
    %44 = "llvm.lshr"(%43, %10) : (i64, i64) -> i64
    ...
    %47 = "llvm.icmp"(%46, %11) <{predicate = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> i1
    "llvm.cond_br"(%47, %12)[^bb4, ^bb3] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i32) -> ()
  ^bb3:  // pred: ^bb2
    %48 = "llvm.getelementptr"(%46, %13) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
  ...
  ^bb4(%50: i32):  // 2 preds: ^bb2, ^bb3
    %51 = "llvm.icmp"(%50, %14) <{predicate = 2 : i64}> : (i32, i32) -> i1
    %52 = "llvm.getelementptr"(%45, %7) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %53 = "llvm.xor"(%44, %15) : (i64, i64) -> i64
    ...
    %57 = "llvm.icmp"(%55, %5) <{predicate = 4 : i64}> : (i64, i64) -> i1
