"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr):
    ...
    "llvm.cond_br"(%17, %1)[^bb7, ^bb1] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i32) -> ()
  ^bb1:  // pred: ^bb0
    ...
    %20 = "llvm.and"(%19, %3) : (i8, i8) -> i8
    %21 = "llvm.icmp"(%20, %4) <{predicate = 0 : i64}> : (i8, i8) -> i1
    "llvm.cond_br"(%21, %1)[^bb7, ^bb2] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i32) -> ()
  ^bb2:  // pred: ^bb1
    %22 = "llvm.getelementptr"(%16, %5) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %23 = "llvm.getelementptr"(%16, %6) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    %26 = "llvm.getelementptr"(%22, %25) <{elem_type = !llvm.struct<"class.llvm::Attribute", (ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %27 = "llvm.getelementptr"(%16, %7) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    %30 = "llvm.sub"(%8, %29) <{overflowFlags = 1 : i32}> : (i64, i64) -> i64
    %31 = "llvm.getelementptr"(%26, %30) <{elem_type = !llvm.struct<"class.llvm::Attribute", (ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %32 = "llvm.ptrtoint"(%31) : (!llvm.ptr) -> i64
    %33 = "llvm.ptrtoint"(%22) : (!llvm.ptr) -> i64
    %34 = "llvm.sub"(%32, %33) <{overflowFlags = 0 : i32}> : (i64, i64) -> i64
    %35 = "llvm.ashr"(%34, %9) <{isExact}> : (i64, i64) -> i64
    %36 = "llvm.icmp"(%35, %8) <{predicate = 4 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%36, %22, %35, %22)[^bb3, ^bb6] <{operandSegmentSizes = array<i32: 1, 2, 1>}> : (i1, !llvm.ptr, i64, !llvm.ptr) -> ()
  ^bb3(%37: !llvm.ptr, %38: i64):  // 2 preds: ^bb2, ^bb5
    %39 = "llvm.lshr"(%38, %10) : (i64, i64) -> i64
    %40 = "llvm.getelementptr"(%37, %39) <{elem_type = !llvm.struct<"class.llvm::Attribute", (ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %41 = "llvm.load"(%40) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "any pointer", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, access_type = <id = "any pointer", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (!llvm.ptr) -> !llvm.ptr
    %42 = "llvm.icmp"(%41, %0) <{predicate = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> i1
    "llvm.cond_br"(%42, %11)[^bb5, ^bb4] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i32) -> ()
  ^bb4:  // pred: ^bb3
    %43 = "llvm.getelementptr"(%41, %12) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    "llvm.br"(%44)[^bb5] : (i32) -> ()
  ^bb5(%45: i32):  // 2 preds: ^bb3, ^bb4
    %46 = "llvm.icmp"(%45, %13) <{predicate = 2 : i64}> : (i32, i32) -> i1
    %47 = "llvm.getelementptr"(%40, %6) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %48 = "llvm.xor"(%39, %14) : (i64, i64) -> i64
    %49 = "llvm.add"(%38, %48) <{overflowFlags = 1 : i32}> : (i64, i64) -> i64
    %50 = "llvm.select"(%46, %49, %39) <{fastmathFlags = #llvm.fastmath<none>}> : (i1, i64, i64) -> i64
    %51 = "llvm.select"(%46, %47, %37) <{fastmathFlags = #llvm.fastmath<none>}> : (i1, !llvm.ptr, !llvm.ptr) -> !llvm.ptr
    %52 = "llvm.icmp"(%50, %8) <{predicate = 4 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%52, %51, %50, %51)[^bb3, ^bb6] <{loop_annotation = #llvm.loop_annotation<mustProgress = true>, operandSegmentSizes = array<i32: 1, 2, 1>}> : (i1, !llvm.ptr, i64, !llvm.ptr) -> ()
  ^bb6(%53: !llvm.ptr):  // 2 preds: ^bb2, ^bb5
    %54 = "llvm.load"(%53) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "any pointer", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, access_type = <id = "any pointer", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (!llvm.ptr) -> i64
    %55 = "llvm.inttoptr"(%54) : (i64) -> !llvm.ptr
    %56 = "llvm.getelementptr"(%55, %15) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    "llvm.br"(%58)[^bb7] : (i32) -> ()
  ^bb7(%59: i32):  // 3 preds: ^bb0, ^bb1, ^bb6
    "llvm.return"(%59) : (i32) -> ()
  }) : () -> ()
