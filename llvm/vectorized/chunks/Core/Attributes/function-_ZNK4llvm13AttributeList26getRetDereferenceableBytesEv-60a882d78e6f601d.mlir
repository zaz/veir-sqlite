"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr):
    ...
    "llvm.cond_br"(%17, %1)[^bb9, ^bb1] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i64) -> ()
  ^bb1:  // pred: ^bb0
    ...
    "llvm.cond_br"(%20, %1)[^bb2, ^bb9] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i64) -> ()
  ^bb2:  // pred: ^bb1
    ...
    "llvm.cond_br"(%24, %1)[^bb9, ^bb3] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i64) -> ()
  ^bb3:  // pred: ^bb2
    ...
    "llvm.cond_br"(%28, %1)[^bb9, ^bb4] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i64) -> ()
  ^bb4:  // pred: ^bb3
    ...
    %34 = "llvm.getelementptr"(%23, %8) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    %42 = "llvm.ashr"(%41, %9) <{isExact}> : (i64, i64) -> i64
    %43 = "llvm.icmp"(%42, %1) <{predicate = 4 : i64}> : (i64, i64) -> i1
  ...
  ^bb5(%44: !llvm.ptr, %45: i64):  // 2 preds: ^bb4, ^bb7
    %46 = "llvm.lshr"(%45, %10) : (i64, i64) -> i64
    ...
    "llvm.cond_br"(%49, %11)[^bb7, ^bb6] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i32) -> ()
  ^bb6:  // pred: ^bb5
  ...
  ^bb7(%52: i32):  // 2 preds: ^bb5, ^bb6
    ...
    %59 = "llvm.icmp"(%57, %1) <{predicate = 4 : i64}> : (i64, i64) -> i1
  ...
  ^bb8(%60: !llvm.ptr):  // 2 preds: ^bb4, ^bb7
    ...
    "llvm.br"(%64)[^bb9] : (i64) -> ()
  ^bb9(%65: i64):  // 5 preds: ^bb0, ^bb1, ^bb2, ^bb3, ^bb8
    "llvm.return"(%65) : (i64) -> ()
  }) : () -> ()
