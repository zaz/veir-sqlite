"builtin.module"() ({
  ...
  ^bb7(%38: i64, %39: !llvm.ptr):  // 2 preds: ^bb0, ^bb6
    ...
    "llvm.cond_br"(%41, %9)[^bb13, ^bb8] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i1) -> ()
  ^bb8:  // pred: ^bb7
    %42 = "llvm.load"(%39) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
  ...
  ^bb9:  // pred: ^bb8
    ...
    "llvm.cond_br"(%46, %9)[^bb13, ^bb10] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i1) -> ()
  ^bb10:  // pred: ^bb9
    ...
    "llvm.cond_br"(%49, %9)[^bb12, ^bb13] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i1) -> ()
  ^bb11:  // pred: ^bb8
    %50 = "llvm.icmp"(%arg1, %2) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%50, %9)[^bb12, ^bb13] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i1) -> ()
  ^bb12:  // 2 preds: ^bb10, ^bb11
    %51 = "llvm.icmp"(%42, %5) <{predicate = 1 : i64}> : (!llvm.ptr, !llvm.ptr) -> i1
    "llvm.br"(%51)[^bb13] : (i1) -> ()
  ^bb13(%52: i1):  // 5 preds: ^bb7, ^bb9, ^bb10, ^bb11, ^bb12
    "llvm.return"(%52) : (i1) -> ()
  }) : () -> ()
