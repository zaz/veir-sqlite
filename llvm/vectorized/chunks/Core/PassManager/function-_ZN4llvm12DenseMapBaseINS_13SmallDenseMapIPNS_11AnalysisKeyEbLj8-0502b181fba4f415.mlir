"builtin.module"() ({
  "llvm.comdat"() <{sym_name = "__llvm_global_comdat"}> ({
    "llvm.comdat_selector"() <{comdat = 0 : i64, sym_name = "_ZN4llvm12DenseMapBaseINS_13SmallDenseMapIPNS_11AnalysisKeyEbLj8ENS_12DenseMapInfoIS3_vEENS_6detail12DenseMapPairIS3_bEEEES3_bS5_S8_E8moveFromERS9_"}> : () -> ()
  }) : () -> ()
  ...
  ^bb4(%58: i32):  // 2 preds: ^bb3, ^bb6
    ...
    %62 = "llvm.getelementptr"(%26, %61) <{elem_type = !llvm.struct<"struct.llvm::detail::DenseMapPair.308", (struct<"struct.std::pair.base.157", packed (ptr, i8)>, array<7 x i8>)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
  ...
  ^bb6(%89: i32, %90: i64, %91: i64, %92: i32):  // 2 preds: ^bb4, ^bb5
    %93 = "llvm.getelementptr"(%43, %90) <{elem_type = !llvm.struct<"struct.llvm::detail::DenseMapPair.308", (struct<"struct.std::pair.base.157", packed (ptr, i8)>, array<7 x i8>)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    %95 = "llvm.getelementptr"(%26, %61) <{elem_type = !llvm.struct<"struct.llvm::detail::DenseMapPair.308", (struct<"struct.std::pair.base.157", packed (ptr, i8)>, array<7 x i8>)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 0, 1>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    "llvm.store"(%96, %94) <{alignment = 1 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "bool", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, access_type = <id = "bool", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (i8, !llvm.ptr) -> ()
