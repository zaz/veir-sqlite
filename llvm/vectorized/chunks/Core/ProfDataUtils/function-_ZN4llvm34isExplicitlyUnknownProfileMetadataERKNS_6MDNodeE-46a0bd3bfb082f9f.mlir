"builtin.module"() ({
  ...
  "llvm.func"() <{CConv = #llvm.cconv<ccc>, arg_attrs = [{llvm.align = 8 : i64, llvm.dereferenceable = 16 : i64, llvm.nocapture, llvm.nonnull, llvm.noundef, llvm.readonly}], dso_local, function_type = !llvm.func<i1 (ptr)>, linkage = #llvm.linkage<external>, no_unwind, passthrough = ["mustprogress", ["min-legal-vector-width", "0"], ["no-trapping-math", "true"], ["stack-protector-buffer-size", "8"], ["target-cpu", "x86-64"]], res_attrs = [{llvm.noundef, llvm.zeroext}], sym_name = "_ZN4llvm34isExplicitlyUnknownProfileMetadataERKNS_6MDNodeE", target_cpu = "x86-64", target_features = #llvm.target_features<["+cmov", "+cx8", "+fxsr", "+mmx", "+sse", "+sse2", "+x87"]>, tune_cpu = "generic", unnamed_addr = 1 : i64, uwtable_kind = #llvm.uwtableKind<async>, visibility_ = 0 : i64}> ({
  ^bb0(%arg0: !llvm.ptr):
    ...
    %10 = "llvm.mlir.addressof"() <{global_name = @_ZN4llvm12MDProfLabels26UnknownBranchWeightsMarkerE}> : () -> !llvm.ptr
  ...
  ^bb1:  // pred: ^bb0
    %19 = "llvm.and"(%16, %7) : (i64, i64) -> i64
    %20 = "llvm.icmp"(%19, %8) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%20, %5)[^bb4, ^bb12] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i1) -> ()
  ^bb2:  // pred: ^bb0
    ...
    "llvm.cond_br"(%23, %5)[^bb3, ^bb12] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i1) -> ()
  ^bb3:  // pred: ^bb2
    ...
    "llvm.br"(%25)[^bb5] : (!llvm.ptr) -> ()
  ^bb4:  // pred: ^bb1
    %26 = "llvm.lshr"(%16, %1) : (i64, i64) -> i64
    %27 = "llvm.and"(%26, %9) : (i64, i64) -> i64
    %28 = "llvm.sub"(%2, %27) <{overflowFlags = 1 : i32}> : (i64, i64) -> i64
    %29 = "llvm.getelementptr"(%15, %28) <{elem_type = !llvm.struct<"class.llvm::MDOperand", (ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    "llvm.br"(%29)[^bb5] : (!llvm.ptr) -> ()
  ^bb5(%30: !llvm.ptr):  // 2 preds: ^bb3, ^bb4
    %31 = "llvm.load"(%10) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "any pointer", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, access_type = <id = "any pointer", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (!llvm.ptr) -> !llvm.ptr
    %32 = "llvm.icmp"(%31, %11) <{predicate = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> i1
    "llvm.cond_br"(%32, %2)[^bb7, ^bb6] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i64) -> ()
  ^bb6:  // pred: ^bb5
  ...
  ^bb7(%34: i64):  // 2 preds: ^bb5, ^bb6
    ...
    %36 = "llvm.icmp"(%35, %11) <{predicate = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> i1
    "llvm.cond_br"(%36, %5)[^bb12, ^bb8] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i1) -> ()
  ^bb8:  // pred: ^bb7
    ...
    %38 = "llvm.icmp"(%37, %12) <{predicate = 0 : i64}> : (i8, i8) -> i1
    "llvm.cond_br"(%38, %5)[^bb9, ^bb12] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i1) -> ()
  ^bb9:  // pred: ^bb8
