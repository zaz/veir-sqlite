"builtin.module"() ({
  ...
  ^bb2:  // pred: ^bb1
    %17 = "llvm.and"(%14, %8) : (i64, i64) -> i64
    %18 = "llvm.icmp"(%17, %9) <{predicate = 0 : i64}> : (i64, i64) -> i1
    %19 = "llvm.lshr"(%14, %1) : (i64, i64) -> i64
    %20 = "llvm.and"(%19, %10) : (i64, i64) -> i64
    %21 = "llvm.sub"(%2, %20) <{overflowFlags = 1 : i32}> : (i64, i64) -> i64
    "llvm.cond_br"(%18)[^bb4, ^bb7] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb3:  // pred: ^bb1
    %22 = "llvm.getelementptr"(%12, %3) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    %25 = "llvm.getelementptr"(%12, %5) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %26 = "llvm.load"(%25) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "_ZTSN4llvm15SmallVectorBaseIjEE", members = {<#llvm.tbaa_type_desc<id = "any pointer", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, 0>, <#llvm.tbaa_type_desc<id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, 8>, <#llvm.tbaa_type_desc<id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, 12>}>, access_type = <id = "any pointer", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (!llvm.ptr) -> !llvm.ptr
    "llvm.cond_br"(%24, %26)[^bb5, ^bb8] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, !llvm.ptr) -> ()
  ^bb4:  // pred: ^bb2
    %27 = "llvm.getelementptr"(%13, %21) <{elem_type = !llvm.struct<"class.llvm::MDOperand", (ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    "llvm.cond_br"(%30, %29)[^bb7, ^bb6] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, !llvm.ptr) -> ()
  ^bb5:  // pred: ^bb3
    ...
    "llvm.cond_br"(%33, %26, %32)[^bb8, ^bb6] <{operandSegmentSizes = array<i32: 1, 1, 1>}> : (i1, !llvm.ptr, !llvm.ptr) -> ()
  ^bb6(%34: !llvm.ptr):  // 2 preds: ^bb4, ^bb5
    "llvm.br"(%34)[^bb1] : (!llvm.ptr) -> ()
  ^bb7:  // 2 preds: ^bb2, ^bb4
    %35 = "llvm.getelementptr"(%13, %21) <{elem_type = !llvm.struct<"class.llvm::MDOperand", (ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    "llvm.br"(%35)[^bb8] : (!llvm.ptr) -> ()
  ^bb8(%36: !llvm.ptr):  // 3 preds: ^bb3, ^bb5, ^bb7
