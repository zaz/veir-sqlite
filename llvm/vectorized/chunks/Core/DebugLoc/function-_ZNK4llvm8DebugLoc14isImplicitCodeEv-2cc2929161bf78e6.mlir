"builtin.module"() ({
  ...
  ^bb1:  // pred: ^bb0
    ...
    %8 = "llvm.icmp"(%7, %3) <{predicate = 2 : i64}> : (i8, i8) -> i1
    "llvm.br"(%8)[^bb2] : (i1) -> ()
