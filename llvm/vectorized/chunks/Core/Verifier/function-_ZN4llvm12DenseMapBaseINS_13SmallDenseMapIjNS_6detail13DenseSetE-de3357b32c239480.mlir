"builtin.module"() ({
  ...
  ^bb1:  // pred: ^bb0
    ...
    %30 = "llvm.getelementptr"(%21, %29) <{elem_type = !llvm.struct<"class.llvm::detail::DenseSetPair.651", (i32)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
  ...
  ^bb2:  // pred: ^bb3
    ...
    %41 = "llvm.getelementptr"(%21, %40) <{elem_type = !llvm.struct<"class.llvm::detail::DenseSetPair.651", (i32)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
