"builtin.module"() ({
  ...
  ^bb1(%10: !llvm.ptr):  // 2 preds: ^bb0, ^bb7
    %11 = "llvm.icmp"(%10, %0) <{predicate = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> i1
    "llvm.cond_br"(%11, %0)[^bb8, ^bb2] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, !llvm.ptr) -> ()
  ^bb2:  // pred: ^bb1
    ...
    %13 = "llvm.icmp"(%12, %1) <{predicate = 0 : i64}> : (i8, i8) -> i1
    "llvm.cond_br"(%13, %10)[^bb8, ^bb3] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, !llvm.ptr) -> ()
  ^bb3:  // pred: ^bb2
    %14 = "llvm.add"(%12, %2) <{overflowFlags = 0 : i32}> : (i8, i8) -> i8
    %15 = "llvm.icmp"(%14, %3) <{predicate = 6 : i64}> : (i8, i8) -> i1
    "llvm.cond_br"(%15, %0)[^bb8, ^bb4] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, !llvm.ptr) -> ()
  ^bb4:  // pred: ^bb3
    %16 = "llvm.getelementptr"(%10, %4) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %17 = "llvm.load"(%16) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> i64
    %18 = "llvm.and"(%17, %5) : (i64, i64) -> i64
    %19 = "llvm.icmp"(%18, %6) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%19)[^bb6, ^bb5] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb5:  // pred: ^bb4
    %20 = "llvm.getelementptr"(%10, %7) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
  ...
  ^bb6:  // pred: ^bb4
    %22 = "llvm.lshr"(%17, %5) : (i64, i64) -> i64
    %23 = "llvm.and"(%22, %8) : (i64, i64) -> i64
    %24 = "llvm.sub"(%6, %23) <{overflowFlags = 1 : i32}> : (i64, i64) -> i64
    %25 = "llvm.getelementptr"(%16, %24) <{elem_type = !llvm.struct<"class.llvm::MDOperand", (ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    "llvm.br"(%25)[^bb7] : (!llvm.ptr) -> ()
  ^bb7(%26: !llvm.ptr):  // 2 preds: ^bb5, ^bb6
    %27 = "llvm.getelementptr"(%26, %9) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    "llvm.br"(%28)[^bb1] : (!llvm.ptr) -> ()
  ^bb8(%29: !llvm.ptr):  // 3 preds: ^bb1, ^bb2, ^bb3
