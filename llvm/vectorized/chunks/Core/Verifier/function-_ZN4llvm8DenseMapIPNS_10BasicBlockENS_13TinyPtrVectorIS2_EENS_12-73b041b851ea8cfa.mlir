"builtin.module"() ({
  ...
  ^bb4(%32: i32):  // 2 preds: ^bb3, ^bb8
    ...
    %36 = "llvm.getelementptr"(%20, %35) <{elem_type = !llvm.struct<"struct.llvm::detail::DenseMapPair.425", (struct<"struct.std::pair.426", (ptr, struct<"class.llvm::TinyPtrVector", (struct<"class.llvm::PointerUnion.428", (struct<"class.llvm::pointer_union_detail::PointerUnionMembers.429", (struct<"class.llvm::pointer_union_detail::PointerUnionMembers.430", (struct<"class.llvm::pointer_union_detail::PointerUnionMembers.431", (struct<"struct.llvm::detail::PunnedPointer", (array<8 x i8>)>)>)>)>)>)>)>)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 0, 1>}> : (!llvm.ptr, i64) -> !llvm.ptr
