"builtin.module"() ({
  "llvm.comdat"() <{sym_name = "__llvm_global_comdat"}> ({
    "llvm.comdat_selector"() <{comdat = 0 : i64, sym_name = "_ZN4llvm14PassNameParser10ValCompareEPKNS_2cl6parserIPKNS_8PassInfoEE10OptionInfoES9_"}> : () -> ()
  }) : () -> ()
  "llvm.module_flags"() <{flags = [#llvm.mlir.module_flag<error, "wchar_size", 4 : i32>, #llvm.mlir.module_flag<min, "PIC Level", 2 : i32>, #llvm.mlir.module_flag<max, "uwtable", 2 : i32>]}> : () -> ()
  "llvm.func"() <{CConv = #llvm.cconv<ccc>, alignment = 2 : i64, arg_attrs = [{llvm.noundef}, {llvm.noundef}], comdat = @__llvm_global_comdat::@_ZN4llvm14PassNameParser10ValCompareEPKNS_2cl6parserIPKNS_8PassInfoEE10OptionInfoES9_, dso_local, function_type = !llvm.func<i32 (ptr, ptr)>, linkage = #llvm.linkage<weak_odr>, no_unwind, passthrough = ["mustprogress", ["min-legal-vector-width", "0"], ["no-trapping-math", "true"], ["stack-protector-buffer-size", "8"], ["target-cpu", "x86-64"]], res_attrs = [{llvm.noundef}], sym_name = "_ZN4llvm14PassNameParser10ValCompareEPKNS_2cl6parserIPKNS_8PassInfoEE10OptionInfoES9_", target_cpu = "x86-64", target_features = #llvm.target_features<["+cmov", "+cx8", "+fxsr", "+mmx", "+sse", "+sse2", "+x87"]>, tune_cpu = "generic", unnamed_addr = 0 : i64, uwtable_kind = #llvm.uwtableKind<async>, visibility_ = 1 : i64}> ({
  ^bb0(%arg0: !llvm.ptr, %arg1: !llvm.ptr):
    ...
    %5 = "llvm.getelementptr"(%arg1, %0) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    %9 = "llvm.intr.umin"(%8, %6) : (i64, i64) -> i64
  ...
  ^bb1:  // pred: ^bb0
    ...
    %16 = "llvm.icmp"(%14, %3) <{predicate = 4 : i64}> : (i32, i32) -> i1
    %17 = "llvm.select"(%16, %4, %3) <{fastmathFlags = #llvm.fastmath<none>}> : (i1, i32, i32) -> i32
    "llvm.cond_br"(%15, %17)[^bb2, ^bb4] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i32) -> ()
  ^bb2:  // 2 preds: ^bb0, ^bb1
    %18 = "llvm.icmp"(%8, %6) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%18, %2)[^bb4, ^bb3] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i32) -> ()
  ^bb3:  // pred: ^bb2
    %19 = "llvm.icmp"(%8, %6) <{predicate = 6 : i64}> : (i64, i64) -> i1
    %20 = "llvm.select"(%19, %3, %4) <{fastmathFlags = #llvm.fastmath<none>}> : (i1, i32, i32) -> i32
    "llvm.br"(%20)[^bb4] : (i32) -> ()
  ^bb4(%21: i32):  // 3 preds: ^bb1, ^bb2, ^bb3
    "llvm.return"(%21) : (i32) -> ()
  }) : () -> ()
