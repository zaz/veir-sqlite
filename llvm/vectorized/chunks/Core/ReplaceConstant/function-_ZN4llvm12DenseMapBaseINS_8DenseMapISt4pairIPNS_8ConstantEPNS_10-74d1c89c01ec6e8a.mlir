"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr, %arg1: i32):
    ...
    %18 = "llvm.alloca"(%0) <{alignment = 16 : i64, elem_type = !llvm.struct<"class.llvm::DenseMap.12", (ptr, ptr, i32, i32)>}> : (i32) -> !llvm.ptr
  ...
  ^bb7:  // 2 preds: ^bb2, ^bb6
    %75 = "llvm.add"(%58, %2) <{overflowFlags = 3 : i32}> : (i64, i64) -> i64
    %76 = "llvm.icmp"(%75, %57) <{predicate = 0 : i64}> : (i64, i64) -> i1
