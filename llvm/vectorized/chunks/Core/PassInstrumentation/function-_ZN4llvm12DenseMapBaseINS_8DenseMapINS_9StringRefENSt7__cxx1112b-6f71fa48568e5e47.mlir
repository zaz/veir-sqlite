"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr, %arg1: i32):
    ...
    %18 = "llvm.alloca"(%0) <{alignment = 16 : i64, elem_type = !llvm.struct<"class.llvm::DenseMap", (ptr, ptr, i32, i32)>}> : (i32) -> !llvm.ptr
    ...
    %54 = "llvm.icmp"(%52, %13) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%54)[^bb11, ^bb1] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb1:  // pred: ^bb0
    %55 = "llvm.zext"(%52) : (i32) -> i64
    %56 = "llvm.add"(%55, %10) <{overflowFlags = 3 : i32}> : (i64, i64) -> i64
    %57 = "llvm.lshr"(%56, %15) : (i64, i64) -> i64
    "llvm.br"(%16)[^bb2] : (i64) -> ()
  ^bb2(%58: i64):  // 2 preds: ^bb1, ^bb8
    ...
    "llvm.cond_br"(%61)[^bb8, ^bb3] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb3:  // pred: ^bb2
    %62 = "llvm.trunc"(%58) <{overflowFlags = 0 : i32}> : (i64) -> i32
    %63 = "llvm.shl"(%62, %17) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
    "llvm.br"(%60)[^bb4] : (i32) -> ()
  ^bb4(%64: i32):  // 2 preds: ^bb3, ^bb7
    %65 = "llvm.intr.cttz"(%64) <{is_zero_poison = true}> : (i32) -> i32
    %66 = "llvm.or"(%65, %63) <{isDisjoint}> : (i32, i32) -> i32
    %67 = "llvm.zext"(%66) : (i32) -> i64
    %68 = "llvm.getelementptr"(%45, %67) <{elem_type = !llvm.struct<"struct.llvm::detail::DenseMapPair", (struct<"struct.std::pair.25", (struct<"class.llvm::StringRef", (ptr, i64)>, struct<"class.std::__cxx11::basic_string", (struct<"struct.std::__cxx11::basic_string<char>::_Alloc_hider", (ptr)>, i64, struct<"union.anon", (i64, array<8 x i8>)>)>)>)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 0, 1>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    %70 = "llvm.getelementptr"(%68, %6) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %71 = "llvm.icmp"(%69, %70) <{predicate = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> i1
    "llvm.cond_br"(%71)[^bb5, ^bb6] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb5:  // pred: ^bb4
    %72 = "llvm.getelementptr"(%68, %5) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    %74 = "llvm.icmp"(%73, %6) <{predicate = 6 : i64}> : (i64, i64) -> i1
    "llvm.intr.assume"(%74) <{op_bundle_sizes = array<i32>}> : (i1) -> ()
    "llvm.br"()[^bb7] : () -> ()
  ^bb6:  // pred: ^bb4
    %75 = "llvm.load"(%70) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, access_type = <id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, offset = 0>]}> : (!llvm.ptr) -> i64
    %76 = "llvm.add"(%75, %2) <{overflowFlags = 0 : i32}> : (i64, i64) -> i64
    "llvm.call"(%69, %76) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<none>, arg_attrs = [{llvm.noundef}, {llvm.noundef}], builtin, callee = @_ZdlPvm, fastmathFlags = #llvm.fastmath<none>, no_unwind, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 2, 0>}> : (!llvm.ptr, i64) -> ()
    "llvm.br"()[^bb7] : () -> ()
  ^bb7:  // 2 preds: ^bb5, ^bb6
    %77 = "llvm.add"(%64, %1) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
    %78 = "llvm.and"(%77, %64) : (i32, i32) -> i32
    %79 = "llvm.icmp"(%78, %13) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%79, %78)[^bb8, ^bb4] <{loop_annotation = #llvm.loop_annotation<mustProgress = true>, operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i32) -> ()
  ^bb8:  // 2 preds: ^bb2, ^bb7
    %80 = "llvm.add"(%58, %2) <{overflowFlags = 3 : i32}> : (i64, i64) -> i64
    %81 = "llvm.icmp"(%80, %57) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%81, %80)[^bb9, ^bb2] <{loop_annotation = #llvm.loop_annotation<mustProgress = true>, operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i64) -> ()
  ^bb9:  // pred: ^bb8
    ...
    "llvm.cond_br"(%83)[^bb11, ^bb10] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb10:  // pred: ^bb9
    %84 = "llvm.load"(%18) <{alignment = 16 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "_ZTSN4llvm8DenseMapINS_9StringRefENSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEENS_12DenseMapInfoIS1_vEENS_6detail12DenseMapPairIS1_S7_EEEE", members = {<#llvm.tbaa_type_desc<id = "any pointer", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, 0>, <#llvm.tbaa_type_desc<id = "any pointer", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, 8>, <#llvm.tbaa_type_desc<id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, 16>, <#llvm.tbaa_type_desc<id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, 20>}>, access_type = <id = "any pointer", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (!llvm.ptr) -> !llvm.ptr
    %85 = "llvm.zext"(%82) : (i32) -> i64
    %86 = "llvm.mul"(%85, %9) <{overflowFlags = 3 : i32}> : (i64, i64) -> i64
    %87 = "llvm.add"(%85, %10) <{overflowFlags = 3 : i32}> : (i64, i64) -> i64
    %88 = "llvm.lshr"(%87, %11) : (i64, i64) -> i64
    %89 = "llvm.and"(%88, %12) : (i64, i64) -> i64
    %90 = "llvm.add"(%89, %86) <{overflowFlags = 3 : i32}> : (i64, i64) -> i64
    "llvm.call"(%84, %90, %5) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<none>, arg_attrs = [{llvm.noundef}, {llvm.noundef}, {llvm.noundef}], callee = @_ZN4llvm17deallocate_bufferEPvmm, fastmathFlags = #llvm.fastmath<none>, no_unwind, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 3, 0>}> : (!llvm.ptr, i64, i64) -> ()
    "llvm.br"()[^bb11] : () -> ()
