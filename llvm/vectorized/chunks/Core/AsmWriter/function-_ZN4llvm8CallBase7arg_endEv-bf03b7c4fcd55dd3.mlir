"builtin.module"() ({
  "llvm.comdat"() <{sym_name = "__llvm_global_comdat"}> ({
    "llvm.comdat_selector"() <{comdat = 0 : i64, sym_name = "_ZN4llvm8CallBase7arg_endEv"}> : () -> ()
  }) : () -> ()
  "llvm.module_flags"() <{flags = [#llvm.mlir.module_flag<error, "wchar_size", 4 : i32>, #llvm.mlir.module_flag<min, "PIC Level", 2 : i32>, #llvm.mlir.module_flag<max, "uwtable", 2 : i32>]}> : () -> ()
  "llvm.func"() <{CConv = #llvm.cconv<ccc>, alignment = 2 : i64, arg_attrs = [{llvm.align = 8 : i64, llvm.dereferenceable = 88 : i64, llvm.nonnull, llvm.noundef}], comdat = @__llvm_global_comdat::@_ZN4llvm8CallBase7arg_endEv, dso_local, function_type = !llvm.func<ptr (ptr)>, linkage = #llvm.linkage<weak_odr>, no_unwind, passthrough = ["mustprogress", ["min-legal-vector-width", "0"], ["no-trapping-math", "true"], ["stack-protector-buffer-size", "8"], ["target-cpu", "x86-64"]], res_attrs = [{llvm.noundef}], sym_name = "_ZN4llvm8CallBase7arg_endEv", target_cpu = "x86-64", target_features = #llvm.target_features<["+cmov", "+cx8", "+fxsr", "+mmx", "+sse", "+sse2", "+x87"]>, tune_cpu = "generic", unnamed_addr = 1 : i64, uwtable_kind = #llvm.uwtableKind<async>, visibility_ = 1 : i64}> ({
  ^bb0(%arg0: !llvm.ptr):
    ...
    %5 = "llvm.mlir.constant"() <{value = 68719476720 : i64}> : () -> i64
    ...
    "llvm.switch"(%9, %0)[^bb3, ^bb4, ^bb1, ^bb2] <{case_operand_segments = array<i32: 1, 0, 0>, case_values = dense<[88, 36, 42]> : vector<3xi8>, operandSegmentSizes = array<i32: 1, 0, 1>}> : (i8, i64) -> ()
  ^bb1:  // pred: ^bb0
    "llvm.br"(%1)[^bb4] : (i64) -> ()
  ^bb2:  // pred: ^bb0
    %10 = "llvm.call"(%arg0) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<tail>, arg_attrs = [{llvm.align = 8 : i64, llvm.dereferenceable = 88 : i64, llvm.nonnull, llvm.noundef}], callee = @_ZNK4llvm8CallBase34getNumSubclassExtraOperandsDynamicEv, fastmathFlags = #llvm.fastmath<none>, no_unwind, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 1, 0>, res_attrs = [{llvm.noundef}]}> : (!llvm.ptr) -> i32
    %11 = "llvm.zext"(%10) : (i32) -> i64
    "llvm.br"(%11)[^bb4] : (i64) -> ()
  ^bb3:  // pred: ^bb0
    "llvm.unreachable"() : () -> ()
  ^bb4(%12: i64):  // 3 preds: ^bb0, ^bb1, ^bb2
    ...
    %15 = "llvm.icmp"(%14, %3) <{predicate = 2 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%15, %4, %0)[^bb5, ^bb7] <{operandSegmentSizes = array<i32: 1, 0, 2>}> : (i1, !llvm.ptr, i64) -> ()
  ^bb5:  // pred: ^bb4
    ...
    %19 = "llvm.icmp"(%18, %3) <{predicate = 2 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%19, %17, %0)[^bb6, ^bb7] <{operandSegmentSizes = array<i32: 1, 0, 2>}> : (i1, !llvm.ptr, i64) -> ()
  ^bb6:  // pred: ^bb5
    ...
    "llvm.br"(%17, %24)[^bb7] : (!llvm.ptr, i64) -> ()
  ^bb7(%25: !llvm.ptr, %26: i64):  // 3 preds: ^bb4, ^bb5, ^bb6
    %27 = "llvm.ptrtoint"(%25) : (!llvm.ptr) -> i64
    %28 = "llvm.sub"(%26, %27) <{overflowFlags = 0 : i32}> : (i64, i64) -> i64
    %29 = "llvm.and"(%28, %5) : (i64, i64) -> i64
    %30 = "llvm.icmp"(%29, %0) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%30, %0)[^bb9, ^bb8] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i64) -> ()
  ^bb8:  // pred: ^bb7
    ...
    %42 = "llvm.getelementptr"(%40, %41) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    %45 = "llvm.sub"(%44, %36) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
    %46 = "llvm.zext"(%45) : (i32) -> i64
    "llvm.br"(%46)[^bb9] : (i64) -> ()
  ^bb9(%47: i64):  // 2 preds: ^bb7, ^bb8
    %48 = "llvm.sub"(%0, %12) <{overflowFlags = 1 : i32}> : (i64, i64) -> i64
    %49 = "llvm.getelementptr"(%arg0, %48) <{elem_type = !llvm.struct<"class.llvm::Use", (ptr, ptr, ptr, ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %50 = "llvm.getelementptr"(%49, %8) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %51 = "llvm.sub"(%0, %47) <{overflowFlags = 1 : i32}> : (i64, i64) -> i64
    %52 = "llvm.getelementptr"(%50, %51) <{elem_type = !llvm.struct<"class.llvm::Use", (ptr, ptr, ptr, ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    "llvm.return"(%52) : (!llvm.ptr) -> ()
  }) : () -> ()
  "llvm.func"() <{CConv = #llvm.cconv<ccc>, arg_attrs = [{llvm.align = 8 : i64, llvm.dereferenceable = 88 : i64, llvm.nonnull, llvm.noundef}], function_type = !llvm.func<i32 (ptr)>, linkage = #llvm.linkage<external>, passthrough = [["no-trapping-math", "true"], ["stack-protector-buffer-size", "8"], ["target-cpu", "x86-64"]], res_attrs = [{llvm.noundef}], sym_name = "_ZNK4llvm8CallBase34getNumSubclassExtraOperandsDynamicEv", target_cpu = "x86-64", target_features = #llvm.target_features<["+cmov", "+cx8", "+fxsr", "+mmx", "+sse", "+sse2", "+x87"]>, tune_cpu = "generic", unnamed_addr = 1 : i64, visibility_ = 0 : i64}> ({
  }) : () -> ()
