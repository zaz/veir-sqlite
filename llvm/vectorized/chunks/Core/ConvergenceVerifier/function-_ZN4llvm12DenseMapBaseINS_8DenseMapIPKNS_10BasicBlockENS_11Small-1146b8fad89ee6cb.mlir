"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr, %arg1: i32):
    ...
    %18 = "llvm.alloca"(%0) <{alignment = 16 : i64, elem_type = !llvm.struct<"class.llvm::DenseMap.48", (ptr, ptr, i32, i32)>}> : (i32) -> !llvm.ptr
  ...
  ^bb9:  // pred: ^bb8
    ...
    %81 = "llvm.mul"(%80, %9) <{overflowFlags = 3 : i32}> : (i64, i64) -> i64
