"builtin.module"() ({
  ...
  ^bb5:  // pred: ^bb2
    ...
    "llvm.br"(%22)[^bb6] : (i1) -> ()
  ^bb6(%23: i1):  // 5 preds: ^bb1, ^bb2, ^bb3, ^bb4, ^bb5
    "llvm.return"(%23) : (i1) -> ()
  }) : () -> ()
