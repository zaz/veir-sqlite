"builtin.module"() ({
  "llvm.comdat"() <{sym_name = "__llvm_global_comdat"}> ({
    "llvm.comdat_selector"() <{comdat = 0 : i64, sym_name = "_ZNK4llvm5APInt3sgtEl"}> : () -> ()
  }) : () -> ()
  "llvm.module_flags"() <{flags = [#llvm.mlir.module_flag<error, "wchar_size", 4 : i32>, #llvm.mlir.module_flag<min, "PIC Level", 2 : i32>, #llvm.mlir.module_flag<max, "uwtable", 2 : i32>]}> : () -> ()
  "llvm.func"() <{CConv = #llvm.cconv<ccc>, alignment = 2 : i64, arg_attrs = [{llvm.align = 8 : i64, llvm.dereferenceable = 12 : i64, llvm.nonnull, llvm.noundef}, {llvm.noundef}], comdat = @__llvm_global_comdat::@_ZNK4llvm5APInt3sgtEl, dso_local, function_type = !llvm.func<i1 (ptr, i64)>, linkage = #llvm.linkage<weak_odr>, no_unwind, passthrough = ["mustprogress", ["min-legal-vector-width", "0"], ["no-trapping-math", "true"], ["stack-protector-buffer-size", "8"], ["target-cpu", "x86-64"]], res_attrs = [{llvm.noundef, llvm.zeroext}], sym_name = "_ZNK4llvm5APInt3sgtEl", target_cpu = "x86-64", target_features = #llvm.target_features<["+cmov", "+cx8", "+fxsr", "+mmx", "+sse", "+sse2", "+x87"]>, tune_cpu = "generic", unnamed_addr = 1 : i64, uwtable_kind = #llvm.uwtableKind<async>, visibility_ = 1 : i64}> ({
  ...
  ^bb1:  // pred: ^bb0
    %13 = "llvm.add"(%11, %2) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
    %14 = "llvm.and"(%13, %3) : (i32, i32) -> i32
    %15 = "llvm.zext"(%14) <{nonNeg}> : (i32) -> i64
    %16 = "llvm.shl"(%4, %15) <{overflowFlags = 2 : i32}> : (i64, i64) -> i64
    %17 = "llvm.load"(%arg0) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
    %18 = "llvm.lshr"(%13, %5) : (i32, i32) -> i32
    %19 = "llvm.zext"(%18) <{nonNeg}> : (i32) -> i64
    %20 = "llvm.getelementptr"(%17, %19) <{elem_type = i64, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
  ...
  ^bb4(%26: i32):  // 2 preds: ^bb2, ^bb3
    %27 = "llvm.add"(%11, %7) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
    %28 = "llvm.sub"(%27, %26) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
    %29 = "llvm.icmp"(%28, %8) <{predicate = 8 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%29, %23)[^bb8, ^bb6] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i1) -> ()
  ^bb5:  // pred: ^bb0
    %30 = "llvm.load"(%arg0) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, access_type = <id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, offset = 0>]}> : (!llvm.ptr) -> i64
    %31 = "llvm.icmp"(%11, %9) <{predicate = 0 : i64}> : (i32, i32) -> i1
    %32 = "llvm.sub"(%8, %11) <{overflowFlags = 3 : i32}> : (i32, i32) -> i32
    %33 = "llvm.zext"(%32) <{nonNeg}> : (i32) -> i64
    %34 = "llvm.shl"(%30, %33) <{overflowFlags = 0 : i32}> : (i64, i64) -> i64
    %35 = "llvm.ashr"(%34, %33) <{isExact}> : (i64, i64) -> i64
    %36 = "llvm.select"(%31, %6, %35) <{fastmathFlags = #llvm.fastmath<none>}> : (i1, i64, i64) -> i64
    "llvm.br"(%36)[^bb7] : (i64) -> ()
  ^bb6:  // pred: ^bb4
    %37 = "llvm.load"(%17) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "long", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, access_type = <id = "long", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (!llvm.ptr) -> i64
    "llvm.br"(%37)[^bb7] : (i64) -> ()
  ^bb7(%38: i64):  // 2 preds: ^bb5, ^bb6
    %39 = "llvm.icmp"(%38, %arg1) <{predicate = 4 : i64}> : (i64, i64) -> i1
    "llvm.br"(%39)[^bb8] : (i1) -> ()
  ^bb8(%40: i1):  // 2 preds: ^bb4, ^bb7
    "llvm.return"(%40) : (i1) -> ()
  }) : () -> ()
