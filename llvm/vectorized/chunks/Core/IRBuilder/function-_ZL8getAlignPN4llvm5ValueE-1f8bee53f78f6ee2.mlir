"builtin.module"() ({
  ...
  "llvm.func"() <{CConv = #llvm.cconv<fastcc>, arg_attrs = [{llvm.noundef}], dso_local, function_type = !llvm.func<i16 (ptr)>, linkage = #llvm.linkage<external>, no_unwind, passthrough = ["mustprogress", ["min-legal-vector-width", "0"], ["no-trapping-math", "true"], ["stack-protector-buffer-size", "8"], ["target-cpu", "x86-64"]], sym_name = "_ZL8getAlignPN4llvm5ValueE", target_cpu = "x86-64", target_features = #llvm.target_features<["+cmov", "+cx8", "+fxsr", "+mmx", "+sse", "+sse2", "+x87"]>, tune_cpu = "generic", unnamed_addr = 2 : i64, uwtable_kind = #llvm.uwtableKind<async>, visibility_ = 1 : i64}> ({
  ^bb0(%arg0: !llvm.ptr):
    ...
    %6 = "llvm.mlir.constant"() <{value = 255 : i16}> : () -> i16
    ...
    "llvm.switch"(%8, %0, %0)[^bb3, ^bb1, ^bb2] <{case_operand_segments = array<i32: 0, 0>, case_values = dense<[17, 15]> : vector<2xi8>, operandSegmentSizes = array<i32: 1, 2, 0>}> : (i8, i16, i16) -> ()
  ^bb1:  // pred: ^bb0
    ...
    %11 = "llvm.lshr"(%10, %3) : (i32, i32) -> i32
    %12 = "llvm.and"(%11, %4) : (i32, i32) -> i32
    %13 = "llvm.icmp"(%12, %5) <{predicate = 0 : i64}> : (i32, i32) -> i1
    %14 = "llvm.trunc"(%12) <{overflowFlags = 3 : i32}> : (i32) -> i16
    %15 = "llvm.add"(%14, %6) <{overflowFlags = 3 : i32}> : (i16, i16) -> i16
    %16 = "llvm.or"(%15, %7) : (i16, i16) -> i16
    %17 = "llvm.select"(%13, %0, %16) <{fastmathFlags = #llvm.fastmath<none>}> : (i1, i16, i16) -> i16
    %18 = "llvm.and"(%17, %7) : (i16, i16) -> i16
    "llvm.br"(%18, %17)[^bb3] : (i16, i16) -> ()
  ^bb2:  // pred: ^bb0
    %19 = "llvm.call"(%arg0) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<tail>, arg_attrs = [{llvm.align = 8 : i64, llvm.dereferenceable = 64 : i64, llvm.nonnull, llvm.noundef}], callee = @_ZNK4llvm11GlobalAlias16getAliaseeObjectEv, fastmathFlags = #llvm.fastmath<none>, no_unwind, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 1, 0>, res_attrs = [{llvm.noundef}]}> : (!llvm.ptr) -> !llvm.ptr
    %20 = "llvm.call"(%19) <{CConv = #llvm.cconv<fastcc>, TailCallKind = #llvm.tailcallkind<tail>, arg_attrs = [{llvm.noundef}], callee = @_ZL8getAlignPN4llvm5ValueE, fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 1, 0>}> : (!llvm.ptr) -> i16
    %21 = "llvm.and"(%20, %1) : (i16, i16) -> i16
    "llvm.br"(%21, %20)[^bb3] : (i16, i16) -> ()
  ^bb3(%22: i16, %23: i16):  // 3 preds: ^bb0, ^bb1, ^bb2
    %24 = "llvm.and"(%23, %6) : (i16, i16) -> i16
    %25 = "llvm.or"(%24, %22) <{isDisjoint}> : (i16, i16) -> i16
    "llvm.return"(%25) : (i16) -> ()
  }) : () -> ()
  "llvm.func"() <{CConv = #llvm.cconv<ccc>, arg_attrs = [{llvm.align = 8 : i64, llvm.dereferenceable = 64 : i64, llvm.nonnull, llvm.noundef}], function_type = !llvm.func<ptr (ptr)>, linkage = #llvm.linkage<external>, passthrough = [["no-trapping-math", "true"], ["stack-protector-buffer-size", "8"], ["target-cpu", "x86-64"]], res_attrs = [{llvm.noundef}], sym_name = "_ZNK4llvm11GlobalAlias16getAliaseeObjectEv", target_cpu = "x86-64", target_features = #llvm.target_features<["+cmov", "+cx8", "+fxsr", "+mmx", "+sse", "+sse2", "+x87"]>, tune_cpu = "generic", unnamed_addr = 1 : i64, visibility_ = 0 : i64}> ({
  }) : () -> ()
