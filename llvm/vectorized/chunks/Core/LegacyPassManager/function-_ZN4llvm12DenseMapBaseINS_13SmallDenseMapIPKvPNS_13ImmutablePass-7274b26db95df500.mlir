"builtin.module"() ({
  "llvm.comdat"() <{sym_name = "__llvm_global_comdat"}> ({
    "llvm.comdat_selector"() <{comdat = 0 : i64, sym_name = "_ZN4llvm12DenseMapBaseINS_13SmallDenseMapIPKvPNS_13ImmutablePassELj8ENS_12DenseMapInfoIS3_vEENS_6detail12DenseMapPairIS3_S5_EEEES3_S5_S7_SA_E4growEj"}> : () -> ()
  }) : () -> ()
  ...
  ^bb0(%arg0: !llvm.ptr, %arg1: i32):
    ...
    %18 = "llvm.alloca"(%0) <{alignment = 8 : i64, elem_type = !llvm.struct<"class.llvm::SmallDenseMap", (i32, struct<"union.anon.158", (struct<"struct.llvm::SmallDenseMap<const void *, llvm::ImmutablePass *, 8>::LargeRep", (ptr, ptr, i32)>, array<112 x i8>)>)>}> : (i32) -> !llvm.ptr
