"builtin.module"() ({
  "llvm.comdat"() <{sym_name = "__llvm_global_comdat"}> ({
    "llvm.comdat_selector"() <{comdat = 0 : i64, sym_name = "_ZN4llvm13FPPassManagerD0Ev"}> : () -> ()
  }) : () -> ()
  ...
  ^bb0(%arg0: !llvm.ptr):
    ...
    %9 = "llvm.mlir.constant"() <{value = 264 : i64}> : () -> i64
    %10 = "llvm.mlir.constant"() <{value = 280 : i64}> : () -> i64
    %11 = "llvm.mlir.constant"() <{value = 260 : i64}> : () -> i64
    %12 = "llvm.mlir.constant"() <{value = 240 : i64}> : () -> i64
  ...
  ^bb10:  // 2 preds: ^bb5, ^bb6
    "llvm.call"(%arg0) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<tail>, arg_attrs = [{llvm.align = 8 : i64, llvm.dereferenceable = 28 : i64, llvm.nonnull, llvm.noundef}], callee = @_ZN4llvm10ModulePassD2Ev, fastmathFlags = #llvm.fastmath<none>, no_unwind, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 1, 0>}> : (!llvm.ptr) -> ()
    "llvm.call"(%arg0, %19) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<tail>, arg_attrs = [{llvm.nonnull, llvm.noundef}, {llvm.noundef}], builtin, callee = @_ZdlPvm, fastmathFlags = #llvm.fastmath<none>, no_unwind, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 2, 0>}> : (!llvm.ptr, i64) -> ()
    "llvm.return"() : () -> ()
  }) : () -> ()
