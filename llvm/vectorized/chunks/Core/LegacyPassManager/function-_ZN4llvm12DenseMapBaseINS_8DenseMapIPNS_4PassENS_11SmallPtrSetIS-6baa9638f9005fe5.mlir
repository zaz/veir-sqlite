"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr, %arg1: i32):
    ...
    %18 = "llvm.alloca"(%0) <{alignment = 16 : i64, elem_type = !llvm.struct<"class.llvm::DenseMap.150", (ptr, ptr, i32, i32)>}> : (i32) -> !llvm.ptr
  ...
  ^bb4(%64: i32):  // 2 preds: ^bb3, ^bb6
    ...
    %68 = "llvm.getelementptr"(%45, %67) <{elem_type = !llvm.struct<"struct.llvm::detail::DenseMapPair", (struct<"struct.std::pair.202", (ptr, struct<"class.llvm::SmallPtrSet.186", (struct<"class.llvm::SmallPtrSetImpl.base.188", (struct<"class.llvm::SmallPtrSetImplBase.base", packed (ptr, i32, i32, i8)>)>, array<8 x ptr>)>)>)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 0, 1>}> : (!llvm.ptr, i64) -> !llvm.ptr
