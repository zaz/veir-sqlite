"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr, %arg1: i32):
    ...
    %12 = "llvm.shl"(%arg1, %1) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
    %13 = "llvm.and"(%12, %2) : (i32, i32) -> i32
    %14 = "llvm.and"(%11, %3) : (i32, i32) -> i32
    %15 = "llvm.or"(%14, %13) <{isDisjoint}> : (i32, i32) -> i32
    "llvm.store"(%15, %10) <{alignment = 8 : i64, ordering = 0 : i64}> : (i32, !llvm.ptr) -> ()
    %16 = "llvm.and"(%11, %4) : (i32, i32) -> i32
    %17 = "llvm.add"(%16, %5) <{overflowFlags = 1 : i32}> : (i32, i32) -> i32
    %18 = "llvm.icmp"(%17, %6) <{predicate = 6 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%18)[^bb2, ^bb1] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb1:  // pred: ^bb0
    %19 = "llvm.icmp"(%13, %7) <{predicate = 1 : i64}> : (i32, i32) -> i1
    %20 = "llvm.icmp"(%16, %8) <{predicate = 1 : i64}> : (i32, i32) -> i1
    %21 = "llvm.and"(%19, %20) : (i1, i1) -> i1
    "llvm.cond_br"(%21)[^bb2, ^bb3] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb2:  // 2 preds: ^bb0, ^bb1
    %22 = "llvm.or"(%15, %9) : (i32, i32) -> i32
    "llvm.store"(%22, %10) <{alignment = 8 : i64, ordering = 0 : i64}> : (i32, !llvm.ptr) -> ()
    "llvm.br"()[^bb3] : () -> ()
  ^bb3:  // 2 preds: ^bb1, ^bb2
    "llvm.return"() : () -> ()
  }) : () -> ()
