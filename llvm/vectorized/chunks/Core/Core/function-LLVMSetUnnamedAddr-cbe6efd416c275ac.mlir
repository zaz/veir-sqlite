"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr, %arg1: i32):
    ...
    %9 = "llvm.or"(%8, %5) <{isDisjoint}> : (i32, i32) -> i32
    "llvm.store"(%9, %6) <{alignment = 8 : i64, ordering = 0 : i64}> : (i32, !llvm.ptr) -> ()
    "llvm.return"() : () -> ()
  }) : () -> ()
