"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr):
    ...
    %10 = "llvm.icmp"(%9, %0) <{predicate = 8 : i64}> : (i8, i8) -> i1
    %11 = "llvm.zext"(%9) : (i8) -> i32
    %12 = "llvm.add"(%11, %1) <{overflowFlags = 1 : i32}> : (i32, i32) -> i32
    %13 = "llvm.icmp"(%12, %2) <{predicate = 6 : i64}> : (i32, i32) -> i1
    %14 = "llvm.select"(%10, %13, %3) <{fastmathFlags = #llvm.fastmath<none>}> : (i1, i1, i1) -> i1
  ...
  ^bb2:  // pred: ^bb0
    ...
    %29 = "llvm.lshr"(%28, %7) <{isExact}> : (i64, i64) -> i64
