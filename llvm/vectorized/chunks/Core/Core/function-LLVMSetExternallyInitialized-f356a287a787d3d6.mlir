"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr, %arg1: i32):
    ...
    %8 = "llvm.select"(%5, %2, %3) <{fastmathFlags = #llvm.fastmath<none>}> : (i1, i8, i8) -> i8
    %9 = "llvm.and"(%7, %4) : (i8, i8) -> i8
    %10 = "llvm.or"(%9, %8) <{isDisjoint}> : (i8, i8) -> i8
    "llvm.store"(%10, %6) <{alignment = 8 : i64, ordering = 0 : i64}> : (i8, !llvm.ptr) -> ()
    "llvm.return"() : () -> ()
  }) : () -> ()
