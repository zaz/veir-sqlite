"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr):
    ...
    %8 = "llvm.select"(%6, %0, %7) <{fastmathFlags = #llvm.fastmath<none>}> : (i1, !llvm.ptr, !llvm.ptr) -> !llvm.ptr
    ...
    %14 = "llvm.icmp"(%10, %13) <{predicate = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> i1
    %15 = "llvm.icmp"(%10, %0) <{predicate = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> i1
    %16 = "llvm.getelementptr"(%10, %5) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %17 = "llvm.or"(%15, %14) : (i1, i1) -> i1
    %18 = "llvm.select"(%17, %0, %16) <{fastmathFlags = #llvm.fastmath<none>}> : (i1, !llvm.ptr, !llvm.ptr) -> !llvm.ptr
