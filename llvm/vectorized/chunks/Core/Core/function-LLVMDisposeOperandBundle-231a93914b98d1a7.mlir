"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr):
    ...
    "llvm.cond_br"(%7)[^bb7, ^bb1] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb1:  // pred: ^bb0
  ...
  ^bb4:  // pred: ^bb3
    ...
    %21 = "llvm.icmp"(%20, %3) <{predicate = 6 : i64}> : (i64, i64) -> i1
  ...
  ^bb5:  // pred: ^bb3
    ...
    %23 = "llvm.add"(%22, %4) <{overflowFlags = 0 : i32}> : (i64, i64) -> i64
