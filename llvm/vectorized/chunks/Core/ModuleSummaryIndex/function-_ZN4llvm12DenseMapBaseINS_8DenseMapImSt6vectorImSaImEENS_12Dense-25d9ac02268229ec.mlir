"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr, %arg1: i32):
    ...
    %18 = "llvm.alloca"(%0) <{alignment = 16 : i64, elem_type = !llvm.struct<"class.llvm::DenseMap.125", (ptr, ptr, i32, i32)>}> : (i32) -> !llvm.ptr
  ...
  ^bb4(%64: i32):  // 2 preds: ^bb3, ^bb6
    ...
    %68 = "llvm.getelementptr"(%45, %67) <{elem_type = !llvm.struct<"struct.llvm::detail::DenseMapPair.339", (struct<"struct.std::pair.340", (i64, struct<"class.std::vector", (struct<"struct.std::_Vector_base", (struct<"struct.std::_Vector_base<unsigned long, std::allocator<unsigned long>>::_Vector_impl", (struct<"struct.std::_Vector_base<unsigned long, std::allocator<unsigned long>>::_Vector_impl_data", (ptr, ptr, ptr)>)>)>)>)>)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 0, 1>}> : (!llvm.ptr, i64) -> !llvm.ptr
