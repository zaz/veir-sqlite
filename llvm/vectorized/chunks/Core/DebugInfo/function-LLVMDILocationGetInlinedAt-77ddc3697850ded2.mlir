"builtin.module"() ({
  ...
  ^bb1:  // pred: ^bb0
    %15 = "llvm.and"(%12, %7) : (i64, i64) -> i64
    %16 = "llvm.icmp"(%15, %8) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%16, %5)[^bb4, ^bb6] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, !llvm.ptr) -> ()
  ^bb2:  // pred: ^bb0
    ...
    "llvm.cond_br"(%19, %5)[^bb3, ^bb6] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, !llvm.ptr) -> ()
  ^bb3:  // pred: ^bb2
    ...
    "llvm.br"(%21)[^bb5] : (!llvm.ptr) -> ()
  ^bb4:  // pred: ^bb1
    %22 = "llvm.lshr"(%12, %1) : (i64, i64) -> i64
    %23 = "llvm.and"(%22, %9) : (i64, i64) -> i64
    %24 = "llvm.sub"(%2, %23) <{overflowFlags = 1 : i32}> : (i64, i64) -> i64
    %25 = "llvm.getelementptr"(%11, %24) <{elem_type = !llvm.struct<"class.llvm::MDOperand", (ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
  ...
  ^bb6(%29: !llvm.ptr):  // 3 preds: ^bb1, ^bb2, ^bb5
