"builtin.module"() ({
  ...
  ^bb4(%32: i32):  // 2 preds: ^bb3, ^bb12
    ...
    %36 = "llvm.getelementptr"(%20, %35) <{elem_type = !llvm.struct<"struct.llvm::detail::DenseMapPair.799", (struct<"struct.std::pair.800", (ptr, struct<"class.llvm::SmallVector.244", (struct<"class.llvm::SmallVectorImpl.245", (struct<"class.llvm::SmallVectorTemplateBase.246", (struct<"class.llvm::SmallVectorTemplateCommon.247", (struct<"class.llvm::SmallVectorBase", (ptr, i32, i32)>)>)>)>, struct<"struct.llvm::SmallVectorStorage.248", (array<32 x i8>)>)>)>)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 0, 1>}> : (!llvm.ptr, i64) -> !llvm.ptr
