"builtin.module"() ({
  "llvm.mlir.global"() <{addr_space = 0 : i32, alignment = 16 : i64, constant, dso_local, global_type = !llvm.array<3 x struct<"struct.BuiltinEntry.108", (i32, i32)>>, linkage = #llvm.linkage<external>, sym_name = "_ZZN4llvm9Intrinsic24getIntrinsicForMSBuiltinENS_9StringRefES1_E12aarch64Names", tls_mode = 0 : i64, unnamed_addr = 0 : i64, visibility_ = 1 : i64}> ({
    ...
    %1 = "llvm.mlir.constant"() <{value = 599 : i32}> : () -> i32
    ...
    %6 = "llvm.mlir.constant"() <{value = 583 : i32}> : () -> i32
    ...
    %11 = "llvm.mlir.constant"() <{value = 582 : i32}> : () -> i32
    ...
    %15 = "llvm.mlir.undef"() : () -> !llvm.array<3 x struct<"struct.BuiltinEntry.108", (i32, i32)>>
    %16 = "llvm.insertvalue"(%15, %14) <{position = array<i64: 0>}> : (!llvm.array<3 x struct<"struct.BuiltinEntry.108", (i32, i32)>>, !llvm.struct<"struct.BuiltinEntry.108", (i32, i32)>) -> !llvm.array<3 x struct<"struct.BuiltinEntry.108", (i32, i32)>>
    %17 = "llvm.insertvalue"(%16, %9) <{position = array<i64: 1>}> : (!llvm.array<3 x struct<"struct.BuiltinEntry.108", (i32, i32)>>, !llvm.struct<"struct.BuiltinEntry.108", (i32, i32)>) -> !llvm.array<3 x struct<"struct.BuiltinEntry.108", (i32, i32)>>
    %18 = "llvm.insertvalue"(%17, %4) <{position = array<i64: 2>}> : (!llvm.array<3 x struct<"struct.BuiltinEntry.108", (i32, i32)>>, !llvm.struct<"struct.BuiltinEntry.108", (i32, i32)>) -> !llvm.array<3 x struct<"struct.BuiltinEntry.108", (i32, i32)>>
    "llvm.return"(%18) : (!llvm.array<3 x struct<"struct.BuiltinEntry.108", (i32, i32)>>) -> ()
  }) : () -> ()
