"builtin.module"() ({
  ...
  ^bb1:  // pred: ^bb0
    ...
    "llvm.br"(%8)[^bb3] : (i64) -> ()
  ^bb2:  // pred: ^bb3
    %27 = "llvm.add"(%29, %11) <{overflowFlags = 3 : i32}> : (i64, i64) -> i64
  ...
  ^bb3(%29: i64):  // 2 preds: ^bb1, ^bb2
    ...
    "llvm.cond_br"(%32, %10)[^bb2, ^bb6] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i1) -> ()
  ^bb4:  // 2 preds: ^bb0, ^bb2
    %33 = "llvm.icmp"(%15, %12) <{predicate = 6 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%33, %10)[^bb6, ^bb5] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i1) -> ()
  ^bb5:  // pred: ^bb4
    ...
    %37 = "llvm.shl"(%9, %36) <{overflowFlags = 1 : i32}> : (i64, i64) -> i64
    ...
    %41 = "llvm.or"(%40, %37) : (i64, i64) -> i64
    %42 = "llvm.icmp"(%41, %9) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.br"(%42)[^bb6] : (i1) -> ()
  ^bb6(%43: i1):  // 3 preds: ^bb3, ^bb4, ^bb5
    "llvm.return"(%43) : (i1) -> ()
  }) : () -> ()
