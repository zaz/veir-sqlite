"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr):
    ...
    "llvm.cond_br"(%21, %3)[^bb1, ^bb8] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i1) -> ()
  ^bb1:  // pred: ^bb0
    ...
    %27 = "llvm.icmp"(%23, %26) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%27, %3)[^bb2, ^bb8] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i1) -> ()
  ^bb2:  // pred: ^bb1
    %28 = "llvm.getelementptr"(%24, %6) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    %31 = "llvm.icmp"(%30, %8) <{predicate = 6 : i64}> : (i32, i32) -> i1
    ...
    %34 = "llvm.select"(%31, %33, %32) <{fastmathFlags = #llvm.fastmath<none>}> : (i1, !llvm.ptr, !llvm.ptr) -> !llvm.ptr
    %35 = "llvm.add"(%29, %9) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
    %36 = "llvm.lshr"(%35, %10) : (i32, i32) -> i32
    %37 = "llvm.intr.umax"(%36, %11) : (i32, i32) -> i32
    %38 = "llvm.add"(%37, %12) <{overflowFlags = 1 : i32}> : (i32, i32) -> i32
    %39 = "llvm.icmp"(%38, %13) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%39)[^bb6, ^bb3] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb3:  // pred: ^bb2
    %40 = "llvm.zext"(%38) <{nonNeg}> : (i32) -> i64
    "llvm.br"(%14)[^bb5] : (i64) -> ()
  ^bb4:  // pred: ^bb5
    %41 = "llvm.add"(%43, %15) <{overflowFlags = 3 : i32}> : (i64, i64) -> i64
    %42 = "llvm.icmp"(%41, %40) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%42, %41)[^bb6, ^bb5] <{loop_annotation = #llvm.loop_annotation<mustProgress = true>, operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i64) -> ()
  ^bb5(%43: i64):  // 2 preds: ^bb3, ^bb4
    %44 = "llvm.getelementptr"(%34, %43) <{elem_type = i64, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %45 = "llvm.load"(%44) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "long", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, access_type = <id = "long", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (!llvm.ptr) -> i64
    %46 = "llvm.icmp"(%45, %14) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%46, %3)[^bb4, ^bb8] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i1) -> ()
  ^bb6:  // 2 preds: ^bb2, ^bb4
    %47 = "llvm.icmp"(%29, %16) <{predicate = 6 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%47, %17)[^bb8, ^bb7] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i1) -> ()
  ^bb7:  // pred: ^bb6
    %48 = "llvm.shl"(%37, %10) <{overflowFlags = 2 : i32}> : (i32, i32) -> i32
    %49 = "llvm.sub"(%35, %48) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
    %50 = "llvm.zext"(%49) <{nonNeg}> : (i32) -> i64
    %51 = "llvm.shl"(%15, %50) <{overflowFlags = 2 : i32}> : (i64, i64) -> i64
    %52 = "llvm.zext"(%38) <{nonNeg}> : (i32) -> i64
    %53 = "llvm.getelementptr"(%34, %52) <{elem_type = i64, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %54 = "llvm.load"(%53) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "long", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, access_type = <id = "long", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (!llvm.ptr) -> i64
    %55 = "llvm.icmp"(%54, %51) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.br"(%55)[^bb8] : (i1) -> ()
  ^bb8(%56: i1):  // 5 preds: ^bb0, ^bb1, ^bb5, ^bb6, ^bb7
    "llvm.return"(%56) : (i1) -> ()
  }) : () -> ()
