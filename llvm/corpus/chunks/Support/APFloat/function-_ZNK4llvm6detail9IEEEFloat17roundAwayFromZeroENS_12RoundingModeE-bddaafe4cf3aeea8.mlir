"builtin.module"() ({
  ...
  "llvm.func"() <{CConv = #llvm.cconv<ccc>, alignment = 2 : i64, arg_attrs = [{llvm.align = 8 : i64, llvm.dereferenceable = 24 : i64, llvm.nonnull, llvm.noundef}, {llvm.noundef, llvm.signext}, {llvm.noundef}, {llvm.noundef}], dso_local, function_type = !llvm.func<i1 (ptr, i8, i32, i32)>, linkage = #llvm.linkage<external>, no_unwind, passthrough = ["mustprogress", ["min-legal-vector-width", "0"], ["no-trapping-math", "true"], ["stack-protector-buffer-size", "8"], ["target-cpu", "x86-64"]], res_attrs = [{llvm.noundef, llvm.zeroext}], sym_name = "_ZNK4llvm6detail9IEEEFloat17roundAwayFromZeroENS_12RoundingModeENS_12lostFractionEj", target_cpu = "x86-64", target_features = #llvm.target_features<["+cmov", "+cx8", "+fxsr", "+mmx", "+sse", "+sse2", "+x87"]>, tune_cpu = "generic", unnamed_addr = 1 : i64, uwtable_kind = #llvm.uwtableKind<async>, visibility_ = 0 : i64}> ({
  ^bb0(%arg0: !llvm.ptr, %arg1: i8, %arg2: i32, %arg3: i32):
    ...
    "llvm.switch"(%arg1, %0)[^bb8, ^bb1, ^bb2, ^bb9, ^bb6, ^bb7] <{case_operand_segments = array<i32: 0, 0, 1, 0, 0>, case_values = dense<[4, 1, 0, 2, 3]> : vector<5xi8>, operandSegmentSizes = array<i32: 1, 0, 1>}> : (i8, i1) -> ()
  ^bb1:  // pred: ^bb0
    %13 = "llvm.and"(%arg2, %11) : (i32, i32) -> i32
    %14 = "llvm.icmp"(%13, %12) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.br"(%14)[^bb9] : (i1) -> ()
  ^bb2:  // pred: ^bb0
    "llvm.switch"(%arg2, %4)[^bb5, ^bb9, ^bb3] <{case_operand_segments = array<i32: 1, 0>, case_values = dense<[3, 2]> : vector<2xi32>, operandSegmentSizes = array<i32: 1, 0, 1>}> : (i32, i1) -> ()
  ^bb3:  // pred: ^bb2
    ...
    %17 = "llvm.and"(%16, %5) : (i8, i8) -> i8
    %18 = "llvm.icmp"(%17, %6) <{predicate = 0 : i64}> : (i8, i8) -> i1
  ...
  ^bb4:  // pred: ^bb3
    ...
    %20 = "llvm.getelementptr"(%19, %7) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    %22 = "llvm.add"(%21, %8) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
    %23 = "llvm.icmp"(%22, %9) <{predicate = 6 : i64}> : (i32, i32) -> i1
    ...
    %27 = "llvm.call"(%26, %arg3) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<tail>, arg_attrs = [{llvm.noundef}, {llvm.noundef}], callee = @_ZN4llvm5APInt12tcExtractBitEPKmj, fastmathFlags = #llvm.fastmath<none>, no_unwind, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 2, 0>, res_attrs = [{llvm.noundef}]}> : (!llvm.ptr, i32) -> i32
    %28 = "llvm.icmp"(%27, %10) <{predicate = 1 : i64}> : (i32, i32) -> i1
    "llvm.br"(%28)[^bb9] : (i1) -> ()
  ^bb5:  // 2 preds: ^bb2, ^bb3
    "llvm.br"(%0)[^bb9] : (i1) -> ()
  ^bb6:  // pred: ^bb0
  ...
  ^bb7:  // pred: ^bb0
    ...
    %35 = "llvm.and"(%34, %2) : (i8, i8) -> i8
    %36 = "llvm.icmp"(%35, %3) <{predicate = 1 : i64}> : (i8, i8) -> i1
    "llvm.br"(%36)[^bb9] : (i1) -> ()
  ^bb8:  // pred: ^bb0
    "llvm.unreachable"() : () -> ()
  ^bb9(%37: i1):  // 7 preds: ^bb0, ^bb1, ^bb2, ^bb4, ^bb5, ^bb6, ^bb7
    "llvm.return"(%37) : (i1) -> ()
  }) : () -> ()
