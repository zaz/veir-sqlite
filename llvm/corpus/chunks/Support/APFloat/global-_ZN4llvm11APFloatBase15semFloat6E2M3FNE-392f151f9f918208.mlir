"builtin.module"() ({
  "llvm.comdat"() <{sym_name = "__llvm_global_comdat"}> ({
    "llvm.comdat_selector"() <{comdat = 0 : i64, sym_name = "_ZN4llvm11APFloatBase15semFloat6E2M3FNE"}> : () -> ()
  }) : () -> ()
  "llvm.mlir.global"() <{addr_space = 0 : i32, alignment = 4 : i64, comdat = @__llvm_global_comdat::@_ZN4llvm11APFloatBase15semFloat6E2M3FNE, constant, global_type = !llvm.struct<(i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8)>, linkage = #llvm.linkage<weak_odr>, sym_name = "_ZN4llvm11APFloatBase15semFloat6E2M3FNE", tls_mode = 0 : i64, unnamed_addr = 0 : i64, visibility_ = 0 : i64}> ({
    ...
    %8 = "llvm.insertvalue"(%7, %2) <{position = array<i64: 1>}> : (!llvm.struct<(i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8)>, i32) -> !llvm.struct<(i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8)>
    %9 = "llvm.insertvalue"(%8, %5) <{position = array<i64: 2>}> : (!llvm.struct<(i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8)>, i32) -> !llvm.struct<(i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8)>
    %10 = "llvm.insertvalue"(%9, %4) <{position = array<i64: 3>}> : (!llvm.struct<(i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8)>, i32) -> !llvm.struct<(i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8)>
    %11 = "llvm.insertvalue"(%10, %3) <{position = array<i64: 4>}> : (!llvm.struct<(i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8)>, i32) -> !llvm.struct<(i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8)>
