"builtin.module"() ({
  ...
  "llvm.func"() <{CConv = #llvm.cconv<ccc>, arg_attrs = [{llvm.noundef}], dso_local, function_type = !llvm.func<i32 (i32)>, linkage = #llvm.linkage<external>, memory_effects = #llvm.memory_effects<other = none, argMem = none, inaccessibleMem = none, errnoMem = none, targetMem0 = none, targetMem1 = none>, no_unwind, passthrough = ["mustprogress", "nofree", "norecurse", "nosync", ["min-legal-vector-width", "0"], ["no-trapping-math", "true"], ["stack-protector-buffer-size", "8"], ["target-cpu", "x86-64"]], res_attrs = [{llvm.noundef}], sym_name = "_ZN4llvm12inverse_fabsENS_11FPClassTestE", target_cpu = "x86-64", target_features = #llvm.target_features<["+cmov", "+cx8", "+fxsr", "+mmx", "+sse", "+sse2", "+x87"]>, tune_cpu = "generic", unnamed_addr = 1 : i64, uwtable_kind = #llvm.uwtableKind<async>, visibility_ = 0 : i64, will_return}> ({
  ^bb0(%arg0: i32):
    ...
    %7 = "llvm.mlir.constant"() <{value = 264 : i32}> : () -> i32
    %8 = "llvm.mlir.constant"() <{value = 512 : i32}> : () -> i32
    %9 = "llvm.mlir.constant"() <{value = 516 : i32}> : () -> i32
    %10 = "llvm.and"(%arg0, %0) : (i32, i32) -> i32
    %11 = "llvm.and"(%arg0, %1) : (i32, i32) -> i32
    ...
    %17 = "llvm.or"(%14, %5) <{isDisjoint}> : (i32, i32) -> i32
    %18 = "llvm.select"(%16, %14, %17) <{fastmathFlags = #llvm.fastmath<none>}> : (i1, i32, i32) -> i32
    %19 = "llvm.and"(%arg0, %6) : (i32, i32) -> i32
    %20 = "llvm.icmp"(%19, %2) <{predicate = 0 : i64}> : (i32, i32) -> i1
    %21 = "llvm.or"(%18, %7) <{isDisjoint}> : (i32, i32) -> i32
    %22 = "llvm.select"(%20, %18, %21) <{fastmathFlags = #llvm.fastmath<none>}> : (i1, i32, i32) -> i32
    %23 = "llvm.and"(%arg0, %8) : (i32, i32) -> i32
    %24 = "llvm.icmp"(%23, %2) <{predicate = 0 : i64}> : (i32, i32) -> i1
    %25 = "llvm.or"(%22, %9) : (i32, i32) -> i32
    %26 = "llvm.select"(%24, %22, %25) <{fastmathFlags = #llvm.fastmath<none>}> : (i1, i32, i32) -> i32
    "llvm.return"(%26) : (i32) -> ()
  }) : () -> ()
