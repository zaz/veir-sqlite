"builtin.module"() ({
  "llvm.comdat"() <{sym_name = "__llvm_global_comdat"}> ({
    "llvm.comdat_selector"() <{comdat = 0 : i64, sym_name = "_ZTVN4llvm18BinaryStreamWriterE"}> : () -> ()
  }) : () -> ()
  "llvm.mlir.global"() <{addr_space = 0 : i32, alignment = 8 : i64, comdat = @__llvm_global_comdat::@_ZTVN4llvm18BinaryStreamWriterE, constant, global_type = !llvm.struct<(array<4 x ptr>)>, linkage = #llvm.linkage<weak_odr>, sym_name = "_ZTVN4llvm18BinaryStreamWriterE", tls_mode = 0 : i64, unnamed_addr = 2 : i64, visibility_ = 0 : i64}> ({
    %0 = "llvm.mlir.addressof"() <{global_name = @_ZN4llvm18BinaryStreamWriterD0Ev}> : () -> !llvm.ptr
    %1 = "llvm.mlir.addressof"() <{global_name = @_ZN4llvm18BinaryStreamWriterD2Ev}> : () -> !llvm.ptr
