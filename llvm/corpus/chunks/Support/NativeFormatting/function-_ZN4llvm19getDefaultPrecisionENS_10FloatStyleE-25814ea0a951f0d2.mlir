"builtin.module"() ({
  ...
  ^bb0(%arg0: i32):
    ...
    %4 = "llvm.select"(%3, %1, %2) <{fastmathFlags = #llvm.fastmath<none>}> : (i1, i64, i64) -> i64
    "llvm.return"(%4) : (i64) -> ()
  }) : () -> ()
