"builtin.module"() ({
  ...
  "llvm.mlir.alias"() <{alias_type = !llvm.func<void (ptr, i32, i32)>, linkage = #llvm.linkage<external>, sym_name = "_ZN4llvm13StringMapImplC1Ejj", tls_mode = 0 : i64, unnamed_addr = 2 : i64, visibility_ = 0 : i64}> ({
    %39 = "llvm.mlir.addressof"() <{global_name = @_ZN4llvm13StringMapImplC2Ejj}> : () -> !llvm.ptr
