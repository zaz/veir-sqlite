"builtin.module"() ({
  ...
  "llvm.func"() <{CConv = #llvm.cconv<ccc>, alignment = 2 : i64, arg_attrs = [{llvm.align = 8 : i64, llvm.dereferenceable = 17 : i64, llvm.nocapture, llvm.nonnull, llvm.noundef, llvm.readonly}, {llvm.nocapture, llvm.noundef}, {llvm.noundef}], dso_local, function_type = !llvm.func<i32 (ptr, ptr, ptr)>, linkage = #llvm.linkage<external>, no_unwind, passthrough = ["mustprogress", ["min-legal-vector-width", "0"], ["no-trapping-math", "true"], ["stack-protector-buffer-size", "8"], ["target-cpu", "x86-64"]], res_attrs = [{llvm.noundef}], sym_name = "_ZNK4llvm13DataExtractor6getU24EPmPNS_5ErrorE", target_cpu = "x86-64", target_features = #llvm.target_features<["+cmov", "+cx8", "+fxsr", "+mmx", "+sse", "+sse2", "+x87"]>, tune_cpu = "generic", unnamed_addr = 1 : i64, uwtable_kind = #llvm.uwtableKind<async>, visibility_ = 0 : i64}> ({
  ...
  ^bb3:  // pred: ^bb2
    ...
    %15 = "llvm.getelementptr"(%14, %12) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    %24 = "llvm.select"(%23, %16, %20) <{fastmathFlags = #llvm.fastmath<none>}> : (i1, i8, i8) -> i8
    %25 = "llvm.select"(%23, %20, %16) <{fastmathFlags = #llvm.fastmath<none>}> : (i1, i8, i8) -> i8
    ...
    %28 = "llvm.zext"(%24) : (i8) -> i32
    %29 = "llvm.zext"(%18) : (i8) -> i32
    %30 = "llvm.shl"(%29, %7) <{overflowFlags = 3 : i32}> : (i32, i32) -> i32
    %31 = "llvm.zext"(%25) : (i8) -> i32
    %32 = "llvm.shl"(%31, %8) <{overflowFlags = 3 : i32}> : (i32, i32) -> i32
    "llvm.br"(%30, %28, %32)[^bb4] : (i32, i32, i32) -> ()
  ^bb4(%33: i32, %34: i32, %35: i32):  // 3 preds: ^bb1, ^bb2, ^bb3
    %36 = "llvm.or"(%34, %33) <{isDisjoint}> : (i32, i32) -> i32
    %37 = "llvm.or"(%36, %35) <{isDisjoint}> : (i32, i32) -> i32
    "llvm.return"(%37) : (i32) -> ()
  }) : () -> ()
