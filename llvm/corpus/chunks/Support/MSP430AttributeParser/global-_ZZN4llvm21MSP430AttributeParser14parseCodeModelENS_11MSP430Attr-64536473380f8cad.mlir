"builtin.module"() ({
  ...
  "llvm.mlir.global"() <{addr_space = 0 : i32, alignment = 16 : i64, constant, dso_local, global_type = !llvm.array<3 x ptr>, linkage = #llvm.linkage<external>, sym_name = "_ZZN4llvm21MSP430AttributeParser14parseCodeModelENS_11MSP430Attrs8AttrTypeEE10StringVals", tls_mode = 0 : i64, unnamed_addr = 0 : i64, visibility_ = 1 : i64}> ({
