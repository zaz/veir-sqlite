"builtin.module"() ({
  ...
  "llvm.mlir.global"() <{addr_space = 0 : i32, alignment = 16 : i64, constant, dso_local, global_type = !llvm.array<3 x ptr>, linkage = #llvm.linkage<external>, sym_name = "_ZZN4llvm18ARMAttributeParser13ABI_WMMX_argsENS_13ARMBuildAttrs8AttrTypeEE7strings", tls_mode = 0 : i64, unnamed_addr = 0 : i64, visibility_ = 1 : i64}> ({
    %0 = "llvm.mlir.addressof"() <{global_name = @".str.93"}> : () -> !llvm.ptr
    %1 = "llvm.mlir.addressof"() <{global_name = @".str.95"}> : () -> !llvm.ptr
    %2 = "llvm.mlir.addressof"() <{global_name = @".str.91"}> : () -> !llvm.ptr
