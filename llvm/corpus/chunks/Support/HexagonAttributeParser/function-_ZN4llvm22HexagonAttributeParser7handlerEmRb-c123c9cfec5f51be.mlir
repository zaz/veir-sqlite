"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr, %arg1: !llvm.ptr, %arg2: i64, %arg3: !llvm.ptr):
    ...
    %3 = "llvm.mlir.addressof"() <{global_name = @switch.table._ZN4llvm22HexagonAttributeParser7handlerEmRb}> : () -> !llvm.ptr
    ...
    %11 = "llvm.add"(%arg2, %1) <{overflowFlags = 0 : i32}> : (i64, i64) -> i64
    %12 = "llvm.icmp"(%11, %2) <{predicate = 6 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%12)[^bb1, ^bb6] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb1:  // pred: ^bb0
    %13 = "llvm.getelementptr"(%3, %4, %11) <{elem_type = !llvm.array<7 x ptr>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, -2147483648>}> : (!llvm.ptr, i64, i64) -> !llvm.ptr
    ...
    %20 = "llvm.and"(%16, %7) : (i64, i64) -> i64
    %21 = "llvm.icmp"(%20, %4) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%21)[^bb3, ^bb2] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb2:  // pred: ^bb1
    %22 = "llvm.load"(%19) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "vtable pointer", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, access_type = <id = "vtable pointer", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, offset = 0>]}> : (!llvm.ptr) -> !llvm.ptr
    %23 = "llvm.getelementptr"(%22, %16) <{elem_type = i8, noWrapFlags = 0 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %24 = "llvm.getelementptr"(%23, %8) <{elem_type = i8, noWrapFlags = 0 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %25 = "llvm.load"(%24) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
    "llvm.br"(%25)[^bb4] : (!llvm.ptr) -> ()
  ^bb3:  // pred: ^bb1
    %26 = "llvm.inttoptr"(%16) : (i64) -> !llvm.ptr
    "llvm.br"(%26)[^bb4] : (!llvm.ptr) -> ()
  ^bb4(%27: !llvm.ptr):  // 2 preds: ^bb2, ^bb3
    %28 = "llvm.trunc"(%arg2) <{overflowFlags = 2 : i32}> : (i64) -> i32
    "llvm.call"(%27, %arg0, %19, %28) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<tail>, arg_attrs = [{llvm.align = 8 : i64, llvm.dead_on_unwind, llvm.sret = !llvm.struct<"class.llvm::Error", (ptr)>, llvm.writable}, {llvm.align = 8 : i64, llvm.dereferenceable = 136 : i64, llvm.nonnull, llvm.noundef}, {llvm.noundef}], fastmathFlags = #llvm.fastmath<none>, no_unwind, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 4, 0>}> : (!llvm.ptr, !llvm.ptr, !llvm.ptr, i32) -> ()
