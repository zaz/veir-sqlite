"builtin.module"() ({
  "llvm.comdat"() <{sym_name = "__llvm_global_comdat"}> ({
    "llvm.comdat_selector"() <{comdat = 0 : i64, sym_name = "_ZN4llvm22PrettyStackTraceFormatD0Ev"}> : () -> ()
  }) : () -> ()
  ...
  ^bb2:  // 2 preds: ^bb0, ^bb1
    ...
    %18 = "llvm.intr.threadlocal.address"(%7) : (!llvm.ptr) -> !llvm.ptr
    "llvm.store"(%17, %18) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "any pointer", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, access_type = <id = "any pointer", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (!llvm.ptr, !llvm.ptr) -> ()
    %19 = "llvm.load"(%8) <{alignment = 4 : i64, ordering = 2 : i64, volatile_}> : (!llvm.ptr) -> i32
    %20 = "llvm.intr.threadlocal.address"(%9) : (!llvm.ptr) -> !llvm.ptr
    ...
    %23 = "llvm.icmp"(%21, %19) <{predicate = 0 : i64}> : (i32, i32) -> i1
    %24 = "llvm.or"(%22, %23) : (i1, i1) -> i1
    "llvm.cond_br"(%24)[^bb4, ^bb3] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb3:  // pred: ^bb2
    %25 = "llvm.call"() <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<tail>, callee = @_ZN4llvm4errsEv, fastmathFlags = #llvm.fastmath<none>, no_unwind, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 0, 0>, res_attrs = [{llvm.align = 8 : i64, llvm.dereferenceable = 96 : i64, llvm.nonnull, llvm.noundef}]}> : () -> !llvm.ptr
