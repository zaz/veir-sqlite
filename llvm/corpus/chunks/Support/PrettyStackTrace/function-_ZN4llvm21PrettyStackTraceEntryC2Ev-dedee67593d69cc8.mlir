"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr):
    ...
    %3 = "llvm.mlir.addressof"() <{global_name = @_ZL30GlobalSigInfoGenerationCounter}> : () -> !llvm.ptr
    %4 = "llvm.mlir.addressof"() <{global_name = @_ZL35ThreadLocalSigInfoGenerationCounter}> : () -> !llvm.ptr
    %5 = "llvm.mlir.constant"() <{value = 0 : i32}> : () -> i32
    %6 = "llvm.mlir.addressof"() <{global_name = @_ZL20PrettyStackTraceHead}> : () -> !llvm.ptr
    ...
    %8 = "llvm.load"(%3) <{alignment = 4 : i64, ordering = 2 : i64, volatile_}> : (!llvm.ptr) -> i32
    %9 = "llvm.intr.threadlocal.address"(%4) : (!llvm.ptr) -> !llvm.ptr
    ...
    %12 = "llvm.icmp"(%10, %8) <{predicate = 0 : i64}> : (i32, i32) -> i1
    %13 = "llvm.or"(%11, %12) : (i1, i1) -> i1
    "llvm.cond_br"(%13)[^bb2, ^bb1] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb1:  // pred: ^bb0
    %14 = "llvm.call"() <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<tail>, callee = @_ZN4llvm4errsEv, fastmathFlags = #llvm.fastmath<none>, no_unwind, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 0, 0>, res_attrs = [{llvm.align = 8 : i64, llvm.dereferenceable = 96 : i64, llvm.nonnull, llvm.noundef}]}> : () -> !llvm.ptr
    ...
    "llvm.store"(%8, %9) <{alignment = 4 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, access_type = <id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (i32, !llvm.ptr) -> ()
    "llvm.br"()[^bb2] : () -> ()
  ^bb2:  // 2 preds: ^bb0, ^bb1
    %15 = "llvm.intr.threadlocal.address"(%6) : (!llvm.ptr) -> !llvm.ptr
