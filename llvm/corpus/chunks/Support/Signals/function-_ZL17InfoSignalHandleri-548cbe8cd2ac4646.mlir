"builtin.module"() ({
  "llvm.mlir.global"() <{addr_space = 0 : i32, alignment = 8 : i64, dso_local, global_type = !llvm.struct<"struct.std::atomic.106", (struct<"struct.std::__atomic_base.107", (ptr)>)>, linkage = #llvm.linkage<external>, sym_name = "_ZL18InfoSignalFunction", tls_mode = 0 : i64, unnamed_addr = 0 : i64, visibility_ = 1 : i64}> ({
  }) : () -> ()
