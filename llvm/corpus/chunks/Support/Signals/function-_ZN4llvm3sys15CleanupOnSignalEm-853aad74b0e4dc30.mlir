"builtin.module"() ({
  ...
  ^bb0(%arg0: i64):
    ...
    %13 = "llvm.trunc"(%arg0) <{overflowFlags = 0 : i32}> : (i64) -> i32
  ...
  ^bb1:  // pred: ^bb0
    ...
    %17 = "llvm.load"(%11) <{alignment = 8 : i64, ordering = 7 : i64}> : (!llvm.ptr) -> i64
    %18 = "llvm.icmp"(%17, %3) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%18)[^bb3, ^bb2] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb2:  // pred: ^bb1
    %19 = "llvm.inttoptr"(%17) : (i64) -> !llvm.ptr
    "llvm.call"(%19) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<tail>, fastmathFlags = #llvm.fastmath<none>, no_unwind, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 1, 0>}> : (!llvm.ptr) -> ()
    "llvm.br"()[^bb3] : () -> ()
  ^bb3:  // 2 preds: ^bb1, ^bb2
    "llvm.store"(%16, %15) <{alignment = 4 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, access_type = <id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (i32, !llvm.ptr) -> ()
    "llvm.br"()[^bb16] : () -> ()
  ^bb4:  // pred: ^bb0
    %20 = "llvm.atomicrmw"(%2, %3) <{alignment = 8 : i64, bin_op = 0 : i64, ordering = 7 : i64}> : (!llvm.ptr, i64) -> i64
    %21 = "llvm.icmp"(%20, %3) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%21)[^bb14, ^bb5] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb5:  // pred: ^bb4
    %22 = "llvm.getelementptr"(%12, %4) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    "llvm.br"(%20)[^bb6] : (i64) -> ()
  ^bb6(%23: i64):  // 2 preds: ^bb5, ^bb13
    %24 = "llvm.inttoptr"(%23) : (i64) -> !llvm.ptr
    %25 = "llvm.atomicrmw"(%24, %6) <{alignment = 8 : i64, bin_op = 0 : i64, ordering = 7 : i64}> : (!llvm.ptr, i64) -> i64
    %26 = "llvm.inttoptr"(%25) : (i64) -> !llvm.ptr
    %27 = "llvm.icmp"(%25, %3) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%27)[^bb12, ^bb7] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb7:  // pred: ^bb6
    %28 = "llvm.icmp"(%26, %5) <{predicate = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> i1
    "llvm.cond_br"(%28)[^bb13, ^bb8] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb8:  // pred: ^bb7
    "llvm.intr.lifetime.start"(%12) : (!llvm.ptr) -> ()
    %29 = "llvm.call"(%26, %12) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<none>, arg_attrs = [{llvm.nonnull, llvm.noundef, llvm.readonly}, {llvm.nonnull, llvm.noundef}], callee = @stat, fastmathFlags = #llvm.fastmath<none>, no_unwind, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 2, 0>}> : (!llvm.ptr, !llvm.ptr) -> i32
    %30 = "llvm.icmp"(%29, %7) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%30)[^bb9, ^bb11] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb9:  // pred: ^bb8
  ...
  ^bb10:  // pred: ^bb9
    %34 = "llvm.call"(%26) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<tail>, arg_attrs = [{llvm.nonnull, llvm.noundef, llvm.readonly}], callee = @unlink, fastmathFlags = #llvm.fastmath<none>, no_unwind, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 1, 0>}> : (!llvm.ptr) -> i32
    "llvm.br"()[^bb11] : () -> ()
  ^bb11:  // 3 preds: ^bb8, ^bb9, ^bb10
    "llvm.intr.lifetime.end"(%12) : (!llvm.ptr) -> ()
    "llvm.br"()[^bb12] : () -> ()
  ^bb12:  // 2 preds: ^bb6, ^bb11
    %35 = "llvm.atomicrmw"(%24, %25) <{alignment = 8 : i64, bin_op = 0 : i64, ordering = 7 : i64}> : (!llvm.ptr, i64) -> i64
    "llvm.br"()[^bb13] : () -> ()
  ^bb13:  // 2 preds: ^bb7, ^bb12
    %36 = "llvm.getelementptr"(%24, %10) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %37 = "llvm.load"(%36) <{alignment = 8 : i64, ordering = 7 : i64}> : (!llvm.ptr) -> i64
    %38 = "llvm.icmp"(%37, %3) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%38, %37)[^bb14, ^bb6] <{loop_annotation = #llvm.loop_annotation<mustProgress = true>, operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i64) -> ()
  ^bb14:  // 2 preds: ^bb4, ^bb13
    %39 = "llvm.atomicrmw"(%2, %20) <{alignment = 8 : i64, bin_op = 0 : i64, ordering = 7 : i64}> : (!llvm.ptr, i64) -> i64
    "llvm.switch"(%13)[^bb15, ^bb16, ^bb16, ^bb16, ^bb16, ^bb16] <{case_operand_segments = array<i32: 0, 0, 0, 0, 0>, case_values = dense<[15, 13, 12, 2, 1]> : vector<5xi32>, operandSegmentSizes = array<i32: 1, 0, 0>}> : (i32) -> ()
  ^bb15:  // pred: ^bb14
    "llvm.call"() <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<tail>, callee = @_ZN4llvm3sys17RunSignalHandlersEv, fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 0, 0>}> : () -> ()
    "llvm.br"()[^bb16] : () -> ()
  ^bb16:  // 7 preds: ^bb3, ^bb14, ^bb14, ^bb14, ^bb14, ^bb14, ^bb15
    "llvm.return"() : () -> ()
  }) : () -> ()
