"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr, %arg1: !llvm.ptr):
    ...
    %6 = "llvm.icmp"(%5, %arg1) <{predicate = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> i1
    "llvm.cond_br"(%6, %0)[^bb5, ^bb1] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i8) -> ()
  ^bb1:  // pred: ^bb0
    %7 = "llvm.ptrtoint"(%arg1) : (!llvm.ptr) -> i64
    "llvm.br"(%5)[^bb2] : (!llvm.ptr) -> ()
  ^bb2(%8: !llvm.ptr):  // 2 preds: ^bb1, ^bb4
    %9 = "llvm.load"(%8) <{alignment = 1 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, access_type = <id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, offset = 0>]}> : (!llvm.ptr) -> i8
    %10 = "llvm.zext"(%9) : (i8) -> i64
    %11 = "llvm.getelementptr"(%1, %2, %10) <{elem_type = !llvm.array<256 x i8>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, -2147483648>}> : (!llvm.ptr, i64, i64) -> !llvm.ptr
    ...
    %16 = "llvm.ptrtoint"(%8) : (!llvm.ptr) -> i64
    %17 = "llvm.sub"(%7, %16) <{overflowFlags = 0 : i32}> : (i64, i64) -> i64
    %18 = "llvm.icmp"(%17, %15) <{predicate = 2 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%18, %4)[^bb5, ^bb3] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i8) -> ()
  ^bb3:  // pred: ^bb2
    %19 = "llvm.call"(%8, %14) <{CConv = #llvm.cconv<fastcc>, TailCallKind = #llvm.tailcallkind<tail>, arg_attrs = [{llvm.nonnull, llvm.noundef}, {llvm.noundef}], callee = @_ZN4llvmL11isLegalUTF8EPKhi, fastmathFlags = #llvm.fastmath<none>, memory_effects = #llvm.memory_effects<other = read, argMem = read, inaccessibleMem = none, errnoMem = read, targetMem0 = none, targetMem1 = none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 2, 0>, res_attrs = [{llvm.noundef, llvm.zeroext}]}> : (!llvm.ptr, i32) -> i8
    %20 = "llvm.icmp"(%19, %4) <{predicate = 0 : i64}> : (i8, i8) -> i1
    "llvm.cond_br"(%20, %4)[^bb5, ^bb4] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i8) -> ()
  ^bb4:  // pred: ^bb3
    %21 = "llvm.getelementptr"(%8, %15) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    "llvm.store"(%21, %arg0) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "any pointer", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, access_type = <id = "any pointer", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (!llvm.ptr, !llvm.ptr) -> ()
    %22 = "llvm.icmp"(%21, %arg1) <{predicate = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> i1
    "llvm.cond_br"(%22, %0, %21)[^bb5, ^bb2] <{operandSegmentSizes = array<i32: 1, 1, 1>}> : (i1, i8, !llvm.ptr) -> ()
  ^bb5(%23: i8):  // 4 preds: ^bb0, ^bb2, ^bb3, ^bb4
    "llvm.return"(%23) : (i8) -> ()
  }) : () -> ()
