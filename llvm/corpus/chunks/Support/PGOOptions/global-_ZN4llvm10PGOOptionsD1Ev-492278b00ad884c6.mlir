"builtin.module"() ({
  ...
  ^bb2:  // pred: ^bb0
    ...
    %20 = "llvm.add"(%19, %2) <{overflowFlags = 0 : i32}> : (i64, i64) -> i64
  ...
  ^bb4:  // pred: ^bb3
    ...
    %27 = "llvm.icmp"(%26, %4) <{predicate = 6 : i64}> : (i64, i64) -> i1
  ...
  ^bb5:  // pred: ^bb3
    ...
    %29 = "llvm.add"(%28, %2) <{overflowFlags = 0 : i32}> : (i64, i64) -> i64
  ...
  ^bb10:  // pred: ^bb9
    ...
    %44 = "llvm.icmp"(%43, %4) <{predicate = 6 : i64}> : (i64, i64) -> i1
  ...
  ^bb11:  // pred: ^bb9
    ...
    %46 = "llvm.add"(%45, %2) <{overflowFlags = 0 : i32}> : (i64, i64) -> i64
