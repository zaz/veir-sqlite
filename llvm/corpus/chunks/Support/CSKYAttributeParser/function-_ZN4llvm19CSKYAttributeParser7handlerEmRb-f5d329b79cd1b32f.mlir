"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr, %arg1: !llvm.ptr, %arg2: i64, %arg3: !llvm.ptr):
    ...
    %3 = "llvm.mlir.constant"() <{value = 520255 : i32}> : () -> i32
    %4 = "llvm.mlir.addressof"() <{global_name = @switch.table._ZN4llvm19CSKYAttributeParser7handlerEmRb}> : () -> !llvm.ptr
  ...
  ^bb1:  // pred: ^bb0
    %14 = "llvm.trunc"(%12) <{overflowFlags = 2 : i32}> : (i64) -> i32
    %15 = "llvm.lshr"(%3, %14) : (i32, i32) -> i32
    %16 = "llvm.trunc"(%15) <{overflowFlags = 0 : i32}> : (i32) -> i1
    "llvm.cond_br"(%16)[^bb2, ^bb7] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb2:  // pred: ^bb1
    %17 = "llvm.getelementptr"(%4, %5, %12) <{elem_type = !llvm.array<19 x ptr>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, -2147483648>}> : (!llvm.ptr, i64, i64) -> !llvm.ptr
