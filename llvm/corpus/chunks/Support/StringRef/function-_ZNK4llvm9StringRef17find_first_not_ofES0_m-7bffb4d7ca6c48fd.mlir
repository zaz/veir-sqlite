"builtin.module"() ({
  ...
  ^bb7(%50: i64):  // 2 preds: ^bb5, ^bb8
    ...
    "llvm.cond_br"(%60, %50)[^bb9, ^bb8] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i64) -> ()
  ^bb8:  // pred: ^bb7
