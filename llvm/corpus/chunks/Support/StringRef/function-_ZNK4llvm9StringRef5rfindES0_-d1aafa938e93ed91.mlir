"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr, %arg1: !llvm.ptr, %arg2: i64):
    ...
    %7 = "llvm.icmp"(%6, %arg2) <{predicate = 6 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%7, %1)[^bb4, ^bb1] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i64) -> ()
  ^bb1:  // pred: ^bb0
    %8 = "llvm.sub"(%6, %arg2) <{overflowFlags = 0 : i32}> : (i64, i64) -> i64
    %9 = "llvm.icmp"(%arg2, %2) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%9, %8, %8)[^bb4, ^bb2] <{operandSegmentSizes = array<i32: 1, 1, 1>}> : (i1, i64, i64) -> ()
  ^bb2(%10: i64):  // 2 preds: ^bb1, ^bb3
    %11 = "llvm.getelementptr"(%4, %10) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %12 = "llvm.call"(%11, %arg1, %arg2) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<tail>, callee = @bcmp, fastmathFlags = #llvm.fastmath<none>, memory_effects = #llvm.memory_effects<other = none, argMem = read, inaccessibleMem = none, errnoMem = none, targetMem0 = none, targetMem1 = none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 3, 0>}> : (!llvm.ptr, !llvm.ptr, i64) -> i32
    %13 = "llvm.icmp"(%12, %3) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%13, %10)[^bb4, ^bb3] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i64) -> ()
  ^bb3:  // pred: ^bb2
    %14 = "llvm.add"(%10, %1) <{overflowFlags = 0 : i32}> : (i64, i64) -> i64
    %15 = "llvm.icmp"(%10, %2) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%15, %1, %14)[^bb4, ^bb2] <{loop_annotation = #llvm.loop_annotation<mustProgress = true>, operandSegmentSizes = array<i32: 1, 1, 1>}> : (i1, i64, i64) -> ()
  ^bb4(%16: i64):  // 4 preds: ^bb0, ^bb1, ^bb2, ^bb3
    "llvm.return"(%16) : (i64) -> ()
  }) : () -> ()
