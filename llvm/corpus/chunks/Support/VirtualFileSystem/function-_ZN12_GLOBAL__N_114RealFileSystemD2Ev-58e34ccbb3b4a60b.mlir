"builtin.module"() ({
  "llvm.mlir.global"() <{addr_space = 0 : i32, alignment = 8 : i64, constant, dso_local, global_type = !llvm.struct<(array<19 x ptr>)>, linkage = #llvm.linkage<external>, sym_name = "_ZTVN12_GLOBAL__N_114RealFileSystemE", tls_mode = 0 : i64, unnamed_addr = 2 : i64, visibility_ = 1 : i64}> ({
  }) : () -> ()
  ...
  ^bb0(%arg0: !llvm.ptr):
    ...
    %1 = "llvm.mlir.addressof"() <{global_name = @_ZTVN12_GLOBAL__N_114RealFileSystemE}> : () -> !llvm.ptr
    %2 = "llvm.getelementptr"(%1, %0) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %3 = "llvm.mlir.constant"() <{value = 328 : i64}> : () -> i64
    %4 = "llvm.mlir.constant"() <{value = 0 : i8}> : () -> i8
    %5 = "llvm.mlir.constant"() <{value = 320 : i64}> : () -> i64
    %6 = "llvm.mlir.constant"() <{value = 168 : i64}> : () -> i64
    %7 = "llvm.mlir.constant"() <{value = 192 : i64}> : () -> i64
