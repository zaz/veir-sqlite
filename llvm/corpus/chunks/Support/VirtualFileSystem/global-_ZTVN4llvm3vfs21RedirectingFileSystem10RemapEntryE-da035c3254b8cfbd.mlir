"builtin.module"() ({
  "llvm.comdat"() <{sym_name = "__llvm_global_comdat"}> ({
    "llvm.comdat_selector"() <{comdat = 0 : i64, sym_name = "_ZTVN4llvm3vfs21RedirectingFileSystem10RemapEntryE"}> : () -> ()
  }) : () -> ()
  "llvm.mlir.global"() <{addr_space = 0 : i32, alignment = 8 : i64, comdat = @__llvm_global_comdat::@_ZTVN4llvm3vfs21RedirectingFileSystem10RemapEntryE, constant, global_type = !llvm.struct<(array<4 x ptr>)>, linkage = #llvm.linkage<weak_odr>, sym_name = "_ZTVN4llvm3vfs21RedirectingFileSystem10RemapEntryE", tls_mode = 0 : i64, unnamed_addr = 2 : i64, visibility_ = 0 : i64}> ({
    %0 = "llvm.mlir.addressof"() <{global_name = @_ZN4llvm3vfs21RedirectingFileSystem10RemapEntryD0Ev}> : () -> !llvm.ptr
