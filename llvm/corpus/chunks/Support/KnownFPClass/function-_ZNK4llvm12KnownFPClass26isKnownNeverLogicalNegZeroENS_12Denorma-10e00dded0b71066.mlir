"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr, %arg1: i16):
    ...
    "llvm.cond_br"(%10, %2)[^bb1, ^bb3] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i1) -> ()
  ^bb1:  // pred: ^bb0
    %11 = "llvm.and"(%8, %3) : (i32, i32) -> i32
    %12 = "llvm.icmp"(%11, %1) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%12, %4)[^bb3, ^bb2] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i1) -> ()
  ^bb2:  // pred: ^bb1
    %13 = "llvm.icmp"(%arg1, %5) <{predicate = 6 : i64}> : (i16, i16) -> i1
    %14 = "llvm.and"(%arg1, %6) : (i16, i16) -> i16
    %15 = "llvm.icmp"(%14, %7) <{predicate = 0 : i64}> : (i16, i16) -> i1
