"builtin.module"() ({
  "llvm.mlir.global"() <{addr_space = 0 : i32, alignment = 1 : i64, constant, dso_local, global_type = !llvm.array<4 x i8>, linkage = #llvm.linkage<external>, sym_name = ".str.7", tls_mode = 0 : i64, unnamed_addr = 2 : i64, visibility_ = 1 : i64}> ({
  }) : () -> ()
  ...
  "llvm.mlir.global"() <{addr_space = 0 : i32, alignment = 1 : i64, constant, dso_local, global_type = !llvm.array<9 x i8>, linkage = #llvm.linkage<external>, sym_name = ".str.9", tls_mode = 0 : i64, unnamed_addr = 2 : i64, visibility_ = 1 : i64}> ({
  }) : () -> ()
  ...
  "llvm.mlir.global"() <{addr_space = 0 : i32, alignment = 16 : i64, constant, dso_local, global_type = !llvm.array<4 x struct<"class.llvm::StringRef", (ptr, i64)>>, linkage = #llvm.linkage<external>, sym_name = "__const._ZN4llvm15SpecialCaseList5parseEjPKNS_12MemoryBufferERNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE.PathPrefixes", tls_mode = 0 : i64, unnamed_addr = 2 : i64, visibility_ = 1 : i64}> ({
    %0 = "llvm.mlir.constant"() <{value = 6 : i64}> : () -> i64
    %1 = "llvm.mlir.addressof"() <{global_name = @".str.10"}> : () -> !llvm.ptr
    ...
    %6 = "llvm.mlir.addressof"() <{global_name = @".str.9"}> : () -> !llvm.ptr
    ...
    %16 = "llvm.mlir.addressof"() <{global_name = @".str.7"}> : () -> !llvm.ptr
    ...
    %20 = "llvm.mlir.undef"() : () -> !llvm.array<4 x struct<"class.llvm::StringRef", (ptr, i64)>>
    %21 = "llvm.insertvalue"(%20, %19) <{position = array<i64: 0>}> : (!llvm.array<4 x struct<"class.llvm::StringRef", (ptr, i64)>>, !llvm.struct<"class.llvm::StringRef", (ptr, i64)>) -> !llvm.array<4 x struct<"class.llvm::StringRef", (ptr, i64)>>
    %22 = "llvm.insertvalue"(%21, %14) <{position = array<i64: 1>}> : (!llvm.array<4 x struct<"class.llvm::StringRef", (ptr, i64)>>, !llvm.struct<"class.llvm::StringRef", (ptr, i64)>) -> !llvm.array<4 x struct<"class.llvm::StringRef", (ptr, i64)>>
    %23 = "llvm.insertvalue"(%22, %9) <{position = array<i64: 2>}> : (!llvm.array<4 x struct<"class.llvm::StringRef", (ptr, i64)>>, !llvm.struct<"class.llvm::StringRef", (ptr, i64)>) -> !llvm.array<4 x struct<"class.llvm::StringRef", (ptr, i64)>>
    %24 = "llvm.insertvalue"(%23, %4) <{position = array<i64: 3>}> : (!llvm.array<4 x struct<"class.llvm::StringRef", (ptr, i64)>>, !llvm.struct<"class.llvm::StringRef", (ptr, i64)>) -> !llvm.array<4 x struct<"class.llvm::StringRef", (ptr, i64)>>
    "llvm.return"(%24) : (!llvm.array<4 x struct<"class.llvm::StringRef", (ptr, i64)>>) -> ()
  }) : () -> ()
