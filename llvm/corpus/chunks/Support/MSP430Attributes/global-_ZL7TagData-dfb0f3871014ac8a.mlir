"builtin.module"() ({
  "llvm.mlir.global"() <{addr_space = 0 : i32, alignment = 16 : i64, constant, dso_local, global_type = !llvm.array<4 x struct<"struct.llvm::TagNameItem", (i32, struct<"class.llvm::StringRef", (ptr, i64)>)>>, linkage = #llvm.linkage<external>, sym_name = "_ZL7TagData", tls_mode = 0 : i64, unnamed_addr = 0 : i64, visibility_ = 1 : i64}> ({
    %0 = "llvm.mlir.constant"() <{value = 13 : i64}> : () -> i64
    %1 = "llvm.mlir.addressof"() <{global_name = @".str.3"}> : () -> !llvm.ptr
    ...
    %10 = "llvm.mlir.addressof"() <{global_name = @".str.2"}> : () -> !llvm.ptr
    ...
    %21 = "llvm.insertvalue"(%20, %9) <{position = array<i64: 1>}> : (!llvm.struct<"class.llvm::StringRef", (ptr, i64)>, i64) -> !llvm.struct<"class.llvm::StringRef", (ptr, i64)>
    ...
    %27 = "llvm.mlir.addressof"() <{global_name = @".str"}> : () -> !llvm.ptr
    ...
    %35 = "llvm.mlir.undef"() : () -> !llvm.array<4 x struct<"struct.llvm::TagNameItem", (i32, struct<"class.llvm::StringRef", (ptr, i64)>)>>
    %36 = "llvm.insertvalue"(%35, %34) <{position = array<i64: 0>}> : (!llvm.array<4 x struct<"struct.llvm::TagNameItem", (i32, struct<"class.llvm::StringRef", (ptr, i64)>)>>, !llvm.struct<"struct.llvm::TagNameItem", (i32, struct<"class.llvm::StringRef", (ptr, i64)>)>) -> !llvm.array<4 x struct<"struct.llvm::TagNameItem", (i32, struct<"class.llvm::StringRef", (ptr, i64)>)>>
    %37 = "llvm.insertvalue"(%36, %25) <{position = array<i64: 1>}> : (!llvm.array<4 x struct<"struct.llvm::TagNameItem", (i32, struct<"class.llvm::StringRef", (ptr, i64)>)>>, !llvm.struct<"struct.llvm::TagNameItem", (i32, struct<"class.llvm::StringRef", (ptr, i64)>)>) -> !llvm.array<4 x struct<"struct.llvm::TagNameItem", (i32, struct<"class.llvm::StringRef", (ptr, i64)>)>>
    %38 = "llvm.insertvalue"(%37, %17) <{position = array<i64: 2>}> : (!llvm.array<4 x struct<"struct.llvm::TagNameItem", (i32, struct<"class.llvm::StringRef", (ptr, i64)>)>>, !llvm.struct<"struct.llvm::TagNameItem", (i32, struct<"class.llvm::StringRef", (ptr, i64)>)>) -> !llvm.array<4 x struct<"struct.llvm::TagNameItem", (i32, struct<"class.llvm::StringRef", (ptr, i64)>)>>
    %39 = "llvm.insertvalue"(%38, %8) <{position = array<i64: 3>}> : (!llvm.array<4 x struct<"struct.llvm::TagNameItem", (i32, struct<"class.llvm::StringRef", (ptr, i64)>)>>, !llvm.struct<"struct.llvm::TagNameItem", (i32, struct<"class.llvm::StringRef", (ptr, i64)>)>) -> !llvm.array<4 x struct<"struct.llvm::TagNameItem", (i32, struct<"class.llvm::StringRef", (ptr, i64)>)>>
    "llvm.return"(%39) : (!llvm.array<4 x struct<"struct.llvm::TagNameItem", (i32, struct<"class.llvm::StringRef", (ptr, i64)>)>>) -> ()
  }) : () -> ()
