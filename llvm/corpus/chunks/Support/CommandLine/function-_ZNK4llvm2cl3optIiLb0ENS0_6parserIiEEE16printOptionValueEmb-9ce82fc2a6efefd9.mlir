"builtin.module"() ({
  "llvm.comdat"() <{sym_name = "__llvm_global_comdat"}> ({
    "llvm.comdat_selector"() <{comdat = 0 : i64, sym_name = "_ZNK4llvm2cl3optIiLb0ENS0_6parserIiEEE16printOptionValueEmb"}> : () -> ()
  }) : () -> ()
  ...
  "llvm.func"() <{CConv = #llvm.cconv<ccc>, alignment = 2 : i64, arg_attrs = [{llvm.align = 8 : i64, llvm.dereferenceable = 184 : i64, llvm.nonnull, llvm.noundef}, {llvm.noundef}, {llvm.noundef, llvm.zeroext}], comdat = @__llvm_global_comdat::@_ZNK4llvm2cl3optIiLb0ENS0_6parserIiEEE16printOptionValueEmb, function_type = !llvm.func<void (ptr, i64, i1)>, linkage = #llvm.linkage<weak_odr>, no_unwind, passthrough = ["mustprogress", ["min-legal-vector-width", "0"], ["no-trapping-math", "true"], ["stack-protector-buffer-size", "8"], ["target-cpu", "x86-64"]], sym_name = "_ZNK4llvm2cl3optIiLb0ENS0_6parserIiEEE16printOptionValueEmb", target_cpu = "x86-64", target_features = #llvm.target_features<["+cmov", "+cx8", "+fxsr", "+mmx", "+sse", "+sse2", "+x87"]>, tune_cpu = "generic", unnamed_addr = 2 : i64, uwtable_kind = #llvm.uwtableKind<async>, visibility_ = 0 : i64}> ({
  ^bb0(%arg0: !llvm.ptr, %arg1: i64, %arg2: i1):
    ...
    %8 = "llvm.mlir.addressof"() <{global_name = @_ZTVN4llvm2cl11OptionValueIiEE}> : () -> !llvm.ptr
    ...
    %11 = "llvm.alloca"(%0) <{alignment = 8 : i64, elem_type = !llvm.struct<"struct.llvm::cl::OptionValue.39", (struct<"struct.llvm::cl::OptionValueBase.base.43", (struct<"class.llvm::cl::OptionValueCopy.base.42", packed (struct<"struct.llvm::cl::GenericOptionValue", (ptr)>, i32, i8)>)>, array<3 x i8>)>}> : (i32) -> !llvm.ptr
