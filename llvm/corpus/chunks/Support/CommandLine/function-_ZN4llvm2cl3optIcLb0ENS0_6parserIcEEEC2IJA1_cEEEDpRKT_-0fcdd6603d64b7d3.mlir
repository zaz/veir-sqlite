"builtin.module"() ({
  "llvm.comdat"() <{sym_name = "__llvm_global_comdat"}> ({
    "llvm.comdat_selector"() <{comdat = 0 : i64, sym_name = "_ZN4llvm2cl3optIcLb0ENS0_6parserIcEEEC2IJA1_cEEEDpRKT_"}> : () -> ()
  }) : () -> ()
  "llvm.mlir.global"() <{addr_space = 0 : i32, alignment = 8 : i64, constant, global_type = !llvm.struct<(array<6 x ptr>)>, linkage = #llvm.linkage<external>, sym_name = "_ZTVN4llvm2cl6parserIcEE", tls_mode = 0 : i64, unnamed_addr = 2 : i64, visibility_ = 0 : i64}> ({
  }) : () -> ()
  "llvm.mlir.global"() <{addr_space = 0 : i32, alignment = 8 : i64, constant, global_type = !llvm.struct<(array<13 x ptr>)>, linkage = #llvm.linkage<external>, sym_name = "_ZTVN4llvm2cl3optIcLb0ENS0_6parserIcEEEE", tls_mode = 0 : i64, unnamed_addr = 2 : i64, visibility_ = 0 : i64}> ({
  }) : () -> ()
  ...
  ^bb0(%arg0: !llvm.ptr, %arg1: !llvm.ptr):
    ...
    %8 = "llvm.mlir.addressof"() <{global_name = @_ZTVN4llvm2cl11OptionValueIcEE}> : () -> !llvm.ptr
    %9 = "llvm.getelementptr"(%8, %7) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %10 = "llvm.mlir.addressof"() <{global_name = @_ZTVN4llvm2cl3optIcLb0ENS0_6parserIcEEEE}> : () -> !llvm.ptr
    ...
    %13 = "llvm.mlir.addressof"() <{global_name = @_ZTVN4llvm2cl6parserIcEE}> : () -> !llvm.ptr
