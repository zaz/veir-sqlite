"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr, %arg1: !llvm.ptr, %arg2: i32):
    ...
    %8 = "llvm.icmp"(%arg2, %0) <{predicate = 6 : i64}> : (i32, i32) -> i1
  ...
  ^bb2:  // pred: ^bb0
    ...
    %13 = "llvm.icmp"(%12, %arg2) <{predicate = 0 : i64}> : (i32, i32) -> i1
  ...
  ^bb3:  // pred: ^bb2
    ...
    "llvm.store"(%arg2, %14) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "_ZTSN4llvm5APIntE", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>, <#llvm.tbaa_type_desc<id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, 8>}>, access_type = <id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 8>]}> : (i32, !llvm.ptr) -> ()
    ...
    "llvm.store"(%19, %arg0) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, access_type = <id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, offset = 0>]}> : (!llvm.ptr, !llvm.ptr) -> ()
    ...
    "llvm.intr.memcpy"(%19, %20, %18) <{arg_attrs = [{llvm.align = 8 : i64, llvm.nonnull}, {llvm.align = 8 : i64}, {}], isVolatile = false}> : (!llvm.ptr, !llvm.ptr, i64) -> ()
    "llvm.br"()[^bb5] : () -> ()
  ^bb4:  // pred: ^bb2
    %21 = "llvm.zext"(%arg2) : (i32) -> i64
    %22 = "llvm.add"(%21, %2) <{overflowFlags = 3 : i32}> : (i64, i64) -> i64
    %23 = "llvm.lshr"(%22, %3) : (i64, i64) -> i64
    %24 = "llvm.shl"(%23, %4) <{overflowFlags = 3 : i32}> : (i64, i64) -> i64
    ...
    %27 = "llvm.icmp"(%12, %0) <{predicate = 6 : i64}> : (i32, i32) -> i1
    ...
    %32 = "llvm.lshr"(%31, %3) : (i64, i64) -> i64
    %33 = "llvm.shl"(%32, %4) <{overflowFlags = 3 : i32}> : (i64, i64) -> i64
    "llvm.intr.memcpy"(%25, %29, %33) <{arg_attrs = [{llvm.align = 8 : i64, llvm.nonnull}, {llvm.align = 8 : i64}, {}], isVolatile = false}> : (!llvm.ptr, !llvm.ptr, i64) -> ()
    %34 = "llvm.getelementptr"(%25, %32) <{elem_type = i64, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %35 = "llvm.sub"(%23, %32) <{overflowFlags = 1 : i32}> : (i64, i64) -> i64
    %36 = "llvm.shl"(%35, %4) <{overflowFlags = 1 : i32}> : (i64, i64) -> i64
    %37 = "llvm.and"(%36, %5) : (i64, i64) -> i64
    "llvm.intr.memset"(%34, %6, %37) <{arg_attrs = [{llvm.align = 8 : i64, llvm.nonnull}, {}, {}], isVolatile = false}> : (!llvm.ptr, i8, i64) -> ()
    "llvm.br"()[^bb5] : () -> ()
