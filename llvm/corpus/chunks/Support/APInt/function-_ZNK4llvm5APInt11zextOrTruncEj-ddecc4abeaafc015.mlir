"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr, %arg1: !llvm.ptr, %arg2: i32):
    ...
    %10 = "llvm.icmp"(%9, %arg2) <{predicate = 6 : i64}> : (i32, i32) -> i1
  ...
  ^bb2:  // pred: ^bb1
    ...
    "llvm.store"(%arg2, %13) <{alias_scopes = [#llvm.alias_scope<id = distinct[0]<>, domain = <id = distinct[1]<>, description = "_ZNK4llvm5APInt4zextEj">, description = "_ZNK4llvm5APInt4zextEj: argument 0">], alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "_ZTSN4llvm5APIntE", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>, <#llvm.tbaa_type_desc<id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, 8>}>, access_type = <id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 8>]}> : (i32, !llvm.ptr) -> ()
    "llvm.store"(%12, %arg0) <{alias_scopes = [#llvm.alias_scope<id = distinct[0]<>, domain = <id = distinct[1]<>, description = "_ZNK4llvm5APInt4zextEj">, description = "_ZNK4llvm5APInt4zextEj: argument 0">], alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, access_type = <id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, offset = 0>]}> : (i64, !llvm.ptr) -> ()
    "llvm.br"()[^bb9] : () -> ()
  ^bb3:  // pred: ^bb1
    %14 = "llvm.zext"(%arg2) : (i32) -> i64
    %15 = "llvm.add"(%14, %2) <{overflowFlags = 3 : i32}> : (i64, i64) -> i64
    %16 = "llvm.lshr"(%15, %5) : (i64, i64) -> i64
    %17 = "llvm.shl"(%16, %3) <{overflowFlags = 3 : i32}> : (i64, i64) -> i64
    %18 = "llvm.call"(%17) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<tail>, allocsize = array<i32: 0>, arg_attrs = [{llvm.noundef}], builtin, callee = @_Znam, fastmathFlags = #llvm.fastmath<none>, no_unwind, noalias_scopes = [#llvm.alias_scope<id = distinct[0]<>, domain = <id = distinct[1]<>, description = "_ZNK4llvm5APInt4zextEj">, description = "_ZNK4llvm5APInt4zextEj: argument 0">], op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 1, 0>, res_attrs = [{llvm.noalias, llvm.nonnull, llvm.noundef}]}> : (i64) -> !llvm.ptr
    ...
    "llvm.store"(%arg2, %19) <{alias_scopes = [#llvm.alias_scope<id = distinct[0]<>, domain = <id = distinct[1]<>, description = "_ZNK4llvm5APInt4zextEj">, description = "_ZNK4llvm5APInt4zextEj: argument 0">], alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "_ZTSN4llvm5APIntE", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>, <#llvm.tbaa_type_desc<id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, 8>}>, access_type = <id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 8>]}> : (i32, !llvm.ptr) -> ()
    "llvm.store"(%18, %arg0) <{alias_scopes = [#llvm.alias_scope<id = distinct[0]<>, domain = <id = distinct[1]<>, description = "_ZNK4llvm5APInt4zextEj">, description = "_ZNK4llvm5APInt4zextEj: argument 0">], alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, access_type = <id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, offset = 0>]}> : (!llvm.ptr, !llvm.ptr) -> ()
    %20 = "llvm.icmp"(%9, %1) <{predicate = 6 : i64}> : (i32, i32) -> i1
    %21 = "llvm.load"(%arg1) <{alignment = 8 : i64, noalias_scopes = [#llvm.alias_scope<id = distinct[0]<>, domain = <id = distinct[1]<>, description = "_ZNK4llvm5APInt4zextEj">, description = "_ZNK4llvm5APInt4zextEj: argument 0">], ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
    %22 = "llvm.select"(%20, %arg1, %21) <{fastmathFlags = #llvm.fastmath<none>}> : (i1, !llvm.ptr, !llvm.ptr) -> !llvm.ptr
    %23 = "llvm.zext"(%9) : (i32) -> i64
    %24 = "llvm.add"(%23, %2) <{overflowFlags = 3 : i32}> : (i64, i64) -> i64
    %25 = "llvm.lshr"(%24, %5) : (i64, i64) -> i64
    %26 = "llvm.shl"(%25, %3) <{overflowFlags = 3 : i32}> : (i64, i64) -> i64
    "llvm.intr.memcpy"(%18, %22, %26) <{arg_attrs = [{llvm.align = 8 : i64, llvm.nonnull}, {llvm.align = 8 : i64}, {}], isVolatile = false, noalias_scopes = [#llvm.alias_scope<id = distinct[0]<>, domain = <id = distinct[1]<>, description = "_ZNK4llvm5APInt4zextEj">, description = "_ZNK4llvm5APInt4zextEj: argument 0">]}> : (!llvm.ptr, !llvm.ptr, i64) -> ()
    %27 = "llvm.getelementptr"(%18, %25) <{elem_type = i64, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %28 = "llvm.sub"(%16, %25) <{overflowFlags = 1 : i32}> : (i64, i64) -> i64
    %29 = "llvm.shl"(%28, %3) <{overflowFlags = 1 : i32}> : (i64, i64) -> i64
    %30 = "llvm.and"(%29, %6) : (i64, i64) -> i64
    "llvm.intr.memset"(%27, %7, %30) <{arg_attrs = [{llvm.align = 8 : i64, llvm.nonnull}, {}, {}], isVolatile = false, noalias_scopes = [#llvm.alias_scope<id = distinct[0]<>, domain = <id = distinct[1]<>, description = "_ZNK4llvm5APInt4zextEj">, description = "_ZNK4llvm5APInt4zextEj: argument 0">]}> : (!llvm.ptr, i8, i64) -> ()
    "llvm.br"()[^bb9] : () -> ()
  ^bb4:  // pred: ^bb0
    %31 = "llvm.icmp"(%9, %arg2) <{predicate = 8 : i64}> : (i32, i32) -> i1
  ...
  ^bb6:  // pred: ^bb4
    ...
    "llvm.store"(%9, %32) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "_ZTSN4llvm5APIntE", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>, <#llvm.tbaa_type_desc<id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, 8>}>, access_type = <id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 8>]}> : (i32, !llvm.ptr) -> ()
    %33 = "llvm.icmp"(%9, %1) <{predicate = 6 : i64}> : (i32, i32) -> i1
  ...
  ^bb7:  // pred: ^bb6
    ...
    "llvm.br"()[^bb9] : () -> ()
  ^bb8:  // pred: ^bb6
    %35 = "llvm.zext"(%9) : (i32) -> i64
    %36 = "llvm.add"(%35, %2) <{overflowFlags = 3 : i32}> : (i64, i64) -> i64
    %37 = "llvm.lshr"(%36, %3) : (i64, i64) -> i64
    %38 = "llvm.and"(%37, %4) : (i64, i64) -> i64
    ...
    "llvm.br"()[^bb9] : () -> ()
  ^bb9:  // 5 preds: ^bb2, ^bb3, ^bb5, ^bb7, ^bb8
    "llvm.return"() : () -> ()
  }) : () -> ()
