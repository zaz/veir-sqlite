"builtin.module"() ({
  ...
  ^bb2:  // pred: ^bb0
    ...
    %42 = "llvm.icmp"(%41, %8) <{predicate = 1 : i64}> : (i64, i64) -> i1
    %43 = "llvm.getelementptr"(%arg2, %1) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    %48 = "llvm.shl"(%5, %47) <{overflowFlags = 2 : i32}> : (i64, i64) -> i64
    %49 = "llvm.icmp"(%44, %6) <{predicate = 6 : i64}> : (i32, i32) -> i1
    %50 = "llvm.load"(%arg2) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
    %51 = "llvm.lshr"(%45, %7) : (i32, i32) -> i32
  ...
  ^bb3:  // pred: ^bb2
    ...
    "llvm.store"(%29, %59) <{alias_scopes = [#llvm.alias_scope<id = distinct[0]<>, domain = <id = distinct[1]<>, description = "_ZN4llvm5APInt17getSignedMinValueEj">, description = "_ZN4llvm5APInt17getSignedMinValueEj: argument 0">], alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "_ZTSN4llvm5APIntE", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>, <#llvm.tbaa_type_desc<id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, 8>}>, access_type = <id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 8>]}> : (i32, !llvm.ptr) -> ()
    "llvm.cond_br"(%34, %16)[^bb5, ^bb4] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, !llvm.ptr) -> ()
  ^bb4:  // pred: ^bb3
    %60 = "llvm.zext"(%29) : (i32) -> i64
    %61 = "llvm.add"(%60, %9) <{overflowFlags = 3 : i32}> : (i64, i64) -> i64
    %62 = "llvm.lshr"(%61, %11) : (i64, i64) -> i64
    %63 = "llvm.and"(%62, %17) : (i64, i64) -> i64
    ...
    "llvm.intr.memset"(%64, %18, %63) <{arg_attrs = [{llvm.align = 8 : i64, llvm.nonnull}, {}, {}], isVolatile = false, noalias_scopes = [#llvm.alias_scope<id = distinct[0]<>, domain = <id = distinct[1]<>, description = "_ZN4llvm5APInt17getSignedMinValueEj">, description = "_ZN4llvm5APInt17getSignedMinValueEj: argument 0">]}> : (!llvm.ptr, i8, i64) -> ()
  ...
  ^bb5(%65: !llvm.ptr):  // 2 preds: ^bb3, ^bb4
    "llvm.store"(%65, %arg0) <{alias_scopes = [#llvm.alias_scope<id = distinct[0]<>, domain = <id = distinct[1]<>, description = "_ZN4llvm5APInt17getSignedMinValueEj">, description = "_ZN4llvm5APInt17getSignedMinValueEj: argument 0">], alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> ()
    %66 = "llvm.getelementptr"(%65, %37) <{elem_type = i64, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %67 = "llvm.select"(%34, %arg0, %66) <{fastmathFlags = #llvm.fastmath<none>}> : (i1, !llvm.ptr, !llvm.ptr) -> !llvm.ptr
    ...
    %69 = "llvm.or"(%68, %33) : (i64, i64) -> i64
    "llvm.store"(%69, %67) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, access_type = <id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, offset = 0>]}> : (i64, !llvm.ptr) -> ()
    "llvm.br"()[^bb10] : () -> ()
  ^bb6:  // pred: ^bb2
  ...
  ^bb8:  // pred: ^bb6
    ...
    %87 = "llvm.add"(%29, %4) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
    %88 = "llvm.and"(%87, %4) : (i32, i32) -> i32
    %89 = "llvm.xor"(%88, %4) : (i32, i32) -> i32
    %90 = "llvm.zext"(%89) <{nonNeg}> : (i32) -> i64
    %91 = "llvm.lshr"(%12, %90) : (i64, i64) -> i64
    %92 = "llvm.add"(%81, %15) <{overflowFlags = 3 : i32}> : (i64, i64) -> i64
    %93 = "llvm.and"(%92, %15) : (i64, i64) -> i64
    ...
    %96 = "llvm.and"(%95, %91) : (i64, i64) -> i64
    "llvm.store"(%96, %94) <{alignment = 8 : i64, noalias_scopes = [#llvm.alias_scope<id = distinct[4]<>, domain = <id = distinct[5]<>, description = "_ZN4llvm5APInt10getAllOnesEj">, description = "_ZN4llvm5APInt10getAllOnesEj: argument 0">, #llvm.alias_scope<id = distinct[2]<>, domain = <id = distinct[3]<>, description = "_ZN4llvm5APInt17getSignedMaxValueEj">, description = "_ZN4llvm5APInt17getSignedMaxValueEj: argument 0">], ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, access_type = <id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, offset = 0>]}> : (i64, !llvm.ptr) -> ()
    "llvm.br"(%83)[^bb9] : (!llvm.ptr) -> ()
  ^bb9(%97: !llvm.ptr):  // 2 preds: ^bb7, ^bb8
    "llvm.store"(%97, %arg0) <{alias_scopes = [#llvm.alias_scope<id = distinct[4]<>, domain = <id = distinct[5]<>, description = "_ZN4llvm5APInt10getAllOnesEj">, description = "_ZN4llvm5APInt10getAllOnesEj: argument 0">, #llvm.alias_scope<id = distinct[2]<>, domain = <id = distinct[3]<>, description = "_ZN4llvm5APInt17getSignedMaxValueEj">, description = "_ZN4llvm5APInt17getSignedMaxValueEj: argument 0">], alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> ()
    %98 = "llvm.xor"(%33, %12) : (i64, i64) -> i64
    %99 = "llvm.getelementptr"(%97, %37) <{elem_type = i64, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %100 = "llvm.select"(%34, %arg0, %99) <{fastmathFlags = #llvm.fastmath<none>}> : (i1, !llvm.ptr, !llvm.ptr) -> !llvm.ptr
    ...
    %102 = "llvm.and"(%101, %98) : (i64, i64) -> i64
  ...
  ^bb10:  // 3 preds: ^bb1, ^bb5, ^bb9
    %103 = "llvm.getelementptr"(%21, %1) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %104 = "llvm.load"(%103) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "_ZTSN4llvm5APIntE", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>, <#llvm.tbaa_type_desc<id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, 8>}>, access_type = <id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 8>]}> : (!llvm.ptr) -> i32
    %105 = "llvm.icmp"(%104, %19) <{predicate = 8 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%105)[^bb11, ^bb13] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb11:  // pred: ^bb10
    ...
    "llvm.cond_br"(%107)[^bb13, ^bb12] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb12:  // pred: ^bb11
    "llvm.call"(%106) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<tail>, arg_attrs = [{llvm.nonnull, llvm.noundef}], builtin, callee = @_ZdaPv, fastmathFlags = #llvm.fastmath<none>, no_unwind, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 1, 0>}> : (!llvm.ptr) -> ()
    "llvm.br"()[^bb13] : () -> ()
