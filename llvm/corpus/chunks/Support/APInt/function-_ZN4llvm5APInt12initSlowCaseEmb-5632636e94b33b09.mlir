"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr, %arg1: i64, %arg2: i1):
    ...
    %14 = "llvm.icmp"(%arg1, %0) <{predicate = 2 : i64}> : (i64, i64) -> i1
    %15 = "llvm.and"(%14, %arg2) : (i1, i1) -> i1
  ...
  ^bb1:  // pred: ^bb0
    ...
    %21 = "llvm.shl"(%20, %3) <{overflowFlags = 3 : i32}> : (i64, i64) -> i64
    ...
    "llvm.store"(%22, %arg0) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, access_type = <id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, offset = 0>]}> : (!llvm.ptr, !llvm.ptr) -> ()
    ...
    %24 = "llvm.add"(%21, %7) <{overflowFlags = 3 : i32}> : (i64, i64) -> i64
    %25 = "llvm.and"(%24, %7) : (i64, i64) -> i64
    "llvm.intr.memset"(%23, %8, %25) <{arg_attrs = [{llvm.align = 8 : i64, llvm.nonnull}, {}, {}], isVolatile = false}> : (!llvm.ptr, i8, i64) -> ()
    %26 = "llvm.add"(%17, %9) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
    %27 = "llvm.and"(%26, %9) : (i32, i32) -> i32
    %28 = "llvm.xor"(%27, %9) : (i32, i32) -> i32
    %29 = "llvm.zext"(%28) <{nonNeg}> : (i32) -> i64
    %30 = "llvm.lshr"(%10, %29) : (i64, i64) -> i64
    %31 = "llvm.icmp"(%17, %11) <{predicate = 0 : i64}> : (i32, i32) -> i1
    %32 = "llvm.ptrtoint"(%22) : (!llvm.ptr) -> i64
    "llvm.cond_br"(%31, %32, %arg0, %0)[^bb4, ^bb2] <{branch_weights = array<i32: 1, 2000>, operandSegmentSizes = array<i32: 1, 3, 0>}> : (i1, i64, !llvm.ptr, i64) -> ()
  ^bb2:  // pred: ^bb1
    %33 = "llvm.icmp"(%17, %12) <{predicate = 6 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%33, %32, %arg0, %30)[^bb4, ^bb3] <{operandSegmentSizes = array<i32: 1, 3, 0>}> : (i1, i64, !llvm.ptr, i64) -> ()
  ^bb3:  // pred: ^bb2
    %34 = "llvm.add"(%20, %13) <{overflowFlags = 3 : i32}> : (i64, i64) -> i64
    %35 = "llvm.and"(%34, %13) : (i64, i64) -> i64
    %36 = "llvm.getelementptr"(%22, %35) <{elem_type = i64, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    "llvm.br"(%37, %36, %30)[^bb4] : (i64, !llvm.ptr, i64) -> ()
  ^bb4(%38: i64, %39: !llvm.ptr, %40: i64):  // 3 preds: ^bb1, ^bb2, ^bb3
    %41 = "llvm.and"(%38, %40) : (i64, i64) -> i64
    "llvm.store"(%41, %39) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, access_type = <id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, offset = 0>]}> : (i64, !llvm.ptr) -> ()
    "llvm.br"()[^bb6] : () -> ()
  ^bb5:  // pred: ^bb0
    %42 = "llvm.lshr"(%19, %3) : (i64, i64) -> i64
    %43 = "llvm.and"(%42, %4) : (i64, i64) -> i64
    %44 = "llvm.call"(%43) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<tail>, allocsize = array<i32: 0>, arg_attrs = [{llvm.noundef}], builtin, callee = @_Znam, fastmathFlags = #llvm.fastmath<none>, no_unwind, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 1, 0>, res_attrs = [{llvm.noalias, llvm.nonnull, llvm.noundef}]}> : (i64) -> !llvm.ptr
    "llvm.intr.memset"(%44, %5, %43) <{arg_attrs = [{llvm.align = 8 : i64, llvm.nonnull}, {}, {}], isVolatile = false}> : (!llvm.ptr, i8, i64) -> ()
    ...
    "llvm.store"(%arg1, %44) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "long", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, access_type = <id = "long", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (i64, !llvm.ptr) -> ()
    "llvm.br"()[^bb6] : () -> ()
  ^bb6:  // 2 preds: ^bb4, ^bb5
    "llvm.return"() : () -> ()
  }) : () -> ()
