"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr, %arg1: !llvm.ptr):
    ...
    %14 = "llvm.add"(%13, %1) <{overflowFlags = 3 : i32}> : (i64, i64) -> i64
    %15 = "llvm.lshr"(%14, %2) : (i64, i64) -> i64
    ...
    "llvm.cond_br"(%18, %4)[^bb3, ^bb2] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i32) -> ()
  ^bb1:  // pred: ^bb2
    %21 = "llvm.add"(%23, %7) <{overflowFlags = 2 : i32}> : (i32, i32) -> i32
    %22 = "llvm.icmp"(%21, %17) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%22, %21)[^bb3, ^bb2] <{loop_annotation = #llvm.loop_annotation<mustProgress = true>, operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i32) -> ()
  ^bb2(%23: i32):  // 2 preds: ^bb0, ^bb1
    ...
    %27 = "llvm.getelementptr"(%20, %24) <{elem_type = i64, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %28 = "llvm.load"(%27) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "long", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, access_type = <id = "long", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (!llvm.ptr) -> i64
    %29 = "llvm.xor"(%28, %26) : (i64, i64) -> i64
    %30 = "llvm.icmp"(%29, %5) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%30, %6)[^bb1, ^bb4] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i1) -> ()
  ^bb3:  // 2 preds: ^bb0, ^bb1
    %31 = "llvm.shl"(%17, %8) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
    %32 = "llvm.icmp"(%12, %31) <{predicate = 0 : i64}> : (i32, i32) -> i1
    %33 = "llvm.sub"(%31, %12) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
    %34 = "llvm.add"(%33, %9) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
    %35 = "llvm.zext"(%34) <{nonNeg}> : (i32) -> i64
    %36 = "llvm.lshr"(%5, %35) : (i64, i64) -> i64
    %37 = "llvm.select"(%32, %10, %36) <{fastmathFlags = #llvm.fastmath<none>}> : (i1, i64, i64) -> i64
    %38 = "llvm.zext"(%17) : (i32) -> i64
    %39 = "llvm.getelementptr"(%19, %38) <{elem_type = i64, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %40 = "llvm.load"(%39) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "long", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, access_type = <id = "long", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (!llvm.ptr) -> i64
    %41 = "llvm.getelementptr"(%20, %38) <{elem_type = i64, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %42 = "llvm.load"(%41) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "long", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, access_type = <id = "long", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (!llvm.ptr) -> i64
    %43 = "llvm.xor"(%42, %40) : (i64, i64) -> i64
    %44 = "llvm.icmp"(%43, %37) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.br"(%44)[^bb4] : (i1) -> ()
  ^bb4(%45: i1):  // 2 preds: ^bb2, ^bb3
    "llvm.return"(%45) : (i1) -> ()
  }) : () -> ()
