"builtin.module"() ({
  ...
  ^bb10:  // pred: ^bb9
    %51 = "llvm.icmp"(%13, %49) <{predicate = 0 : i64}> : (i32, i32) -> i1
    %52 = "llvm.load"(%arg0) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> i64
    %53 = "llvm.zext"(%49) <{nonNeg}> : (i32) -> i64
    %54 = "llvm.shl"(%52, %53) <{overflowFlags = 0 : i32}> : (i64, i64) -> i64
    %55 = "llvm.select"(%51, %7, %54) <{fastmathFlags = #llvm.fastmath<none>}> : (i1, i64, i64) -> i64
    %56 = "llvm.add"(%13, %10) <{overflowFlags = 3 : i32}> : (i32, i32) -> i32
    %57 = "llvm.and"(%56, %10) : (i32, i32) -> i32
    %58 = "llvm.xor"(%57, %10) : (i32, i32) -> i32
    %59 = "llvm.zext"(%58) <{nonNeg}> : (i32) -> i64
    %60 = "llvm.lshr"(%5, %59) : (i64, i64) -> i64
    %61 = "llvm.icmp"(%13, %4) <{predicate = 0 : i64}> : (i32, i32) -> i1
    %62 = "llvm.select"(%61, %7, %60) <{fastmathFlags = #llvm.fastmath<none>}> : (i1, i64, i64) -> i64
    %63 = "llvm.and"(%55, %62) : (i64, i64) -> i64
    "llvm.store"(%63, %arg0) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, access_type = <id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, offset = 0>]}> : (i64, !llvm.ptr) -> ()
    "llvm.br"()[^bb12] : () -> ()
  ^bb11:  // pred: ^bb9
