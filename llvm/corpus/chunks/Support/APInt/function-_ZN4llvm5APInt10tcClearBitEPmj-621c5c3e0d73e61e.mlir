"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr, %arg1: i32):
    ...
    %6 = "llvm.shl"(%1, %5) <{overflowFlags = 2 : i32}> : (i64, i64) -> i64
    %7 = "llvm.xor"(%6, %2) : (i64, i64) -> i64
    %8 = "llvm.lshr"(%arg1, %3) : (i32, i32) -> i32
    %9 = "llvm.zext"(%8) <{nonNeg}> : (i32) -> i64
    %10 = "llvm.getelementptr"(%arg0, %9) <{elem_type = i64, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %11 = "llvm.load"(%10) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "long", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, access_type = <id = "long", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (!llvm.ptr) -> i64
    %12 = "llvm.and"(%11, %7) : (i64, i64) -> i64
