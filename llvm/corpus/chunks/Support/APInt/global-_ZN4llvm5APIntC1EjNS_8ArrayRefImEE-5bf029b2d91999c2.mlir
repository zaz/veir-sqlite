"builtin.module"() ({
  "llvm.mlir.alias"() <{alias_type = !llvm.func<void (ptr, i32, ptr, i64)>, linkage = #llvm.linkage<external>, sym_name = "_ZN4llvm5APIntC1EjNS_8ArrayRefImEE", tls_mode = 0 : i64, unnamed_addr = 2 : i64, visibility_ = 0 : i64}> ({
    %45 = "llvm.mlir.addressof"() <{global_name = @_ZN4llvm5APIntC2EjNS_8ArrayRefImEE}> : () -> !llvm.ptr
