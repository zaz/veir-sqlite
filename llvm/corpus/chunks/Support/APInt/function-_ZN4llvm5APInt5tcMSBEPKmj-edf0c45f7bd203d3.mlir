"builtin.module"() ({
  ...
  ^bb1(%5: i32):  // 2 preds: ^bb0, ^bb3
    %6 = "llvm.add"(%5, %0) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
  ...
  ^bb2:  // pred: ^bb1
    ...
    %12 = "llvm.trunc"(%11) <{overflowFlags = 3 : i32}> : (i64) -> i32
    %13 = "llvm.shl"(%6, %2) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
    %14 = "llvm.or"(%13, %12) <{isDisjoint}> : (i32, i32) -> i32
    %15 = "llvm.xor"(%14, %3) : (i32, i32) -> i32
    "llvm.br"(%15)[^bb4] : (i32) -> ()
  ^bb3:  // pred: ^bb1
    %16 = "llvm.icmp"(%6, %4) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%16, %0, %6)[^bb4, ^bb1] <{loop_annotation = #llvm.loop_annotation<mustProgress = true>, operandSegmentSizes = array<i32: 1, 1, 1>}> : (i1, i32, i32) -> ()
