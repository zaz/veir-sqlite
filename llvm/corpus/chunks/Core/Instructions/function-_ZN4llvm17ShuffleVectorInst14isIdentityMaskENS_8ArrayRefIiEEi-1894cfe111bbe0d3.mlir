"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr, %arg1: i64, %arg2: i32):
    ...
    "llvm.cond_br"(%11, %0)[^bb1, ^bb9] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i1) -> ()
  ^bb1:  // pred: ^bb0
    ...
    "llvm.cond_br"(%13, %0, %2, %arg0, %2)[^bb9, ^bb2] <{operandSegmentSizes = array<i32: 1, 1, 3>}> : (i1, i1, i8, !llvm.ptr, i8) -> ()
  ...
  ^bb3:  // pred: ^bb2
    ...
    "llvm.cond_br"(%29, %27, %22, %0)[^bb4, ^bb9] <{operandSegmentSizes = array<i32: 1, 2, 1>}> : (i1, i8, i8, i1) -> ()
  ...
  ^bb5:  // pred: ^bb4
    ...
    "llvm.cond_br"(%36, %0)[^bb6, ^bb9] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i1) -> ()
  ^bb6:  // pred: ^bb5
    %37 = "llvm.trunc"(%arg1) <{overflowFlags = 0 : i32}> : (i64) -> i32
    %38 = "llvm.icmp"(%37, %7) <{predicate = 2 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%38, %5)[^bb9, ^bb7] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i1) -> ()
  ^bb7:  // pred: ^bb6
    %39 = "llvm.and"(%arg1, %8) : (i64, i64) -> i64
    "llvm.br"(%1)[^bb8] : (i64) -> ()
  ^bb8(%40: i64):  // 2 preds: ^bb7, ^bb8
    %41 = "llvm.getelementptr"(%arg0, %40) <{elem_type = i32, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    %45 = "llvm.icmp"(%40, %44) <{predicate = 0 : i64}> : (i64, i64) -> i1
    %46 = "llvm.or"(%43, %45) : (i1, i1) -> i1
    %47 = "llvm.trunc"(%40) <{overflowFlags = 0 : i32}> : (i64) -> i32
    %48 = "llvm.add"(%47, %arg2) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
    %49 = "llvm.icmp"(%42, %48) <{predicate = 0 : i64}> : (i32, i32) -> i1
    %50 = "llvm.or"(%49, %46) : (i1, i1) -> i1
    %51 = "llvm.add"(%40, %9) <{overflowFlags = 3 : i32}> : (i64, i64) -> i64
    %52 = "llvm.icmp"(%51, %39) <{predicate = 1 : i64}> : (i64, i64) -> i1
    %53 = "llvm.select"(%50, %52, %0) <{fastmathFlags = #llvm.fastmath<none>}> : (i1, i1, i1) -> i1
    "llvm.cond_br"(%53, %51, %50)[^bb8, ^bb9] <{loop_annotation = #llvm.loop_annotation<mustProgress = true>, operandSegmentSizes = array<i32: 1, 1, 1>}> : (i1, i64, i1) -> ()
  ^bb9(%54: i1):  // 6 preds: ^bb0, ^bb1, ^bb3, ^bb5, ^bb6, ^bb8
    "llvm.return"(%54) : (i1) -> ()
  }) : () -> ()
