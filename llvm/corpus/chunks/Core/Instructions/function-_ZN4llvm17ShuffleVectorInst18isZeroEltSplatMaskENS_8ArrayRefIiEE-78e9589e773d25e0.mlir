"builtin.module"() ({
  ...
  ^bb5:  // pred: ^bb4
    ...
    "llvm.cond_br"(%36, %0)[^bb6, ^bb12] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i1) -> ()
  ^bb6:  // pred: ^bb5
    %37 = "llvm.trunc"(%arg1) <{overflowFlags = 0 : i32}> : (i64) -> i32
    %38 = "llvm.icmp"(%37, %7) <{predicate = 2 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%38, %5)[^bb12, ^bb7] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i1) -> ()
  ^bb7:  // pred: ^bb6
    %39 = "llvm.and"(%arg1, %8) : (i64, i64) -> i64
    %40 = "llvm.and"(%arg1, %8) : (i64, i64) -> i64
    "llvm.br"(%1)[^bb8] : (i64) -> ()
  ^bb8(%41: i64):  // 2 preds: ^bb7, ^bb10
    %42 = "llvm.getelementptr"(%arg0, %41) <{elem_type = i32, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %43 = "llvm.load"(%42) <{alignment = 4 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, access_type = <id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (!llvm.ptr) -> i32
    "llvm.switch"(%43)[^bb9, ^bb10, ^bb10] <{case_operand_segments = array<i32: 0, 0>, case_values = dense<[-1, 0]> : vector<2xi32>, operandSegmentSizes = array<i32: 1, 0, 0>}> : (i32) -> ()
  ^bb9:  // pred: ^bb8
    %44 = "llvm.icmp"(%43, %arg2) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%44, %0)[^bb10, ^bb12] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i1) -> ()
  ^bb10:  // 3 preds: ^bb8, ^bb8, ^bb9
    %45 = "llvm.add"(%41, %9) <{overflowFlags = 3 : i32}> : (i64, i64) -> i64
    %46 = "llvm.icmp"(%45, %40) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%46, %45)[^bb11, ^bb8] <{loop_annotation = #llvm.loop_annotation<mustProgress = true>, operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i64) -> ()
  ^bb11:  // pred: ^bb10
    %47 = "llvm.icmp"(%45, %39) <{predicate = 9 : i64}> : (i64, i64) -> i1
    "llvm.br"(%47)[^bb12] : (i1) -> ()
  ^bb12(%48: i1):  // 7 preds: ^bb0, ^bb1, ^bb3, ^bb5, ^bb6, ^bb9, ^bb11
    "llvm.return"(%48) : (i1) -> ()
  }) : () -> ()
