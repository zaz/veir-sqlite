"builtin.module"() ({
  "llvm.comdat"() <{sym_name = "__llvm_global_comdat"}> ({
    "llvm.comdat_selector"() <{comdat = 0 : i64, sym_name = "_ZNK4llvm8CallBase8arg_sizeEv"}> : () -> ()
  }) : () -> ()
  "llvm.module_flags"() <{flags = [#llvm.mlir.module_flag<error, "wchar_size", 4 : i32>, #llvm.mlir.module_flag<min, "PIC Level", 2 : i32>, #llvm.mlir.module_flag<max, "uwtable", 2 : i32>]}> : () -> ()
  "llvm.func"() <{CConv = #llvm.cconv<ccc>, alignment = 2 : i64, arg_attrs = [{llvm.align = 8 : i64, llvm.dereferenceable = 88 : i64, llvm.nonnull, llvm.noundef}], comdat = @__llvm_global_comdat::@_ZNK4llvm8CallBase8arg_sizeEv, dso_local, function_type = !llvm.func<i32 (ptr)>, linkage = #llvm.linkage<weak_odr>, no_unwind, passthrough = ["mustprogress", ["min-legal-vector-width", "0"], ["no-trapping-math", "true"], ["stack-protector-buffer-size", "8"], ["target-cpu", "x86-64"]], res_attrs = [{llvm.noundef}], sym_name = "_ZNK4llvm8CallBase8arg_sizeEv", target_cpu = "x86-64", target_features = #llvm.target_features<["+cmov", "+cx8", "+fxsr", "+mmx", "+sse", "+sse2", "+x87"]>, tune_cpu = "generic", unnamed_addr = 1 : i64, uwtable_kind = #llvm.uwtableKind<async>, visibility_ = 1 : i64}> ({
  ^bb0(%arg0: !llvm.ptr):
    ...
    "llvm.switch"(%13, %0)[^bb3, ^bb4, ^bb1, ^bb2] <{case_operand_segments = array<i32: 1, 0, 0>, case_values = dense<[88, 36, 42]> : vector<3xi8>, operandSegmentSizes = array<i32: 1, 0, 1>}> : (i8, i64) -> ()
  ^bb1:  // pred: ^bb0
    "llvm.br"(%3)[^bb4] : (i64) -> ()
  ^bb2:  // pred: ^bb0
  ...
  ^bb3:  // pred: ^bb0
    "llvm.unreachable"() : () -> ()
  ^bb4(%18: i64):  // 3 preds: ^bb0, ^bb1, ^bb2
    ...
    %21 = "llvm.icmp"(%20, %5) <{predicate = 2 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%21, %20, %6, %0)[^bb5, ^bb7] <{operandSegmentSizes = array<i32: 1, 0, 3>}> : (i1, i32, !llvm.ptr, i64) -> ()
  ^bb5:  // pred: ^bb4
    ...
    %25 = "llvm.icmp"(%24, %5) <{predicate = 2 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%25, %24, %23, %0)[^bb6, ^bb7] <{operandSegmentSizes = array<i32: 1, 0, 3>}> : (i1, i32, !llvm.ptr, i64) -> ()
  ^bb6:  // pred: ^bb5
    %26 = "llvm.call"(%arg0) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<tail>, arg_attrs = [{llvm.align = 8 : i64, llvm.dereferenceable = 24 : i64, llvm.nonnull, llvm.noundef}], callee = @_ZN4llvm4User13getDescriptorEv, fastmathFlags = #llvm.fastmath<none>, no_unwind, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 1, 0>}> : (!llvm.ptr) -> !llvm.struct<(ptr, i64)>
    %27 = "llvm.extractvalue"(%26) <{position = array<i64: 0>}> : (!llvm.struct<(ptr, i64)>) -> !llvm.ptr
    %28 = "llvm.extractvalue"(%26) <{position = array<i64: 1>}> : (!llvm.struct<(ptr, i64)>) -> i64
    %29 = "llvm.getelementptr"(%27, %28) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %30 = "llvm.ptrtoint"(%29) : (!llvm.ptr) -> i64
    %31 = "llvm.load"(%19) <{alignment = 4 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> i32
    "llvm.br"(%31, %23, %30)[^bb7] : (i32, !llvm.ptr, i64) -> ()
  ^bb7(%32: i32, %33: !llvm.ptr, %34: i64):  // 3 preds: ^bb4, ^bb5, ^bb6
    ...
    "llvm.cond_br"(%38, %32, %0)[^bb9, ^bb8] <{operandSegmentSizes = array<i32: 1, 2, 0>}> : (i1, i32, i64) -> ()
  ^bb8:  // pred: ^bb7
    %39 = "llvm.icmp"(%32, %5) <{predicate = 2 : i64}> : (i32, i32) -> i1
    "llvm.intr.assume"(%39) <{op_bundle_sizes = array<i32>}> : (i1) -> ()
    %40 = "llvm.call"(%arg0) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<tail>, arg_attrs = [{llvm.align = 8 : i64, llvm.dereferenceable = 24 : i64, llvm.nonnull, llvm.noundef}], callee = @_ZN4llvm4User13getDescriptorEv, fastmathFlags = #llvm.fastmath<none>, no_unwind, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 1, 0>}> : (!llvm.ptr) -> !llvm.struct<(ptr, i64)>
    %41 = "llvm.extractvalue"(%40) <{position = array<i64: 0>}> : (!llvm.struct<(ptr, i64)>) -> !llvm.ptr
    ...
    %46 = "llvm.call"(%arg0) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<tail>, arg_attrs = [{llvm.align = 8 : i64, llvm.dereferenceable = 24 : i64, llvm.nonnull, llvm.noundef}], callee = @_ZN4llvm4User13getDescriptorEv, fastmathFlags = #llvm.fastmath<none>, no_unwind, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 1, 0>}> : (!llvm.ptr) -> !llvm.struct<(ptr, i64)>
    %47 = "llvm.extractvalue"(%46) <{position = array<i64: 0>}> : (!llvm.struct<(ptr, i64)>) -> !llvm.ptr
    %48 = "llvm.extractvalue"(%46) <{position = array<i64: 1>}> : (!llvm.struct<(ptr, i64)>) -> i64
    ...
    %52 = "llvm.sub"(%51, %43) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
    %53 = "llvm.zext"(%52) : (i32) -> i64
    %54 = "llvm.load"(%19) <{alignment = 4 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> i32
    "llvm.br"(%54, %53)[^bb9] : (i32, i64) -> ()
  ^bb9(%55: i32, %56: i64):  // 2 preds: ^bb7, ^bb8
    %57 = "llvm.sub"(%0, %18) <{overflowFlags = 1 : i32}> : (i64, i64) -> i64
    %58 = "llvm.getelementptr"(%arg0, %57) <{elem_type = !llvm.struct<"class.llvm::Use", (ptr, ptr, ptr, ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %59 = "llvm.getelementptr"(%58, %10) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %60 = "llvm.sub"(%0, %56) <{overflowFlags = 1 : i32}> : (i64, i64) -> i64
    %61 = "llvm.getelementptr"(%59, %60) <{elem_type = !llvm.struct<"class.llvm::Use", (ptr, ptr, ptr, ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %62 = "llvm.and"(%55, %11) : (i32, i32) -> i32
    %63 = "llvm.zext"(%62) <{nonNeg}> : (i32) -> i64
    %64 = "llvm.sub"(%0, %63) <{overflowFlags = 1 : i32}> : (i64, i64) -> i64
    %65 = "llvm.getelementptr"(%arg0, %64) <{elem_type = !llvm.struct<"class.llvm::Use", (ptr, ptr, ptr, ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %66 = "llvm.ptrtoint"(%61) : (!llvm.ptr) -> i64
    %67 = "llvm.ptrtoint"(%65) : (!llvm.ptr) -> i64
    %68 = "llvm.sub"(%66, %67) <{overflowFlags = 0 : i32}> : (i64, i64) -> i64
    %69 = "llvm.lshr"(%68, %12) <{isExact}> : (i64, i64) -> i64
