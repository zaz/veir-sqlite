"builtin.module"() ({
  ...
  "llvm.func"() <{CConv = #llvm.cconv<ccc>, alignment = 2 : i64, arg_attrs = [{llvm.align = 8 : i64, llvm.dereferenceable = 88 : i64, llvm.nonnull, llvm.noundef}], dso_local, function_type = !llvm.func<i32 (ptr)>, linkage = #llvm.linkage<external>, no_unwind, passthrough = ["mustprogress", ["min-legal-vector-width", "0"], ["no-trapping-math", "true"], ["stack-protector-buffer-size", "8"], ["target-cpu", "x86-64"]], res_attrs = [{llvm.noundef}], sym_name = "_ZNK4llvm8CallBase8arg_sizeEv", target_cpu = "x86-64", target_features = #llvm.target_features<["+cmov", "+cx8", "+fxsr", "+mmx", "+sse", "+sse2", "+x87"]>, tune_cpu = "generic", unnamed_addr = 1 : i64, uwtable_kind = #llvm.uwtableKind<async>, visibility_ = 1 : i64}> ({
  }) : () -> ()
  "llvm.func"() <{CConv = #llvm.cconv<ccc>, arg_attrs = [{llvm.align = 8 : i64, llvm.dereferenceable = 8 : i64, llvm.nonnull, llvm.noundef}], function_type = !llvm.func<i16 (ptr)>, linkage = #llvm.linkage<external>, passthrough = [["no-trapping-math", "true"], ["stack-protector-buffer-size", "8"], ["target-cpu", "x86-64"]], sym_name = "_ZNK4llvm12AttributeSet14getCaptureInfoEv", target_cpu = "x86-64", target_features = #llvm.target_features<["+cmov", "+cx8", "+fxsr", "+mmx", "+sse", "+sse2", "+x87"]>, tune_cpu = "generic", unnamed_addr = 1 : i64, visibility_ = 0 : i64}> ({
  }) : () -> ()
  ...
  "llvm.func"() <{CConv = #llvm.cconv<ccc>, alignment = 2 : i64, arg_attrs = [{llvm.align = 8 : i64, llvm.dereferenceable = 88 : i64, llvm.nonnull, llvm.noundef}], dso_local, function_type = !llvm.func<i1 (ptr)>, linkage = #llvm.linkage<external>, no_unwind, passthrough = ["mustprogress", ["min-legal-vector-width", "0"], ["no-trapping-math", "true"], ["stack-protector-buffer-size", "8"], ["target-cpu", "x86-64"]], res_attrs = [{llvm.noundef, llvm.zeroext}], sym_name = "_ZNK4llvm8CallBase48hasArgumentWithAdditionalReturnCaptureComponentsEv", target_cpu = "x86-64", target_features = #llvm.target_features<["+cmov", "+cx8", "+fxsr", "+mmx", "+sse", "+sse2", "+x87"]>, tune_cpu = "generic", unnamed_addr = 1 : i64, uwtable_kind = #llvm.uwtableKind<async>, visibility_ = 0 : i64}> ({
  ^bb0(%arg0: !llvm.ptr):
    ...
    %12 = "llvm.mlir.constant"() <{value = 14 : i8}> : () -> i8
    ...
    %18 = "llvm.alloca"(%0) <{alignment = 8 : i64, elem_type = !llvm.struct<"class.llvm::AttributeList", (ptr)>}> : (i32) -> !llvm.ptr
    %19 = "llvm.alloca"(%0) <{alignment = 8 : i64, elem_type = !llvm.struct<"class.llvm::AttributeSet", (ptr)>}> : (i32) -> !llvm.ptr
    %20 = "llvm.alloca"(%0) <{alignment = 8 : i64, elem_type = !llvm.struct<"class.llvm::AttributeSet", (ptr)>}> : (i32) -> !llvm.ptr
    %21 = "llvm.alloca"(%0) <{alignment = 8 : i64, elem_type = !llvm.struct<"class.llvm::AttributeList", (ptr)>}> : (i32) -> !llvm.ptr
    %22 = "llvm.call"(%arg0) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<tail>, arg_attrs = [{llvm.align = 8 : i64, llvm.dereferenceable = 88 : i64, llvm.nonnull, llvm.noundef}], callee = @_ZNK4llvm8CallBase8arg_sizeEv, fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 1, 0>, res_attrs = [{llvm.noundef}]}> : (!llvm.ptr) -> i32
    %23 = "llvm.icmp"(%22, %1) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%23, %2)[^bb7, ^bb1] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i1) -> ()
  ^bb1:  // pred: ^bb0
    ...
    "llvm.br"(%6, %7)[^bb2] : (i64, i1) -> ()
  ^bb2(%28: i64, %29: i1):  // 2 preds: ^bb1, ^bb6
    %30 = "llvm.load"(%24) <{alignment = 4 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> i32
    %31 = "llvm.and"(%30, %8) : (i32, i32) -> i32
    %32 = "llvm.zext"(%31) <{nonNeg}> : (i32) -> i64
    %33 = "llvm.sub"(%6, %32) <{overflowFlags = 1 : i32}> : (i64, i64) -> i64
    %34 = "llvm.getelementptr"(%arg0, %33) <{elem_type = !llvm.struct<"class.llvm::Use", (ptr, ptr, ptr, ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %35 = "llvm.getelementptr"(%34, %28) <{elem_type = !llvm.struct<"class.llvm::Use", (ptr, ptr, ptr, ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    %37 = "llvm.getelementptr"(%36, %9) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    %39 = "llvm.getelementptr"(%38, %9) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
  ...
  ^bb3:  // pred: ^bb2
    ...
    %49 = "llvm.icmp"(%48, %12) <{predicate = 0 : i64}> : (i8, i8) -> i1
    "llvm.cond_br"(%49, %46)[^bb4, ^bb5] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i16) -> ()
  ^bb4:  // pred: ^bb3
    "llvm.intr.lifetime.start"(%20) : (!llvm.ptr) -> ()
    "llvm.intr.lifetime.start"(%21) : (!llvm.ptr) -> ()
    %50 = "llvm.getelementptr"(%47, %13) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    %52 = "llvm.call"(%21, %44) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<none>, arg_attrs = [{llvm.align = 8 : i64, llvm.dereferenceable = 8 : i64, llvm.nonnull, llvm.noundef}, {llvm.noundef}], callee = @_ZNK4llvm13AttributeList13getParamAttrsEj, fastmathFlags = #llvm.fastmath<none>, no_unwind, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 2, 0>}> : (!llvm.ptr, i32) -> !llvm.ptr
    "llvm.store"(%52, %20) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> ()
    %53 = "llvm.call"(%20) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<none>, arg_attrs = [{llvm.align = 8 : i64, llvm.dereferenceable = 8 : i64, llvm.nonnull, llvm.noundef}], callee = @_ZNK4llvm12AttributeSet14getCaptureInfoEv, fastmathFlags = #llvm.fastmath<none>, no_unwind, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 1, 0>}> : (!llvm.ptr) -> i16
    %54 = "llvm.and"(%53, %46) : (i16, i16) -> i16
    "llvm.intr.lifetime.end"(%21) : (!llvm.ptr) -> ()
    "llvm.intr.lifetime.end"(%20) : (!llvm.ptr) -> ()
    "llvm.br"(%54)[^bb5] : (i16) -> ()
  ^bb5(%55: i16):  // 2 preds: ^bb3, ^bb4
    %56 = "llvm.trunc"(%55) <{overflowFlags = 0 : i32}> : (i16) -> i8
    %57 = "llvm.lshr"(%55, %14) : (i16, i16) -> i16
    %58 = "llvm.trunc"(%57) <{overflowFlags = 2 : i32}> : (i16) -> i8
    %59 = "llvm.and"(%56, %15) : (i8, i8) -> i8
    %60 = "llvm.xor"(%59, %15) : (i8, i8) -> i8
    %61 = "llvm.and"(%60, %58) : (i8, i8) -> i8
    %62 = "llvm.icmp"(%61, %16) <{predicate = 0 : i64}> : (i8, i8) -> i1
    "llvm.cond_br"(%62, %29)[^bb6, ^bb7] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i1) -> ()
  ^bb6:  // 2 preds: ^bb2, ^bb5
    %63 = "llvm.add"(%28, %17) <{overflowFlags = 3 : i32}> : (i64, i64) -> i64
    %64 = "llvm.icmp"(%63, %27) <{predicate = 6 : i64}> : (i64, i64) -> i1
    %65 = "llvm.icmp"(%63, %27) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%65, %64, %63, %64)[^bb7, ^bb2] <{loop_annotation = #llvm.loop_annotation<mustProgress = true>, operandSegmentSizes = array<i32: 1, 1, 2>}> : (i1, i1, i64, i1) -> ()
  ^bb7(%66: i1):  // 3 preds: ^bb0, ^bb5, ^bb6
    "llvm.return"(%66) : (i1) -> ()
  }) : () -> ()
