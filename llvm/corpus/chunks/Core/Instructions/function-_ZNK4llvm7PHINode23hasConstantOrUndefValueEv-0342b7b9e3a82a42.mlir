"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr):
    ...
    "llvm.cond_br"(%13, %3)[^bb6, ^bb1] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i1) -> ()
  ^bb1:  // pred: ^bb0
    ...
    %16 = "llvm.zext"(%12) <{nonNeg}> : (i32) -> i64
    "llvm.br"(%5, %6)[^bb2] : (i64, !llvm.ptr) -> ()
  ^bb2(%17: i64, %18: !llvm.ptr):  // 2 preds: ^bb1, ^bb5
    %19 = "llvm.getelementptr"(%15, %17) <{elem_type = !llvm.struct<"class.llvm::Use", (ptr, ptr, ptr, ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    %21 = "llvm.icmp"(%20, %arg0) <{predicate = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> i1
    "llvm.cond_br"(%21, %18)[^bb5, ^bb3] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, !llvm.ptr) -> ()
  ^bb3:  // pred: ^bb2
    ...
    %23 = "llvm.icmp"(%22, %7) <{predicate = 6 : i64}> : (i8, i8) -> i1
    "llvm.cond_br"(%23, %18)[^bb5, ^bb4] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, !llvm.ptr) -> ()
  ^bb4:  // pred: ^bb3
    %24 = "llvm.icmp"(%18, %6) <{predicate = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> i1
    %25 = "llvm.icmp"(%18, %20) <{predicate = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> i1
    %26 = "llvm.or"(%24, %25) : (i1, i1) -> i1
    "llvm.cond_br"(%26, %20, %8)[^bb5, ^bb6] <{operandSegmentSizes = array<i32: 1, 1, 1>}> : (i1, !llvm.ptr, i1) -> ()
  ^bb5(%27: !llvm.ptr):  // 3 preds: ^bb2, ^bb3, ^bb4
    %28 = "llvm.add"(%17, %9) <{overflowFlags = 3 : i32}> : (i64, i64) -> i64
    %29 = "llvm.icmp"(%28, %16) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%29, %3, %28, %27)[^bb6, ^bb2] <{loop_annotation = #llvm.loop_annotation<mustProgress = true>, operandSegmentSizes = array<i32: 1, 1, 2>}> : (i1, i1, i64, !llvm.ptr) -> ()
  ^bb6(%30: i1):  // 3 preds: ^bb0, ^bb4, ^bb5
    "llvm.return"(%30) : (i1) -> ()
  }) : () -> ()
