"builtin.module"() ({
  ...
  "llvm.func"() <{CConv = #llvm.cconv<ccc>, alignment = 2 : i64, arg_attrs = [{llvm.nocapture, llvm.noundef, llvm.readonly}, {llvm.nocapture, llvm.noundef, llvm.readonly}, {llvm.readonly}, {}], dso_local, function_type = !llvm.func<i1 (ptr, ptr, ptr, i64)>, linkage = #llvm.linkage<external>, memory_effects = #llvm.memory_effects<other = read, argMem = read, inaccessibleMem = none, errnoMem = read, targetMem0 = none, targetMem1 = none>, no_unwind, passthrough = ["mustprogress", "nofree", ["min-legal-vector-width", "0"], ["no-trapping-math", "true"], ["stack-protector-buffer-size", "8"], ["target-cpu", "x86-64"]], res_attrs = [{llvm.noundef, llvm.zeroext}], sym_name = "_ZN4llvm17ShuffleVectorInst15isValidOperandsEPKNS_5ValueES3_NS_8ArrayRefIiEE", target_cpu = "x86-64", target_features = #llvm.target_features<["+cmov", "+cx8", "+fxsr", "+mmx", "+sse", "+sse2", "+x87"]>, tune_cpu = "generic", unnamed_addr = 1 : i64, uwtable_kind = #llvm.uwtableKind<async>, visibility_ = 0 : i64, will_return}> ({
  ^bb0(%arg0: !llvm.ptr, %arg1: !llvm.ptr, %arg2: !llvm.ptr, %arg3: i64):
    ...
    "llvm.cond_br"(%19, %3)[^bb1, ^bb11] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i1) -> ()
  ^bb1:  // pred: ^bb0
    ...
    %22 = "llvm.icmp"(%15, %21) <{predicate = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> i1
    "llvm.cond_br"(%22, %3)[^bb2, ^bb11] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i1) -> ()
  ^bb2:  // pred: ^bb1
    %23 = "llvm.and"(%17, %4) : (i32, i32) -> i32
    %24 = "llvm.icmp"(%23, %4) <{predicate = 0 : i64}> : (i32, i32) -> i1
    %25 = "llvm.getelementptr"(%arg2, %arg3) <{elem_type = i32, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %26 = "llvm.icmp"(%arg3, %5) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%26)[^bb6, ^bb3] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb3:  // pred: ^bb2
    %27 = "llvm.getelementptr"(%15, %6) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    %29 = "llvm.shl"(%28, %7) <{overflowFlags = 1 : i32}> : (i32, i32) -> i32
    "llvm.br"(%arg2)[^bb5] : (!llvm.ptr) -> ()
  ^bb4:  // pred: ^bb5
    %30 = "llvm.getelementptr"(%32, %10) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %31 = "llvm.icmp"(%30, %25) <{predicate = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> i1
    "llvm.cond_br"(%31, %30)[^bb6, ^bb5] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, !llvm.ptr) -> ()
  ^bb5(%32: !llvm.ptr):  // 2 preds: ^bb3, ^bb4
    ...
    %35 = "llvm.icmp"(%33, %29) <{predicate = 2 : i64}> : (i32, i32) -> i1
    %36 = "llvm.select"(%34, %9, %35) <{fastmathFlags = #llvm.fastmath<none>}> : (i1, i1, i1) -> i1
    "llvm.cond_br"(%36, %3)[^bb4, ^bb11] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i1) -> ()
  ^bb6:  // 2 preds: ^bb2, ^bb4
    "llvm.cond_br"(%24)[^bb7, ^bb10] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb7:  // pred: ^bb6
    %37 = "llvm.load"(%arg2) <{alignment = 4 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, access_type = <id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (!llvm.ptr) -> i32
    "llvm.switch"(%37, %3)[^bb11, ^bb8, ^bb8] <{case_operand_segments = array<i32: 0, 0>, case_values = dense<[0, -1]> : vector<2xi32>, operandSegmentSizes = array<i32: 1, 1, 0>}> : (i32, i1) -> ()
  ^bb8:  // 2 preds: ^bb7, ^bb7
    %38 = "llvm.icmp"(%arg3, %11) <{predicate = 6 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%38)[^bb10, ^bb9] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb9:  // pred: ^bb8
    %39 = "llvm.shl"(%arg3, %11) <{overflowFlags = 1 : i32}> : (i64, i64) -> i64
    %40 = "llvm.getelementptr"(%arg2, %10) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %41 = "llvm.add"(%39, %12) <{overflowFlags = 1 : i32}> : (i64, i64) -> i64
    %42 = "llvm.call"(%40, %arg2, %41) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<tail>, arg_attrs = [{llvm.nonnull}, {llvm.nonnull}, {}], callee = @bcmp, fastmathFlags = #llvm.fastmath<none>, memory_effects = #llvm.memory_effects<other = none, argMem = read, inaccessibleMem = none, errnoMem = none, targetMem0 = none, targetMem1 = none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 3, 0>}> : (!llvm.ptr, !llvm.ptr, i64) -> i32
    %43 = "llvm.icmp"(%42, %13) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%43, %3)[^bb10, ^bb11] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i1) -> ()
  ^bb10:  // 3 preds: ^bb6, ^bb8, ^bb9
    "llvm.br"(%9)[^bb11] : (i1) -> ()
  ^bb11(%44: i1):  // 6 preds: ^bb0, ^bb1, ^bb5, ^bb7, ^bb9, ^bb10
    "llvm.return"(%44) : (i1) -> ()
  }) : () -> ()
