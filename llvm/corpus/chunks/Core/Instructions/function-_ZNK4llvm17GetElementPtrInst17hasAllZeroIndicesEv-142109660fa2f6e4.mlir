"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr):
    ...
    %13 = "llvm.sub"(%2, %12) <{overflowFlags = 1 : i32}> : (i64, i64) -> i64
    %14 = "llvm.getelementptr"(%arg0, %13) <{elem_type = !llvm.struct<"class.llvm::Use", (ptr, ptr, ptr, ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %15 = "llvm.icmp"(%11, %3) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%15, %4, %3)[^bb4, ^bb2] <{operandSegmentSizes = array<i32: 1, 1, 1>}> : (i1, i1, i32) -> ()
  ^bb1:  // pred: ^bb3
    %16 = "llvm.add"(%18, %3) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
    %17 = "llvm.icmp"(%16, %11) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%17, %4, %16)[^bb4, ^bb2] <{loop_annotation = #llvm.loop_annotation<mustProgress = true>, operandSegmentSizes = array<i32: 1, 1, 1>}> : (i1, i1, i32) -> ()
  ^bb2(%18: i32):  // 2 preds: ^bb0, ^bb1
    %19 = "llvm.zext"(%18) : (i32) -> i64
    %20 = "llvm.getelementptr"(%14, %19) <{elem_type = !llvm.struct<"class.llvm::Use", (ptr, ptr, ptr, ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    "llvm.cond_br"(%23, %6)[^bb3, ^bb4] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i1) -> ()
  ^bb3:  // pred: ^bb2
    ...
    %26 = "llvm.icmp"(%25, %8) <{predicate = 2 : i64}> : (i8, i8) -> i1
    "llvm.cond_br"(%26, %6)[^bb1, ^bb4] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i1) -> ()
  ^bb4(%27: i1):  // 4 preds: ^bb0, ^bb1, ^bb2, ^bb3
    "llvm.return"(%27) : (i1) -> ()
  }) : () -> ()
