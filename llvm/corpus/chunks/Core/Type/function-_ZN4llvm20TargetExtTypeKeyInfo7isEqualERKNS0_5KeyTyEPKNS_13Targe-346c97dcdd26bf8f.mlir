"builtin.module"() ({
  "llvm.comdat"() <{sym_name = "__llvm_global_comdat"}> ({
    "llvm.comdat_selector"() <{comdat = 0 : i64, sym_name = "_ZN4llvm20TargetExtTypeKeyInfo7isEqualERKNS0_5KeyTyEPKNS_13TargetExtTypeE"}> : () -> ()
  }) : () -> ()
  "llvm.module_flags"() <{flags = [#llvm.mlir.module_flag<error, "wchar_size", 4 : i32>, #llvm.mlir.module_flag<min, "PIC Level", 2 : i32>, #llvm.mlir.module_flag<max, "uwtable", 2 : i32>]}> : () -> ()
  "llvm.func"() <{CConv = #llvm.cconv<ccc>, alignment = 2 : i64, arg_attrs = [{llvm.align = 8 : i64, llvm.dereferenceable = 48 : i64, llvm.nonnull, llvm.noundef}, {llvm.noundef}], comdat = @__llvm_global_comdat::@_ZN4llvm20TargetExtTypeKeyInfo7isEqualERKNS0_5KeyTyEPKNS_13TargetExtTypeE, dso_local, function_type = !llvm.func<i1 (ptr, ptr)>, linkage = #llvm.linkage<weak_odr>, no_unwind, passthrough = ["mustprogress", ["min-legal-vector-width", "0"], ["no-trapping-math", "true"], ["stack-protector-buffer-size", "8"], ["target-cpu", "x86-64"]], res_attrs = [{llvm.noundef, llvm.zeroext}], sym_name = "_ZN4llvm20TargetExtTypeKeyInfo7isEqualERKNS0_5KeyTyEPKNS_13TargetExtTypeE", target_cpu = "x86-64", target_features = #llvm.target_features<["+cmov", "+cx8", "+fxsr", "+mmx", "+sse", "+sse2", "+x87"]>, tune_cpu = "generic", unnamed_addr = 1 : i64, uwtable_kind = #llvm.uwtableKind<async>, visibility_ = 1 : i64}> ({
  ...
  ^bb3:  // 2 preds: ^bb1, ^bb2
    ...
    %40 = "llvm.icmp"(%39, %22) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%40, %7)[^bb4, ^bb9] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i1) -> ()
  ^bb4:  // pred: ^bb3
    %41 = "llvm.icmp"(%21, %9) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%41)[^bb6, ^bb5] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb5:  // pred: ^bb4
    %42 = "llvm.shl"(%22, %10) <{overflowFlags = 3 : i32}> : (i64, i64) -> i64
    %43 = "llvm.call"(%37, %19, %42) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<tail>, callee = @bcmp, fastmathFlags = #llvm.fastmath<none>, memory_effects = #llvm.memory_effects<other = none, argMem = read, inaccessibleMem = none, errnoMem = none, targetMem0 = none, targetMem1 = none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 3, 0>}> : (!llvm.ptr, !llvm.ptr, i64) -> i32
    %44 = "llvm.icmp"(%43, %9) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%44, %7)[^bb6, ^bb9] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i1) -> ()
  ^bb6:  // 2 preds: ^bb4, ^bb5
    ...
    %49 = "llvm.icmp"(%48, %28) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%49, %7)[^bb7, ^bb9] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i1) -> ()
  ^bb7:  // pred: ^bb6
    %50 = "llvm.icmp"(%26, %11) <{predicate = 6 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%50, %12)[^bb9, ^bb8] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i1) -> ()
  ^bb8:  // pred: ^bb7
    %51 = "llvm.shl"(%28, %13) <{overflowFlags = 3 : i32}> : (i64, i64) -> i64
    %52 = "llvm.call"(%46, %24, %51) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<tail>, callee = @bcmp, fastmathFlags = #llvm.fastmath<none>, memory_effects = #llvm.memory_effects<other = none, argMem = read, inaccessibleMem = none, errnoMem = none, targetMem0 = none, targetMem1 = none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 3, 0>}> : (!llvm.ptr, !llvm.ptr, i64) -> i32
    %53 = "llvm.icmp"(%52, %9) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.br"(%53)[^bb9] : (i1) -> ()
  ^bb9(%54: i1):  // 7 preds: ^bb0, ^bb2, ^bb3, ^bb5, ^bb6, ^bb7, ^bb8
    "llvm.return"(%54) : (i1) -> ()
  }) : () -> ()
