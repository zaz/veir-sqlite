"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr):
    ...
    "llvm.cond_br"(%17, %arg0, %arg0, %16)[^bb1, ^bb3] <{operandSegmentSizes = array<i32: 1, 1, 2>}> : (i1, !llvm.ptr, !llvm.ptr, i32) -> ()
  ^bb1(%18: !llvm.ptr):  // 2 preds: ^bb0, ^bb2
    ...
    "llvm.cond_br"(%22, %6)[^bb8, ^bb2] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i1) -> ()
  ^bb2:  // pred: ^bb1
    %23 = "llvm.getelementptr"(%18, %7) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    "llvm.cond_br"(%28, %24, %24, %27)[^bb1, ^bb3] <{operandSegmentSizes = array<i32: 1, 1, 2>}> : (i1, !llvm.ptr, !llvm.ptr, i32) -> ()
  ^bb3(%29: !llvm.ptr, %30: i32):  // 2 preds: ^bb0, ^bb2
    %31 = "llvm.icmp"(%30, %8) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%31, %9)[^bb4, ^bb7] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i1) -> ()
  ^bb4:  // pred: ^bb3
    %32 = "llvm.getelementptr"(%29, %10) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    "llvm.cond_br"(%34, %6)[^bb7, ^bb5] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i1) -> ()
  ^bb5:  // pred: ^bb4
    %35 = "llvm.getelementptr"(%29, %12) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
  ...
  ^bb6(%38: i64):  // 2 preds: ^bb5, ^bb6
    ...
    %41 = "llvm.call"(%40) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<tail>, arg_attrs = [{llvm.align = 8 : i64, llvm.dereferenceable = 24 : i64, llvm.nonnull, llvm.noundef}], callee = @_ZNK4llvm4Type9isEmptyTyEv, fastmathFlags = #llvm.fastmath<none>, memory_effects = #llvm.memory_effects<other = read, argMem = read, inaccessibleMem = none, errnoMem = read, targetMem0 = none, targetMem1 = none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 1, 0>, res_attrs = [{llvm.noundef, llvm.zeroext}]}> : (!llvm.ptr) -> i1
    %42 = "llvm.xor"(%41, %6) : (i1, i1) -> i1
    %43 = "llvm.add"(%38, %13) <{overflowFlags = 3 : i32}> : (i64, i64) -> i64
    %44 = "llvm.icmp"(%43, %37) <{predicate = 0 : i64}> : (i64, i64) -> i1
    %45 = "llvm.select"(%42, %6, %44) <{fastmathFlags = #llvm.fastmath<none>}> : (i1, i1, i1) -> i1
    "llvm.cond_br"(%45, %41, %43)[^bb7, ^bb6] <{loop_annotation = #llvm.loop_annotation<mustProgress = true>, operandSegmentSizes = array<i32: 1, 1, 1>}> : (i1, i1, i64) -> ()
  ^bb7(%46: i1):  // 3 preds: ^bb3, ^bb4, ^bb6
    %47 = "llvm.and"(%31, %46) : (i1, i1) -> i1
    "llvm.br"(%47)[^bb8] : (i1) -> ()
  ^bb8(%48: i1):  // 2 preds: ^bb1, ^bb7
    "llvm.return"(%48) : (i1) -> ()
  }) : () -> ()
