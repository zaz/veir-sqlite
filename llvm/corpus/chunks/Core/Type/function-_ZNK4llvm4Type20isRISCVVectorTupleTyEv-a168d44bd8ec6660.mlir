"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr):
    ...
    %5 = "llvm.mlir.constant"() <{value = 18 : i64}> : () -> i64
    %6 = "llvm.mlir.constant"() <{value = 24 : i64}> : () -> i64
    %7 = "llvm.mlir.addressof"() <{global_name = @".str"}> : () -> !llvm.ptr
    ...
    "llvm.cond_br"(%12, %3)[^bb1, ^bb3] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i1) -> ()
  ^bb1:  // pred: ^bb0
    ...
    "llvm.cond_br"(%15, %3)[^bb2, ^bb3] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i1) -> ()
  ^bb2:  // pred: ^bb1
