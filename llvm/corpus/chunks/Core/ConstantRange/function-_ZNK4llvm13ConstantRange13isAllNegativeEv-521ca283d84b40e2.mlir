"builtin.module"() ({
  ...
  ^bb2:  // pred: ^bb1
    ...
    "llvm.cond_br"(%21, %3)[^bb13, ^bb7] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i1) -> ()
  ^bb3:  // pred: ^bb0
    ...
    "llvm.cond_br"(%25, %3)[^bb13, ^bb4] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i1) -> ()
  ^bb4:  // pred: ^bb3
  ...
  ^bb5:  // pred: ^bb4
    ...
    "llvm.cond_br"(%27, %4)[^bb13, ^bb6] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i1) -> ()
  ^bb6:  // pred: ^bb5
    ...
    "llvm.cond_br"(%31, %4)[^bb13, ^bb8] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i1) -> ()
  ^bb7:  // pred: ^bb2
    ...
    "llvm.cond_br"(%33, %4)[^bb13, ^bb8] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i1) -> ()
  ^bb8:  // 4 preds: ^bb1, ^bb4, ^bb6, ^bb7
    ...
    "llvm.cond_br"(%35, %4)[^bb13, ^bb9] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i1) -> ()
  ^bb9:  // pred: ^bb8
    ...
    %38 = "llvm.add"(%37, %10) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
    %39 = "llvm.and"(%38, %11) : (i32, i32) -> i32
    %40 = "llvm.zext"(%39) <{nonNeg}> : (i32) -> i64
    %41 = "llvm.shl"(%12, %40) <{overflowFlags = 2 : i32}> : (i64, i64) -> i64
    %42 = "llvm.icmp"(%37, %2) <{predicate = 6 : i64}> : (i32, i32) -> i1
    %43 = "llvm.load"(%15) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
    %44 = "llvm.lshr"(%38, %13) : (i32, i32) -> i32
    ...
    %47 = "llvm.select"(%42, %15, %46) <{fastmathFlags = #llvm.fastmath<none>}> : (i1, !llvm.ptr, !llvm.ptr) -> !llvm.ptr
    ...
    %49 = "llvm.and"(%41, %48) : (i64, i64) -> i64
    %50 = "llvm.icmp"(%49, %5) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%50, %3)[^bb10, ^bb13] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i1) -> ()
  ^bb10:  // pred: ^bb9
    "llvm.cond_br"(%42)[^bb11, ^bb12] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb11:  // pred: ^bb10
    %51 = "llvm.icmp"(%43, %14) <{predicate = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> i1
    "llvm.br"(%51)[^bb13] : (i1) -> ()
  ^bb12:  // pred: ^bb10
    %52 = "llvm.call"(%15) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<tail>, arg_attrs = [{llvm.align = 8 : i64, llvm.dereferenceable = 12 : i64, llvm.nonnull, llvm.noundef}], callee = @_ZNK4llvm5APInt25countLeadingZerosSlowCaseEv, fastmathFlags = #llvm.fastmath<none>, memory_effects = #llvm.memory_effects<other = read, argMem = read, inaccessibleMem = read, errnoMem = read, targetMem0 = none, targetMem1 = none>, no_unwind, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 1, 0>, res_attrs = [{llvm.noundef}], will_return}> : (!llvm.ptr) -> i32
    %53 = "llvm.icmp"(%52, %37) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.br"(%53)[^bb13] : (i1) -> ()
  ^bb13(%54: i1):  // 9 preds: ^bb2, ^bb3, ^bb5, ^bb6, ^bb7, ^bb8, ^bb9, ^bb11, ^bb12
    "llvm.return"(%54) : (i1) -> ()
  }) : () -> ()
