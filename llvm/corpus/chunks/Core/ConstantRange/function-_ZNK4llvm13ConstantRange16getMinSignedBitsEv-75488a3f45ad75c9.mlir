"builtin.module"() ({
  ...
  "llvm.func"() <{CConv = #llvm.cconv<ccc>, alignment = 2 : i64, arg_attrs = [{llvm.align = 8 : i64, llvm.dereferenceable = 32 : i64, llvm.nonnull, llvm.noundef}], dso_local, function_type = !llvm.func<i32 (ptr)>, linkage = #llvm.linkage<external>, no_unwind, passthrough = ["mustprogress", ["min-legal-vector-width", "0"], ["no-trapping-math", "true"], ["stack-protector-buffer-size", "8"], ["target-cpu", "x86-64"]], res_attrs = [{llvm.noundef}], sym_name = "_ZNK4llvm13ConstantRange16getMinSignedBitsEv", target_cpu = "x86-64", target_features = #llvm.target_features<["+cmov", "+cx8", "+fxsr", "+mmx", "+sse", "+sse2", "+x87"]>, tune_cpu = "generic", unnamed_addr = 1 : i64, uwtable_kind = #llvm.uwtableKind<async>, visibility_ = 0 : i64}> ({
  ^bb0(%arg0: !llvm.ptr):
  ...
  ^bb2:  // pred: ^bb1
    ...
    "llvm.cond_br"(%22, %4)[^bb27, ^bb4] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i32) -> ()
  ^bb3:  // pred: ^bb0
    ...
    "llvm.cond_br"(%26, %4)[^bb27, ^bb4] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i32) -> ()
  ^bb4:  // 3 preds: ^bb1, ^bb2, ^bb3
    ...
    %27 = "llvm.getelementptr"(%14, %2) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %28 = "llvm.load"(%27) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "_ZTSN4llvm5APIntE", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>, <#llvm.tbaa_type_desc<id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, 8>}>, access_type = <id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 8>]}> : (!llvm.ptr) -> i32
    %29 = "llvm.add"(%28, %6) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
    %30 = "llvm.and"(%29, %7) : (i32, i32) -> i32
    %31 = "llvm.zext"(%30) <{nonNeg}> : (i32) -> i64
    %32 = "llvm.shl"(%8, %31) <{overflowFlags = 2 : i32}> : (i64, i64) -> i64
    %33 = "llvm.icmp"(%28, %3) <{predicate = 6 : i64}> : (i32, i32) -> i1
    %34 = "llvm.load"(%14) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
    %35 = "llvm.lshr"(%29, %9) : (i32, i32) -> i32
    ...
    %38 = "llvm.select"(%33, %14, %37) <{fastmathFlags = #llvm.fastmath<none>}> : (i1, !llvm.ptr, !llvm.ptr) -> !llvm.ptr
    ...
    %42 = "llvm.ptrtoint"(%34) : (!llvm.ptr) -> i64
    "llvm.cond_br"(%41)[^bb9, ^bb5] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb5:  // pred: ^bb4
    "llvm.cond_br"(%33)[^bb6, ^bb8] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb6:  // pred: ^bb5
    %43 = "llvm.icmp"(%28, %4) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%43, %4)[^bb12, ^bb7] <{branch_weights = array<i32: 1, 2000>, operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i32) -> ()
  ^bb7:  // pred: ^bb6
    %44 = "llvm.sub"(%10, %28) <{overflowFlags = 3 : i32}> : (i32, i32) -> i32
    %45 = "llvm.zext"(%44) <{nonNeg}> : (i32) -> i64
    %46 = "llvm.shl"(%42, %45) <{overflowFlags = 0 : i32}> : (i64, i64) -> i64
    %47 = "llvm.xor"(%46, %11) : (i64, i64) -> i64
    %48 = "llvm.intr.ctlz"(%47) <{is_zero_poison = false}> : (i64) -> i64
    %49 = "llvm.trunc"(%48) <{overflowFlags = 3 : i32}> : (i64) -> i32
    "llvm.br"(%49)[^bb12] : (i32) -> ()
  ^bb8:  // pred: ^bb5
    %50 = "llvm.call"(%14) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<none>, arg_attrs = [{llvm.align = 8 : i64, llvm.dereferenceable = 12 : i64, llvm.nonnull, llvm.noundef}], callee = @_ZNK4llvm5APInt24countLeadingOnesSlowCaseEv, fastmathFlags = #llvm.fastmath<none>, memory_effects = #llvm.memory_effects<other = read, argMem = read, inaccessibleMem = read, errnoMem = read, targetMem0 = none, targetMem1 = none>, no_unwind, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 1, 0>, res_attrs = [{llvm.noundef}], will_return}> : (!llvm.ptr) -> i32
    "llvm.br"(%50)[^bb12] : (i32) -> ()
  ^bb9:  // pred: ^bb4
    "llvm.cond_br"(%33)[^bb10, ^bb11] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb10:  // pred: ^bb9
    %51 = "llvm.add"(%28, %12) <{overflowFlags = 1 : i32}> : (i32, i32) -> i32
    %52 = "llvm.intr.ctlz"(%42) <{is_zero_poison = false}> : (i64) -> i64
    %53 = "llvm.trunc"(%52) <{overflowFlags = 3 : i32}> : (i64) -> i32
    %54 = "llvm.add"(%51, %53) <{overflowFlags = 1 : i32}> : (i32, i32) -> i32
    "llvm.br"(%54)[^bb12] : (i32) -> ()
  ^bb11:  // pred: ^bb9
    %55 = "llvm.call"(%14) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<none>, arg_attrs = [{llvm.align = 8 : i64, llvm.dereferenceable = 12 : i64, llvm.nonnull, llvm.noundef}], callee = @_ZNK4llvm5APInt25countLeadingZerosSlowCaseEv, fastmathFlags = #llvm.fastmath<none>, memory_effects = #llvm.memory_effects<other = read, argMem = read, inaccessibleMem = read, errnoMem = read, targetMem0 = none, targetMem1 = none>, no_unwind, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 1, 0>, res_attrs = [{llvm.noundef}], will_return}> : (!llvm.ptr) -> i32
    "llvm.br"(%55)[^bb12] : (i32) -> ()
  ^bb12(%56: i32):  // 5 preds: ^bb6, ^bb7, ^bb8, ^bb10, ^bb11
    %57 = "llvm.add"(%28, %0) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
    %58 = "llvm.sub"(%57, %56) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
    ...
    %59 = "llvm.getelementptr"(%15, %2) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %60 = "llvm.load"(%59) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "_ZTSN4llvm5APIntE", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>, <#llvm.tbaa_type_desc<id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, 8>}>, access_type = <id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 8>]}> : (!llvm.ptr) -> i32
    %61 = "llvm.add"(%60, %6) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
    %62 = "llvm.and"(%61, %7) : (i32, i32) -> i32
    %63 = "llvm.zext"(%62) <{nonNeg}> : (i32) -> i64
    %64 = "llvm.shl"(%8, %63) <{overflowFlags = 2 : i32}> : (i64, i64) -> i64
    %65 = "llvm.icmp"(%60, %3) <{predicate = 6 : i64}> : (i32, i32) -> i1
    %66 = "llvm.load"(%15) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
    %67 = "llvm.lshr"(%61, %9) : (i32, i32) -> i32
    ...
    %70 = "llvm.select"(%65, %15, %69) <{fastmathFlags = #llvm.fastmath<none>}> : (i1, !llvm.ptr, !llvm.ptr) -> !llvm.ptr
    ...
    %74 = "llvm.ptrtoint"(%66) : (!llvm.ptr) -> i64
    "llvm.cond_br"(%73)[^bb17, ^bb13] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb13:  // pred: ^bb12
    "llvm.cond_br"(%65)[^bb14, ^bb16] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb14:  // pred: ^bb13
    %75 = "llvm.icmp"(%60, %4) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%75, %4)[^bb20, ^bb15] <{branch_weights = array<i32: 1, 2000>, operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i32) -> ()
  ^bb15:  // pred: ^bb14
    %76 = "llvm.sub"(%10, %60) <{overflowFlags = 3 : i32}> : (i32, i32) -> i32
    %77 = "llvm.zext"(%76) <{nonNeg}> : (i32) -> i64
    %78 = "llvm.shl"(%74, %77) <{overflowFlags = 0 : i32}> : (i64, i64) -> i64
    %79 = "llvm.xor"(%78, %11) : (i64, i64) -> i64
    %80 = "llvm.intr.ctlz"(%79) <{is_zero_poison = false}> : (i64) -> i64
  ...
  ^bb18:  // pred: ^bb17
    %83 = "llvm.add"(%60, %12) <{overflowFlags = 1 : i32}> : (i32, i32) -> i32
    %84 = "llvm.intr.ctlz"(%74) <{is_zero_poison = false}> : (i64) -> i64
    %85 = "llvm.trunc"(%84) <{overflowFlags = 3 : i32}> : (i64) -> i32
    %86 = "llvm.add"(%83, %85) <{overflowFlags = 1 : i32}> : (i32, i32) -> i32
    "llvm.br"(%86)[^bb20] : (i32) -> ()
  ^bb19:  // pred: ^bb17
    %87 = "llvm.call"(%15) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<none>, arg_attrs = [{llvm.align = 8 : i64, llvm.dereferenceable = 12 : i64, llvm.nonnull, llvm.noundef}], callee = @_ZNK4llvm5APInt25countLeadingZerosSlowCaseEv, fastmathFlags = #llvm.fastmath<none>, memory_effects = #llvm.memory_effects<other = read, argMem = read, inaccessibleMem = read, errnoMem = read, targetMem0 = none, targetMem1 = none>, no_unwind, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 1, 0>, res_attrs = [{llvm.noundef}], will_return}> : (!llvm.ptr) -> i32
    "llvm.br"(%87)[^bb21] : (i32) -> ()
  ^bb20(%88: i32):  // 3 preds: ^bb14, ^bb15, ^bb18
    %89 = "llvm.add"(%60, %0) <{overflowFlags = 3 : i32}> : (i32, i32) -> i32
    %90 = "llvm.sub"(%89, %88) <{overflowFlags = 1 : i32}> : (i32, i32) -> i32
    %91 = "llvm.intr.umax"(%58, %90) : (i32, i32) -> i32
    "llvm.br"(%91)[^bb23] : (i32) -> ()
  ^bb21(%92: i32):  // 2 preds: ^bb16, ^bb19
    %93 = "llvm.add"(%60, %0) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
    %94 = "llvm.sub"(%93, %92) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
    %95 = "llvm.intr.umax"(%58, %94) : (i32, i32) -> i32
    %96 = "llvm.icmp"(%66, %13) <{predicate = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> i1
    "llvm.cond_br"(%96, %95)[^bb23, ^bb22] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i32) -> ()
  ^bb22:  // pred: ^bb21
    ...
    "llvm.br"(%95)[^bb23] : (i32) -> ()
  ^bb23(%97: i32):  // 3 preds: ^bb20, ^bb21, ^bb22
    "llvm.intr.lifetime.end"(%15) : (!llvm.ptr) -> ()
    %98 = "llvm.load"(%27) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "_ZTSN4llvm5APIntE", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>, <#llvm.tbaa_type_desc<id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, 8>}>, access_type = <id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 8>]}> : (!llvm.ptr) -> i32
    %99 = "llvm.icmp"(%98, %10) <{predicate = 8 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%99)[^bb24, ^bb26] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb24:  // pred: ^bb23
    %100 = "llvm.load"(%14) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, access_type = <id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, offset = 0>]}> : (!llvm.ptr) -> !llvm.ptr
    %101 = "llvm.icmp"(%100, %13) <{predicate = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> i1
  ...
  ^bb26:  // 3 preds: ^bb23, ^bb24, ^bb25
    ...
    "llvm.br"(%97)[^bb27] : (i32) -> ()
  ^bb27(%102: i32):  // 3 preds: ^bb2, ^bb3, ^bb26
    "llvm.return"(%102) : (i32) -> ()
  }) : () -> ()
