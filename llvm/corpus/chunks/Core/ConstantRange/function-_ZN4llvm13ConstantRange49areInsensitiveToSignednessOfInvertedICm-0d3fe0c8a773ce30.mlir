"builtin.module"() ({
  ...
  ^bb2:  // pred: ^bb1
    ...
    %18 = "llvm.icmp"(%17, %14) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%18, %3)[^bb22, ^bb4] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i1) -> ()
  ^bb3:  // pred: ^bb0
    ...
    "llvm.cond_br"(%22, %3)[^bb22, ^bb4] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i1) -> ()
  ^bb4:  // 3 preds: ^bb1, ^bb2, ^bb3
    %23 = "llvm.getelementptr"(%arg1, %0) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    %26 = "llvm.icmp"(%25, %2) <{predicate = 6 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%26)[^bb7, ^bb5] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb5:  // pred: ^bb4
    %27 = "llvm.call"(%arg1, %23) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<tail>, arg_attrs = [{llvm.align = 8 : i64, llvm.dereferenceable = 12 : i64, llvm.nonnull, llvm.noundef}, {llvm.align = 8 : i64, llvm.dereferenceable = 12 : i64, llvm.nonnull, llvm.noundef}], callee = @_ZNK4llvm5APInt13equalSlowCaseERKS0_, fastmathFlags = #llvm.fastmath<none>, memory_effects = #llvm.memory_effects<other = read, argMem = read, inaccessibleMem = read, errnoMem = read, targetMem0 = none, targetMem1 = none>, no_unwind, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 2, 0>, res_attrs = [{llvm.noundef, llvm.zeroext}], will_return}> : (!llvm.ptr, !llvm.ptr) -> i1
    "llvm.cond_br"(%27)[^bb6, ^bb8] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb6:  // pred: ^bb5
    %28 = "llvm.call"(%arg1) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<tail>, arg_attrs = [{llvm.align = 8 : i64, llvm.dereferenceable = 12 : i64, llvm.nonnull, llvm.noundef}], callee = @_ZNK4llvm5APInt25countLeadingZerosSlowCaseEv, fastmathFlags = #llvm.fastmath<none>, memory_effects = #llvm.memory_effects<other = read, argMem = read, inaccessibleMem = read, errnoMem = read, targetMem0 = none, targetMem1 = none>, no_unwind, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 1, 0>, res_attrs = [{llvm.noundef}], will_return}> : (!llvm.ptr) -> i32
    %29 = "llvm.icmp"(%28, %25) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%29, %3)[^bb22, ^bb8] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i1) -> ()
  ^bb7:  // pred: ^bb4
    ...
    %31 = "llvm.load"(%23) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, access_type = <id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, offset = 0>]}> : (!llvm.ptr) -> i64
    %32 = "llvm.or"(%31, %30) : (i64, i64) -> i64
    %33 = "llvm.icmp"(%32, %4) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%33, %3)[^bb22, ^bb8] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i1) -> ()
  ^bb8:  // 3 preds: ^bb5, ^bb6, ^bb7
    ...
    %35 = "llvm.icmp"(%34, %5) <{predicate = 4 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%35)[^bb9, ^bb13] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb9:  // pred: ^bb8
    %36 = "llvm.getelementptr"(%arg0, %6) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
  ...
  ^bb10:  // pred: ^bb9
    %39 = "llvm.load"(%12) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, access_type = <id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, offset = 0>]}> : (!llvm.ptr) -> i64
    %40 = "llvm.add"(%37, %7) <{overflowFlags = 1 : i32}> : (i32, i32) -> i32
    %41 = "llvm.zext"(%40) <{nonNeg}> : (i32) -> i64
    %42 = "llvm.shl"(%9, %41) <{overflowFlags = 2 : i32}> : (i64, i64) -> i64
    %43 = "llvm.icmp"(%39, %42) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%43)[^bb13, ^bb15] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb11:  // pred: ^bb9
    %44 = "llvm.add"(%37, %7) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
    %45 = "llvm.and"(%44, %8) : (i32, i32) -> i32
    %46 = "llvm.zext"(%45) <{nonNeg}> : (i32) -> i64
    %47 = "llvm.shl"(%9, %46) <{overflowFlags = 2 : i32}> : (i64, i64) -> i64
    %48 = "llvm.load"(%12) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
    %49 = "llvm.lshr"(%44, %10) : (i32, i32) -> i32
  ...
  ^bb13:  // 3 preds: ^bb8, ^bb10, ^bb12
    ...
    %65 = "llvm.select"(%15, %arg0, %64) <{fastmathFlags = #llvm.fastmath<none>}> : (i1, !llvm.ptr, !llvm.ptr) -> !llvm.ptr
  ...
  ^bb14:  // pred: ^bb13
    %69 = "llvm.call"(%arg1) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<tail>, arg_attrs = [{llvm.align = 8 : i64, llvm.dereferenceable = 32 : i64, llvm.nonnull, llvm.noundef}], callee = @_ZNK4llvm13ConstantRange13isAllNegativeEv, fastmathFlags = #llvm.fastmath<none>, memory_effects = #llvm.memory_effects<other = read, argMem = read, inaccessibleMem = read, errnoMem = read, targetMem0 = none, targetMem1 = none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 1, 0>, res_attrs = [{llvm.noundef, llvm.zeroext}]}> : (!llvm.ptr) -> i1
    "llvm.cond_br"(%69, %3)[^bb22, ^bb15] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i1) -> ()
  ^bb15:  // 5 preds: ^bb10, ^bb11, ^bb12, ^bb13, ^bb14
    %70 = "llvm.call"(%arg0) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<tail>, arg_attrs = [{llvm.align = 8 : i64, llvm.dereferenceable = 32 : i64, llvm.nonnull, llvm.noundef}], callee = @_ZNK4llvm13ConstantRange13isAllNegativeEv, fastmathFlags = #llvm.fastmath<none>, memory_effects = #llvm.memory_effects<other = read, argMem = read, inaccessibleMem = read, errnoMem = read, targetMem0 = none, targetMem1 = none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 1, 0>, res_attrs = [{llvm.noundef, llvm.zeroext}]}> : (!llvm.ptr) -> i1
    "llvm.cond_br"(%70, %11)[^bb16, ^bb22] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i1) -> ()
  ^bb16:  // pred: ^bb15
    %71 = "llvm.call"(%arg1, %23) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<tail>, arg_attrs = [{llvm.align = 8 : i64, llvm.dereferenceable = 12 : i64, llvm.nonnull, llvm.noundef, llvm.readonly}, {llvm.align = 8 : i64, llvm.dereferenceable = 12 : i64, llvm.nonnull, llvm.noundef, llvm.readonly}], callee = @_ZNK4llvm5APInt13compareSignedERKS0_, fastmathFlags = #llvm.fastmath<none>, memory_effects = #llvm.memory_effects<other = read, argMem = read, inaccessibleMem = read, errnoMem = read, targetMem0 = none, targetMem1 = none>, no_unwind, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 2, 0>, res_attrs = [{llvm.noundef}], will_return}> : (!llvm.ptr, !llvm.ptr) -> i32
    %72 = "llvm.icmp"(%71, %5) <{predicate = 4 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%72)[^bb17, ^bb21] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb17:  // pred: ^bb16
    %73 = "llvm.getelementptr"(%arg1, %6) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
  ...
  ^bb18:  // pred: ^bb17
    %76 = "llvm.load"(%23) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, access_type = <id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, offset = 0>]}> : (!llvm.ptr) -> i64
    %77 = "llvm.add"(%74, %7) <{overflowFlags = 1 : i32}> : (i32, i32) -> i32
    %78 = "llvm.zext"(%77) <{nonNeg}> : (i32) -> i64
    %79 = "llvm.shl"(%9, %78) <{overflowFlags = 2 : i32}> : (i64, i64) -> i64
    %80 = "llvm.icmp"(%76, %79) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%80, %11)[^bb21, ^bb22] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i1) -> ()
  ^bb19:  // pred: ^bb17
    %81 = "llvm.add"(%74, %7) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
    %82 = "llvm.and"(%81, %8) : (i32, i32) -> i32
    %83 = "llvm.zext"(%82) <{nonNeg}> : (i32) -> i64
    %84 = "llvm.shl"(%9, %83) <{overflowFlags = 2 : i32}> : (i64, i64) -> i64
    %85 = "llvm.load"(%23) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
    %86 = "llvm.lshr"(%81, %10) : (i32, i32) -> i32
    ...
    "llvm.cond_br"(%91, %11)[^bb22, ^bb20] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i1) -> ()
  ^bb20:  // pred: ^bb19
    %92 = "llvm.call"(%23) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<tail>, arg_attrs = [{llvm.align = 8 : i64, llvm.dereferenceable = 12 : i64, llvm.nonnull, llvm.noundef, llvm.readonly}], callee = @_ZNK4llvm5APInt26countTrailingZerosSlowCaseEv, fastmathFlags = #llvm.fastmath<none>, memory_effects = #llvm.memory_effects<other = read, argMem = read, inaccessibleMem = read, errnoMem = read, targetMem0 = none, targetMem1 = none>, no_unwind, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 1, 0>, res_attrs = [{llvm.noundef}], will_return}> : (!llvm.ptr) -> i32
    %93 = "llvm.icmp"(%92, %81) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%93, %11)[^bb21, ^bb22] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i1) -> ()
  ^bb21:  // 3 preds: ^bb16, ^bb18, ^bb20
    %94 = "llvm.add"(%25, %7) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
    %95 = "llvm.and"(%94, %8) : (i32, i32) -> i32
    %96 = "llvm.zext"(%95) <{nonNeg}> : (i32) -> i64
    %97 = "llvm.shl"(%9, %96) <{overflowFlags = 2 : i32}> : (i64, i64) -> i64
    %98 = "llvm.load"(%arg1) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
    %99 = "llvm.lshr"(%94, %10) : (i32, i32) -> i32
    %100 = "llvm.zext"(%99) <{nonNeg}> : (i32) -> i64
    %101 = "llvm.getelementptr"(%98, %100) <{elem_type = i64, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %102 = "llvm.select"(%26, %arg1, %101) <{fastmathFlags = #llvm.fastmath<none>}> : (i1, !llvm.ptr, !llvm.ptr) -> !llvm.ptr
    %103 = "llvm.load"(%102) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, access_type = <id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, offset = 0>]}> : (!llvm.ptr) -> i64
    %104 = "llvm.and"(%103, %97) : (i64, i64) -> i64
    %105 = "llvm.icmp"(%104, %4) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.br"(%105)[^bb22] : (i1) -> ()
  ^bb22(%106: i1):  // 10 preds: ^bb2, ^bb3, ^bb6, ^bb7, ^bb14, ^bb15, ^bb18, ^bb19, ^bb20, ^bb21
    "llvm.return"(%106) : (i1) -> ()
  }) : () -> ()
