"builtin.module"() ({
  "llvm.comdat"() <{sym_name = "__llvm_global_comdat"}> ({
    "llvm.comdat_selector"() <{comdat = 0 : i64, sym_name = "_ZN4llvm12DenseMapBaseINS_13SmallDenseMapIPvSt4pairINS_12PointerUnionIJPNS_15MetadataAsValueEPNS_8MetadataEPNS_14DebugValueUserEEEEmELj4ENS_12DenseMapInfoIS2_vEENS_6detail12DenseMapPairIS2_SC_EEEES2_SC_SE_SH_E8moveFromERSI_"}> : () -> ()
  }) : () -> ()
  ...
  ^bb4(%57: i32):  // 2 preds: ^bb3, ^bb6
    ...
    %64 = "llvm.mul"(%63, %13) <{overflowFlags = 0 : i32}> : (i64, i64) -> i64
    %65 = "llvm.lshr"(%64, %9) : (i64, i64) -> i64
    %66 = "llvm.xor"(%65, %64) : (i64, i64) -> i64
    %67 = "llvm.trunc"(%66) <{overflowFlags = 0 : i32}> : (i64) -> i32
    %68 = "llvm.and"(%46, %67) : (i32, i32) -> i32
    %69 = "llvm.zext"(%68) : (i32) -> i64
    %70 = "llvm.lshr"(%69, %10) : (i64, i64) -> i64
    %71 = "llvm.getelementptr"(%39, %70) <{elem_type = i32, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %72 = "llvm.load"(%71) <{alignment = 4 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, access_type = <id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (!llvm.ptr) -> i32
    %73 = "llvm.and"(%68, %14) : (i32, i32) -> i32
    %74 = "llvm.shl"(%0, %73) <{overflowFlags = 2 : i32}> : (i32, i32) -> i32
    %75 = "llvm.and"(%74, %72) : (i32, i32) -> i32
    %76 = "llvm.icmp"(%75, %1) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%76, %69, %70, %74, %68)[^bb6, ^bb5] <{operandSegmentSizes = array<i32: 1, 3, 1>}> : (i1, i64, i64, i32, i32) -> ()
  ^bb5(%77: i32):  // 2 preds: ^bb4, ^bb5
    %78 = "llvm.add"(%77, %0) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
    %79 = "llvm.and"(%78, %46) : (i32, i32) -> i32
    %80 = "llvm.zext"(%79) : (i32) -> i64
    %81 = "llvm.lshr"(%80, %10) : (i64, i64) -> i64
    %82 = "llvm.getelementptr"(%39, %81) <{elem_type = i32, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %83 = "llvm.load"(%82) <{alignment = 4 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, access_type = <id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (!llvm.ptr) -> i32
    %84 = "llvm.and"(%79, %14) : (i32, i32) -> i32
    ...
    "llvm.cond_br"(%87, %80, %81, %85, %79)[^bb6, ^bb5] <{loop_annotation = #llvm.loop_annotation<mustProgress = true>, operandSegmentSizes = array<i32: 1, 3, 1>}> : (i1, i64, i64, i32, i32) -> ()
  ^bb6(%88: i64, %89: i64, %90: i32):  // 2 preds: ^bb4, ^bb5
    %91 = "llvm.getelementptr"(%42, %88) <{elem_type = !llvm.struct<"struct.llvm::detail::DenseMapPair", (struct<"struct.std::pair", (ptr, struct<"struct.std::pair.348", (struct<"class.llvm::PointerUnion", (struct<"class.llvm::pointer_union_detail::PointerUnionMembers", (struct<"class.llvm::pointer_union_detail::PointerUnionMembers.335", (struct<"class.llvm::pointer_union_detail::PointerUnionMembers.336", (struct<"class.llvm::pointer_union_detail::PointerUnionMembers.337", (struct<"struct.llvm::detail::PunnedPointer", (array<8 x i8>)>)>)>)>)>)>, i64)>)>)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    "llvm.store"(%62, %91) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "any pointer", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, access_type = <id = "any pointer", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (!llvm.ptr, !llvm.ptr) -> ()
    %92 = "llvm.getelementptr"(%91, %2) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %93 = "llvm.getelementptr"(%25, %60) <{elem_type = !llvm.struct<"struct.llvm::detail::DenseMapPair", (struct<"struct.std::pair", (ptr, struct<"struct.std::pair.348", (struct<"class.llvm::PointerUnion", (struct<"class.llvm::pointer_union_detail::PointerUnionMembers", (struct<"class.llvm::pointer_union_detail::PointerUnionMembers.335", (struct<"class.llvm::pointer_union_detail::PointerUnionMembers.336", (struct<"class.llvm::pointer_union_detail::PointerUnionMembers.337", (struct<"struct.llvm::detail::PunnedPointer", (array<8 x i8>)>)>)>)>)>)>, i64)>)>)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 0, 1>}> : (!llvm.ptr, i64) -> !llvm.ptr
    "llvm.intr.memcpy"(%92, %93, %4) <{arg_attrs = [{llvm.align = 8 : i64, llvm.dereferenceable = 16 : i64, llvm.nonnull, llvm.noundef}, {llvm.align = 8 : i64, llvm.dereferenceable = 16 : i64, llvm.nonnull, llvm.noundef}, {}], isVolatile = false}> : (!llvm.ptr, !llvm.ptr, i64) -> ()
    %94 = "llvm.getelementptr"(%39, %89) <{elem_type = i32, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %95 = "llvm.load"(%94) <{alignment = 4 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, access_type = <id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (!llvm.ptr) -> i32
    %96 = "llvm.or"(%95, %90) : (i32, i32) -> i32
    "llvm.store"(%96, %94) <{alignment = 4 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, access_type = <id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (i32, !llvm.ptr) -> ()
    %97 = "llvm.add"(%57, %7) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
    %98 = "llvm.and"(%97, %57) : (i32, i32) -> i32
    %99 = "llvm.icmp"(%98, %1) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%99, %98)[^bb7, ^bb4] <{loop_annotation = #llvm.loop_annotation<mustProgress = true>, operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i32) -> ()
  ^bb7:  // 2 preds: ^bb2, ^bb6
    %100 = "llvm.add"(%51, %15) <{overflowFlags = 3 : i32}> : (i64, i64) -> i64
    %101 = "llvm.icmp"(%100, %50) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%101, %100)[^bb8, ^bb2] <{loop_annotation = #llvm.loop_annotation<mustProgress = true>, operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i64) -> ()
  ^bb8:  // pred: ^bb7
    %102 = "llvm.load"(%arg1) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> i32
    %103 = "llvm.load"(%arg0) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> i32
    %104 = "llvm.and"(%103, %0) : (i32, i32) -> i32
    "llvm.br"(%104, %102)[^bb9] : (i32, i32) -> ()
  ^bb9(%105: i32, %106: i32):  // 2 preds: ^bb0, ^bb8
    %107 = "llvm.and"(%106, %16) : (i32, i32) -> i32
    %108 = "llvm.or"(%105, %107) <{isDisjoint}> : (i32, i32) -> i32
    ...
    "llvm.cond_br"(%111, %109)[^bb10, ^bb12] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i32) -> ()
  ^bb10:  // pred: ^bb9
    %112 = "llvm.load"(%30) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, access_type = <id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, offset = 0>]}> : (!llvm.ptr) -> i32
    %113 = "llvm.icmp"(%112, %1) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%113, %109)[^bb12, ^bb11] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i32) -> ()
  ^bb11:  // pred: ^bb10
    %114 = "llvm.load"(%23) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, access_type = <id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, offset = 0>]}> : (!llvm.ptr) -> !llvm.ptr
    %115 = "llvm.zext"(%112) : (i32) -> i64
    %116 = "llvm.mul"(%115, %5) <{overflowFlags = 3 : i32}> : (i64, i64) -> i64
    %117 = "llvm.add"(%115, %9) <{overflowFlags = 3 : i32}> : (i64, i64) -> i64
    %118 = "llvm.lshr"(%117, %17) : (i64, i64) -> i64
    %119 = "llvm.and"(%118, %18) : (i64, i64) -> i64
    %120 = "llvm.add"(%119, %116) <{overflowFlags = 3 : i32}> : (i64, i64) -> i64
    "llvm.call"(%114, %120, %2) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<tail>, arg_attrs = [{llvm.noundef}, {llvm.noundef}, {llvm.noundef}], callee = @_ZN4llvm17deallocate_bufferEPvmm, fastmathFlags = #llvm.fastmath<none>, no_unwind, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 3, 0>}> : (!llvm.ptr, i64, i64) -> ()
    %121 = "llvm.load"(%arg1) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> i32
    "llvm.br"(%121)[^bb12] : (i32) -> ()
  ^bb12(%122: i32):  // 3 preds: ^bb9, ^bb10, ^bb11
    %123 = "llvm.and"(%122, %16) : (i32, i32) -> i32
    "llvm.store"(%123, %arg1) <{alignment = 8 : i64, ordering = 0 : i64}> : (i32, !llvm.ptr) -> ()
