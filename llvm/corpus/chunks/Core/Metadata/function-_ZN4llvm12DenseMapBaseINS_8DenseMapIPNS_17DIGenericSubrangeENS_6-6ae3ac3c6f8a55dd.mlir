"builtin.module"() ({
  ...
  ^bb11(%77: i64):  // 2 preds: ^bb9, ^bb10
    ...
    %82 = "llvm.getelementptr"(%24, %81) <{elem_type = !llvm.struct<"class.llvm::detail::DenseSetPair.1378", (ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
  ...
  ^bb13:  // pred: ^bb14
    ...
    %94 = "llvm.getelementptr"(%24, %93) <{elem_type = !llvm.struct<"class.llvm::detail::DenseSetPair.1378", (ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
