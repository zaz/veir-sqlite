"builtin.module"() ({
  ...
  ^bb3:  // pred: ^bb2
    ...
    "llvm.store"(%34, %27) <{alignment = 8 : i64, noalias_scopes = [#llvm.alias_scope<id = distinct[0]<>, domain = <id = distinct[1]<>, description = "_ZN4llvm25ContextAndReplaceableUses19takeReplaceableUsesEv">, description = "_ZN4llvm25ContextAndReplaceableUses19takeReplaceableUsesEv: argument 0">], ordering = 0 : i64}> : (i64, !llvm.ptr) -> ()
    "llvm.call"(%32, %10) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<tail>, arg_attrs = [{llvm.align = 8 : i64, llvm.dereferenceable = 128 : i64, llvm.nonnull, llvm.noundef}, {llvm.noundef, llvm.zeroext}], callee = @_ZN4llvm23ReplaceableMetadataImpl14resolveAllUsesEb, fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 2, 0>}> : (!llvm.ptr, i1) -> ()
    %35 = "llvm.getelementptr"(%32, %11) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
  ...
  ^bb4:  // pred: ^bb3
    %39 = "llvm.getelementptr"(%32, %13) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %40 = "llvm.load"(%39) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, access_type = <id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, offset = 0>]}> : (!llvm.ptr) -> i32
    %41 = "llvm.icmp"(%40, %5) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%41)[^bb6, ^bb5] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb5:  // pred: ^bb4
    %42 = "llvm.getelementptr"(%32, %14) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    %44 = "llvm.zext"(%40) : (i32) -> i64
    %45 = "llvm.mul"(%44, %14) <{overflowFlags = 3 : i32}> : (i64, i64) -> i64
    %46 = "llvm.add"(%44, %15) <{overflowFlags = 3 : i32}> : (i64, i64) -> i64
    %47 = "llvm.lshr"(%46, %16) : (i64, i64) -> i64
    %48 = "llvm.and"(%47, %17) : (i64, i64) -> i64
    %49 = "llvm.add"(%48, %45) <{overflowFlags = 3 : i32}> : (i64, i64) -> i64
    "llvm.call"(%43, %49, %6) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<tail>, arg_attrs = [{llvm.noundef}, {llvm.noundef}, {llvm.noundef}], callee = @_ZN4llvm17deallocate_bufferEPvmm, fastmathFlags = #llvm.fastmath<none>, no_unwind, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 3, 0>}> : (!llvm.ptr, i64, i64) -> ()
    "llvm.br"()[^bb6] : () -> ()
  ^bb6:  // 3 preds: ^bb3, ^bb4, ^bb5
    "llvm.call"(%32, %18) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<tail>, arg_attrs = [{llvm.nonnull, llvm.noundef}, {llvm.noundef}], builtin, callee = @_ZdlPvm, fastmathFlags = #llvm.fastmath<none>, no_unwind, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 2, 0>}> : (!llvm.ptr, i64) -> ()
    "llvm.br"()[^bb7] : () -> ()
  ^bb7:  // 4 preds: ^bb0, ^bb1, ^bb2, ^bb6
    "llvm.return"() : () -> ()
  }) : () -> ()
