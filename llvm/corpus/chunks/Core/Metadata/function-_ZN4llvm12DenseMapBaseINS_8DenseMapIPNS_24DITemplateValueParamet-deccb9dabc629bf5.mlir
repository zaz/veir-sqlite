"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr, %arg1: !llvm.ptr, %arg2: !llvm.ptr):
    ...
    %19 = "llvm.mlir.constant"() <{value = 29 : i64}> : () -> i64
  ...
  ^bb1:  // pred: ^bb0
    ...
    %48 = "llvm.getelementptr"(%22, %10) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
  ...
  ^bb2(%51: i64, %52: i32, %53: i32):  // 2 preds: ^bb1, ^bb7
    %54 = "llvm.getelementptr"(%26, %51) <{elem_type = !llvm.struct<"class.llvm::detail::DenseSetPair.1231", (ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    %60 = "llvm.icmp"(%59, %14) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%60)[^bb4, ^bb3] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb3:  // pred: ^bb2
    %61 = "llvm.getelementptr"(%55, %15) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    "llvm.br"(%62)[^bb5] : (!llvm.ptr) -> ()
  ^bb4:  // pred: ^bb2
    %63 = "llvm.lshr"(%58, %13) : (i64, i64) -> i64
    %64 = "llvm.and"(%63, %16) : (i64, i64) -> i64
    %65 = "llvm.sub"(%14, %64) <{overflowFlags = 1 : i32}> : (i64, i64) -> i64
    %66 = "llvm.getelementptr"(%57, %65) <{elem_type = !llvm.struct<"class.llvm::MDOperand", (ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    "llvm.br"(%66)[^bb5] : (!llvm.ptr) -> ()
  ^bb5(%67: !llvm.ptr):  // 2 preds: ^bb3, ^bb4
    ...
    %69 = "llvm.getelementptr"(%67, %3) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %70 = "llvm.load"(%69) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "_ZTSN4llvm9MDOperandE", members = {<#llvm.tbaa_type_desc<id = "any pointer", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, 0>}>, access_type = <id = "any pointer", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (!llvm.ptr) -> !llvm.ptr
    %71 = "llvm.getelementptr"(%55, %17) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %72 = "llvm.load"(%71) <{alignment = 1 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> i8
    %73 = "llvm.lshr"(%72, %18) : (i8, i8) -> i8
    %74 = "llvm.zext"(%56) : (i16) -> i32
    %75 = "llvm.getelementptr"(%67, %1) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    "llvm.store"(%68, %47) <{alignment = 4 : i64, ordering = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> ()
    "llvm.store"(%70, %48) <{alignment = 4 : i64, ordering = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> ()
    "llvm.store"(%73, %49) <{alignment = 4 : i64, ordering = 0 : i64}> : (i8, !llvm.ptr) -> ()
    "llvm.store"(%76, %50) <{alignment = 1 : i64, ordering = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> ()
    %77 = "llvm.call"(%22, %19) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<none>, arg_attrs = [{llvm.nonnull, llvm.noundef}, {llvm.noundef}], callee = @_ZN4llvm11xxh3_64bitsEPKhm, fastmathFlags = #llvm.fastmath<none>, no_unwind, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 2, 0>, res_attrs = [{llvm.noundef}]}> : (!llvm.ptr, i64) -> i64
    "llvm.intr.lifetime.end"(%22) : (!llvm.ptr) -> ()
    %78 = "llvm.trunc"(%77) <{overflowFlags = 0 : i32}> : (i64) -> i32
    %79 = "llvm.xor"(%78, %20) : (i32, i32) -> i32
    %80 = "llvm.sub"(%53, %79) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
    %81 = "llvm.and"(%80, %31) : (i32, i32) -> i32
    %82 = "llvm.sub"(%52, %79) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
    %83 = "llvm.and"(%82, %31) : (i32, i32) -> i32
    %84 = "llvm.icmp"(%81, %83) <{predicate = 6 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%84, %53)[^bb6, ^bb7] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i32) -> ()
  ^bb6:  // pred: ^bb5
    %85 = "llvm.zext"(%53) : (i32) -> i64
    %86 = "llvm.getelementptr"(%26, %85) <{elem_type = !llvm.struct<"class.llvm::detail::DenseSetPair.1231", (ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %87 = "llvm.load"(%54) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "any pointer", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, access_type = <id = "any pointer", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (!llvm.ptr) -> !llvm.ptr
    "llvm.store"(%87, %86) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "any pointer", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, access_type = <id = "any pointer", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (!llvm.ptr, !llvm.ptr) -> ()
    "llvm.br"(%52)[^bb7] : (i32) -> ()
  ^bb7(%88: i32):  // 2 preds: ^bb5, ^bb6
    %89 = "llvm.add"(%52, %0) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
    %90 = "llvm.and"(%89, %31) : (i32, i32) -> i32
    %91 = "llvm.zext"(%90) : (i32) -> i64
    %92 = "llvm.lshr"(%91, %6) : (i64, i64) -> i64
    %93 = "llvm.getelementptr"(%28, %92) <{elem_type = i32, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %94 = "llvm.load"(%93) <{alignment = 4 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, access_type = <id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (!llvm.ptr) -> i32
    %95 = "llvm.and"(%90, %7) : (i32, i32) -> i32
    %96 = "llvm.shl"(%0, %95) <{overflowFlags = 2 : i32}> : (i32, i32) -> i32
    %97 = "llvm.and"(%96, %94) : (i32, i32) -> i32
    %98 = "llvm.icmp"(%97, %8) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%98, %88, %91, %90, %88)[^bb8, ^bb2] <{operandSegmentSizes = array<i32: 1, 1, 3>}> : (i1, i32, i64, i32, i32) -> ()
  ^bb8(%99: i32):  // 2 preds: ^bb0, ^bb7
    %100 = "llvm.and"(%99, %7) : (i32, i32) -> i32
    %101 = "llvm.shl"(%0, %100) <{overflowFlags = 2 : i32}> : (i32, i32) -> i32
    %102 = "llvm.xor"(%101, %2) : (i32, i32) -> i32
    %103 = "llvm.lshr"(%99, %21) : (i32, i32) -> i32
    %104 = "llvm.zext"(%103) <{nonNeg}> : (i32) -> i64
    %105 = "llvm.getelementptr"(%28, %104) <{elem_type = i32, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %106 = "llvm.load"(%105) <{alignment = 4 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, access_type = <id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (!llvm.ptr) -> i32
    %107 = "llvm.and"(%106, %102) : (i32, i32) -> i32
    "llvm.store"(%107, %105) <{alignment = 4 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, access_type = <id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (i32, !llvm.ptr) -> ()
    "llvm.return"() : () -> ()
  }) : () -> ()
