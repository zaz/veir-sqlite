"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr):
    ...
    %10 = "llvm.mlir.constant"() <{value = 30 : i8}> : () -> i8
    ...
    %12 = "llvm.add"(%11, %0) <{overflowFlags = 0 : i32}> : (i8, i8) -> i8
  ...
  ^bb1:  // pred: ^bb0
    ...
    %16 = "llvm.and"(%15, %6) : (i8, i8) -> i8
    %17 = "llvm.icmp"(%16, %3) <{predicate = 0 : i64}> : (i8, i8) -> i1
    "llvm.cond_br"(%17, %7)[^bb4, ^bb2] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i1) -> ()
  ^bb2:  // pred: ^bb1
    ...
    %20 = "llvm.icmp"(%19, %9) <{predicate = 1 : i64}> : (i32, i32) -> i1
    %21 = "llvm.icmp"(%11, %10) <{predicate = 0 : i64}> : (i8, i8) -> i1
    %22 = "llvm.or"(%20, %21) : (i1, i1) -> i1
    "llvm.br"(%22)[^bb4] : (i1) -> ()
  ^bb3:  // pred: ^bb0
    %23 = "llvm.add"(%11, %2) <{overflowFlags = 0 : i32}> : (i8, i8) -> i8
    %24 = "llvm.icmp"(%23, %3) <{predicate = 6 : i64}> : (i8, i8) -> i1
    %25 = "llvm.icmp"(%11, %4) <{predicate = 0 : i64}> : (i8, i8) -> i1
    %26 = "llvm.or"(%25, %24) : (i1, i1) -> i1
    "llvm.br"(%26)[^bb4] : (i1) -> ()
  ^bb4(%27: i1):  // 3 preds: ^bb1, ^bb2, ^bb3
    "llvm.return"(%27) : (i1) -> ()
  }) : () -> ()
