"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr, %arg1: !llvm.ptr):
    ...
    %21 = "llvm.alloca"(%0) <{alignment = 1 : i64, elem_type = !llvm.struct<"struct.std::array.1279", (array<5 x i8>)>}> : (i32) -> !llvm.ptr
    %22 = "llvm.alloca"(%0) <{alignment = 8 : i64, elem_type = !llvm.struct<"struct.std::array.1278", (array<33 x i8>)>}> : (i32) -> !llvm.ptr
  ...
  ^bb5(%75: i64, %76: i32):  // 2 preds: ^bb3, ^bb4
    %77 = "llvm.getelementptr"(%23, %75) <{elem_type = !llvm.struct<"class.llvm::detail::DenseSetPair.1277", (ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
  ...
  ^bb6:  // pred: ^bb5
    %80 = "llvm.getelementptr"(%23, %75) <{elem_type = !llvm.struct<"class.llvm::detail::DenseSetPair.1277", (ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
