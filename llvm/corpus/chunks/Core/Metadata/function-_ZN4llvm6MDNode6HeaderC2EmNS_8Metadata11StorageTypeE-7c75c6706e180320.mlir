"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr, %arg1: i64, %arg2: i32):
    ...
    %14 = "llvm.icmp"(%arg1, %2) <{predicate = 6 : i64}> : (i64, i64) -> i1
    %15 = "llvm.load"(%arg0) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> i64
    %16 = "llvm.and"(%15, %3) : (i64, i64) -> i64
    %17 = "llvm.icmp"(%arg2, %1) <{predicate = 1 : i64}> : (i32, i32) -> i1
    %18 = "llvm.zext"(%17) : (i1) -> i64
    %19 = "llvm.select"(%17, %4, %5) <{fastmathFlags = #llvm.fastmath<none>}> : (i1, i64, i64) -> i64
    %20 = "llvm.intr.umax"(%19, %arg1) : (i64, i64) -> i64
    %21 = "llvm.shl"(%20, %4) <{overflowFlags = 0 : i32}> : (i64, i64) -> i64
    %22 = "llvm.and"(%21, %6) : (i64, i64) -> i64
    %23 = "llvm.select"(%14, %22, %0) <{fastmathFlags = #llvm.fastmath<none>}> : (i1, i64, i64) -> i64
    %24 = "llvm.or"(%23, %18) <{isDisjoint}> : (i64, i64) -> i64
    %25 = "llvm.or"(%24, %16) <{isDisjoint}> : (i64, i64) -> i64
    "llvm.cond_br"(%14)[^bb2, ^bb1] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb1:  // pred: ^bb0
    %26 = "llvm.and"(%25, %7) : (i64, i64) -> i64
    %27 = "llvm.or"(%26, %4) <{isDisjoint}> : (i64, i64) -> i64
    ...
    "llvm.store"(%1, %30) <{alignment = 4 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "_ZTSN4llvm15SmallVectorBaseIjEE", members = {<#llvm.tbaa_type_desc<id = "any pointer", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, 0>, <#llvm.tbaa_type_desc<id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, 8>, <#llvm.tbaa_type_desc<id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, 12>}>, access_type = <id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 12>]}> : (i32, !llvm.ptr) -> ()
    ...
    "llvm.br"()[^bb5] : () -> ()
  ^bb2:  // pred: ^bb0
    %31 = "llvm.shl"(%arg1, %11) <{overflowFlags = 3 : i32}> : (i64, i64) -> i64
    %32 = "llvm.and"(%25, %7) : (i64, i64) -> i64
    %33 = "llvm.or"(%32, %31) <{isDisjoint}> : (i64, i64) -> i64
    "llvm.store"(%33, %arg0) <{alignment = 8 : i64, ordering = 0 : i64}> : (i64, !llvm.ptr) -> ()
    %34 = "llvm.icmp"(%20, %5) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%34)[^bb5, ^bb3] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb3:  // pred: ^bb2
    %35 = "llvm.sub"(%5, %20) <{overflowFlags = 1 : i32}> : (i64, i64) -> i64
    %36 = "llvm.getelementptr"(%arg0, %35) <{elem_type = !llvm.struct<"class.llvm::MDOperand", (ptr)>, noWrapFlags = 0 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    "llvm.br"(%36)[^bb4] : (!llvm.ptr) -> ()
  ^bb4(%37: !llvm.ptr):  // 2 preds: ^bb3, ^bb4
    %38 = "llvm.getelementptr"(%37, %0) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    "llvm.store"(%12, %37) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "_ZTSN4llvm9MDOperandE", members = {<#llvm.tbaa_type_desc<id = "any pointer", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, 0>}>, access_type = <id = "any pointer", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (!llvm.ptr, !llvm.ptr) -> ()
    %39 = "llvm.icmp"(%38, %arg0) <{predicate = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> i1
    "llvm.cond_br"(%39, %38)[^bb5, ^bb4] <{loop_annotation = #llvm.loop_annotation<mustProgress = true>, operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, !llvm.ptr) -> ()
