"builtin.module"() ({
  ...
  ^bb2(%46: i64, %47: i32, %48: i32):  // 2 preds: ^bb1, ^bb7
    %49 = "llvm.getelementptr"(%22, %46) <{elem_type = !llvm.struct<"class.llvm::detail::DenseSetPair.1321", (ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
  ...
  ^bb6:  // pred: ^bb5
    ...
    %79 = "llvm.getelementptr"(%22, %78) <{elem_type = !llvm.struct<"class.llvm::detail::DenseSetPair.1321", (ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
