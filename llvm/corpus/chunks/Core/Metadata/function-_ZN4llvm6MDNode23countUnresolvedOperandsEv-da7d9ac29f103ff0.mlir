"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr):
    ...
    %21 = "llvm.icmp"(%20, %2) <{predicate = 0 : i64}> : (i64, i64) -> i1
  ...
  ^bb1:  // pred: ^bb0
    ...
    "llvm.br"(%26, %23)[^bb3] : (i64, !llvm.ptr) -> ()
  ^bb2:  // pred: ^bb0
    %27 = "llvm.lshr"(%19, %1) : (i64, i64) -> i64
    %28 = "llvm.and"(%27, %5) : (i64, i64) -> i64
    %29 = "llvm.sub"(%2, %28) <{overflowFlags = 1 : i32}> : (i64, i64) -> i64
    %30 = "llvm.getelementptr"(%18, %29) <{elem_type = !llvm.struct<"class.llvm::MDOperand", (ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %31 = "llvm.lshr"(%19, %6) : (i64, i64) -> i64
    %32 = "llvm.and"(%31, %5) : (i64, i64) -> i64
    "llvm.br"(%32, %30)[^bb3] : (i64, !llvm.ptr) -> ()
  ^bb3(%33: i64, %34: !llvm.ptr):  // 2 preds: ^bb1, ^bb2
    %35 = "llvm.getelementptr"(%34, %33) <{elem_type = !llvm.struct<"class.llvm::MDOperand", (ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %36 = "llvm.icmp"(%33, %2) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%36, %7, %7, %34)[^bb9, ^bb4] <{operandSegmentSizes = array<i32: 1, 1, 2>}> : (i1, i32, i32, !llvm.ptr) -> ()
  ^bb4(%37: i32, %38: !llvm.ptr):  // 2 preds: ^bb3, ^bb8
  ...
  ^bb7:  // pred: ^bb6
    ...
    %50 = "llvm.icmp"(%49, %7) <{predicate = 1 : i64}> : (i32, i32) -> i1
    "llvm.br"(%50)[^bb8] : (i1) -> ()
  ^bb8(%51: i1):  // 4 preds: ^bb4, ^bb5, ^bb6, ^bb7
    %52 = "llvm.zext"(%51) : (i1) -> i32
    %53 = "llvm.add"(%37, %52) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
    %54 = "llvm.getelementptr"(%38, %17) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %55 = "llvm.icmp"(%54, %35) <{predicate = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> i1
    "llvm.cond_br"(%55, %53, %53, %54)[^bb9, ^bb4] <{loop_annotation = #llvm.loop_annotation<mustProgress = true>, operandSegmentSizes = array<i32: 1, 1, 2>}> : (i1, i32, i32, !llvm.ptr) -> ()
  ^bb9(%56: i32):  // 2 preds: ^bb3, ^bb8
