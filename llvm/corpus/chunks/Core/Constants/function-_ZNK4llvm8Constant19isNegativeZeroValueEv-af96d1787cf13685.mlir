"builtin.module"() ({
  ...
  "llvm.func"() <{CConv = #llvm.cconv<ccc>, alignment = 2 : i64, arg_attrs = [{llvm.align = 8 : i64, llvm.dereferenceable = 24 : i64, llvm.nonnull, llvm.noundef}], dso_local, function_type = !llvm.func<i1 (ptr)>, linkage = #llvm.linkage<external>, no_unwind, passthrough = ["mustprogress", ["min-legal-vector-width", "0"], ["no-trapping-math", "true"], ["stack-protector-buffer-size", "8"], ["target-cpu", "x86-64"]], res_attrs = [{llvm.noundef, llvm.zeroext}], sym_name = "_ZNK4llvm8Constant19isNegativeZeroValueEv", target_cpu = "x86-64", target_features = #llvm.target_features<["+cmov", "+cx8", "+fxsr", "+mmx", "+sse", "+sse2", "+x87"]>, tune_cpu = "generic", unnamed_addr = 1 : i64, uwtable_kind = #llvm.uwtableKind<async>, visibility_ = 0 : i64}> ({
  ^bb0(%arg0: !llvm.ptr):
    ...
    %15 = "llvm.mlir.addressof"() <{global_name = @_ZN4llvm11APFloatBase18semPPCDoubleDoubleE}> : () -> !llvm.ptr
    %16 = "llvm.mlir.constant"() <{value = 32 : i64}> : () -> i64
    %17 = "llvm.mlir.constant"() <{value = 20 : i64}> : () -> i64
    %18 = "llvm.mlir.constant"() <{value = 3 : i8}> : () -> i8
    %19 = "llvm.mlir.constant"() <{value = 8 : i8}> : () -> i8
    ...
    %21 = "llvm.icmp"(%20, %0) <{predicate = 0 : i64}> : (i8, i8) -> i1
    "llvm.cond_br"(%21, %arg0)[^bb4, ^bb1] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, !llvm.ptr) -> ()
  ^bb1:  // pred: ^bb0
  ...
  ^bb3:  // pred: ^bb2
    ...
    %31 = "llvm.icmp"(%30, %0) <{predicate = 0 : i64}> : (i8, i8) -> i1
    "llvm.cond_br"(%31, %28)[^bb4, ^bb6] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, !llvm.ptr) -> ()
  ^bb4(%32: !llvm.ptr):  // 2 preds: ^bb0, ^bb3
    %33 = "llvm.getelementptr"(%32, %14) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    %35 = "llvm.icmp"(%34, %15) <{predicate = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> i1
    %36 = "llvm.getelementptr"(%32, %16) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    %39 = "llvm.getelementptr"(%38, %17) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %40 = "llvm.load"(%39) <{alignment = 4 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> i8
    %41 = "llvm.and"(%40, %0) : (i8, i8) -> i8
    %42 = "llvm.icmp"(%41, %18) <{predicate = 0 : i64}> : (i8, i8) -> i1
    "llvm.cond_br"(%42, %4)[^bb5, ^bb12] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i1) -> ()
  ^bb5:  // pred: ^bb4
    %43 = "llvm.and"(%40, %19) : (i8, i8) -> i8
    %44 = "llvm.icmp"(%43, %13) <{predicate = 1 : i64}> : (i8, i8) -> i1
    "llvm.br"(%44)[^bb12] : (i1) -> ()
  ^bb6:  // 3 preds: ^bb1, ^bb2, ^bb3
    ...
    %47 = "llvm.getelementptr"(%46, %1) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %48 = "llvm.load"(%47) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> i32
    %49 = "llvm.and"(%48, %2) : (i32, i32) -> i32
    %50 = "llvm.icmp"(%49, %3) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%50, %48)[^bb7, ^bb8] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i32) -> ()
  ^bb7:  // pred: ^bb6
    %51 = "llvm.getelementptr"(%46, %6) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
  ...
  ^bb8(%56: i32):  // 2 preds: ^bb6, ^bb7
    ...
    %58 = "llvm.icmp"(%57, %7) <{predicate = 6 : i64}> : (i8, i8) -> i1
    "llvm.cond_br"(%58)[^bb11, ^bb9] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb9:  // pred: ^bb8
    %59 = "llvm.and"(%56, %8) : (i32, i32) -> i32
    %60 = "llvm.icmp"(%59, %9) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%60, %4)[^bb12, ^bb10] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i1) -> ()
  ^bb10:  // 2 preds: ^bb9, ^bb11
    ...
    %63 = "llvm.icmp"(%62, %13) <{predicate = 2 : i64}> : (i8, i8) -> i1
    "llvm.br"(%63)[^bb12] : (i1) -> ()
  ^bb11:  // pred: ^bb8
    %64 = "llvm.lshr"(%10, %57) : (i8, i8) -> i8
    %65 = "llvm.trunc"(%64) <{overflowFlags = 0 : i32}> : (i8) -> i1
    %66 = "llvm.and"(%56, %11) : (i32, i32) -> i32
    %67 = "llvm.icmp"(%66, %9) <{predicate = 0 : i64}> : (i32, i32) -> i1
    %68 = "llvm.or"(%67, %65) : (i1, i1) -> i1
    "llvm.cond_br"(%68, %4)[^bb12, ^bb10] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i1) -> ()
  ^bb12(%69: i1):  // 5 preds: ^bb4, ^bb5, ^bb9, ^bb10, ^bb11
    "llvm.return"(%69) : (i1) -> ()
  }) : () -> ()
