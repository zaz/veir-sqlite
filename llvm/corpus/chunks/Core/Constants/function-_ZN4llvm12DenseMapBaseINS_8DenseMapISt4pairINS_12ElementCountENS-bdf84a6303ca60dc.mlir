"builtin.module"() ({
  ...
  ^bb4(%30: i32):  // 2 preds: ^bb3, ^bb12
    ...
    %34 = "llvm.getelementptr"(%18, %33) <{elem_type = !llvm.struct<"struct.llvm::detail::DenseMapPair.622", (struct<"struct.std::pair.623", (struct<"struct.std::pair", (struct<"class.llvm::ElementCount", (struct<"class.llvm::details::FixedOrScalableQuantity.base", packed (i32, i8)>, array<3 x i8>)>, struct<"class.llvm::APInt", packed (struct<"union.anon", (i64)>, i32, array<4 x i8>)>)>, struct<"class.std::unique_ptr.399", (struct<"struct.std::__uniq_ptr_data.400", (struct<"class.std::__uniq_ptr_impl.401", (struct<"class.std::tuple.402", (struct<"struct.std::_Tuple_impl.403", (struct<"struct.std::_Head_base.406", (ptr)>)>)>)>)>)>)>)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, 0, 1>}> : (!llvm.ptr, i64) -> !llvm.ptr
  ...
  ^bb9:  // 2 preds: ^bb4, ^bb8
    ...
    %43 = "llvm.getelementptr"(%18, %33) <{elem_type = !llvm.struct<"struct.llvm::detail::DenseMapPair.622", (struct<"struct.std::pair.623", (struct<"struct.std::pair", (struct<"class.llvm::ElementCount", (struct<"class.llvm::details::FixedOrScalableQuantity.base", packed (i32, i8)>, array<3 x i8>)>, struct<"class.llvm::APInt", packed (struct<"union.anon", (i64)>, i32, array<4 x i8>)>)>, struct<"class.std::unique_ptr.399", (struct<"struct.std::__uniq_ptr_data.400", (struct<"class.std::__uniq_ptr_impl.401", (struct<"class.std::tuple.402", (struct<"struct.std::_Tuple_impl.403", (struct<"struct.std::_Head_base.406", (ptr)>)>)>)>)>)>)>)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
