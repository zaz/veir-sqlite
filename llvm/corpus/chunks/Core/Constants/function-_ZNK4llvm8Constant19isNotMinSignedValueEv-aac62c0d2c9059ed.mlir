"builtin.module"() ({
  ...
  "llvm.func"() <{CConv = #llvm.cconv<ccc>, alignment = 2 : i64, arg_attrs = [{llvm.align = 8 : i64, llvm.dereferenceable = 24 : i64, llvm.nonnull, llvm.noundef}, {llvm.noundef, llvm.zeroext}], dso_local, function_type = !llvm.func<ptr (ptr, i1)>, linkage = #llvm.linkage<external>, no_unwind, passthrough = ["mustprogress", ["min-legal-vector-width", "0"], ["no-trapping-math", "true"], ["stack-protector-buffer-size", "8"], ["target-cpu", "x86-64"]], res_attrs = [{llvm.noundef}], sym_name = "_ZNK4llvm8Constant13getSplatValueEb", target_cpu = "x86-64", target_features = #llvm.target_features<["+cmov", "+cx8", "+fxsr", "+mmx", "+sse", "+sse2", "+x87"]>, tune_cpu = "generic", unnamed_addr = 1 : i64, uwtable_kind = #llvm.uwtableKind<async>, visibility_ = 0 : i64}> ({
  }) : () -> ()
  "llvm.func"() <{CConv = #llvm.cconv<ccc>, alignment = 2 : i64, arg_attrs = [{llvm.align = 8 : i64, llvm.dereferenceable = 24 : i64, llvm.nonnull, llvm.noundef}, {llvm.noundef}], dso_local, function_type = !llvm.func<ptr (ptr, i32)>, linkage = #llvm.linkage<external>, no_unwind, passthrough = ["mustprogress", ["min-legal-vector-width", "0"], ["no-trapping-math", "true"], ["stack-protector-buffer-size", "8"], ["target-cpu", "x86-64"]], res_attrs = [{llvm.noundef}], sym_name = "_ZNK4llvm8Constant19getAggregateElementEj", target_cpu = "x86-64", target_features = #llvm.target_features<["+cmov", "+cx8", "+fxsr", "+mmx", "+sse", "+sse2", "+x87"]>, tune_cpu = "generic", unnamed_addr = 1 : i64, uwtable_kind = #llvm.uwtableKind<async>, visibility_ = 0 : i64}> ({
  }) : () -> ()
  "llvm.func"() <{CConv = #llvm.cconv<ccc>, alignment = 2 : i64, arg_attrs = [{llvm.align = 8 : i64, llvm.dereferenceable = 24 : i64, llvm.nonnull, llvm.noundef}], dso_local, function_type = !llvm.func<i1 (ptr)>, linkage = #llvm.linkage<external>, no_unwind, passthrough = ["mustprogress", ["min-legal-vector-width", "0"], ["no-trapping-math", "true"], ["stack-protector-buffer-size", "8"], ["target-cpu", "x86-64"]], res_attrs = [{llvm.noundef, llvm.zeroext}], sym_name = "_ZNK4llvm8Constant19isNotMinSignedValueEv", target_cpu = "x86-64", target_features = #llvm.target_features<["+cmov", "+cx8", "+fxsr", "+mmx", "+sse", "+sse2", "+x87"]>, tune_cpu = "generic", unnamed_addr = 1 : i64, uwtable_kind = #llvm.uwtableKind<async>, visibility_ = 0 : i64}> ({
  ^bb0(%arg0: !llvm.ptr):
    ...
    %17 = "llvm.mlir.constant"() <{value = 254 : i32}> : () -> i32
  ...
  ^bb1(%19: !llvm.ptr):  // 2 preds: ^bb0, ^bb22
    ...
    "llvm.switch"(%20)[^bb16, ^bb2, ^bb7] <{case_operand_segments = array<i32: 0, 0>, case_values = dense<[5, 7]> : vector<2xi8>, operandSegmentSizes = array<i32: 1, 0, 0>}> : (i8) -> ()
  ^bb2:  // pred: ^bb1
    %21 = "llvm.getelementptr"(%19, %1) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %22 = "llvm.getelementptr"(%19, %11) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
  ...
  ^bb3:  // pred: ^bb2
    ...
    %26 = "llvm.add"(%23, %5) <{overflowFlags = 1 : i32}> : (i32, i32) -> i32
    %27 = "llvm.zext"(%26) <{nonNeg}> : (i32) -> i64
    %28 = "llvm.shl"(%7, %27) <{overflowFlags = 2 : i32}> : (i64, i64) -> i64
    %29 = "llvm.icmp"(%25, %28) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.br"(%29)[^bb6] : (i1) -> ()
  ^bb4:  // pred: ^bb2
    %30 = "llvm.add"(%23, %5) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
  ...
  ^bb10:  // 2 preds: ^bb8, ^bb9
    %48 = "llvm.getelementptr"(%18, %3) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %49 = "llvm.load"(%48) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "_ZTSN4llvm5APIntE", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>, <#llvm.tbaa_type_desc<id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, 8>}>, access_type = <id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 8>]}> : (!llvm.ptr) -> i32
    %50 = "llvm.icmp"(%49, %4) <{predicate = 6 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%50)[^bb13, ^bb11] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb11:  // pred: ^bb10
    %51 = "llvm.add"(%49, %5) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
    %52 = "llvm.and"(%51, %6) : (i32, i32) -> i32
    %53 = "llvm.zext"(%52) <{nonNeg}> : (i32) -> i64
    %54 = "llvm.shl"(%7, %53) <{overflowFlags = 2 : i32}> : (i64, i64) -> i64
    %55 = "llvm.load"(%18) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
    %56 = "llvm.lshr"(%51, %8) : (i32, i32) -> i32
    ...
    %60 = "llvm.and"(%59, %54) : (i64, i64) -> i64
    %61 = "llvm.icmp"(%60, %9) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%61, %10)[^bb14, ^bb12] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i1) -> ()
  ^bb12:  // pred: ^bb11
    %62 = "llvm.call"(%18) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<none>, arg_attrs = [{llvm.align = 8 : i64, llvm.dereferenceable = 12 : i64, llvm.nonnull, llvm.noundef}], callee = @_ZNK4llvm5APInt26countTrailingZerosSlowCaseEv, fastmathFlags = #llvm.fastmath<none>, memory_effects = #llvm.memory_effects<other = read, argMem = read, inaccessibleMem = read, errnoMem = read, targetMem0 = none, targetMem1 = none>, no_unwind, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 1, 0>, res_attrs = [{llvm.noundef}], will_return}> : (!llvm.ptr) -> i32
    %63 = "llvm.icmp"(%62, %51) <{predicate = 1 : i64}> : (i32, i32) -> i1
    "llvm.br"(%63)[^bb14] : (i1) -> ()
  ^bb13:  // pred: ^bb10
    %64 = "llvm.load"(%18) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, access_type = <id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, offset = 0>]}> : (!llvm.ptr) -> i64
    %65 = "llvm.add"(%49, %5) <{overflowFlags = 1 : i32}> : (i32, i32) -> i32
    %66 = "llvm.zext"(%65) <{nonNeg}> : (i32) -> i64
    %67 = "llvm.shl"(%7, %66) <{overflowFlags = 2 : i32}> : (i64, i64) -> i64
    %68 = "llvm.icmp"(%64, %67) <{predicate = 1 : i64}> : (i64, i64) -> i1
    "llvm.br"(%68)[^bb15] : (i1) -> ()
  ^bb14(%69: i1):  // 2 preds: ^bb11, ^bb12
    ...
    "llvm.br"(%69)[^bb15] : (i1) -> ()
  ^bb15(%70: i1):  // 2 preds: ^bb13, ^bb14
    "llvm.intr.lifetime.end"(%18) : (!llvm.ptr) -> ()
    "llvm.br"(%70)[^bb23] : (i1) -> ()
  ^bb16:  // pred: ^bb1
    %71 = "llvm.getelementptr"(%19, %3) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    %77 = "llvm.icmp"(%72, %15) <{predicate = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> i1
    %78 = "llvm.or"(%77, %76) : (i1, i1) -> i1
    "llvm.cond_br"(%78)[^bb21, ^bb17] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb17:  // pred: ^bb16
    %79 = "llvm.getelementptr"(%72, %11) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    %81 = "llvm.icmp"(%80, %16) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%81, %10, %16)[^bb23, ^bb19] <{operandSegmentSizes = array<i32: 1, 1, 1>}> : (i1, i1, i32) -> ()
  ^bb18:  // pred: ^bb20
    %82 = "llvm.add"(%84, %0) <{overflowFlags = 2 : i32}> : (i32, i32) -> i32
    %83 = "llvm.icmp"(%82, %80) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%83, %10, %82)[^bb23, ^bb19] <{loop_annotation = #llvm.loop_annotation<mustProgress = true>, operandSegmentSizes = array<i32: 1, 1, 1>}> : (i1, i1, i32) -> ()
  ^bb19(%84: i32):  // 2 preds: ^bb17, ^bb18
    %85 = "llvm.call"(%19, %84) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<tail>, arg_attrs = [{llvm.align = 8 : i64, llvm.dereferenceable = 24 : i64, llvm.nonnull, llvm.noundef}, {llvm.noundef}], callee = @_ZNK4llvm8Constant19getAggregateElementEj, fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 2, 0>, res_attrs = [{llvm.noundef}]}> : (!llvm.ptr, i32) -> !llvm.ptr
    %86 = "llvm.icmp"(%85, %15) <{predicate = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> i1
    "llvm.cond_br"(%86, %12)[^bb23, ^bb20] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i1) -> ()
  ^bb20:  // pred: ^bb19
    %87 = "llvm.call"(%85) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<tail>, arg_attrs = [{llvm.align = 8 : i64, llvm.dereferenceable = 24 : i64, llvm.nonnull, llvm.noundef}], callee = @_ZNK4llvm8Constant19isNotMinSignedValueEv, fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 1, 0>, res_attrs = [{llvm.noundef, llvm.zeroext}]}> : (!llvm.ptr) -> i1
    "llvm.cond_br"(%87, %12)[^bb18, ^bb23] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i1) -> ()
  ^bb21:  // pred: ^bb16
    %88 = "llvm.and"(%74, %17) : (i32, i32) -> i32
    %89 = "llvm.icmp"(%88, %14) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%89, %12)[^bb22, ^bb23] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i1) -> ()
  ^bb22:  // pred: ^bb21
    %90 = "llvm.call"(%19, %12) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<tail>, arg_attrs = [{llvm.align = 8 : i64, llvm.dereferenceable = 24 : i64, llvm.nonnull, llvm.noundef}, {llvm.noundef, llvm.zeroext}], callee = @_ZNK4llvm8Constant13getSplatValueEb, fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 2, 0>, res_attrs = [{llvm.noundef}]}> : (!llvm.ptr, i1) -> !llvm.ptr
    %91 = "llvm.icmp"(%90, %15) <{predicate = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> i1
    "llvm.cond_br"(%91, %12, %90)[^bb23, ^bb1] <{operandSegmentSizes = array<i32: 1, 1, 1>}> : (i1, i1, !llvm.ptr) -> ()
  ^bb23(%92: i1):  // 8 preds: ^bb6, ^bb15, ^bb17, ^bb18, ^bb19, ^bb20, ^bb21, ^bb22
    "llvm.return"(%92) : (i1) -> ()
  }) : () -> ()
