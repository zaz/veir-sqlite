"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr):
    ...
    %12 = "llvm.icmp"(%11, %0) <{predicate = 6 : i64}> : (i8, i8) -> i1
    "llvm.cond_br"(%12, %1)[^bb8, ^bb1] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i1) -> ()
  ^bb1:  // pred: ^bb0
    %13 = "llvm.icmp"(%11, %2) <{predicate = 6 : i64}> : (i8, i8) -> i1
    "llvm.cond_br"(%13, %3)[^bb8, ^bb2] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i1) -> ()
  ^bb2:  // pred: ^bb1
    "llvm.switch"(%11, %1)[^bb8, ^bb3, ^bb3, ^bb3, ^bb3] <{case_operand_segments = array<i32: 0, 0, 0, 0>, case_values = dense<[19, 13, 12, 11]> : vector<4xi8>, operandSegmentSizes = array<i32: 1, 1, 0>}> : (i8, i1) -> ()
  ^bb3:  // 4 preds: ^bb2, ^bb2, ^bb2, ^bb2
  ...
  ^bb4:  // pred: ^bb3
    ...
    %20 = "llvm.and"(%15, %8) : (i32, i32) -> i32
    %21 = "llvm.zext"(%20) <{nonNeg}> : (i32) -> i64
    "llvm.br"(%19, %21)[^bb6] : (!llvm.ptr, i64) -> ()
  ^bb5:  // pred: ^bb3
    %22 = "llvm.and"(%15, %8) : (i32, i32) -> i32
    %23 = "llvm.zext"(%22) <{nonNeg}> : (i32) -> i64
    %24 = "llvm.sub"(%9, %23) <{overflowFlags = 1 : i32}> : (i64, i64) -> i64
    %25 = "llvm.getelementptr"(%arg0, %24) <{elem_type = !llvm.struct<"class.llvm::Use", (ptr, ptr, ptr, ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    "llvm.br"(%25, %23)[^bb6] : (!llvm.ptr, i64) -> ()
  ^bb6(%26: !llvm.ptr, %27: i64):  // 2 preds: ^bb4, ^bb5
    %28 = "llvm.getelementptr"(%26, %27) <{elem_type = !llvm.struct<"class.llvm::Use", (ptr, ptr, ptr, ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %29 = "llvm.icmp"(%27, %9) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%29, %3, %26)[^bb8, ^bb7] <{operandSegmentSizes = array<i32: 1, 1, 1>}> : (i1, i1, !llvm.ptr) -> ()
  ^bb7(%30: !llvm.ptr):  // 2 preds: ^bb6, ^bb7
    ...
    %32 = "llvm.call"(%31) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<tail>, arg_attrs = [{llvm.align = 8 : i64, llvm.dereferenceable = 24 : i64, llvm.nonnull, llvm.noundef}], callee = @_ZNK4llvm8Constant18isManifestConstantEv, fastmathFlags = #llvm.fastmath<none>, memory_effects = #llvm.memory_effects<other = read, argMem = read, inaccessibleMem = none, errnoMem = read, targetMem0 = none, targetMem1 = none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 1, 0>, res_attrs = [{llvm.noundef, llvm.zeroext}]}> : (!llvm.ptr) -> i1
    %33 = "llvm.getelementptr"(%30, %10) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %34 = "llvm.icmp"(%33, %28) <{predicate = 1 : i64}> : (!llvm.ptr, !llvm.ptr) -> i1
    %35 = "llvm.select"(%32, %34, %1) <{fastmathFlags = #llvm.fastmath<none>}> : (i1, i1, i1) -> i1
    "llvm.cond_br"(%35, %33, %32)[^bb7, ^bb8] <{operandSegmentSizes = array<i32: 1, 1, 1>}> : (i1, !llvm.ptr, i1) -> ()
  ^bb8(%36: i1):  // 5 preds: ^bb0, ^bb1, ^bb2, ^bb6, ^bb7
    "llvm.return"(%36) : (i1) -> ()
  }) : () -> ()
