"builtin.module"() ({
  ...
  "llvm.func"() <{CConv = #llvm.cconv<ccc>, alignment = 2 : i64, arg_attrs = [{llvm.noundef}, {llvm.noundef}], dso_local, function_type = !llvm.func<ptr (ptr, ptr)>, linkage = #llvm.linkage<external>, no_unwind, passthrough = ["mustprogress", ["min-legal-vector-width", "0"], ["no-trapping-math", "true"], ["stack-protector-buffer-size", "8"], ["target-cpu", "x86-64"]], res_attrs = [{llvm.noundef}], sym_name = "_ZN4llvm12ConstantExpr14getPointerCastEPNS_8ConstantEPNS_4TypeE", target_cpu = "x86-64", target_features = #llvm.target_features<["+cmov", "+cx8", "+fxsr", "+mmx", "+sse", "+sse2", "+x87"]>, tune_cpu = "generic", unnamed_addr = 1 : i64, uwtable_kind = #llvm.uwtableKind<async>, visibility_ = 0 : i64}> ({
  ^bb0(%arg0: !llvm.ptr, %arg1: !llvm.ptr):
    ...
    %9 = "llvm.mlir.constant"() <{value = 52 : i32}> : () -> i32
    %10 = "llvm.mlir.constant"() <{value = 51 : i32}> : () -> i32
    ...
    "llvm.cond_br"(%15, %13)[^bb1, ^bb2] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i32) -> ()
  ^bb1:  // pred: ^bb0
    ...
    "llvm.br"(%20)[^bb2] : (i32) -> ()
  ^bb2(%21: i32):  // 2 preds: ^bb0, ^bb1
    %22 = "llvm.and"(%21, %4) : (i32, i32) -> i32
    %23 = "llvm.icmp"(%22, %5) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%23, %6)[^bb10, ^bb3] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i32) -> ()
  ^bb3:  // pred: ^bb2
    ...
    "llvm.cond_br"(%29, %27)[^bb4, ^bb5] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i32) -> ()
  ^bb4:  // pred: ^bb3
    %30 = "llvm.getelementptr"(%25, %3) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    %33 = "llvm.getelementptr"(%32, %0) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
  ...
  ^bb6:  // pred: ^bb5
    %36 = "llvm.getelementptr"(%arg1, %3) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    "llvm.cond_br"(%42, %40)[^bb8, ^bb9] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i32) -> ()
  ^bb7:  // pred: ^bb5
    %43 = "llvm.and"(%13, %4) : (i32, i32) -> i32
    %44 = "llvm.icmp"(%43, %7) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%44, %13)[^bb8, ^bb9] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i32) -> ()
  ^bb8(%45: i32):  // 2 preds: ^bb6, ^bb7
    %46 = "llvm.xor"(%45, %35) : (i32, i32) -> i32
    %47 = "llvm.icmp"(%46, %8) <{predicate = 6 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%47, %9)[^bb9, ^bb10] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i32) -> ()
  ^bb9:  // 3 preds: ^bb6, ^bb7, ^bb8
    %48 = "llvm.icmp"(%25, %arg1) <{predicate = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> i1
    "llvm.cond_br"(%48, %arg0, %10)[^bb11, ^bb10] <{operandSegmentSizes = array<i32: 1, 1, 1>}> : (i1, !llvm.ptr, i32) -> ()
  ^bb10(%49: i32):  // 3 preds: ^bb2, ^bb8, ^bb9
    %50 = "llvm.call"(%49, %arg0, %arg1, %11) <{CConv = #llvm.cconv<fastcc>, TailCallKind = #llvm.tailcallkind<tail>, arg_attrs = [{llvm.noundef}, {llvm.nonnull, llvm.noundef}, {llvm.nonnull, llvm.noundef}, {llvm.noundef, llvm.zeroext}], callee = @_ZL13getFoldedCastN4llvm11Instruction7CastOpsEPNS_8ConstantEPNS_4TypeEb, fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 4, 0>, res_attrs = [{llvm.noundef}]}> : (i32, !llvm.ptr, !llvm.ptr, i1) -> !llvm.ptr
    "llvm.br"(%50)[^bb11] : (!llvm.ptr) -> ()
  ^bb11(%51: !llvm.ptr):  // 2 preds: ^bb9, ^bb10
