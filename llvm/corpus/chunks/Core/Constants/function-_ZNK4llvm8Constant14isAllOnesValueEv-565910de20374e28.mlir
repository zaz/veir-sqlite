"builtin.module"() ({
  ...
  "llvm.func"() <{CConv = #llvm.cconv<ccc>, alignment = 2 : i64, arg_attrs = [{llvm.align = 8 : i64, llvm.dereferenceable = 24 : i64, llvm.nonnull, llvm.noundef}], dso_local, function_type = !llvm.func<i1 (ptr)>, linkage = #llvm.linkage<external>, no_unwind, passthrough = ["mustprogress", ["min-legal-vector-width", "0"], ["no-trapping-math", "true"], ["stack-protector-buffer-size", "8"], ["target-cpu", "x86-64"]], res_attrs = [{llvm.noundef, llvm.zeroext}], sym_name = "_ZNK4llvm8Constant14isAllOnesValueEv", target_cpu = "x86-64", target_features = #llvm.target_features<["+cmov", "+cx8", "+fxsr", "+mmx", "+sse", "+sse2", "+x87"]>, tune_cpu = "generic", unnamed_addr = 1 : i64, uwtable_kind = #llvm.uwtableKind<async>, visibility_ = 0 : i64}> ({
  ^bb0(%arg0: !llvm.ptr):
    ...
    %11 = "llvm.mlir.constant"() <{value = 254 : i32}> : () -> i32
  ...
  ^bb1(%15: !llvm.ptr):  // 2 preds: ^bb0, ^bb20
    ...
    "llvm.switch"(%16)[^bb19, ^bb2, ^bb6, ^bb10] <{case_operand_segments = array<i32: 0, 0, 0>, case_values = dense<[5, 6, 7]> : vector<3xi8>, operandSegmentSizes = array<i32: 1, 0, 0>}> : (i8) -> ()
  ^bb2:  // pred: ^bb1
    %17 = "llvm.getelementptr"(%15, %1) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %18 = "llvm.getelementptr"(%15, %10) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    "llvm.cond_br"(%20, %5)[^bb21, ^bb3] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i1) -> ()
  ^bb3:  // pred: ^bb2
    %21 = "llvm.icmp"(%19, %6) <{predicate = 6 : i64}> : (i32, i32) -> i1
  ...
  ^bb6:  // pred: ^bb1
    ...
    "llvm.cond_br"(%32, %5)[^bb21, ^bb7] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i1) -> ()
  ^bb7:  // pred: ^bb6
    %33 = "llvm.icmp"(%31, %6) <{predicate = 6 : i64}> : (i32, i32) -> i1
  ...
  ^bb8:  // pred: ^bb7
    ...
    %35 = "llvm.sub"(%8, %31) <{overflowFlags = 3 : i32}> : (i32, i32) -> i32
    %36 = "llvm.zext"(%35) <{nonNeg}> : (i32) -> i64
    %37 = "llvm.lshr"(%9, %36) : (i64, i64) -> i64
    %38 = "llvm.icmp"(%34, %37) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.br"(%38)[^bb21] : (i1) -> ()
  ^bb9:  // pred: ^bb7
    %39 = "llvm.call"(%29) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<tail>, arg_attrs = [{llvm.align = 8 : i64, llvm.dereferenceable = 12 : i64, llvm.nonnull, llvm.noundef}], callee = @_ZNK4llvm5APInt25countTrailingOnesSlowCaseEv, fastmathFlags = #llvm.fastmath<none>, memory_effects = #llvm.memory_effects<other = read, argMem = read, inaccessibleMem = read, errnoMem = read, targetMem0 = none, targetMem1 = none>, no_unwind, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 1, 0>, res_attrs = [{llvm.noundef}], will_return}> : (!llvm.ptr) -> i32
    %40 = "llvm.icmp"(%39, %31) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.br"(%40)[^bb21] : (i1) -> ()
  ^bb10:  // pred: ^bb1
    "llvm.intr.lifetime.start"(%14) : (!llvm.ptr) -> ()
    %41 = "llvm.getelementptr"(%15, %1) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
  ...
  ^bb13:  // 2 preds: ^bb11, ^bb12
    %44 = "llvm.getelementptr"(%14, %3) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %45 = "llvm.load"(%44) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "_ZTSN4llvm5APIntE", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>, <#llvm.tbaa_type_desc<id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, 8>}>, access_type = <id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 8>]}> : (!llvm.ptr) -> i32
    %46 = "llvm.icmp"(%45, %4) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%46, %5)[^bb18, ^bb14] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i1) -> ()
  ^bb14:  // pred: ^bb13
    %47 = "llvm.icmp"(%45, %6) <{predicate = 6 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%47)[^bb15, ^bb16] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb15:  // pred: ^bb14
    %48 = "llvm.load"(%14) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, access_type = <id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, offset = 0>]}> : (!llvm.ptr) -> i64
    %49 = "llvm.sub"(%8, %45) <{overflowFlags = 3 : i32}> : (i32, i32) -> i32
    %50 = "llvm.zext"(%49) <{nonNeg}> : (i32) -> i64
    %51 = "llvm.lshr"(%9, %50) : (i64, i64) -> i64
    %52 = "llvm.icmp"(%48, %51) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.br"(%52)[^bb18] : (i1) -> ()
  ^bb16:  // pred: ^bb14
    %53 = "llvm.call"(%14) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<none>, arg_attrs = [{llvm.align = 8 : i64, llvm.dereferenceable = 12 : i64, llvm.nonnull, llvm.noundef}], callee = @_ZNK4llvm5APInt25countTrailingOnesSlowCaseEv, fastmathFlags = #llvm.fastmath<none>, memory_effects = #llvm.memory_effects<other = read, argMem = read, inaccessibleMem = read, errnoMem = read, targetMem0 = none, targetMem1 = none>, no_unwind, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 1, 0>, res_attrs = [{llvm.noundef}], will_return}> : (!llvm.ptr) -> i32
    %54 = "llvm.icmp"(%53, %45) <{predicate = 0 : i64}> : (i32, i32) -> i1
    %55 = "llvm.load"(%14) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, access_type = <id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, offset = 0>]}> : (!llvm.ptr) -> !llvm.ptr
    %56 = "llvm.icmp"(%55, %7) <{predicate = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> i1
    "llvm.cond_br"(%56, %54)[^bb18, ^bb17] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i1) -> ()
  ^bb17:  // pred: ^bb16
    ...
    "llvm.br"(%54)[^bb18] : (i1) -> ()
  ^bb18(%57: i1):  // 4 preds: ^bb13, ^bb15, ^bb16, ^bb17
    "llvm.intr.lifetime.end"(%14) : (!llvm.ptr) -> ()
    "llvm.br"(%57)[^bb21] : (i1) -> ()
  ^bb19:  // pred: ^bb1
    %58 = "llvm.getelementptr"(%15, %3) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    "llvm.cond_br"(%63, %13)[^bb20, ^bb21] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i1) -> ()
  ^bb20:  // pred: ^bb19
    %64 = "llvm.call"(%15, %13) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<tail>, arg_attrs = [{llvm.align = 8 : i64, llvm.dereferenceable = 24 : i64, llvm.nonnull, llvm.noundef}, {llvm.noundef, llvm.zeroext}], callee = @_ZNK4llvm8Constant13getSplatValueEb, fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 2, 0>, res_attrs = [{llvm.noundef}]}> : (!llvm.ptr, i1) -> !llvm.ptr
    %65 = "llvm.icmp"(%64, %7) <{predicate = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> i1
    "llvm.cond_br"(%65, %13, %64)[^bb21, ^bb1] <{operandSegmentSizes = array<i32: 1, 1, 1>}> : (i1, i1, !llvm.ptr) -> ()
  ^bb21(%66: i1):  // 9 preds: ^bb2, ^bb4, ^bb5, ^bb6, ^bb8, ^bb9, ^bb18, ^bb19, ^bb20
    "llvm.return"(%66) : (i1) -> ()
  }) : () -> ()
