"builtin.module"() ({
  "llvm.comdat"() <{sym_name = "__llvm_global_comdat"}> ({
    "llvm.comdat_selector"() <{comdat = 0 : i64, sym_name = "_ZN4llvm12DenseMapBaseINS_13SmallDenseMapIPNS_15DomTreeNodeBaseINS_10BasicBlockEEENS_6detail13DenseSetEmptyELj8ENS_12DenseMapInfoIS5_vEENS6_12DenseSetPairIS5_EEEES5_S7_S9_SB_E8moveFromERSC_"}> : () -> ()
  }) : () -> ()
  ...
  "llvm.func"() <{CConv = #llvm.cconv<ccc>, alignment = 2 : i64, arg_attrs = [{llvm.align = 1 : i64, llvm.dereferenceable = 1 : i64, llvm.nonnull, llvm.noundef}, {llvm.align = 8 : i64, llvm.dereferenceable = 80 : i64, llvm.nonnull, llvm.noundef}], comdat = @__llvm_global_comdat::@_ZN4llvm12DenseMapBaseINS_13SmallDenseMapIPNS_15DomTreeNodeBaseINS_10BasicBlockEEENS_6detail13DenseSetEmptyELj8ENS_12DenseMapInfoIS5_vEENS6_12DenseSetPairIS5_EEEES5_S7_S9_SB_E8moveFromERSC_, dso_local, function_type = !llvm.func<void (ptr, ptr)>, linkage = #llvm.linkage<weak_odr>, no_inline, no_unwind, passthrough = ["mustprogress", ["min-legal-vector-width", "0"], ["no-trapping-math", "true"], ["stack-protector-buffer-size", "8"], ["target-cpu", "x86-64"]], sym_name = "_ZN4llvm12DenseMapBaseINS_13SmallDenseMapIPNS_15DomTreeNodeBaseINS_10BasicBlockEEENS_6detail13DenseSetEmptyELj8ENS_12DenseMapInfoIS5_vEENS6_12DenseSetPairIS5_EEEES5_S7_S9_SB_E8moveFromERSC_", target_cpu = "x86-64", target_features = #llvm.target_features<["+cmov", "+cx8", "+fxsr", "+mmx", "+sse", "+sse2", "+x87"]>, tune_cpu = "generic", unnamed_addr = 1 : i64, uwtable_kind = #llvm.uwtableKind<async>, visibility_ = 1 : i64}> ({
  ...
  ^bb4(%57: i32):  // 2 preds: ^bb3, ^bb6
    ...
    %61 = "llvm.getelementptr"(%25, %60) <{elem_type = !llvm.struct<"class.llvm::detail::DenseSetPair", (ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    "llvm.cond_br"(%76, %72, %69, %70, %74, %68)[^bb6, ^bb5] <{operandSegmentSizes = array<i32: 1, 4, 1>}> : (i1, i32, i64, i64, i32, i32) -> ()
  ^bb5(%77: i32):  // 2 preds: ^bb4, ^bb5
    ...
    "llvm.cond_br"(%87, %83, %80, %81, %85, %79)[^bb6, ^bb5] <{loop_annotation = #llvm.loop_annotation<mustProgress = true>, operandSegmentSizes = array<i32: 1, 4, 1>}> : (i1, i32, i64, i64, i32, i32) -> ()
  ^bb6(%88: i32, %89: i64, %90: i64, %91: i32):  // 2 preds: ^bb4, ^bb5
    %92 = "llvm.getelementptr"(%42, %89) <{elem_type = !llvm.struct<"class.llvm::detail::DenseSetPair", (ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    "llvm.store"(%62, %92) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "any pointer", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, access_type = <id = "any pointer", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (!llvm.ptr, !llvm.ptr) -> ()
    %93 = "llvm.getelementptr"(%39, %90) <{elem_type = i32, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %94 = "llvm.or"(%88, %91) : (i32, i32) -> i32
    "llvm.store"(%94, %93) <{alignment = 4 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, access_type = <id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (i32, !llvm.ptr) -> ()
    %95 = "llvm.add"(%57, %7) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
    %96 = "llvm.and"(%95, %57) : (i32, i32) -> i32
    %97 = "llvm.icmp"(%96, %1) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%97, %96)[^bb7, ^bb4] <{loop_annotation = #llvm.loop_annotation<mustProgress = true>, operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i32) -> ()
  ^bb7:  // 2 preds: ^bb2, ^bb6
    %98 = "llvm.add"(%51, %15) <{overflowFlags = 3 : i32}> : (i64, i64) -> i64
    %99 = "llvm.icmp"(%98, %50) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%99, %98)[^bb8, ^bb2] <{loop_annotation = #llvm.loop_annotation<mustProgress = true>, operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i64) -> ()
  ^bb8:  // pred: ^bb7
    %100 = "llvm.load"(%arg1) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> i32
    %101 = "llvm.load"(%arg0) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> i32
    %102 = "llvm.and"(%101, %0) : (i32, i32) -> i32
    "llvm.br"(%102, %100)[^bb9] : (i32, i32) -> ()
  ^bb9(%103: i32, %104: i32):  // 2 preds: ^bb0, ^bb8
    %105 = "llvm.and"(%104, %16) : (i32, i32) -> i32
    %106 = "llvm.or"(%103, %105) <{isDisjoint}> : (i32, i32) -> i32
    "llvm.store"(%106, %arg0) <{alignment = 8 : i64, ordering = 0 : i64}> : (i32, !llvm.ptr) -> ()
    %107 = "llvm.load"(%arg1) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> i32
    %108 = "llvm.and"(%107, %0) : (i32, i32) -> i32
    %109 = "llvm.icmp"(%108, %1) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%109, %107)[^bb10, ^bb12] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i32) -> ()
  ^bb10:  // pred: ^bb9
    %110 = "llvm.load"(%30) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, access_type = <id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, offset = 0>]}> : (!llvm.ptr) -> i32
    %111 = "llvm.icmp"(%110, %1) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%111, %107)[^bb12, ^bb11] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i32) -> ()
  ^bb11:  // pred: ^bb10
    %112 = "llvm.load"(%23) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, access_type = <id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, offset = 0>]}> : (!llvm.ptr) -> !llvm.ptr
    %113 = "llvm.zext"(%110) : (i32) -> i64
    %114 = "llvm.shl"(%113, %17) <{overflowFlags = 3 : i32}> : (i64, i64) -> i64
    %115 = "llvm.add"(%113, %9) <{overflowFlags = 3 : i32}> : (i64, i64) -> i64
    %116 = "llvm.lshr"(%115, %17) : (i64, i64) -> i64
    %117 = "llvm.and"(%116, %18) : (i64, i64) -> i64
    %118 = "llvm.add"(%117, %114) <{overflowFlags = 3 : i32}> : (i64, i64) -> i64
    "llvm.call"(%112, %118, %2) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<tail>, arg_attrs = [{llvm.noundef}, {llvm.noundef}, {llvm.noundef}], callee = @_ZN4llvm17deallocate_bufferEPvmm, fastmathFlags = #llvm.fastmath<none>, no_unwind, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 3, 0>}> : (!llvm.ptr, i64, i64) -> ()
    %119 = "llvm.load"(%arg1) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> i32
    "llvm.br"(%119)[^bb12] : (i32) -> ()
  ^bb12(%120: i32):  // 3 preds: ^bb9, ^bb10, ^bb11
    %121 = "llvm.and"(%120, %16) : (i32, i32) -> i32
    "llvm.store"(%121, %arg1) <{alignment = 8 : i64, ordering = 0 : i64}> : (i32, !llvm.ptr) -> ()
