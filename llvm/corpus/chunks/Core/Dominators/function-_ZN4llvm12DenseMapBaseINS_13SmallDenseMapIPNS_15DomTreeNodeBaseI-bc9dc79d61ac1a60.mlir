"builtin.module"() ({
  "llvm.comdat"() <{sym_name = "__llvm_global_comdat"}> ({
    "llvm.comdat_selector"() <{comdat = 0 : i64, sym_name = "_ZN4llvm12DenseMapBaseINS_13SmallDenseMapIPNS_15DomTreeNodeBaseINS_10BasicBlockEEENS_6detail13DenseSetEmptyELj8ENS_12DenseMapInfoIS5_vEENS6_12DenseSetPairIS5_EEEES5_S7_S9_SB_E4growEj"}> : () -> ()
  }) : () -> ()
  ...
  ^bb0(%arg0: !llvm.ptr, %arg1: i32):
    ...
    %18 = "llvm.alloca"(%0) <{alignment = 8 : i64, elem_type = !llvm.struct<"class.llvm::SmallDenseMap.225", (i32, struct<"union.anon.227", (struct<"struct.llvm::SmallDenseMap<llvm::DomTreeNodeBase<BasicBlock> *, llvm::detail::DenseSetEmpty, 8, llvm::DenseMapInfo<llvm::DomTreeNodeBase<BasicBlock> *>, llvm::detail::DenseSetPair<llvm::DomTreeNodeBase<BasicBlock> *>>::LargeRep", (ptr, ptr, i32)>, array<48 x i8>)>)>}> : (i32) -> !llvm.ptr
  ...
  ^bb7:  // pred: ^bb5
    ...
    %61 = "llvm.shl"(%60, %9) <{overflowFlags = 3 : i32}> : (i64, i64) -> i64
    %62 = "llvm.add"(%60, %10) <{overflowFlags = 3 : i32}> : (i64, i64) -> i64
    %63 = "llvm.lshr"(%62, %9) : (i64, i64) -> i64
  ...
  ^bb11:  // pred: ^bb10
    ...
    %95 = "llvm.shl"(%94, %9) <{overflowFlags = 3 : i32}> : (i64, i64) -> i64
    %96 = "llvm.add"(%94, %10) <{overflowFlags = 3 : i32}> : (i64, i64) -> i64
    %97 = "llvm.lshr"(%96, %9) : (i64, i64) -> i64
