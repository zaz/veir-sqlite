"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr, %arg1: !llvm.ptr):
    ...
    %25 = "llvm.alloca"(%0) <{alignment = 4 : i64, elem_type = !llvm.struct<"struct.std::array.855", (array<44 x i8>)>}> : (i32) -> !llvm.ptr
    %26 = "llvm.alloca"(%0) <{alignment = 8 : i64, elem_type = !llvm.struct<"struct.std::array.811", (array<16 x i8>)>}> : (i32) -> !llvm.ptr
  ...
  ^bb13(%100: i64, %101: i32):  // 2 preds: ^bb11, ^bb12
    %102 = "llvm.getelementptr"(%27, %100) <{elem_type = !llvm.struct<"class.llvm::detail::DenseSetPair.924", (ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
  ...
  ^bb14:  // pred: ^bb13
    %105 = "llvm.getelementptr"(%27, %100) <{elem_type = !llvm.struct<"class.llvm::detail::DenseSetPair.924", (ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
