"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr):
    ...
    %10 = "llvm.getelementptr"(%6, %9) <{elem_type = !llvm.ptr, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %11 = "llvm.icmp"(%8, %2) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%11, %6)[^bb1, ^bb2] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, !llvm.ptr) -> ()
  ^bb1:  // 2 preds: ^bb0, ^bb4
    "llvm.return"() : () -> ()
  ^bb2(%12: !llvm.ptr):  // 2 preds: ^bb0, ^bb4
  ...
  ^bb3:  // pred: ^bb2
    ...
    "llvm.br"()[^bb4] : () -> ()
  ^bb4:  // 2 preds: ^bb2, ^bb3
    %15 = "llvm.getelementptr"(%12, %4) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %16 = "llvm.icmp"(%15, %10) <{predicate = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> i1
    "llvm.cond_br"(%16, %15)[^bb1, ^bb2] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, !llvm.ptr) -> ()
  }) : () -> ()
