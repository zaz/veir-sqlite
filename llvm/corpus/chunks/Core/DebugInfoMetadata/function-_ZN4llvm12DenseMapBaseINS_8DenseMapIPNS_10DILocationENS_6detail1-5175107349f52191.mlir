"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr, %arg1: !llvm.ptr, %arg2: !llvm.ptr):
    ...
    %26 = "llvm.alloca"(%0) <{alignment = 8 : i64, elem_type = !llvm.struct<"struct.std::array.792", (array<24 x i8>)>}> : (i32) -> !llvm.ptr
    %27 = "llvm.alloca"(%0) <{alignment = 8 : i64, elem_type = !llvm.struct<"struct.std::array.791", (array<32 x i8>)>}> : (i32) -> !llvm.ptr
  ...
  ^bb8(%83: i64):  // 2 preds: ^bb6, ^bb7
    ...
    %88 = "llvm.getelementptr"(%28, %87) <{elem_type = !llvm.struct<"class.llvm::detail::DenseSetPair.790", (ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
  ...
  ^bb10:  // pred: ^bb11
    ...
    %100 = "llvm.getelementptr"(%28, %99) <{elem_type = !llvm.struct<"class.llvm::detail::DenseSetPair.790", (ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
