"builtin.module"() ({
  ...
  ^bb3(%21: !llvm.ptr):  // 2 preds: ^bb1, ^bb2
    ...
    "llvm.cond_br"(%24, %2)[^bb8, ^bb4] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i64) -> ()
  ^bb4:  // pred: ^bb3
    ...
    %26 = "llvm.add"(%25, %7) <{overflowFlags = 0 : i32}> : (i8, i8) -> i8
    %27 = "llvm.icmp"(%26, %8) <{predicate = 6 : i64}> : (i8, i8) -> i1
    "llvm.cond_br"(%27)[^bb6, ^bb5] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb5:  // pred: ^bb4
    %28 = "llvm.ptrtoint"(%23) : (!llvm.ptr) -> i64
    "llvm.br"(%28)[^bb8] : (i64) -> ()
  ^bb6:  // pred: ^bb4
    %29 = "llvm.icmp"(%25, %9) <{predicate = 0 : i64}> : (i8, i8) -> i1
    "llvm.cond_br"(%29, %2)[^bb7, ^bb8] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i64) -> ()
  ^bb7:  // pred: ^bb6
    %30 = "llvm.ptrtoint"(%23) : (!llvm.ptr) -> i64
    %31 = "llvm.or"(%30, %10) : (i64, i64) -> i64
    "llvm.br"(%31)[^bb8] : (i64) -> ()
  ^bb8(%32: i64):  // 4 preds: ^bb3, ^bb5, ^bb6, ^bb7
    "llvm.return"(%32) : (i64) -> ()
  }) : () -> ()
