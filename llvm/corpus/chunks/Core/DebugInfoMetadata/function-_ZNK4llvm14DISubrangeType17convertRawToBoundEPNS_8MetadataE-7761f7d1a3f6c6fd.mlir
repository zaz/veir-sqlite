"builtin.module"() ({
  ...
  "llvm.func"() <{CConv = #llvm.cconv<ccc>, alignment = 2 : i64, arg_attrs = [{llvm.align = 8 : i64, llvm.dereferenceable = 28 : i64, llvm.nocapture, llvm.nonnull, llvm.noundef, llvm.readnone}, {llvm.noundef}], dso_local, function_type = !llvm.func<i64 (ptr, ptr)>, linkage = #llvm.linkage<external>, memory_effects = #llvm.memory_effects<other = none, argMem = read, inaccessibleMem = none, errnoMem = none, targetMem0 = none, targetMem1 = none>, no_unwind, passthrough = ["mustprogress", "nofree", "norecurse", "nosync", ["min-legal-vector-width", "0"], ["no-trapping-math", "true"], ["stack-protector-buffer-size", "8"], ["target-cpu", "x86-64"]], sym_name = "_ZNK4llvm14DISubrangeType17convertRawToBoundEPNS_8MetadataE", target_cpu = "x86-64", target_features = #llvm.target_features<["+cmov", "+cx8", "+fxsr", "+mmx", "+sse", "+sse2", "+x87"]>, tune_cpu = "generic", unnamed_addr = 1 : i64, uwtable_kind = #llvm.uwtableKind<async>, visibility_ = 0 : i64, will_return}> ({
  ...
  ^bb2:  // pred: ^bb1
    ...
    "llvm.br"(%14)[^bb8] : (i64) -> ()
  ^bb3:  // pred: ^bb1
    %15 = "llvm.add"(%10, %3) <{overflowFlags = 0 : i32}> : (i8, i8) -> i8
    %16 = "llvm.icmp"(%15, %4) <{predicate = 6 : i64}> : (i8, i8) -> i1
    "llvm.cond_br"(%16)[^bb4, ^bb5] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb4:  // pred: ^bb3
    %17 = "llvm.ptrtoint"(%arg1) : (!llvm.ptr) -> i64
    %18 = "llvm.or"(%17, %7) : (i64, i64) -> i64
    "llvm.br"(%18)[^bb8] : (i64) -> ()
  ^bb5:  // pred: ^bb3
    "llvm.switch"(%10, %1)[^bb8, ^bb6, ^bb7] <{case_operand_segments = array<i32: 0, 0>, case_values = dense<[7, 13]> : vector<2xi8>, operandSegmentSizes = array<i32: 1, 1, 0>}> : (i8, i64) -> ()
  ^bb6:  // pred: ^bb5
    %19 = "llvm.ptrtoint"(%arg1) : (!llvm.ptr) -> i64
    %20 = "llvm.or"(%19, %6) : (i64, i64) -> i64
    "llvm.br"(%20)[^bb8] : (i64) -> ()
  ^bb7:  // pred: ^bb5
    %21 = "llvm.ptrtoint"(%arg1) : (!llvm.ptr) -> i64
    %22 = "llvm.or"(%21, %5) : (i64, i64) -> i64
    "llvm.br"(%22)[^bb8] : (i64) -> ()
  ^bb8(%23: i64):  // 6 preds: ^bb0, ^bb2, ^bb4, ^bb5, ^bb6, ^bb7
    "llvm.return"(%23) : (i64) -> ()
  }) : () -> ()
