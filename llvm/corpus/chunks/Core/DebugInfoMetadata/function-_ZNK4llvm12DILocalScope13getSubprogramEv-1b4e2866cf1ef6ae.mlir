"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr):
    ...
    %9 = "llvm.add"(%8, %0) <{overflowFlags = 0 : i32}> : (i8, i8) -> i8
    %10 = "llvm.icmp"(%9, %1) <{predicate = 6 : i64}> : (i8, i8) -> i1
    "llvm.cond_br"(%10, %arg0, %arg0)[^bb1, ^bb5] <{operandSegmentSizes = array<i32: 1, 1, 1>}> : (i1, !llvm.ptr, !llvm.ptr) -> ()
  ...
  ^bb3:  // pred: ^bb1
    %18 = "llvm.lshr"(%13, %3) : (i64, i64) -> i64
    %19 = "llvm.and"(%18, %6) : (i64, i64) -> i64
    %20 = "llvm.sub"(%4, %19) <{overflowFlags = 1 : i32}> : (i64, i64) -> i64
  ...
  ^bb4(%22: !llvm.ptr):  // 2 preds: ^bb2, ^bb3
    ...
    %26 = "llvm.add"(%25, %0) <{overflowFlags = 0 : i32}> : (i8, i8) -> i8
    %27 = "llvm.icmp"(%26, %1) <{predicate = 6 : i64}> : (i8, i8) -> i1
    "llvm.cond_br"(%27, %24, %24)[^bb1, ^bb5] <{operandSegmentSizes = array<i32: 1, 1, 1>}> : (i1, !llvm.ptr, !llvm.ptr) -> ()
