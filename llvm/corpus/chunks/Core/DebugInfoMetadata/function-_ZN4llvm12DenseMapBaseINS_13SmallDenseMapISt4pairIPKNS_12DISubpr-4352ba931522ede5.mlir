"builtin.module"() ({
  "llvm.comdat"() <{sym_name = "__llvm_global_comdat"}> ({
    "llvm.comdat_selector"() <{comdat = 0 : i64, sym_name = "_ZN4llvm12DenseMapBaseINS_13SmallDenseMapISt4pairIPKNS_12DISubprogramEPKNS_10DILocationEEjLj4ENS_12DenseMapInfoIS9_vEENS_6detail12DenseMapPairIS9_jEEEES9_jSB_SE_E4growEj"}> : () -> ()
  }) : () -> ()
  ...
  ^bb0(%arg0: !llvm.ptr, %arg1: i32):
    ...
    %18 = "llvm.alloca"(%0) <{alignment = 8 : i64, elem_type = !llvm.struct<"class.llvm::SmallDenseMap.363", (i32, struct<"union.anon.365", (struct<"struct.llvm::SmallDenseMap<std::pair<const llvm::DISubprogram *, const llvm::DILocation *>, unsigned int>::LargeRep", (ptr, ptr, i32)>, array<80 x i8>)>)>}> : (i32) -> !llvm.ptr
