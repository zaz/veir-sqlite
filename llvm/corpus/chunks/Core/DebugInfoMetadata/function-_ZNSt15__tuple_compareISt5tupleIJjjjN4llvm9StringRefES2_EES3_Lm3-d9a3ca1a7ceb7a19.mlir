"builtin.module"() ({
  "llvm.comdat"() <{sym_name = "__llvm_global_comdat"}> ({
    "llvm.comdat_selector"() <{comdat = 0 : i64, sym_name = "_ZNSt15__tuple_compareISt5tupleIJjjjN4llvm9StringRefES2_EES3_Lm3ELm5EE6__lessERKS3_S6_"}> : () -> ()
  }) : () -> ()
  "llvm.module_flags"() <{flags = [#llvm.mlir.module_flag<error, "wchar_size", 4 : i32>, #llvm.mlir.module_flag<min, "PIC Level", 2 : i32>, #llvm.mlir.module_flag<max, "uwtable", 2 : i32>]}> : () -> ()
  "llvm.func"() <{CConv = #llvm.cconv<ccc>, alignment = 2 : i64, arg_attrs = [{llvm.align = 8 : i64, llvm.dereferenceable = 44 : i64, llvm.nonnull, llvm.noundef}, {llvm.align = 8 : i64, llvm.dereferenceable = 44 : i64, llvm.nonnull, llvm.noundef}], comdat = @__llvm_global_comdat::@_ZNSt15__tuple_compareISt5tupleIJjjjN4llvm9StringRefES2_EES3_Lm3ELm5EE6__lessERKS3_S6_, dso_local, function_type = !llvm.func<i1 (ptr, ptr)>, linkage = #llvm.linkage<weak_odr>, no_unwind, passthrough = ["mustprogress", ["min-legal-vector-width", "0"], ["no-trapping-math", "true"], ["stack-protector-buffer-size", "8"], ["target-cpu", "x86-64"]], res_attrs = [{llvm.noundef, llvm.zeroext}], sym_name = "_ZNSt15__tuple_compareISt5tupleIJjjjN4llvm9StringRefES2_EES3_Lm3ELm5EE6__lessERKS3_S6_", target_cpu = "x86-64", target_features = #llvm.target_features<["+cmov", "+cx8", "+fxsr", "+mmx", "+sse", "+sse2", "+x87"]>, tune_cpu = "generic", unnamed_addr = 1 : i64, uwtable_kind = #llvm.uwtableKind<async>, visibility_ = 1 : i64}> ({
  ...
  ^bb2:  // pred: ^bb0
    %20 = "llvm.icmp"(%10, %14) <{predicate = 6 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%20, %4)[^bb14, ^bb6] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i1) -> ()
  ^bb3:  // pred: ^bb1
    %21 = "llvm.icmp"(%10, %14) <{predicate = 6 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%21, %4)[^bb14, ^bb5] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i1) -> ()
  ^bb4:  // pred: ^bb1
    %22 = "llvm.icmp"(%18, %3) <{predicate = 2 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%22, %4)[^bb14, ^bb5] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i1) -> ()
  ^bb5:  // 2 preds: ^bb3, ^bb4
    %23 = "llvm.call"(%12, %8, %15) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<tail>, arg_attrs = [{llvm.noundef}, {llvm.noundef}, {llvm.noundef}], callee = @memcmp, fastmathFlags = #llvm.fastmath<none>, memory_effects = #llvm.memory_effects<other = none, argMem = read, inaccessibleMem = none, errnoMem = none, targetMem0 = none, targetMem1 = none>, no_unwind, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 3, 0>, will_return}> : (!llvm.ptr, !llvm.ptr, i64) -> i32
  ...
  ^bb6:  // 2 preds: ^bb2, ^bb5
    %26 = "llvm.icmp"(%14, %10) <{predicate = 6 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%26, %5)[^bb14, ^bb8] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i1) -> ()
  ^bb7:  // pred: ^bb5
    %27 = "llvm.icmp"(%24, %3) <{predicate = 2 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%27, %5)[^bb14, ^bb8] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i1) -> ()
  ^bb8:  // 2 preds: ^bb6, ^bb7
    ...
    %30 = "llvm.getelementptr"(%arg1, %6) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %31 = "llvm.load"(%30) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "long", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, access_type = <id = "long", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (!llvm.ptr) -> i64
    %32 = "llvm.intr.umin"(%29, %31) : (i64, i64) -> i64
    %33 = "llvm.icmp"(%32, %2) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%33)[^bb9, ^bb10] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb9:  // pred: ^bb8
    %34 = "llvm.icmp"(%29, %31) <{predicate = 6 : i64}> : (i64, i64) -> i1
    "llvm.br"(%34)[^bb14] : (i1) -> ()
  ^bb10:  // pred: ^bb8
    ...
    %37 = "llvm.call"(%36, %35, %32) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<tail>, arg_attrs = [{llvm.noundef}, {llvm.noundef}, {llvm.noundef}], callee = @memcmp, fastmathFlags = #llvm.fastmath<none>, memory_effects = #llvm.memory_effects<other = none, argMem = read, inaccessibleMem = none, errnoMem = none, targetMem0 = none, targetMem1 = none>, no_unwind, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 3, 0>, will_return}> : (!llvm.ptr, !llvm.ptr, i64) -> i32
    %38 = "llvm.freeze"(%37) : (i32) -> i32
    %39 = "llvm.icmp"(%38, %3) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%39)[^bb11, ^bb12] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb11:  // pred: ^bb10
    %40 = "llvm.icmp"(%29, %31) <{predicate = 6 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%40, %4)[^bb14, ^bb13] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i1) -> ()
  ^bb12:  // pred: ^bb10
    %41 = "llvm.icmp"(%38, %3) <{predicate = 2 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%41, %4)[^bb14, ^bb13] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i1) -> ()
  ^bb13:  // 2 preds: ^bb11, ^bb12
    "llvm.br"(%5)[^bb14] : (i1) -> ()
  ^bb14(%42: i1):  // 9 preds: ^bb2, ^bb3, ^bb4, ^bb6, ^bb7, ^bb9, ^bb11, ^bb12, ^bb13
    "llvm.return"(%42) : (i1) -> ()
  }) : () -> ()
