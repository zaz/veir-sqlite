"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr):
    ...
    "llvm.cond_br"(%8, %arg0, %arg0)[^bb1, ^bb5] <{operandSegmentSizes = array<i32: 1, 1, 1>}> : (i1, !llvm.ptr, !llvm.ptr) -> ()
  ^bb1(%9: !llvm.ptr):  // 2 preds: ^bb0, ^bb4
  ...
  ^bb3:  // pred: ^bb1
    %16 = "llvm.lshr"(%11, %2) : (i64, i64) -> i64
    %17 = "llvm.and"(%16, %5) : (i64, i64) -> i64
    %18 = "llvm.sub"(%3, %17) <{overflowFlags = 1 : i32}> : (i64, i64) -> i64
    %19 = "llvm.getelementptr"(%10, %18) <{elem_type = !llvm.struct<"class.llvm::MDOperand", (ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
  ...
  ^bb4(%20: !llvm.ptr):  // 2 preds: ^bb2, ^bb3
    ...
    %24 = "llvm.icmp"(%23, %0) <{predicate = 0 : i64}> : (i8, i8) -> i1
    "llvm.cond_br"(%24, %22, %22)[^bb1, ^bb5] <{operandSegmentSizes = array<i32: 1, 1, 1>}> : (i1, !llvm.ptr, !llvm.ptr) -> ()
  ^bb5(%25: !llvm.ptr):  // 2 preds: ^bb0, ^bb4
