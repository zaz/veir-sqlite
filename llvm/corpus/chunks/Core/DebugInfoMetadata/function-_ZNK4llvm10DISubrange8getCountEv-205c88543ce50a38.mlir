"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr):
    ...
    %7 = "llvm.mlir.constant"() <{value = -27 : i8}> : () -> i8
  ...
  ^bb2:  // pred: ^bb0
    %18 = "llvm.lshr"(%13, %1) : (i64, i64) -> i64
    %19 = "llvm.and"(%18, %4) : (i64, i64) -> i64
    %20 = "llvm.sub"(%2, %19) <{overflowFlags = 1 : i32}> : (i64, i64) -> i64
    %21 = "llvm.getelementptr"(%12, %20) <{elem_type = !llvm.struct<"class.llvm::MDOperand", (ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
  ...
  ^bb5:  // pred: ^bb4
    ...
    "llvm.br"(%29)[^bb10] : (i64) -> ()
  ^bb6:  // pred: ^bb4
    %30 = "llvm.add"(%25, %7) <{overflowFlags = 0 : i32}> : (i8, i8) -> i8
    %31 = "llvm.icmp"(%30, %8) <{predicate = 6 : i64}> : (i8, i8) -> i1
    "llvm.cond_br"(%31)[^bb8, ^bb7] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb7:  // pred: ^bb6
    %32 = "llvm.ptrtoint"(%23) : (!llvm.ptr) -> i64
    %33 = "llvm.or"(%32, %1) : (i64, i64) -> i64
    "llvm.br"(%33)[^bb10] : (i64) -> ()
  ^bb8:  // pred: ^bb6
    %34 = "llvm.icmp"(%25, %9) <{predicate = 0 : i64}> : (i8, i8) -> i1
    "llvm.cond_br"(%34, %2)[^bb9, ^bb10] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i64) -> ()
  ^bb9:  // pred: ^bb8
    %35 = "llvm.ptrtoint"(%23) : (!llvm.ptr) -> i64
    %36 = "llvm.or"(%35, %10) : (i64, i64) -> i64
    "llvm.br"(%36)[^bb10] : (i64) -> ()
  ^bb10(%37: i64):  // 5 preds: ^bb3, ^bb5, ^bb7, ^bb8, ^bb9
    "llvm.return"(%37) : (i64) -> ()
  }) : () -> ()
