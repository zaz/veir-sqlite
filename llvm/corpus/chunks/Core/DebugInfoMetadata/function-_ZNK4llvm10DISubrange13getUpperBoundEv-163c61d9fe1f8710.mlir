"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr):
    ...
    %8 = "llvm.mlir.constant"() <{value = -27 : i8}> : () -> i8
  ...
  ^bb3(%23: !llvm.ptr):  // 2 preds: ^bb1, ^bb2
    ...
    "llvm.cond_br"(%26, %2)[^bb10, ^bb4] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i64) -> ()
  ^bb4:  // pred: ^bb3
  ...
  ^bb5:  // pred: ^bb4
    %29 = "llvm.getelementptr"(%25, %12) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    "llvm.br"(%31)[^bb10] : (i64) -> ()
  ^bb6:  // pred: ^bb4
    %32 = "llvm.add"(%27, %8) <{overflowFlags = 0 : i32}> : (i8, i8) -> i8
    %33 = "llvm.icmp"(%32, %9) <{predicate = 6 : i64}> : (i8, i8) -> i1
    "llvm.cond_br"(%33)[^bb8, ^bb7] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb7:  // pred: ^bb6
    %34 = "llvm.ptrtoint"(%25) : (!llvm.ptr) -> i64
    %35 = "llvm.or"(%34, %1) : (i64, i64) -> i64
    "llvm.br"(%35)[^bb10] : (i64) -> ()
  ^bb8:  // pred: ^bb6
    %36 = "llvm.icmp"(%27, %10) <{predicate = 0 : i64}> : (i8, i8) -> i1
    "llvm.cond_br"(%36, %2)[^bb9, ^bb10] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i64) -> ()
  ^bb9:  // pred: ^bb8
    %37 = "llvm.ptrtoint"(%25) : (!llvm.ptr) -> i64
    %38 = "llvm.or"(%37, %11) : (i64, i64) -> i64
    "llvm.br"(%38)[^bb10] : (i64) -> ()
  ^bb10(%39: i64):  // 5 preds: ^bb3, ^bb5, ^bb7, ^bb8, ^bb9
    "llvm.return"(%39) : (i64) -> ()
  }) : () -> ()
