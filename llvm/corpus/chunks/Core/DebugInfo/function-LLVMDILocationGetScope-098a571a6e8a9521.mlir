"builtin.module"() ({
  ...
  ^bb2:  // pred: ^bb0
    %11 = "llvm.lshr"(%6, %1) : (i64, i64) -> i64
    %12 = "llvm.and"(%11, %4) : (i64, i64) -> i64
    %13 = "llvm.sub"(%2, %12) <{overflowFlags = 1 : i32}> : (i64, i64) -> i64
    %14 = "llvm.getelementptr"(%5, %13) <{elem_type = !llvm.struct<"class.llvm::MDOperand", (ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
