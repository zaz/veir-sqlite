"builtin.module"() ({
  ...
  ^bb2:  // pred: ^bb0
    %13 = "llvm.lshr"(%8, %1) : (i64, i64) -> i64
    %14 = "llvm.and"(%13, %4) : (i64, i64) -> i64
    %15 = "llvm.sub"(%2, %14) <{overflowFlags = 1 : i32}> : (i64, i64) -> i64
    %16 = "llvm.getelementptr"(%7, %15) <{elem_type = !llvm.struct<"class.llvm::MDOperand", (ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
  ...
  ^bb3(%17: !llvm.ptr):  // 2 preds: ^bb1, ^bb2
    ...
    "llvm.cond_br"(%20, %6, %2)[^bb5, ^bb4] <{operandSegmentSizes = array<i32: 1, 2, 0>}> : (i1, !llvm.ptr, i64) -> ()
  ^bb4:  // pred: ^bb3
    ...
    %23 = "llvm.extractvalue"(%21) <{position = array<i64: 1>}> : (!llvm.struct<(ptr, i64)>) -> i64
    "llvm.br"(%22, %23)[^bb5] : (!llvm.ptr, i64) -> ()
  ^bb5(%24: !llvm.ptr, %25: i64):  // 2 preds: ^bb3, ^bb4
    "llvm.store"(%25, %arg1) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "long", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, access_type = <id = "long", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (i64, !llvm.ptr) -> ()
