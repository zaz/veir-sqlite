"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr):
    ...
    %7 = "llvm.icmp"(%6, %0) <{predicate = 0 : i64}> : (i8, i8) -> i1
    "llvm.cond_br"(%7, %arg0)[^bb5, ^bb1] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, !llvm.ptr) -> ()
  ^bb1:  // pred: ^bb0
