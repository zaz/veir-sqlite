"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr, %arg1: !llvm.ptr, %arg2: !llvm.ptr):
    ...
    %11 = "llvm.icmp"(%arg2, %0) <{predicate = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> i1
    "llvm.cond_br"(%11, %arg2)[^bb10, ^bb1] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, !llvm.ptr) -> ()
  ^bb1(%12: !llvm.ptr):  // 2 preds: ^bb0, ^bb9
  ...
  ^bb2:  // pred: ^bb1
    %17 = "llvm.getelementptr"(%12, %4) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
  ...
  ^bb3:  // pred: ^bb1
    %19 = "llvm.lshr"(%14, %2) : (i64, i64) -> i64
    %20 = "llvm.and"(%19, %5) : (i64, i64) -> i64
    %21 = "llvm.sub"(%3, %20) <{overflowFlags = 1 : i32}> : (i64, i64) -> i64
  ...
  ^bb4(%23: !llvm.ptr):  // 2 preds: ^bb2, ^bb3
    ...
    %25 = "llvm.load"(%13) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> i64
  ...
  ^bb5:  // pred: ^bb4
    %28 = "llvm.and"(%25, %8) : (i64, i64) -> i64
    %29 = "llvm.icmp"(%28, %9) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%29)[^bb8, ^bb10] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb6:  // pred: ^bb4
    %30 = "llvm.getelementptr"(%12, %6) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
  ...
  ^bb7:  // pred: ^bb6
    %33 = "llvm.getelementptr"(%12, %4) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %34 = "llvm.load"(%33) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "_ZTSN4llvm15SmallVectorBaseIjEE", members = {<#llvm.tbaa_type_desc<id = "any pointer", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, 0>, <#llvm.tbaa_type_desc<id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, 8>, <#llvm.tbaa_type_desc<id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, 12>}>, access_type = <id = "any pointer", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (!llvm.ptr) -> !llvm.ptr
    "llvm.br"(%34)[^bb9] : (!llvm.ptr) -> ()
  ^bb8:  // pred: ^bb5
    %35 = "llvm.lshr"(%25, %2) : (i64, i64) -> i64
    %36 = "llvm.and"(%35, %5) : (i64, i64) -> i64
    %37 = "llvm.sub"(%3, %36) <{overflowFlags = 1 : i32}> : (i64, i64) -> i64
    %38 = "llvm.getelementptr"(%13, %37) <{elem_type = !llvm.struct<"class.llvm::MDOperand", (ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
  ...
  ^bb9(%39: !llvm.ptr):  // 2 preds: ^bb7, ^bb8
    ...
    "llvm.cond_br"(%42, %41)[^bb10, ^bb1] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, !llvm.ptr) -> ()
  ^bb10:  // 4 preds: ^bb0, ^bb5, ^bb6, ^bb9
    "llvm.return"() : () -> ()
  }) : () -> ()
