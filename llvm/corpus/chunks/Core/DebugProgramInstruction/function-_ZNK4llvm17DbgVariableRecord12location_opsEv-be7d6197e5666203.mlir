"builtin.module"() ({
  ...
  ^bb3:  // pred: ^bb2
    ...
    "llvm.br"()[^bb7] : () -> ()
  ^bb4:  // pred: ^bb2
    %21 = "llvm.icmp"(%14, %6) <{predicate = 0 : i64}> : (i8, i8) -> i1
    "llvm.cond_br"(%21)[^bb5, ^bb6] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb5:  // pred: ^bb4
    %22 = "llvm.getelementptr"(%12, %9) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    %25 = "llvm.or"(%24, %10) : (i64, i64) -> i64
    %26 = "llvm.getelementptr"(%12, %4) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    %29 = "llvm.getelementptr"(%23, %28) <{elem_type = !llvm.ptr, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %30 = "llvm.ptrtoint"(%29) : (!llvm.ptr) -> i64
    %31 = "llvm.or"(%30, %10) : (i64, i64) -> i64
    "llvm.store"(%25, %arg0) <{alignment = 8 : i64, ordering = 0 : i64}> : (i64, !llvm.ptr) -> ()
