"builtin.module"() ({
  ...
  ^bb3(%18: !llvm.ptr):  // 2 preds: ^bb1, ^bb2
    ...
    "llvm.cond_br"(%20, %5, %2)[^bb5, ^bb4] <{operandSegmentSizes = array<i32: 1, 2, 0>}> : (i1, !llvm.ptr, i64) -> ()
  ^bb4:  // pred: ^bb3
  ...
  ^bb5(%24: !llvm.ptr, %25: i64):  // 2 preds: ^bb3, ^bb4
    %26 = "llvm.insertvalue"(%6, %24) <{position = array<i64: 0>}> : (!llvm.struct<(ptr, i64)>, !llvm.ptr) -> !llvm.struct<(ptr, i64)>
    %27 = "llvm.insertvalue"(%26, %25) <{position = array<i64: 1>}> : (!llvm.struct<(ptr, i64)>, i64) -> !llvm.struct<(ptr, i64)>
    "llvm.return"(%27) : (!llvm.struct<(ptr, i64)>) -> ()
  }) : () -> ()
