"builtin.module"() ({
  "llvm.comdat"() <{sym_name = "__llvm_global_comdat"}> ({
    "llvm.comdat_selector"() <{comdat = 0 : i64, sym_name = "_ZN4llvm12StringSwitchIjjE5CasesESt16initializer_listINS_13StringLiteralEEj"}> : () -> ()
  }) : () -> ()
  "llvm.module_flags"() <{flags = [#llvm.mlir.module_flag<error, "wchar_size", 4 : i32>, #llvm.mlir.module_flag<min, "PIC Level", 2 : i32>, #llvm.mlir.module_flag<max, "uwtable", 2 : i32>]}> : () -> ()
  "llvm.func"() <{CConv = #llvm.cconv<ccc>, alignment = 2 : i64, arg_attrs = [{llvm.align = 8 : i64, llvm.dereferenceable = 24 : i64, llvm.nonnull, llvm.noundef}, {}, {}, {llvm.noundef}], comdat = @__llvm_global_comdat::@_ZN4llvm12StringSwitchIjjE5CasesESt16initializer_listINS_13StringLiteralEEj, dso_local, function_type = !llvm.func<ptr (ptr, ptr, i64, i32)>, linkage = #llvm.linkage<weak_odr>, no_unwind, passthrough = ["mustprogress", ["min-legal-vector-width", "0"], ["no-trapping-math", "true"], ["stack-protector-buffer-size", "8"], ["target-cpu", "x86-64"]], res_attrs = [{llvm.align = 8 : i64, llvm.dereferenceable = 24 : i64, llvm.nonnull, llvm.noundef}], sym_name = "_ZN4llvm12StringSwitchIjjE5CasesESt16initializer_listINS_13StringLiteralEEj", target_cpu = "x86-64", target_features = #llvm.target_features<["+cmov", "+cx8", "+fxsr", "+mmx", "+sse", "+sse2", "+x87"]>, tune_cpu = "generic", unnamed_addr = 1 : i64, uwtable_kind = #llvm.uwtableKind<async>, visibility_ = 1 : i64}> ({
  ^bb0(%arg0: !llvm.ptr, %arg1: !llvm.ptr, %arg2: i64, %arg3: i32):
    ...
    %6 = "llvm.getelementptr"(%arg1, %arg2) <{elem_type = !llvm.struct<"class.llvm::StringLiteral", (struct<"class.llvm::StringRef", (ptr, i64)>)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %7 = "llvm.icmp"(%arg2, %0) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%7)[^bb8, ^bb1] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb1:  // pred: ^bb0
    ...
    %10 = "llvm.trunc"(%9) <{overflowFlags = 2 : i32}> : (i8) -> i1
    %11 = "llvm.load"(%arg0) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> !llvm.ptr
    ...
    "llvm.cond_br"(%10)[^bb8, ^bb2] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb2:  // pred: ^bb1
    %14 = "llvm.icmp"(%13, %0) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.br"(%arg1)[^bb3] : (!llvm.ptr) -> ()
  ^bb3(%15: !llvm.ptr):  // 2 preds: ^bb2, ^bb7
    ...
    %19 = "llvm.icmp"(%13, %18) <{predicate = 0 : i64}> : (i64, i64) -> i1
  ...
  ^bb6:  // 2 preds: ^bb4, ^bb5
    ...
    %23 = "llvm.zext"(%arg3) : (i32) -> i64
    %24 = "llvm.or"(%23, %5) <{isDisjoint}> : (i64, i64) -> i64
    "llvm.store"(%24, %22) <{alignment = 8 : i64, ordering = 0 : i64}> : (i64, !llvm.ptr) -> ()
    "llvm.br"()[^bb8] : () -> ()
  ^bb7:  // 2 preds: ^bb3, ^bb5
    %25 = "llvm.getelementptr"(%15, %4) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %26 = "llvm.icmp"(%25, %6) <{predicate = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> i1
    "llvm.cond_br"(%26, %25)[^bb8, ^bb3] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, !llvm.ptr) -> ()
  ^bb8:  // 4 preds: ^bb0, ^bb1, ^bb6, ^bb7
