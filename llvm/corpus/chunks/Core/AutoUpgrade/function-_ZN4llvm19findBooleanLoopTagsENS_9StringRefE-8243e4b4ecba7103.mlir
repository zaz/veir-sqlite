"builtin.module"() ({
  "llvm.comdat"() <{sym_name = "__llvm_global_comdat"}> ({
    "llvm.comdat_selector"() <{comdat = 0 : i64, sym_name = "_ZN4llvm19findBooleanLoopTagsENS_9StringRefE"}> : () -> ()
  }) : () -> ()
  ...
  "llvm.func"() <{CConv = #llvm.cconv<ccc>, comdat = @__llvm_global_comdat::@_ZN4llvm19findBooleanLoopTagsENS_9StringRefE, dso_local, function_type = !llvm.func<ptr (ptr, i64)>, inline_hint, linkage = #llvm.linkage<weak_odr>, no_unwind, passthrough = ["mustprogress", ["min-legal-vector-width", "0"], ["no-trapping-math", "true"], ["stack-protector-buffer-size", "8"], ["target-cpu", "x86-64"]], res_attrs = [{llvm.noundef}], sym_name = "_ZN4llvm19findBooleanLoopTagsENS_9StringRefE", target_cpu = "x86-64", target_features = #llvm.target_features<["+cmov", "+cx8", "+fxsr", "+mmx", "+sse", "+sse2", "+x87"]>, tune_cpu = "generic", unnamed_addr = 1 : i64, uwtable_kind = #llvm.uwtableKind<async>, visibility_ = 1 : i64}> ({
  ^bb0(%arg0: !llvm.ptr, %arg1: i64):
    %0 = "llvm.mlir.addressof"() <{global_name = @".str.1240"}> : () -> !llvm.ptr
    %1 = "llvm.mlir.constant"() <{value = 35 : i64}> : () -> i64
    %2 = "llvm.mlir.constant"() <{value = 0 : i32}> : () -> i32
    %3 = "llvm.mlir.constant"() <{value = 96 : i64}> : () -> i64
    %4 = "llvm.mlir.addressof"() <{global_name = @_ZN4llvm18OldBooleanLoopTagsE}> : () -> !llvm.ptr
    %5 = "llvm.getelementptr"(%4, %3) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %6 = "llvm.mlir.addressof"() <{global_name = @".str.1238"}> : () -> !llvm.ptr
    ...
    %10 = "llvm.mlir.addressof"() <{global_name = @".str.1236"}> : () -> !llvm.ptr
