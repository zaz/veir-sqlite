"builtin.module"() ({
  ...
  "llvm.mlir.global"() <{addr_space = 0 : i32, alignment = 1 : i64, constant, dso_local, global_type = !llvm.array<29 x i8>, linkage = #llvm.linkage<external>, sym_name = ".str.1235", tls_mode = 0 : i64, unnamed_addr = 2 : i64, visibility_ = 1 : i64}> ({
  }) : () -> ()
  ...
  "llvm.mlir.global"() <{addr_space = 0 : i32, alignment = 1 : i64, constant, dso_local, global_type = !llvm.array<28 x i8>, linkage = #llvm.linkage<external>, sym_name = ".str.1237", tls_mode = 0 : i64, unnamed_addr = 2 : i64, visibility_ = 1 : i64}> ({
  }) : () -> ()
  ...
  "llvm.mlir.global"() <{addr_space = 0 : i32, alignment = 1 : i64, constant, dso_local, global_type = !llvm.array<38 x i8>, linkage = #llvm.linkage<external>, sym_name = ".str.1239", tls_mode = 0 : i64, unnamed_addr = 2 : i64, visibility_ = 1 : i64}> ({
  }) : () -> ()
  ...
  "llvm.mlir.global"() <{addr_space = 0 : i32, alignment = 1 : i64, constant, dso_local, global_type = !llvm.array<37 x i8>, linkage = #llvm.linkage<external>, sym_name = ".str.1241", tls_mode = 0 : i64, unnamed_addr = 2 : i64, visibility_ = 1 : i64}> ({
  }) : () -> ()
  "llvm.mlir.global"() <{addr_space = 0 : i32, alignment = 16 : i64, comdat = @__llvm_global_comdat::@_ZN4llvm18OldBooleanLoopTagsE, constant, global_type = !llvm.array<4 x struct<(struct<(ptr, i64)>, struct<(ptr, i64)>)>>, linkage = #llvm.linkage<weak_odr>, sym_name = "_ZN4llvm18OldBooleanLoopTagsE", tls_mode = 0 : i64, unnamed_addr = 0 : i64, visibility_ = 0 : i64}> ({
    ...
    %1 = "llvm.mlir.addressof"() <{global_name = @".str.1241"}> : () -> !llvm.ptr
    ...
    %6 = "llvm.mlir.addressof"() <{global_name = @".str.1240"}> : () -> !llvm.ptr
    ...
    %14 = "llvm.mlir.addressof"() <{global_name = @".str.1239"}> : () -> !llvm.ptr
    ...
    %18 = "llvm.mlir.addressof"() <{global_name = @".str.1238"}> : () -> !llvm.ptr
    ...
    %26 = "llvm.mlir.addressof"() <{global_name = @".str.1237"}> : () -> !llvm.ptr
    ...
    %31 = "llvm.mlir.addressof"() <{global_name = @".str.1236"}> : () -> !llvm.ptr
    ...
    %39 = "llvm.mlir.addressof"() <{global_name = @".str.1235"}> : () -> !llvm.ptr
    ...
    %43 = "llvm.mlir.addressof"() <{global_name = @".str.1234"}> : () -> !llvm.ptr
