"builtin.module"() ({
  "llvm.comdat"() <{sym_name = "__llvm_global_comdat"}> ({
    "llvm.comdat_selector"() <{comdat = 0 : i64, sym_name = "_ZNSt14_Optional_baseIN4llvm6VFInfoELb0ELb0EED2Ev"}> : () -> ()
  }) : () -> ()
  ...
  ^bb5:  // pred: ^bb4
    ...
    %30 = "llvm.icmp"(%29, %6) <{predicate = 6 : i64}> : (i64, i64) -> i1
