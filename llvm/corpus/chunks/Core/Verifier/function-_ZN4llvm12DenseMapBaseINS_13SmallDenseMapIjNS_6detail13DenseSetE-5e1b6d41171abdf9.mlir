"builtin.module"() ({
  ...
  ^bb4(%54: i32):  // 2 preds: ^bb3, ^bb6
    ...
    %58 = "llvm.getelementptr"(%24, %57) <{elem_type = !llvm.struct<"class.llvm::detail::DenseSetPair.651", (i32)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
  ...
  ^bb6:  // pred: ^bb5
    ...
    %73 = "llvm.getelementptr"(%40, %63) <{elem_type = !llvm.struct<"class.llvm::detail::DenseSetPair.651", (i32)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
