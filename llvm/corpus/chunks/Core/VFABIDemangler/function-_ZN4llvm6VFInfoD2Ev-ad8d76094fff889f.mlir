"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr):
    ...
    %7 = "llvm.mlir.constant"() <{value = 160 : i64}> : () -> i64
  ...
  ^bb1:  // pred: ^bb0
    ...
    %16 = "llvm.icmp"(%15, %4) <{predicate = 6 : i64}> : (i64, i64) -> i1
    "llvm.intr.assume"(%16) <{op_bundle_sizes = array<i32>}> : (i1) -> ()
    "llvm.br"()[^bb3] : () -> ()
  ^bb2:  // pred: ^bb0
    %17 = "llvm.load"(%12) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, access_type = <id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, offset = 0>]}> : (!llvm.ptr) -> i64
    %18 = "llvm.add"(%17, %2) <{overflowFlags = 0 : i32}> : (i64, i64) -> i64
    "llvm.call"(%11, %18) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<tail>, arg_attrs = [{llvm.noundef}, {llvm.noundef}], builtin, callee = @_ZdlPvm, fastmathFlags = #llvm.fastmath<none>, no_unwind, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 2, 0>}> : (!llvm.ptr, i64) -> ()
    "llvm.br"()[^bb3] : () -> ()
  ^bb3:  // 2 preds: ^bb1, ^bb2
  ...
  ^bb4:  // pred: ^bb3
    ...
    %25 = "llvm.icmp"(%24, %4) <{predicate = 6 : i64}> : (i64, i64) -> i1
