"builtin.module"() ({
  ...
  ^bb1:  // pred: ^bb0
    ...
    %9 = "llvm.select"(%arg1, %2, %3) <{fastmathFlags = #llvm.fastmath<none>}> : (i1, i8, i8) -> i8
    %10 = "llvm.and"(%8, %4) : (i8, i8) -> i8
    %11 = "llvm.or"(%10, %9) <{isDisjoint}> : (i8, i8) -> i8
    "llvm.store"(%11, %7) <{alignment = 1 : i64, ordering = 0 : i64}> : (i8, !llvm.ptr) -> ()
    "llvm.br"()[^bb2] : () -> ()
  ^bb2:  // 2 preds: ^bb0, ^bb1
    "llvm.return"() : () -> ()
  }) : () -> ()
