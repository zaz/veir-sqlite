"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr, %arg1: i32):
    ...
    %7 = "llvm.select"(%4, %0, %2) <{fastmathFlags = #llvm.fastmath<none>}> : (i1, i32, i32) -> i32
    %8 = "llvm.and"(%6, %3) : (i32, i32) -> i32
    %9 = "llvm.or"(%8, %7) <{isDisjoint}> : (i32, i32) -> i32
    "llvm.store"(%9, %5) <{alignment = 8 : i64, ordering = 0 : i64}> : (i32, !llvm.ptr) -> ()
    "llvm.return"() : () -> ()
  }) : () -> ()
