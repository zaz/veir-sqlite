"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr):
    ...
    %8 = "llvm.icmp"(%5, %2) <{predicate = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> i1
    %9 = "llvm.getelementptr"(%5, %3) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %10 = "llvm.or"(%7, %8) : (i1, i1) -> i1
    %11 = "llvm.select"(%10, %2, %9) <{fastmathFlags = #llvm.fastmath<none>}> : (i1, !llvm.ptr, !llvm.ptr) -> !llvm.ptr
