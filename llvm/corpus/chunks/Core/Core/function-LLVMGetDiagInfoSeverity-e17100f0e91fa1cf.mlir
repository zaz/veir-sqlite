"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr):
    ...
    %6 = "llvm.load"(%5) <{alignment = 4 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "_ZTSN4llvm14DiagnosticInfoE", members = {<#llvm.tbaa_type_desc<id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, 8>, <#llvm.tbaa_type_desc<id = "_ZTSN4llvm18DiagnosticSeverityE", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, 12>}>, access_type = <id = "_ZTSN4llvm18DiagnosticSeverityE", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 12>]}> : (!llvm.ptr) -> i8
    %7 = "llvm.add"(%6, %1) <{overflowFlags = 0 : i32}> : (i8, i8) -> i8
    %8 = "llvm.icmp"(%7, %2) <{predicate = 6 : i64}> : (i8, i8) -> i1
    %9 = "llvm.zext"(%7) : (i8) -> i32
    %10 = "llvm.add"(%9, %3) <{overflowFlags = 3 : i32}> : (i32, i32) -> i32
