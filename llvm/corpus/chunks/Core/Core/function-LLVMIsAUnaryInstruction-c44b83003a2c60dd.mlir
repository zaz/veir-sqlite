"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr):
    ...
    "llvm.cond_br"(%4, %0)[^bb5, ^bb1] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, !llvm.ptr) -> ()
  ^bb1:  // pred: ^bb0
    ...
    "llvm.cond_br"(%6, %0)[^bb2, ^bb5] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, !llvm.ptr) -> ()
  ^bb2:  // pred: ^bb1
    "llvm.switch"(%5)[^bb3, ^bb4, ^bb4, ^bb4, ^bb4, ^bb4, ^bb4] <{case_operand_segments = array<i32: 0, 0, 0, 0, 0, 0>, case_values = dense<[43, 62, 63, 92, 96, 99]> : vector<6xi8>, operandSegmentSizes = array<i32: 1, 0, 0>}> : (i8) -> ()
  ^bb3:  // pred: ^bb2
    %7 = "llvm.zext"(%5) : (i8) -> i32
    %8 = "llvm.add"(%7, %2) <{overflowFlags = 1 : i32}> : (i32, i32) -> i32
    %9 = "llvm.icmp"(%8, %3) <{predicate = 6 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%9, %0)[^bb4, ^bb5] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, !llvm.ptr) -> ()
  ^bb4:  // 7 preds: ^bb2, ^bb2, ^bb2, ^bb2, ^bb2, ^bb2, ^bb3
    "llvm.br"(%arg0)[^bb5] : (!llvm.ptr) -> ()
  ^bb5(%10: !llvm.ptr):  // 4 preds: ^bb0, ^bb1, ^bb3, ^bb4
