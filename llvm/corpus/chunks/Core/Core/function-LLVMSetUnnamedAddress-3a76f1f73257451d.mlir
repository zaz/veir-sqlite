"builtin.module"() ({
  ...
  ^bb2:  // pred: ^bb0
    ...
    %10 = "llvm.or"(%9, %3) <{isDisjoint}> : (i32, i32) -> i32
    "llvm.store"(%10, %7) <{alignment = 8 : i64, ordering = 0 : i64}> : (i32, !llvm.ptr) -> ()
    "llvm.br"()[^bb4] : () -> ()
  ^bb3:  // pred: ^bb0
    ...
    %14 = "llvm.or"(%13, %2) <{isDisjoint}> : (i32, i32) -> i32
    "llvm.store"(%14, %11) <{alignment = 8 : i64, ordering = 0 : i64}> : (i32, !llvm.ptr) -> ()
    "llvm.br"()[^bb4] : () -> ()
