"builtin.module"() ({
  "llvm.comdat"() <{sym_name = "__llvm_global_comdat"}> ({
    "llvm.comdat_selector"() <{comdat = 0 : i64, sym_name = "_ZN4llvm12DenseMapBaseINS_13SmallDenseMapINS_9StringRefENS_6detail13DenseSetEmptyELj8ENS_12DenseMapInfoIS2_vEENS3_12DenseSetPairIS2_EEEES2_S4_S6_S8_E4growEj"}> : () -> ()
  }) : () -> ()
  ...
  ^bb0(%arg0: !llvm.ptr, %arg1: i32):
    ...
    %18 = "llvm.alloca"(%0) <{alignment = 8 : i64, elem_type = !llvm.struct<"class.llvm::SmallDenseMap", (i32, struct<"union.anon.29", (struct<"struct.llvm::SmallDenseMap<llvm::StringRef, llvm::detail::DenseSetEmpty, 8, llvm::DenseMapInfo<StringRef, void>, llvm::detail::DenseSetPair<llvm::StringRef>>::LargeRep", (ptr, ptr, i32)>, array<112 x i8>)>)>}> : (i32) -> !llvm.ptr
