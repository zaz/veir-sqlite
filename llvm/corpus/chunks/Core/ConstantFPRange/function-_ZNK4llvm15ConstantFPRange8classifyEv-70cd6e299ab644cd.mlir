"builtin.module"() ({
  ...
  "llvm.func"() <{CConv = #llvm.cconv<ccc>, alignment = 2 : i64, arg_attrs = [{llvm.align = 8 : i64, llvm.dereferenceable = 49 : i64, llvm.nonnull, llvm.noundef}], dso_local, function_type = !llvm.func<i32 (ptr)>, linkage = #llvm.linkage<external>, no_unwind, passthrough = ["mustprogress", ["min-legal-vector-width", "0"], ["no-trapping-math", "true"], ["stack-protector-buffer-size", "8"], ["target-cpu", "x86-64"]], res_attrs = [{llvm.noundef}], sym_name = "_ZNK4llvm15ConstantFPRange8classifyEv", target_cpu = "x86-64", target_features = #llvm.target_features<["+cmov", "+cx8", "+fxsr", "+mmx", "+sse", "+sse2", "+x87"]>, tune_cpu = "generic", unnamed_addr = 1 : i64, uwtable_kind = #llvm.uwtableKind<async>, visibility_ = 0 : i64}> ({
  ^bb0(%arg0: !llvm.ptr):
    ...
    %14 = "llvm.lshr"(%13, %1) : (i8, i8) -> i8
    %15 = "llvm.and"(%14, %1) : (i8, i8) -> i8
    %16 = "llvm.zext"(%15) <{nonNeg}> : (i8) -> i32
    %17 = "llvm.trunc"(%13) <{overflowFlags = 0 : i32}> : (i8) -> i1
    %18 = "llvm.or"(%16, %2) <{isDisjoint}> : (i32, i32) -> i32
    %19 = "llvm.select"(%17, %18, %16) <{fastmathFlags = #llvm.fastmath<none>}> : (i1, i32, i32) -> i32
    ...
    %24 = "llvm.select"(%21, %23, %arg0) <{fastmathFlags = #llvm.fastmath<none>}> : (i1, !llvm.ptr, !llvm.ptr) -> !llvm.ptr
  ...
  ^bb1:  // pred: ^bb0
    ...
    %34 = "llvm.select"(%31, %33, %29) <{fastmathFlags = #llvm.fastmath<none>}> : (i1, !llvm.ptr, !llvm.ptr) -> !llvm.ptr
    %35 = "llvm.getelementptr"(%34, %5) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    "llvm.cond_br"(%38, %19)[^bb3, ^bb2] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i32) -> ()
  ^bb2:  // 2 preds: ^bb0, ^bb1
    ...
    %42 = "llvm.shl"(%41, %11) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
    %43 = "llvm.sub"(%42, %39) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
    %44 = "llvm.or"(%43, %19) : (i32, i32) -> i32
    "llvm.br"(%44)[^bb3] : (i32) -> ()
