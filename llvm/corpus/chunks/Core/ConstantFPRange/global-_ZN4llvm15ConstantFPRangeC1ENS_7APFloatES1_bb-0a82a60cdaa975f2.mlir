"builtin.module"() ({
  "llvm.mlir.alias"() <{alias_type = !llvm.func<void (ptr, ptr, ptr, i1, i1)>, linkage = #llvm.linkage<external>, sym_name = "_ZN4llvm15ConstantFPRangeC1ENS_7APFloatES1_bb", tls_mode = 0 : i64, unnamed_addr = 2 : i64, visibility_ = 0 : i64}> ({
    %13 = "llvm.mlir.addressof"() <{global_name = @_ZN4llvm15ConstantFPRangeC2ENS_7APFloatES1_bb}> : () -> !llvm.ptr
    "llvm.return"(%13) : (!llvm.ptr) -> ()
  }) : () -> ()
  "llvm.module_flags"() <{flags = [#llvm.mlir.module_flag<error, "wchar_size", 4 : i32>, #llvm.mlir.module_flag<min, "PIC Level", 2 : i32>, #llvm.mlir.module_flag<max, "uwtable", 2 : i32>]}> : () -> ()
  "llvm.func"() <{CConv = #llvm.cconv<ccc>, alignment = 2 : i64, arg_attrs = [{llvm.align = 8 : i64, llvm.dereferenceable = 49 : i64, llvm.nonnull, llvm.noundef}, {llvm.nonnull, llvm.noundef}, {llvm.noundef}, {llvm.noundef, llvm.zeroext}, {llvm.noundef, llvm.zeroext}], dso_local, function_type = !llvm.func<void (ptr, ptr, ptr, i1, i1)>, linkage = #llvm.linkage<external>, no_unwind, passthrough = ["mustprogress", ["min-legal-vector-width", "0"], ["no-trapping-math", "true"], ["stack-protector-buffer-size", "8"], ["target-cpu", "x86-64"]], sym_name = "_ZN4llvm15ConstantFPRangeC2ENS_7APFloatES1_bb", target_cpu = "x86-64", target_features = #llvm.target_features<["+cmov", "+cx8", "+fxsr", "+mmx", "+sse", "+sse2", "+x87"]>, tune_cpu = "generic", unnamed_addr = 2 : i64, uwtable_kind = #llvm.uwtableKind<async>, visibility_ = 0 : i64}> ({
  ^bb0(%arg0: !llvm.ptr, %arg1: !llvm.ptr, %arg2: !llvm.ptr, %arg3: i1, %arg4: i1):
    ...
    %9 = "llvm.and"(%8, %2) : (i8, i8) -> i8
    %10 = "llvm.select"(%arg4, %3, %4) <{fastmathFlags = #llvm.fastmath<none>}> : (i1, i8, i8) -> i8
    %11 = "llvm.or"(%10, %5) <{isDisjoint}> : (i8, i8) -> i8
    %12 = "llvm.or"(%11, %9) <{isDisjoint}> : (i8, i8) -> i8
    "llvm.store"(%12, %7) <{alignment = 8 : i64, ordering = 0 : i64}> : (i8, !llvm.ptr) -> ()
    "llvm.return"() : () -> ()
  }) : () -> ()
