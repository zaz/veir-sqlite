"builtin.module"() ({
  "llvm.mlir.global"() <{addr_space = 0 : i32, alignment = 1 : i64, constant, dso_local, global_type = !llvm.array<6 x i8>, linkage = #llvm.linkage<external>, sym_name = ".str", tls_mode = 0 : i64, unnamed_addr = 2 : i64, visibility_ = 1 : i64}> ({
  }) : () -> ()
  ...
  "llvm.mlir.global"() <{addr_space = 0 : i32, alignment = 1 : i64, constant, dso_local, global_type = !llvm.array<16 x i8>, linkage = #llvm.linkage<external>, sym_name = ".str.2", tls_mode = 0 : i64, unnamed_addr = 2 : i64, visibility_ = 1 : i64}> ({
  }) : () -> ()
  "llvm.mlir.global"() <{addr_space = 0 : i32, alignment = 1 : i64, constant, dso_local, global_type = !llvm.array<24 x i8>, linkage = #llvm.linkage<external>, sym_name = ".str.3", tls_mode = 0 : i64, unnamed_addr = 2 : i64, visibility_ = 1 : i64}> ({
  }) : () -> ()
  ...
  "llvm.mlir.global"() <{addr_space = 0 : i32, alignment = 4 : i64, constant, dso_local, global_type = !llvm.array<9 x i32>, linkage = #llvm.linkage<external>, sym_name = "switch.table._ZN4llvm21getNameFromBundleAttrE10BundleAttr.9.rel", tls_mode = 0 : i64, unnamed_addr = 2 : i64, visibility_ = 1 : i64}> ({
    %0 = "llvm.mlir.addressof"() <{global_name = @switch.table._ZN4llvm21getNameFromBundleAttrE10BundleAttr.9.rel}> : () -> !llvm.ptr
    ...
    %18 = "llvm.mlir.addressof"() <{global_name = @".str.3"}> : () -> !llvm.ptr
    ...
    %22 = "llvm.mlir.addressof"() <{global_name = @".str.2"}> : () -> !llvm.ptr
    ...
    %26 = "llvm.mlir.addressof"() <{global_name = @".str.1"}> : () -> !llvm.ptr
    ...
    %38 = "llvm.mlir.undef"() : () -> !llvm.array<9 x i32>
    %39 = "llvm.insertvalue"(%38, %37) <{position = array<i64: 0>}> : (!llvm.array<9 x i32>, i32) -> !llvm.array<9 x i32>
    %40 = "llvm.insertvalue"(%39, %33) <{position = array<i64: 1>}> : (!llvm.array<9 x i32>, i32) -> !llvm.array<9 x i32>
    %41 = "llvm.insertvalue"(%40, %29) <{position = array<i64: 2>}> : (!llvm.array<9 x i32>, i32) -> !llvm.array<9 x i32>
    %42 = "llvm.insertvalue"(%41, %25) <{position = array<i64: 3>}> : (!llvm.array<9 x i32>, i32) -> !llvm.array<9 x i32>
    %43 = "llvm.insertvalue"(%42, %21) <{position = array<i64: 4>}> : (!llvm.array<9 x i32>, i32) -> !llvm.array<9 x i32>
    %44 = "llvm.insertvalue"(%43, %17) <{position = array<i64: 5>}> : (!llvm.array<9 x i32>, i32) -> !llvm.array<9 x i32>
    %45 = "llvm.insertvalue"(%44, %13) <{position = array<i64: 6>}> : (!llvm.array<9 x i32>, i32) -> !llvm.array<9 x i32>
    %46 = "llvm.insertvalue"(%45, %9) <{position = array<i64: 7>}> : (!llvm.array<9 x i32>, i32) -> !llvm.array<9 x i32>
    %47 = "llvm.insertvalue"(%46, %5) <{position = array<i64: 8>}> : (!llvm.array<9 x i32>, i32) -> !llvm.array<9 x i32>
    "llvm.return"(%47) : (!llvm.array<9 x i32>) -> ()
  }) : () -> ()
