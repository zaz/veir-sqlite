"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr, %arg1: !llvm.ptr):
    ...
    %8 = "llvm.mlir.constant"() <{value = -58720257 : i32}> : () -> i32
    "llvm.call"(%arg0, %arg1) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<tail>, arg_attrs = [{llvm.align = 8 : i64, llvm.dereferenceable = 60 : i64, llvm.nonnull, llvm.noundef}, {llvm.noundef}], callee = @_ZN4llvm12GlobalObject18copyAttributesFromEPKS0_, fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 2, 0>}> : (!llvm.ptr, !llvm.ptr) -> ()
    ...
    %15 = "llvm.or"(%14, %11) <{isDisjoint}> : (i8, i8) -> i8
    "llvm.store"(%15, %12) <{alignment = 8 : i64, ordering = 0 : i64}> : (i8, !llvm.ptr) -> ()
  ...
  ^bb1:  // pred: ^bb0
    ...
    %26 = "llvm.shl"(%22, %5) <{overflowFlags = 3 : i32}> : (i32, i32) -> i32
    %27 = "llvm.and"(%25, %8) : (i32, i32) -> i32
    %28 = "llvm.or"(%27, %26) <{isDisjoint}> : (i32, i32) -> i32
    "llvm.store"(%28, %24) <{alignment = 8 : i64, ordering = 0 : i64}> : (i32, !llvm.ptr) -> ()
    "llvm.br"()[^bb2] : () -> ()
  ^bb2:  // 2 preds: ^bb0, ^bb1
    "llvm.return"() : () -> ()
  }) : () -> ()
