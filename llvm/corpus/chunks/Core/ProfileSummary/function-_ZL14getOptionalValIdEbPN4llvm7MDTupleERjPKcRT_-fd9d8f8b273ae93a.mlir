"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr, %arg1: !llvm.ptr, %arg2: !llvm.ptr):
    ...
    %14 = "llvm.mlir.constant"() <{value = 19 : i64}> : () -> i64
    %15 = "llvm.mlir.addressof"() <{global_name = @".str.12"}> : () -> !llvm.ptr
    ...
    %25 = "llvm.and"(%24, %1) : (i64, i64) -> i64
    %26 = "llvm.icmp"(%25, %2) <{predicate = 0 : i64}> : (i64, i64) -> i1
  ...
  ^bb2:  // pred: ^bb0
    %29 = "llvm.lshr"(%24, %1) : (i64, i64) -> i64
    %30 = "llvm.and"(%29, %4) : (i64, i64) -> i64
    %31 = "llvm.sub"(%2, %30) <{overflowFlags = 1 : i32}> : (i64, i64) -> i64
  ...
  ^bb3(%33: !llvm.ptr):  // 2 preds: ^bb1, ^bb2
    %34 = "llvm.zext"(%22) : (i32) -> i64
    %35 = "llvm.getelementptr"(%33, %34) <{elem_type = !llvm.struct<"class.llvm::MDOperand", (ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    %38 = "llvm.icmp"(%37, %5) <{predicate = 0 : i64}> : (i8, i8) -> i1
    "llvm.cond_br"(%38, %6)[^bb4, ^bb16] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i1) -> ()
  ^bb4:  // pred: ^bb3
    %39 = "llvm.getelementptr"(%36, %0) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %40 = "llvm.load"(%39) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> i64
    %41 = "llvm.and"(%40, %1) : (i64, i64) -> i64
    %42 = "llvm.icmp"(%41, %2) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%42)[^bb5, ^bb6] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb5:  // pred: ^bb4
    %43 = "llvm.and"(%40, %9) : (i64, i64) -> i64
    %44 = "llvm.icmp"(%43, %10) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%44, %6)[^bb8, ^bb16] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i1) -> ()
  ^bb6:  // pred: ^bb4
    ...
    "llvm.cond_br"(%47, %6)[^bb7, ^bb16] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i1) -> ()
  ^bb7:  // pred: ^bb6
    %48 = "llvm.getelementptr"(%36, %3) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %49 = "llvm.load"(%48) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "_ZTSN4llvm15SmallVectorBaseIjEE", members = {<#llvm.tbaa_type_desc<id = "any pointer", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, 0>, <#llvm.tbaa_type_desc<id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, 8>, <#llvm.tbaa_type_desc<id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, 12>}>, access_type = <id = "any pointer", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (!llvm.ptr) -> !llvm.ptr
    "llvm.br"(%49)[^bb9] : (!llvm.ptr) -> ()
  ^bb8:  // pred: ^bb5
    %50 = "llvm.lshr"(%40, %1) : (i64, i64) -> i64
    %51 = "llvm.and"(%50, %4) : (i64, i64) -> i64
    %52 = "llvm.sub"(%2, %51) <{overflowFlags = 1 : i32}> : (i64, i64) -> i64
    %53 = "llvm.getelementptr"(%39, %52) <{elem_type = !llvm.struct<"class.llvm::MDOperand", (ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    "llvm.br"(%53)[^bb9] : (!llvm.ptr) -> ()
  ^bb9(%54: !llvm.ptr):  // 2 preds: ^bb7, ^bb8
    ...
    %58 = "llvm.getelementptr"(%54, %12) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
  ...
  ^bb12:  // pred: ^bb11
    ...
    %72 = "llvm.getelementptr"(%71, %18) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %73 = "llvm.call"(%72) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<tail>, arg_attrs = [{llvm.align = 8 : i64, llvm.dereferenceable = 24 : i64, llvm.nonnull, llvm.noundef}], callee = @_ZNK4llvm7APFloat15convertToDoubleEv, fastmathFlags = #llvm.fastmath<none>, no_unwind, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 1, 0>, res_attrs = [{llvm.noundef}]}> : (!llvm.ptr) -> f64
    ...
    %74 = "llvm.load"(%arg1) <{alignment = 4 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, access_type = <id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (!llvm.ptr) -> i32
    %75 = "llvm.add"(%74, %19) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
    "llvm.store"(%75, %arg1) <{alignment = 4 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, access_type = <id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (i32, !llvm.ptr) -> ()
    %76 = "llvm.load"(%23) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> i64
    %77 = "llvm.and"(%76, %1) : (i64, i64) -> i64
    %78 = "llvm.icmp"(%77, %2) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%78)[^bb13, ^bb14] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb13:  // pred: ^bb12
    %79 = "llvm.trunc"(%76) <{overflowFlags = 0 : i32}> : (i64) -> i32
    %80 = "llvm.lshr"(%79, %20) : (i32, i32) -> i32
    %81 = "llvm.and"(%80, %21) : (i32, i32) -> i32
    "llvm.br"(%81)[^bb15] : (i32) -> ()
  ^bb14:  // pred: ^bb12
    %82 = "llvm.getelementptr"(%arg0, %7) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %83 = "llvm.load"(%82) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "_ZTSN4llvm15SmallVectorBaseIjEE", members = {<#llvm.tbaa_type_desc<id = "any pointer", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, 0>, <#llvm.tbaa_type_desc<id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, 8>, <#llvm.tbaa_type_desc<id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, 12>}>, access_type = <id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 8>]}> : (!llvm.ptr) -> i32
    "llvm.br"(%83)[^bb15] : (i32) -> ()
  ^bb15(%84: i32):  // 2 preds: ^bb13, ^bb14
    %85 = "llvm.icmp"(%75, %84) <{predicate = 6 : i64}> : (i32, i32) -> i1
    "llvm.br"(%85)[^bb16] : (i1) -> ()
  ^bb16(%86: i1):  // 7 preds: ^bb3, ^bb5, ^bb6, ^bb9, ^bb10, ^bb11, ^bb15
    "llvm.return"(%86) : (i1) -> ()
  }) : () -> ()
  ...
  "llvm.func"() <{CConv = #llvm.cconv<ccc>, arg_attrs = [{llvm.align = 8 : i64, llvm.dereferenceable = 24 : i64, llvm.nonnull, llvm.noundef}], function_type = !llvm.func<f64 (ptr)>, linkage = #llvm.linkage<external>, passthrough = [["no-trapping-math", "true"], ["stack-protector-buffer-size", "8"], ["target-cpu", "x86-64"]], res_attrs = [{llvm.noundef}], sym_name = "_ZNK4llvm7APFloat15convertToDoubleEv", target_cpu = "x86-64", target_features = #llvm.target_features<["+cmov", "+cx8", "+fxsr", "+mmx", "+sse", "+sse2", "+x87"]>, tune_cpu = "generic", unnamed_addr = 1 : i64, visibility_ = 0 : i64}> ({
  }) : () -> ()
