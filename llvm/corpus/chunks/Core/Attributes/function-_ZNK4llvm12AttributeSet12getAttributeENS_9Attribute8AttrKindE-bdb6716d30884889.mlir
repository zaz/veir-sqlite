"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr, %arg1: i32):
    ...
    "llvm.cond_br"(%14, %0)[^bb7, ^bb1] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, !llvm.ptr) -> ()
  ^bb1:  // pred: ^bb0
    %15 = "llvm.getelementptr"(%13, %1) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %16 = "llvm.sdiv"(%arg1, %2) : (i32, i32) -> i32
    %17 = "llvm.sext"(%16) : (i32) -> i64
    %18 = "llvm.getelementptr"(%15, %3, %17) <{elem_type = !llvm.array<16 x i8>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, -2147483648>}> : (!llvm.ptr, i64, i64) -> !llvm.ptr
    %19 = "llvm.load"(%18) <{alignment = 1 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, access_type = <id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, offset = 0>]}> : (!llvm.ptr) -> i8
    %20 = "llvm.zext"(%19) : (i8) -> i32
    %21 = "llvm.and"(%arg1, %4) : (i32, i32) -> i32
    %22 = "llvm.shl"(%5, %21) <{overflowFlags = 3 : i32}> : (i32, i32) -> i32
    %23 = "llvm.and"(%22, %20) : (i32, i32) -> i32
    %24 = "llvm.icmp"(%23, %6) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%24, %0)[^bb7, ^bb2] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, !llvm.ptr) -> ()
  ^bb2:  // pred: ^bb1
    %25 = "llvm.getelementptr"(%13, %7) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %26 = "llvm.getelementptr"(%13, %8) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    %30 = "llvm.getelementptr"(%13, %9) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    %33 = "llvm.sub"(%3, %32) <{overflowFlags = 1 : i32}> : (i64, i64) -> i64
    ...
    %38 = "llvm.ashr"(%37, %10) <{isExact}> : (i64, i64) -> i64
  ...
  ^bb3(%40: !llvm.ptr, %41: i64):  // 2 preds: ^bb2, ^bb5
    ...
    "llvm.cond_br"(%45, %6)[^bb5, ^bb4] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i32) -> ()
  ^bb4:  // pred: ^bb3
    %46 = "llvm.getelementptr"(%44, %1) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
  ...
  ^bb5(%48: i32):  // 2 preds: ^bb3, ^bb4
    %49 = "llvm.icmp"(%48, %arg1) <{predicate = 2 : i64}> : (i32, i32) -> i1
    %50 = "llvm.getelementptr"(%43, %8) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %51 = "llvm.xor"(%42, %12) : (i64, i64) -> i64
    ...
    %55 = "llvm.icmp"(%53, %3) <{predicate = 4 : i64}> : (i64, i64) -> i1
  ...
  ^bb7(%59: !llvm.ptr):  // 3 preds: ^bb0, ^bb1, ^bb6
