"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr):
    ...
    %17 = "llvm.load"(%16) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, access_type = <id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, offset = 0>]}> : (!llvm.ptr) -> i8
    %18 = "llvm.and"(%17, %1) : (i8, i8) -> i8
    %19 = "llvm.icmp"(%18, %2) <{predicate = 0 : i64}> : (i8, i8) -> i1
    "llvm.cond_br"(%19, %3)[^bb6, ^bb1] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i32) -> ()
  ^bb1:  // pred: ^bb0
    ...
    %24 = "llvm.getelementptr"(%20, %23) <{elem_type = !llvm.struct<"class.llvm::Attribute", (ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    %28 = "llvm.sub"(%7, %27) <{overflowFlags = 1 : i32}> : (i64, i64) -> i64
    %29 = "llvm.getelementptr"(%24, %28) <{elem_type = !llvm.struct<"class.llvm::Attribute", (ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %30 = "llvm.ptrtoint"(%29) : (!llvm.ptr) -> i64
    %31 = "llvm.ptrtoint"(%20) : (!llvm.ptr) -> i64
    %32 = "llvm.sub"(%30, %31) <{overflowFlags = 0 : i32}> : (i64, i64) -> i64
    %33 = "llvm.ashr"(%32, %8) <{isExact}> : (i64, i64) -> i64
    %34 = "llvm.icmp"(%33, %7) <{predicate = 4 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%34, %20, %33, %20)[^bb2, ^bb5] <{operandSegmentSizes = array<i32: 1, 2, 1>}> : (i1, !llvm.ptr, i64, !llvm.ptr) -> ()
  ^bb2(%35: !llvm.ptr, %36: i64):  // 2 preds: ^bb1, ^bb4
    %37 = "llvm.lshr"(%36, %9) : (i64, i64) -> i64
    %38 = "llvm.getelementptr"(%35, %37) <{elem_type = !llvm.struct<"class.llvm::Attribute", (ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %39 = "llvm.load"(%38) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "any pointer", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, access_type = <id = "any pointer", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (!llvm.ptr) -> !llvm.ptr
    %40 = "llvm.icmp"(%39, %10) <{predicate = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> i1
    "llvm.cond_br"(%40, %11)[^bb4, ^bb3] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i32) -> ()
  ^bb3:  // pred: ^bb2
    %41 = "llvm.getelementptr"(%39, %12) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
  ...
  ^bb4(%43: i32):  // 2 preds: ^bb2, ^bb3
    %44 = "llvm.icmp"(%43, %13) <{predicate = 2 : i64}> : (i32, i32) -> i1
    %45 = "llvm.getelementptr"(%38, %5) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %46 = "llvm.xor"(%37, %14) : (i64, i64) -> i64
    %47 = "llvm.add"(%36, %46) <{overflowFlags = 1 : i32}> : (i64, i64) -> i64
    %48 = "llvm.select"(%44, %47, %37) <{fastmathFlags = #llvm.fastmath<none>}> : (i1, i64, i64) -> i64
    %49 = "llvm.select"(%44, %45, %35) <{fastmathFlags = #llvm.fastmath<none>}> : (i1, !llvm.ptr, !llvm.ptr) -> !llvm.ptr
    %50 = "llvm.icmp"(%48, %7) <{predicate = 4 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%50, %49, %48, %49)[^bb2, ^bb5] <{loop_annotation = #llvm.loop_annotation<mustProgress = true>, operandSegmentSizes = array<i32: 1, 2, 1>}> : (i1, !llvm.ptr, i64, !llvm.ptr) -> ()
  ^bb5(%51: !llvm.ptr):  // 2 preds: ^bb1, ^bb4
    %52 = "llvm.load"(%51) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "any pointer", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, access_type = <id = "any pointer", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (!llvm.ptr) -> i64
    %53 = "llvm.inttoptr"(%52) : (i64) -> !llvm.ptr
