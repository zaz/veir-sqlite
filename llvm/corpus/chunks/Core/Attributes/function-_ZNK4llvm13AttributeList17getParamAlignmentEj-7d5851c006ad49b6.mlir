"builtin.module"() ({
  ...
  "llvm.func"() <{CConv = #llvm.cconv<ccc>, alignment = 2 : i64, arg_attrs = [{llvm.align = 8 : i64, llvm.dereferenceable = 8 : i64, llvm.nocapture, llvm.nonnull, llvm.noundef, llvm.readonly}, {llvm.noundef}], dso_local, function_type = !llvm.func<i16 (ptr, i32)>, linkage = #llvm.linkage<external>, memory_effects = #llvm.memory_effects<other = read, argMem = read, inaccessibleMem = none, errnoMem = read, targetMem0 = none, targetMem1 = none>, no_unwind, passthrough = ["mustprogress", "nofree", "norecurse", "nosync", ["min-legal-vector-width", "0"], ["no-trapping-math", "true"], ["stack-protector-buffer-size", "8"], ["target-cpu", "x86-64"]], sym_name = "_ZNK4llvm13AttributeList17getParamAlignmentEj", target_cpu = "x86-64", target_features = #llvm.target_features<["+cmov", "+cx8", "+fxsr", "+mmx", "+sse", "+sse2", "+x87"]>, tune_cpu = "generic", unnamed_addr = 1 : i64, uwtable_kind = #llvm.uwtableKind<async>, visibility_ = 0 : i64, will_return}> ({
  ^bb0(%arg0: !llvm.ptr, %arg1: i32):
    ...
    "llvm.cond_br"(%20, %2)[^bb9, ^bb1] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i16) -> ()
  ^bb1:  // pred: ^bb0
    %21 = "llvm.getelementptr"(%19, %3) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    %23 = "llvm.icmp"(%18, %22) <{predicate = 6 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%23, %2)[^bb2, ^bb9] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i16) -> ()
  ^bb2:  // pred: ^bb1
    %24 = "llvm.getelementptr"(%19, %4) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %25 = "llvm.zext"(%18) : (i32) -> i64
    %26 = "llvm.getelementptr"(%24, %25) <{elem_type = !llvm.struct<"class.llvm::AttributeSet", (ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    %29 = "llvm.icmp"(%27, %5) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%29, %2)[^bb9, ^bb3] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i16) -> ()
  ^bb3:  // pred: ^bb2
    %30 = "llvm.getelementptr"(%28, %6) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    %32 = "llvm.and"(%31, %7) : (i8, i8) -> i8
    %33 = "llvm.icmp"(%32, %8) <{predicate = 0 : i64}> : (i8, i8) -> i1
    "llvm.cond_br"(%33, %2)[^bb9, ^bb4] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i16) -> ()
  ^bb4:  // pred: ^bb3
    %34 = "llvm.getelementptr"(%28, %9) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %35 = "llvm.getelementptr"(%28, %3) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    %38 = "llvm.getelementptr"(%34, %37) <{elem_type = !llvm.struct<"class.llvm::Attribute", (ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %39 = "llvm.getelementptr"(%28, %4) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    %42 = "llvm.sub"(%5, %41) <{overflowFlags = 1 : i32}> : (i64, i64) -> i64
    %43 = "llvm.getelementptr"(%38, %42) <{elem_type = !llvm.struct<"class.llvm::Attribute", (ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %44 = "llvm.ptrtoint"(%43) : (!llvm.ptr) -> i64
    %45 = "llvm.ptrtoint"(%34) : (!llvm.ptr) -> i64
    %46 = "llvm.sub"(%44, %45) <{overflowFlags = 0 : i32}> : (i64, i64) -> i64
    %47 = "llvm.ashr"(%46, %10) <{isExact}> : (i64, i64) -> i64
    %48 = "llvm.icmp"(%47, %5) <{predicate = 4 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%48, %34, %47, %34)[^bb5, ^bb8] <{operandSegmentSizes = array<i32: 1, 2, 1>}> : (i1, !llvm.ptr, i64, !llvm.ptr) -> ()
  ^bb5(%49: !llvm.ptr, %50: i64):  // 2 preds: ^bb4, ^bb7
    %51 = "llvm.lshr"(%50, %11) : (i64, i64) -> i64
    %52 = "llvm.getelementptr"(%49, %51) <{elem_type = !llvm.struct<"class.llvm::Attribute", (ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %53 = "llvm.load"(%52) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "any pointer", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, access_type = <id = "any pointer", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (!llvm.ptr) -> !llvm.ptr
    %54 = "llvm.icmp"(%53, %1) <{predicate = 0 : i64}> : (!llvm.ptr, !llvm.ptr) -> i1
    "llvm.cond_br"(%54, %12)[^bb7, ^bb6] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i32) -> ()
  ^bb6:  // pred: ^bb5
    %55 = "llvm.getelementptr"(%53, %13) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    "llvm.br"(%56)[^bb7] : (i32) -> ()
  ^bb7(%57: i32):  // 2 preds: ^bb5, ^bb6
    %58 = "llvm.icmp"(%57, %14) <{predicate = 2 : i64}> : (i32, i32) -> i1
    %59 = "llvm.getelementptr"(%52, %3) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %60 = "llvm.xor"(%51, %15) : (i64, i64) -> i64
    %61 = "llvm.add"(%50, %60) <{overflowFlags = 1 : i32}> : (i64, i64) -> i64
    %62 = "llvm.select"(%58, %61, %51) <{fastmathFlags = #llvm.fastmath<none>}> : (i1, i64, i64) -> i64
    %63 = "llvm.select"(%58, %59, %49) <{fastmathFlags = #llvm.fastmath<none>}> : (i1, !llvm.ptr, !llvm.ptr) -> !llvm.ptr
    %64 = "llvm.icmp"(%62, %5) <{predicate = 4 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%64, %63, %62, %63)[^bb5, ^bb8] <{loop_annotation = #llvm.loop_annotation<mustProgress = true>, operandSegmentSizes = array<i32: 1, 2, 1>}> : (i1, !llvm.ptr, i64, !llvm.ptr) -> ()
  ^bb8(%65: !llvm.ptr):  // 2 preds: ^bb4, ^bb7
    %66 = "llvm.load"(%65) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "any pointer", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, access_type = <id = "any pointer", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (!llvm.ptr) -> i64
    %67 = "llvm.inttoptr"(%66) : (i64) -> !llvm.ptr
    %68 = "llvm.getelementptr"(%67, %16) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    %72 = "llvm.trunc"(%71) <{overflowFlags = 3 : i32}> : (i64) -> i16
    %73 = "llvm.xor"(%72, %17) : (i16, i16) -> i16
    %74 = "llvm.select"(%70, %2, %73) <{fastmathFlags = #llvm.fastmath<none>}> : (i1, i16, i16) -> i16
    "llvm.br"(%74)[^bb9] : (i16) -> ()
  ^bb9(%75: i16):  // 5 preds: ^bb0, ^bb1, ^bb2, ^bb3, ^bb8
    "llvm.return"(%75) : (i16) -> ()
  }) : () -> ()
