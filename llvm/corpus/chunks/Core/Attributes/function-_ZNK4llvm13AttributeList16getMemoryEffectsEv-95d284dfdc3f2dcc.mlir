"builtin.module"() ({
  ...
  ^bb1:  // pred: ^bb0
    ...
    "llvm.cond_br"(%20, %1)[^bb9, ^bb2] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i32) -> ()
  ^bb2:  // pred: ^bb1
  ...
  ^bb4:  // pred: ^bb3
    %29 = "llvm.getelementptr"(%23, %9) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    %34 = "llvm.getelementptr"(%23, %4) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
  ...
  ^bb5(%44: !llvm.ptr, %45: i64):  // 2 preds: ^bb4, ^bb7
    ...
    "llvm.cond_br"(%49, %3)[^bb7, ^bb6] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i32) -> ()
  ^bb6:  // pred: ^bb5
