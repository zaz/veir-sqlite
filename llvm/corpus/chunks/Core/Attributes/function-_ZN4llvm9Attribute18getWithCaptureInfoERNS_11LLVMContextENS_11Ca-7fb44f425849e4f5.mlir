"builtin.module"() ({
  ...
  "llvm.func"() <{CConv = #llvm.cconv<ccc>, alignment = 2 : i64, arg_attrs = [{llvm.align = 8 : i64, llvm.dereferenceable = 8 : i64, llvm.nocapture, llvm.nonnull, llvm.noundef, llvm.readonly}, {}], dso_local, function_type = !llvm.func<ptr (ptr, i16)>, linkage = #llvm.linkage<external>, no_unwind, passthrough = ["mustprogress", ["min-legal-vector-width", "0"], ["no-trapping-math", "true"], ["stack-protector-buffer-size", "8"], ["target-cpu", "x86-64"]], res_attrs = [{llvm.noundef}], sym_name = "_ZN4llvm9Attribute18getWithCaptureInfoERNS_11LLVMContextENS_11CaptureInfoE", target_cpu = "x86-64", target_features = #llvm.target_features<["+cmov", "+cx8", "+fxsr", "+mmx", "+sse", "+sse2", "+x87"]>, tune_cpu = "generic", unnamed_addr = 1 : i64, uwtable_kind = #llvm.uwtableKind<async>, visibility_ = 0 : i64}> ({
  ^bb0(%arg0: !llvm.ptr, %arg1: i16):
    %0 = "llvm.mlir.constant"() <{value = 8 : i16}> : () -> i16
    %1 = "llvm.mlir.constant"() <{value = 4 : i16}> : () -> i16
    %2 = "llvm.mlir.constant"() <{value = 4080 : i16}> : () -> i16
    %3 = "llvm.mlir.constant"() <{value = 94 : i32}> : () -> i32
    %4 = "llvm.lshr"(%arg1, %0) : (i16, i16) -> i16
    %5 = "llvm.shl"(%arg1, %1) <{overflowFlags = 0 : i32}> : (i16, i16) -> i16
    %6 = "llvm.and"(%5, %2) : (i16, i16) -> i16
    %7 = "llvm.or"(%6, %4) : (i16, i16) -> i16
    %8 = "llvm.zext"(%7) <{nonNeg}> : (i16) -> i64
    %9 = "llvm.call"(%arg0, %3, %8) <{CConv = #llvm.cconv<ccc>, TailCallKind = #llvm.tailcallkind<tail>, arg_attrs = [{llvm.align = 8 : i64, llvm.dereferenceable = 8 : i64, llvm.nonnull, llvm.noundef}, {llvm.noundef}, {llvm.noundef}], callee = @_ZN4llvm9Attribute3getERNS_11LLVMContextENS0_8AttrKindEm, fastmathFlags = #llvm.fastmath<none>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 3, 0>}> : (!llvm.ptr, i32, i64) -> !llvm.ptr
