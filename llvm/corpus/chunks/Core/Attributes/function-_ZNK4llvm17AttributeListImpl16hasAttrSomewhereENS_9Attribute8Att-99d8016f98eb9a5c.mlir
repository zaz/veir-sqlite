"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr, %arg1: i32, %arg2: !llvm.ptr):
    ...
    %13 = "llvm.sdiv"(%arg1, %1) : (i32, i32) -> i32
    %14 = "llvm.sext"(%13) : (i32) -> i64
    %15 = "llvm.getelementptr"(%12, %2, %14) <{elem_type = !llvm.array<16 x i8>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, -2147483648>}> : (!llvm.ptr, i64, i64) -> !llvm.ptr
    ...
    %18 = "llvm.and"(%arg1, %3) : (i32, i32) -> i32
    %19 = "llvm.shl"(%4, %18) <{overflowFlags = 3 : i32}> : (i32, i32) -> i32
    %20 = "llvm.and"(%19, %17) : (i32, i32) -> i32
    %21 = "llvm.icmp"(%20, %5) <{predicate = 1 : i64}> : (i32, i32) -> i1
    %22 = "llvm.icmp"(%arg2, %6) <{predicate = 1 : i64}> : (!llvm.ptr, !llvm.ptr) -> i1
    %23 = "llvm.and"(%22, %21) : (i1, i1) -> i1
  ...
  ^bb1:  // pred: ^bb0
    ...
    "llvm.cond_br"(%26)[^bb7, ^bb2] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb2:  // pred: ^bb1
  ...
  ^bb3(%29: i64):  // 2 preds: ^bb2, ^bb6
    %30 = "llvm.getelementptr"(%27, %29) <{elem_type = !llvm.struct<"class.llvm::AttributeSet", (ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    "llvm.cond_br"(%32)[^bb6, ^bb4] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb4:  // pred: ^bb3
    %33 = "llvm.getelementptr"(%31, %9) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %34 = "llvm.getelementptr"(%33, %2, %14) <{elem_type = !llvm.array<16 x i8>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, -2147483648>}> : (!llvm.ptr, i64, i64) -> !llvm.ptr
    ...
    %37 = "llvm.and"(%19, %36) : (i32, i32) -> i32
    %38 = "llvm.icmp"(%37, %5) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%38)[^bb6, ^bb5] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb5:  // pred: ^bb4
    %39 = "llvm.trunc"(%29) <{overflowFlags = 2 : i32}> : (i64) -> i32
    %40 = "llvm.add"(%39, %10) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
    "llvm.store"(%40, %arg2) <{alignment = 4 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, access_type = <id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (i32, !llvm.ptr) -> ()
    "llvm.br"()[^bb7] : () -> ()
  ^bb6:  // 2 preds: ^bb3, ^bb4
    %41 = "llvm.add"(%29, %11) <{overflowFlags = 3 : i32}> : (i64, i64) -> i64
    %42 = "llvm.icmp"(%41, %28) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%42, %41)[^bb7, ^bb3] <{loop_annotation = #llvm.loop_annotation<mustProgress = true>, operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i64) -> ()
  ^bb7:  // 4 preds: ^bb0, ^bb1, ^bb5, ^bb6
    "llvm.return"(%21) : (i1) -> ()
  }) : () -> ()
