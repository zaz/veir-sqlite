"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr, %arg1: i32):
    ...
    %14 = "llvm.sdiv"(%arg1, %1) : (i32, i32) -> i32
    %15 = "llvm.sext"(%14) : (i32) -> i64
    %16 = "llvm.getelementptr"(%13, %2, %15) <{elem_type = !llvm.array<16 x i8>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, -2147483648>}> : (!llvm.ptr, i64, i64) -> !llvm.ptr
    ...
    %19 = "llvm.and"(%arg1, %3) : (i32, i32) -> i32
    %20 = "llvm.shl"(%4, %19) <{overflowFlags = 3 : i32}> : (i32, i32) -> i32
    %21 = "llvm.and"(%20, %18) : (i32, i32) -> i32
    %22 = "llvm.icmp"(%21, %5) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%22, %6)[^bb6, ^bb1] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, !llvm.ptr) -> ()
  ^bb1:  // pred: ^bb0
    ...
    %36 = "llvm.ashr"(%35, %10) <{isExact}> : (i64, i64) -> i64
  ...
  ^bb2(%38: !llvm.ptr, %39: i64):  // 2 preds: ^bb1, ^bb4
    ...
    "llvm.cond_br"(%43, %5)[^bb4, ^bb3] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i32) -> ()
  ^bb3:  // pred: ^bb2
  ...
  ^bb4(%46: i32):  // 2 preds: ^bb2, ^bb3
    %47 = "llvm.icmp"(%46, %arg1) <{predicate = 2 : i64}> : (i32, i32) -> i1
    %48 = "llvm.getelementptr"(%41, %8) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %49 = "llvm.xor"(%40, %12) : (i64, i64) -> i64
    ...
    %53 = "llvm.icmp"(%51, %2) <{predicate = 4 : i64}> : (i64, i64) -> i1
  ...
  ^bb5(%54: !llvm.ptr):  // 2 preds: ^bb1, ^bb4
    ...
    "llvm.br"(%56)[^bb6] : (!llvm.ptr) -> ()
  ^bb6(%57: !llvm.ptr):  // 2 preds: ^bb0, ^bb5
