"builtin.module"() ({
  ...
  "llvm.func"() <{CConv = #llvm.cconv<ccc>, alignment = 2 : i64, arg_attrs = [{llvm.align = 8 : i64, llvm.dereferenceable = 8 : i64, llvm.nocapture, llvm.nonnull, llvm.noundef, llvm.readonly}, {llvm.noundef}, {llvm.noundef}], dso_local, function_type = !llvm.func<i1 (ptr, i32, i32)>, linkage = #llvm.linkage<external>, memory_effects = #llvm.memory_effects<other = read, argMem = read, inaccessibleMem = none, errnoMem = read, targetMem0 = none, targetMem1 = none>, no_unwind, passthrough = ["mustprogress", "nofree", "norecurse", "nosync", ["min-legal-vector-width", "0"], ["no-trapping-math", "true"], ["stack-protector-buffer-size", "8"], ["target-cpu", "x86-64"]], res_attrs = [{llvm.noundef, llvm.zeroext}], sym_name = "_ZNK4llvm13AttributeList19hasAttributeAtIndexEjNS_9Attribute8AttrKindE", target_cpu = "x86-64", target_features = #llvm.target_features<["+cmov", "+cx8", "+fxsr", "+mmx", "+sse", "+sse2", "+x87"]>, tune_cpu = "generic", unnamed_addr = 1 : i64, uwtable_kind = #llvm.uwtableKind<async>, visibility_ = 0 : i64, will_return}> ({
  ^bb0(%arg0: !llvm.ptr, %arg1: i32, %arg2: i32):
    ...
    %10 = "llvm.add"(%arg1, %0) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
  ...
  ^bb1:  // pred: ^bb0
    ...
    %15 = "llvm.icmp"(%10, %14) <{predicate = 6 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%15, %2)[^bb2, ^bb4] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i1) -> ()
  ^bb2:  // pred: ^bb1
    %16 = "llvm.getelementptr"(%11, %4) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %17 = "llvm.zext"(%10) : (i32) -> i64
    %18 = "llvm.getelementptr"(%16, %17) <{elem_type = !llvm.struct<"class.llvm::AttributeSet", (ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %19 = "llvm.load"(%18) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "any pointer", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, access_type = <id = "any pointer", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (!llvm.ptr) -> i64
    %20 = "llvm.icmp"(%19, %5) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%20, %2)[^bb4, ^bb3] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i1) -> ()
  ^bb3:  // pred: ^bb2
    %21 = "llvm.inttoptr"(%19) : (i64) -> !llvm.ptr
    %22 = "llvm.getelementptr"(%21, %6) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %23 = "llvm.sdiv"(%arg2, %7) : (i32, i32) -> i32
    %24 = "llvm.sext"(%23) : (i32) -> i64
    %25 = "llvm.getelementptr"(%22, %5, %24) <{elem_type = !llvm.array<16 x i8>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648, -2147483648>}> : (!llvm.ptr, i64, i64) -> !llvm.ptr
    ...
    %28 = "llvm.and"(%arg2, %8) : (i32, i32) -> i32
    %29 = "llvm.shl"(%0, %28) <{overflowFlags = 3 : i32}> : (i32, i32) -> i32
    %30 = "llvm.and"(%29, %27) : (i32, i32) -> i32
    %31 = "llvm.icmp"(%30, %9) <{predicate = 1 : i64}> : (i32, i32) -> i1
    "llvm.br"(%31)[^bb4] : (i1) -> ()
  ^bb4(%32: i1):  // 4 preds: ^bb0, ^bb1, ^bb2, ^bb3
    "llvm.return"(%32) : (i1) -> ()
  }) : () -> ()
