"builtin.module"() ({
  ...
  "llvm.func"() <{CConv = #llvm.cconv<ccc>, alignment = 2 : i64, arg_attrs = [{llvm.align = 8 : i64, llvm.dereferenceable = 8 : i64, llvm.nocapture, llvm.nonnull, llvm.noundef, llvm.readonly}, {llvm.noundef}], dso_local, function_type = !llvm.func<struct<(i64, i8)> (ptr, i32)>, linkage = #llvm.linkage<external>, memory_effects = #llvm.memory_effects<other = read, argMem = read, inaccessibleMem = none, errnoMem = read, targetMem0 = none, targetMem1 = none>, no_unwind, passthrough = ["mustprogress", "nofree", "norecurse", "nosync", ["min-legal-vector-width", "0"], ["no-trapping-math", "true"], ["stack-protector-buffer-size", "8"], ["target-cpu", "x86-64"]], sym_name = "_ZNK4llvm13AttributeList19getDeadOnReturnInfoEj", target_cpu = "x86-64", target_features = #llvm.target_features<["+cmov", "+cx8", "+fxsr", "+mmx", "+sse", "+sse2", "+x87"]>, tune_cpu = "generic", unnamed_addr = 1 : i64, uwtable_kind = #llvm.uwtableKind<async>, visibility_ = 0 : i64, will_return}> ({
  ^bb0(%arg0: !llvm.ptr, %arg1: i32):
    ...
    %16 = "llvm.mlir.poison"() : () -> !llvm.struct<(i64, i8)>
    %17 = "llvm.add"(%arg1, %0) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
    ...
    "llvm.cond_br"(%19, %2, %3)[^bb9, ^bb1] <{operandSegmentSizes = array<i32: 1, 2, 0>}> : (i1, i8, i64) -> ()
  ^bb1:  // pred: ^bb0
    %20 = "llvm.getelementptr"(%18, %4) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    %22 = "llvm.icmp"(%17, %21) <{predicate = 6 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%22, %2, %3)[^bb2, ^bb9] <{operandSegmentSizes = array<i32: 1, 0, 2>}> : (i1, i8, i64) -> ()
  ^bb2:  // pred: ^bb1
    ...
    %25 = "llvm.getelementptr"(%23, %24) <{elem_type = !llvm.struct<"class.llvm::AttributeSet", (ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %26 = "llvm.load"(%25) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "any pointer", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, access_type = <id = "any pointer", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (!llvm.ptr) -> i64
    %27 = "llvm.inttoptr"(%26) : (i64) -> !llvm.ptr
    %28 = "llvm.icmp"(%26, %3) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%28, %2, %3)[^bb9, ^bb3] <{operandSegmentSizes = array<i32: 1, 2, 0>}> : (i1, i8, i64) -> ()
  ^bb3:  // pred: ^bb2
    ...
    %31 = "llvm.icmp"(%30, %7) <{predicate = 4 : i64}> : (i8, i8) -> i1
    "llvm.cond_br"(%31, %2, %3)[^bb9, ^bb4] <{operandSegmentSizes = array<i32: 1, 2, 0>}> : (i1, i8, i64) -> ()
  ^bb4:  // pred: ^bb3
    %32 = "llvm.getelementptr"(%27, %8) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %33 = "llvm.getelementptr"(%27, %4) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    %37 = "llvm.getelementptr"(%27, %5) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    %46 = "llvm.icmp"(%45, %3) <{predicate = 4 : i64}> : (i64, i64) -> i1
  ...
  ^bb7(%55: i32):  // 2 preds: ^bb5, ^bb6
    ...
    %57 = "llvm.getelementptr"(%50, %4) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    %62 = "llvm.icmp"(%60, %3) <{predicate = 4 : i64}> : (i64, i64) -> i1
  ...
  ^bb8(%63: !llvm.ptr):  // 2 preds: ^bb4, ^bb7
    ...
    %65 = "llvm.inttoptr"(%64) : (i64) -> !llvm.ptr
    ...
    %68 = "llvm.icmp"(%67, %14) <{predicate = 1 : i64}> : (i64, i64) -> i1
    %69 = "llvm.zext"(%68) : (i1) -> i8
    "llvm.br"(%69, %67)[^bb9] : (i8, i64) -> ()
  ^bb9(%70: i8, %71: i64):  // 5 preds: ^bb0, ^bb1, ^bb2, ^bb3, ^bb8
    %72 = "llvm.insertvalue"(%16, %71) <{position = array<i64: 0>}> : (!llvm.struct<(i64, i8)>, i64) -> !llvm.struct<(i64, i8)>
    %73 = "llvm.insertvalue"(%72, %70) <{position = array<i64: 1>}> : (!llvm.struct<(i64, i8)>, i8) -> !llvm.struct<(i64, i8)>
    "llvm.return"(%73) : (!llvm.struct<(i64, i8)>) -> ()
  }) : () -> ()
