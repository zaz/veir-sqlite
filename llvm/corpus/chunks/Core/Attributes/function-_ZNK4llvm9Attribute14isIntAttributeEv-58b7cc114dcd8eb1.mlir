"builtin.module"() ({
  ...
  ^bb1:  // pred: ^bb0
    %6 = "llvm.getelementptr"(%4, %2) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    %8 = "llvm.icmp"(%7, %3) <{predicate = 0 : i64}> : (i8, i8) -> i1
    "llvm.br"(%8)[^bb2] : (i1) -> ()
