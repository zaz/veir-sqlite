"builtin.module"() ({
  ...
  ^bb2:  // pred: ^bb1
    %11 = "llvm.getelementptr"(%6, %3) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    %13 = "llvm.icmp"(%12, %arg1) <{predicate = 0 : i64}> : (i32, i32) -> i1
    "llvm.cond_br"(%13, %4)[^bb4, ^bb3] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i1) -> ()
  ^bb3:  // 3 preds: ^bb0, ^bb1, ^bb2
    %14 = "llvm.icmp"(%arg1, %5) <{predicate = 0 : i64}> : (i32, i32) -> i1
    %15 = "llvm.and"(%14, %7) : (i1, i1) -> i1
    "llvm.br"(%15)[^bb4] : (i1) -> ()
