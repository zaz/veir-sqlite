"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr, %arg1: i32):
    ...
    "llvm.cond_br"(%18, %2)[^bb9, ^bb1] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i64) -> ()
  ^bb1:  // pred: ^bb0
    ...
    "llvm.cond_br"(%21, %2)[^bb2, ^bb9] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i64) -> ()
  ^bb2:  // pred: ^bb1
    ...
    %27 = "llvm.icmp"(%25, %2) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%27, %2)[^bb9, ^bb3] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i64) -> ()
  ^bb3:  // pred: ^bb2
    ...
    "llvm.cond_br"(%31, %2)[^bb9, ^bb4] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i64) -> ()
  ^bb4:  // pred: ^bb3
    %32 = "llvm.getelementptr"(%26, %8) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %33 = "llvm.getelementptr"(%26, %3) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    %40 = "llvm.sub"(%2, %39) <{overflowFlags = 1 : i32}> : (i64, i64) -> i64
    ...
    %46 = "llvm.icmp"(%45, %2) <{predicate = 4 : i64}> : (i64, i64) -> i1
  ...
  ^bb7(%55: i32):  // 2 preds: ^bb5, ^bb6
    ...
    %57 = "llvm.getelementptr"(%50, %3) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    %62 = "llvm.icmp"(%60, %2) <{predicate = 4 : i64}> : (i64, i64) -> i1
  ...
  ^bb8(%63: !llvm.ptr):  // 2 preds: ^bb4, ^bb7
    ...
    "llvm.br"(%67)[^bb9] : (i64) -> ()
  ^bb9(%68: i64):  // 5 preds: ^bb0, ^bb1, ^bb2, ^bb3, ^bb8
    "llvm.return"(%68) : (i64) -> ()
  }) : () -> ()
