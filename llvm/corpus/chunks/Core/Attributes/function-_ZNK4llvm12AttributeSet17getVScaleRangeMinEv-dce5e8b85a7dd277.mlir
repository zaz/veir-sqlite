"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr):
    ...
    %12 = "llvm.mlir.constant"() <{value = 103 : i32}> : () -> i32
    ...
    %19 = "llvm.alloca"(%0) <{alignment = 8 : i64, elem_type = !llvm.struct<"struct.std::pair", (i32, struct<"class.std::optional.10", (struct<"struct.std::_Optional_base.11", (struct<"struct.std::_Optional_payload.13", (struct<"struct.std::_Optional_payload_base.base.15", packed (struct<"union.std::_Optional_payload_base<unsigned int>::_Storage", (i32)>, i8)>, array<3 x i8>)>)>)>)>}> : (i32) -> !llvm.ptr
    ...
    "llvm.cond_br"(%21, %0)[^bb7, ^bb1] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i32) -> ()
  ^bb1:  // pred: ^bb0
    ...
    %24 = "llvm.icmp"(%23, %3) <{predicate = 4 : i64}> : (i8, i8) -> i1
    "llvm.cond_br"(%24, %0)[^bb7, ^bb2] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i32) -> ()
  ^bb2:  // pred: ^bb1
    ...
    %30 = "llvm.getelementptr"(%20, %6) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    %33 = "llvm.sub"(%7, %32) <{overflowFlags = 1 : i32}> : (i64, i64) -> i64
    %34 = "llvm.getelementptr"(%29, %33) <{elem_type = !llvm.struct<"class.llvm::Attribute", (ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %35 = "llvm.ptrtoint"(%34) : (!llvm.ptr) -> i64
    %36 = "llvm.ptrtoint"(%25) : (!llvm.ptr) -> i64
    %37 = "llvm.sub"(%35, %36) <{overflowFlags = 0 : i32}> : (i64, i64) -> i64
    %38 = "llvm.ashr"(%37, %8) <{isExact}> : (i64, i64) -> i64
    %39 = "llvm.icmp"(%38, %7) <{predicate = 4 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%39, %25, %38, %25)[^bb3, ^bb6] <{operandSegmentSizes = array<i32: 1, 2, 1>}> : (i1, !llvm.ptr, i64, !llvm.ptr) -> ()
  ^bb3(%40: !llvm.ptr, %41: i64):  // 2 preds: ^bb2, ^bb5
    %42 = "llvm.lshr"(%41, %9) : (i64, i64) -> i64
    %43 = "llvm.getelementptr"(%40, %42) <{elem_type = !llvm.struct<"class.llvm::Attribute", (ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    "llvm.cond_br"(%45, %10)[^bb5, ^bb4] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i32) -> ()
  ^bb4:  // pred: ^bb3
    %46 = "llvm.getelementptr"(%44, %11) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
  ...
  ^bb5(%48: i32):  // 2 preds: ^bb3, ^bb4
    %49 = "llvm.icmp"(%48, %12) <{predicate = 2 : i64}> : (i32, i32) -> i1
    %50 = "llvm.getelementptr"(%43, %5) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %51 = "llvm.xor"(%42, %13) : (i64, i64) -> i64
    %52 = "llvm.add"(%41, %51) <{overflowFlags = 1 : i32}> : (i64, i64) -> i64
    %53 = "llvm.select"(%49, %52, %42) <{fastmathFlags = #llvm.fastmath<none>}> : (i1, i64, i64) -> i64
    %54 = "llvm.select"(%49, %50, %40) <{fastmathFlags = #llvm.fastmath<none>}> : (i1, !llvm.ptr, !llvm.ptr) -> !llvm.ptr
    %55 = "llvm.icmp"(%53, %7) <{predicate = 4 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%55, %54, %53, %54)[^bb3, ^bb6] <{loop_annotation = #llvm.loop_annotation<mustProgress = true>, operandSegmentSizes = array<i32: 1, 2, 1>}> : (i1, !llvm.ptr, i64, !llvm.ptr) -> ()
  ^bb6(%56: !llvm.ptr):  // 2 preds: ^bb2, ^bb5
    %57 = "llvm.load"(%56) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "any pointer", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, access_type = <id = "any pointer", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (!llvm.ptr) -> i64
    %58 = "llvm.inttoptr"(%57) : (i64) -> !llvm.ptr
    %59 = "llvm.getelementptr"(%58, %14) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    %61 = "llvm.lshr"(%60, %15) : (i64, i64) -> i64
    %62 = "llvm.trunc"(%61) <{overflowFlags = 2 : i32}> : (i64) -> i32
    %63 = "llvm.and"(%60, %16) : (i64, i64) -> i64
    %64 = "llvm.icmp"(%63, %7) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.intr.lifetime.start"(%19) : (!llvm.ptr) -> ()
    "llvm.store"(%62, %19) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "_ZTSSt4pairIjSt8optionalIjEE", members = {<#llvm.tbaa_type_desc<id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, 0>, <#llvm.tbaa_type_desc<id = "_ZTSSt8optionalIjE", members = {<#llvm.tbaa_type_desc<id = "_ZTSSt14_Optional_baseIjLb1ELb1EE", members = {<#llvm.tbaa_type_desc<id = "_ZTSSt17_Optional_payloadIjLb1ELb1ELb1EE", members = {<#llvm.tbaa_type_desc<id = "_ZTSSt22_Optional_payload_baseIjE", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>, <#llvm.tbaa_type_desc<id = "bool", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, 4>}>, 0>}>, 0>}>, 0>}>, 4>}>, access_type = <id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (i32, !llvm.ptr) -> ()
    %65 = "llvm.select"(%64, %7, %17) <{fastmathFlags = #llvm.fastmath<none>}> : (i1, i64, i64) -> i64
    %66 = "llvm.or"(%65, %63) <{isDisjoint}> : (i64, i64) -> i64
    %67 = "llvm.getelementptr"(%19, %18) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    "llvm.store"(%66, %67) <{alignment = 4 : i64, ordering = 0 : i64}> : (i64, !llvm.ptr) -> ()
    ...
    "llvm.br"(%69)[^bb7] : (i32) -> ()
  ^bb7(%70: i32):  // 3 preds: ^bb0, ^bb1, ^bb6
    "llvm.return"(%70) : (i32) -> ()
  }) : () -> ()
