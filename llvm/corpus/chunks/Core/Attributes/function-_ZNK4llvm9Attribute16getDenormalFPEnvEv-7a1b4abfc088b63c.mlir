"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr):
    ...
    %5 = "llvm.mlir.constant"() <{value = 196608 : i32}> : () -> i32
    %6 = "llvm.mlir.constant"() <{value = 6 : i32}> : () -> i32
    %7 = "llvm.mlir.constant"() <{value = 768 : i32}> : () -> i32
    ...
    %13 = "llvm.shl"(%11, %2) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
    %14 = "llvm.and"(%13, %3) : (i32, i32) -> i32
    %15 = "llvm.shl"(%11, %4) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
    %16 = "llvm.and"(%15, %5) : (i32, i32) -> i32
    %17 = "llvm.shl"(%11, %6) <{overflowFlags = 0 : i32}> : (i32, i32) -> i32
    %18 = "llvm.and"(%17, %7) : (i32, i32) -> i32
    %19 = "llvm.or"(%16, %12) <{isDisjoint}> : (i32, i32) -> i32
    %20 = "llvm.or"(%19, %14) <{isDisjoint}> : (i32, i32) -> i32
    %21 = "llvm.or"(%20, %18) <{isDisjoint}> : (i32, i32) -> i32
    "llvm.return"(%21) : (i32) -> ()
  }) : () -> ()
