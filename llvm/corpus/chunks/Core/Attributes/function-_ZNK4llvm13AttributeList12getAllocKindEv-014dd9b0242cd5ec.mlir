"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr):
    ...
    "llvm.cond_br"(%16, %1)[^bb9, ^bb1] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i64) -> ()
  ^bb1:  // pred: ^bb0
    ...
    "llvm.cond_br"(%19, %1)[^bb9, ^bb2] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i64) -> ()
  ^bb2:  // pred: ^bb1
    %20 = "llvm.getelementptr"(%15, %4) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    %23 = "llvm.icmp"(%21, %1) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%23, %1)[^bb9, ^bb3] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i64) -> ()
  ^bb3:  // pred: ^bb2
    ...
    "llvm.cond_br"(%27, %1)[^bb9, ^bb4] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i64) -> ()
  ^bb4:  // pred: ^bb3
    ...
    %33 = "llvm.getelementptr"(%22, %4) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    %42 = "llvm.icmp"(%41, %1) <{predicate = 4 : i64}> : (i64, i64) -> i1
  ...
  ^bb5(%43: !llvm.ptr, %44: i64):  // 2 preds: ^bb4, ^bb7
    ...
    "llvm.cond_br"(%48, %3)[^bb7, ^bb6] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i32) -> ()
  ^bb6:  // pred: ^bb5
  ...
  ^bb7(%51: i32):  // 2 preds: ^bb5, ^bb6
    ...
    %58 = "llvm.icmp"(%56, %1) <{predicate = 4 : i64}> : (i64, i64) -> i1
  ...
  ^bb8(%59: !llvm.ptr):  // 2 preds: ^bb4, ^bb7
    ...
    "llvm.br"(%63)[^bb9] : (i64) -> ()
  ^bb9(%64: i64):  // 5 preds: ^bb0, ^bb1, ^bb2, ^bb3, ^bb8
    "llvm.return"(%64) : (i64) -> ()
  }) : () -> ()
