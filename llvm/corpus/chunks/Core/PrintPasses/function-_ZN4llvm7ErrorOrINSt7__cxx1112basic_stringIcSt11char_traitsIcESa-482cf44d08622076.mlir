"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr):
    ...
    %6 = "llvm.trunc"(%5) <{overflowFlags = 0 : i32}> : (i8) -> i1
    "llvm.cond_br"(%6)[^bb4, ^bb1] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb1:  // pred: ^bb0
  ...
  ^bb2:  // pred: ^bb1
    ...
    %12 = "llvm.icmp"(%11, %1) <{predicate = 6 : i64}> : (i64, i64) -> i1
