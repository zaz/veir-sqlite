"builtin.module"() ({
  ...
  ^bb0(%arg0: !llvm.ptr):
    ...
    "llvm.cond_br"(%18, %2)[^bb14, ^bb1] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i1) -> ()
  ^bb1:  // pred: ^bb0
  ...
  ^bb2:  // pred: ^bb1
    ...
    "llvm.cond_br"(%24, %2)[^bb14, ^bb5] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i1) -> ()
  ^bb3:  // pred: ^bb1
    ...
    "llvm.cond_br"(%27, %2)[^bb14, ^bb4] <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (i1, i1) -> ()
  ^bb4:  // pred: ^bb3
  ...
  ^bb6(%34: !llvm.ptr):  // 2 preds: ^bb4, ^bb5
    ...
    "llvm.cond_br"(%37, %2)[^bb7, ^bb14] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i1) -> ()
  ^bb7:  // pred: ^bb6
    ...
    "llvm.cond_br"(%42, %2)[^bb8, ^bb14] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i1) -> ()
  ^bb8:  // pred: ^bb7
    %43 = "llvm.icmp"(%40, %5) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%43)[^bb10, ^bb9] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb9:  // pred: ^bb8
    ...
    "llvm.cond_br"(%45, %2)[^bb10, ^bb14] <{operandSegmentSizes = array<i32: 1, 0, 1>}> : (i1, i1) -> ()
  ^bb10:  // 2 preds: ^bb8, ^bb9
    %46 = "llvm.load"(%19) <{alignment = 8 : i64, ordering = 0 : i64}> : (!llvm.ptr) -> i64
    %47 = "llvm.and"(%46, %4) : (i64, i64) -> i64
    %48 = "llvm.icmp"(%47, %5) <{predicate = 0 : i64}> : (i64, i64) -> i1
    "llvm.cond_br"(%48)[^bb12, ^bb11] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb11:  // pred: ^bb10
    %49 = "llvm.getelementptr"(%arg0, %8) <{elem_type = i8, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    %50 = "llvm.load"(%49) <{alignment = 8 : i64, ordering = 0 : i64, tbaa = [#llvm.tbaa_tag<base_type = <id = "_ZTSN4llvm15SmallVectorBaseIjEE", members = {<#llvm.tbaa_type_desc<id = "any pointer", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, 0>, <#llvm.tbaa_type_desc<id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, 8>, <#llvm.tbaa_type_desc<id = "int", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, 12>}>, access_type = <id = "any pointer", members = {<#llvm.tbaa_type_desc<id = "omnipotent char", members = {<#llvm.tbaa_root<id = "Simple C++ TBAA">, 0>}>, 0>}>, offset = 0>]}> : (!llvm.ptr) -> !llvm.ptr
    "llvm.br"(%50)[^bb13] : (!llvm.ptr) -> ()
  ^bb12:  // pred: ^bb10
    %51 = "llvm.lshr"(%46, %4) : (i64, i64) -> i64
    %52 = "llvm.and"(%51, %11) : (i64, i64) -> i64
    %53 = "llvm.sub"(%5, %52) <{overflowFlags = 1 : i32}> : (i64, i64) -> i64
    %54 = "llvm.getelementptr"(%19, %53) <{elem_type = !llvm.struct<"class.llvm::MDOperand", (ptr)>, noWrapFlags = 3 : i32, rawConstantIndices = array<i32: -2147483648>}> : (!llvm.ptr, i64) -> !llvm.ptr
    "llvm.br"(%54)[^bb13] : (!llvm.ptr) -> ()
  ^bb13(%55: !llvm.ptr):  // 2 preds: ^bb11, ^bb12
    ...
    %59 = "llvm.icmp"(%58, %12) <{predicate = 0 : i64}> : (i8, i8) -> i1
    "llvm.br"(%59)[^bb14] : (i1) -> ()
  ^bb14(%60: i1):  // 7 preds: ^bb0, ^bb2, ^bb3, ^bb6, ^bb7, ^bb9, ^bb13
    "llvm.return"(%60) : (i1) -> ()
  }) : () -> ()
